...
final class Class246_Sub9 extends Node {
	...
	static final Class246_Sub9 method1848(CacheIndex class_fs, int i) {
	...
	static final Class246_Sub9 method1850(CacheIndex class_fs, int i, int i_4_) {
		if (!method1852(class_fs)) {
			class_fs.method85(i_4_, (byte) -124, i);
			return null;
		}
		byte[] is = class_fs.get_file(i_4_, i);
		if (is == null)
			return null;
		return new Class246_Sub9(is);
	}
	...
	private static final boolean method1852(CacheIndex class_fs) {
		if (!aBool4002) {
			byte[] is = class_fs.get_file(0, 0);
			if (is == null)
				return false;
			method1851(is);
			aBool4002 = true;
