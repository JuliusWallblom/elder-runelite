...
final class InvTypeLoader {
	private CacheIndex aClass_fs838;
	...
	static MultilingualString aClass67_844;
	...
	final Class246_Sub1_Sub2 method416(int i, int i_0_) {
		try {
			...
			byte[] is = aClass_fs838.get_file(i_0_, i);
			class246_sub1_sub2 = new Class246_Sub1_Sub2();
			if (is != null)
				class246_sub1_sub2.method2422(i + 1439100499, new Buffer(is));
			synchronized (aClass54_843) {
	...
	InvTypeLoader(Class101 class101, int i, CacheIndex class_fs) {
		try {
			aClass_fs838 = class_fs;
			aClass_fs838.child_count(5);
		} catch (RuntimeException runtimeexception) {
	...
	static {
		...
		aClass67_844 = new MultilingualString("glow2:", "leuchten2:", "brillant2:", "brilho2:");
