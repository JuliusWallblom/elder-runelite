...
final class Class35 {
	...
	static MultilingualString aClass67_468;
	...
	static final Class21_Sub2 method251(int i, Buffer stream) {
		try {
			if (i != 18002)
				method251(-52, null);
			anInt471++;
			return new Class21_Sub2(stream.method2375((byte) 1), stream.method2375((byte) 1), stream.method2375((byte) 1), stream.method2375((byte) 1), stream.read24BitInteger((byte) 29), stream.readUnsignedByte());
		} catch (RuntimeException runtimeexception) {
	...
	static {
		aClass67_468 = new MultilingualString("Loaded client variable data", "Client-Variablen geladen", "Variables du client charg\u00e9es", "As vari\u00e1veis do sistema foram carregadas");
	}
}
