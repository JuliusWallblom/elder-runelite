...
final class Class246_Sub28_Sub1 extends TextureOperation {
	...
	static final void decodeGlobalPlayerUpdate(Stream_Sub1 stream_sub1, int i) {
		try {
			...
			for (int i_1_ = 0; (i_1_ ^ 0xffffffff) > (Class246_Sub4.anInt3869 ^ 0xffffffff); i_1_++) {
				...
				if ((0x1 & Class246_Sub1_Sub8.aByteArray6107[i_2_] ^ 0xffffffff) == -1) {
					if (i_0_ > 0) {
						...
						if (i_3_ == 0) {
							i_0_ = Widget.method1510((byte) -37, stream_sub1);
							Class246_Sub1_Sub8.aByteArray6107[i_2_] = (byte) (Class236.method1523((Class246_Sub1_Sub8.aByteArray6107[i_2_]), 2));
						} else
							IterableNodeHashTable.method546(stream_sub1, i_2_, (byte) -64);
					}
				}
			}
				...
				if ((Class246_Sub1_Sub8.aByteArray6107[i_5_] & 0x1 ^ 0xffffffff) != -1) {
					if ((i_0_ ^ 0xffffffff) < -1) {
						...
						if ((i_6_ ^ 0xffffffff) == -1) {
							...
							IterableNodeHashTable.method546(stream_sub1, i_5_, (byte) -64);
					}
				}
			}
			...
			stream_sub1.method2477(i ^ ~0x3a5);
			for (int i_7_ = 0; i_7_ < EnumType.anInt2541; i_7_++) {
			...
			for (int i_10_ = 0; EnumType.anInt2541 > i_10_; i_10_++) {
			...
			for (int i_13_ = 1; i_13_ < 2048; i_13_++) {
				...
				Player class_r_sub1 = Class143.players[i_13_];
				if (class_r_sub1 != null)
					Class53.anIntArray755[Class246_Sub4.anInt3869++] = i_13_;
				else
					Class172.anIntArray2430[EnumType.anInt2541++] = i_13_;
			}
		} catch (RuntimeException runtimeexception) {
	...
	final void method2143(int i, int i_29_, Buffer stream) {
		try {
			int i_30_ = i_29_;
			if (i_30_ == 0)
	...
	final int[][] method2139(byte i, int i_31_) {
		try {
			anInt5793++;
			int[][] is = ((TextureOperation) this).aClass136_4933.method922((byte) 80, i_31_);
			if (i < 33)
				anIntArray5791 = null;
	...
	static {
		new MultilingualString("Please wait until you are logged out of your previous channel.", "Bitte warte, bis du den vorherigen Chatraum verlassen hast.", "Veuillez attendre d'\u00eatre d\u00e9connect\u00e9(e) de votre canal pr\u00e9c\u00e9dent.", "Aguarde at\u00e9 se desconectar do canal anterior.");
	}
}
