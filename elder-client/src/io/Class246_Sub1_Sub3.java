...
final class Class246_Sub1_Sub3 extends NodeSub {
	int[] anIntArray5699;
	...
	static AbstractSprite aClass_l5707;
	...
	static MultilingualString aClass67_5721;
	...
	final void method2433(byte i, int[] is, Buffer stream) {
		while_14_: do {
			try {
				anInt5703++;
				if (i <= 22)
	...
	final void method2434(Buffer stream, int i) {
		try {
			if (i == 9536) {
				for (;;) {
	...
	final String method2436(Buffer stream, int i) {
		try {
			anInt5709++;
			if (i != -127)
				method2431(-72);
	...
	private final void method2437(Buffer stream, int i, boolean bool) {
		try {
			if (bool != false)
				anInt5710 = 37;
			anInt5716++;
			if ((i ^ 0xffffffff) != -2) {
				if (i == 2) {
					...
					for (int i_11_ = 0; i_10_ > i_11_; i_11_++)
						((Class246_Sub1_Sub3) this).anIntArray5699[i_11_] = stream.readUnsignedShort();
					...
					for (int i_13_ = 0; i_13_ < i_12_; i_13_++) {
						...
						if (class81 != null) {
							...
							for (int i_15_ = 0; ((Class81) class81).anInt1062 > i_15_; i_15_++)
								anIntArrayArray5717[i_13_][i_15_] = stream.readUnsignedShort();
						}
					}
	...
	static {
		...
		aClass67_5721 = new MultilingualString("Examine", "Untersuchen", "Examiner", "Examinar");
	}
}
