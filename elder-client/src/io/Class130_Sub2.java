...
final class Class130_Sub2 extends Class130 {
	...
	final void method1773() {
		...
		for (Varc class246_sub1_sub11 = ((Varc) ((Class130_Sub2) this).aClass166_3791.method1104(
				125)); class246_sub1_sub11 != null; class246_sub1_sub11 = (Varc) ((Class130_Sub2) this).aClass166_3791
						.method1108((byte) -112)) {
			if (((Class4) (((Varc) class246_sub1_sub11).aClass4_6237)).anInt36 == 1)
				class246_sub1_sub11.removeDual();
		}
	...
	final void method1777(SceneGraph class260, long l, Class19[] class19s, Class303[] class162s, boolean bool) {
	...
	final void method1778() {
		...
		for (Class130_Sub6 class130_sub6 = (Class130_Sub6) aClass68_3782.method445(
				62); class130_sub6 != null; class130_sub6 = (Class130_Sub6) aClass68_3782.method442((byte) -71))
	...
	final boolean method1780(SceneGraph class260, long l) {
		...
		if (aBool3794) {
			for (Class130_Sub6 class130_sub6 = (Class130_Sub6) aClass68_3782.method445(
					62); class130_sub6 != null; class130_sub6 = (Class130_Sub6) aClass68_3782.method442((byte) -44)) {
		...
		for (Class130_Sub6 class130_sub6 = (Class130_Sub6) aClass68_3782.method445(
				62); class130_sub6 != null; class130_sub6 = (Class130_Sub6) aClass68_3782.method442((byte) -73))
			class130_sub6.method2105(i, 93, l, !aBool3784, class260);
		aLong3790 = l;
		return true;
	}

	private final void method1781(Class303[] class162s, boolean bool) {
		for (int i = 0; i < 8; i++)
			aBoolArray3786[i] = false;
		while_159_: for (Varc class246_sub1_sub11 = ((Varc) ((Class130_Sub2) this).aClass166_3791.method1104(
				71)); class246_sub1_sub11 != null; class246_sub1_sub11 = (Varc) ((Class130_Sub2) this).aClass166_3791
						.method1108((byte) -112)) {
			if (class162s != null) {
				for (int i = 0; i < class162s.length; i++) {
					if ((((Varc) class246_sub1_sub11).aClass162_6236) == class162s[i]
							|| ((((Varc) class246_sub1_sub11).aClass162_6236) == ((Class303) class162s[i]).aClass162_2296)) {
		...
		if (class162s != null) {
			for (int i = 0; i < class162s.length; i++) {
				if (anInt3796 == 8)
					break;
				if (!aBoolArray3786[i]) {
					Varc class246_sub1_sub11 = null;
					if ((((Class4) class162s[i].method1078((byte) 34)).anInt36 == 1)
							&& Class246_Sub23.anInt4820 < 32) {
						class246_sub1_sub11 = new Varc(class162s[i], this);
						Class90.aClass83_1170.method532((byte) 75, class246_sub1_sub11,
								(long) (((Class303) class162s[i]).anInt2290));
						Class246_Sub23.anInt4820++;
					}
					if (class246_sub1_sub11 == null)
						class246_sub1_sub11 = new Varc(class162s[i], this);
					((Class130_Sub2) this).aClass166_3791.push_head(class246_sub1_sub11);
					anInt3796++;
					aBoolArray3786[i] = true;
				}
			}
	...
	private final void method1783(SceneGraph class260, Class19[] class19s, boolean bool) {
		for (int i = 0; i < 8; i++)
			aBoolArray3788[i] = false;
		while_161_: for (Class130_Sub6 class130_sub6 = (Class130_Sub6) aClass68_3782.method445(
				62); class130_sub6 != null; class130_sub6 = (Class130_Sub6) aClass68_3782.method442((byte) -86)) {
			if (class19s != null) {
				for (int i = 0; i < class19s.length; i++) {
					if ((((Class130_Sub6) class130_sub6).aClass19_4852 == class19s[i])
							|| (((Class130_Sub6) class130_sub6).aClass19_4852 == ((Class19) class19s[i]).aClass19_297)) {
