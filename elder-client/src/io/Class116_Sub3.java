...
final class Class116_Sub3 extends Font {
	...
	Class116_Sub3(Class260_Sub1 class260_sub1, FontMetric class73, LDSprite[] class10s, int[] is, int[] is_88_) {
		...
		for (int i = 0; i < class10s.length; i++) {
			aByteArrayArray5119[i] = ((LDSprite) class10s[i]).aByteArray157;
			anIntArray5120[i] = ((LDSprite) class10s[i]).anInt162;
			anIntArray5121[i] = ((LDSprite) class10s[i]).anInt158;
		}
		anIntArray5123 = ((LDSprite) class10s[0]).anIntArray160;
	}
