...
final class Class189 {
	...
	private CacheIndex aClass_fs2672;
	...
	static final long method1241(byte i, int i_0_, Class_f class_f, int i_1_) {
		try {
			...
			long l_4_ = (long) (0x40000000
					| (i_1_ << 7 | i_0_ | class_f.method24(118) << 14 | class_f.method18((byte) -70) << 20));
			if (((LocType) class185).wall_or_door == 0)
				l_4_ |= l_3_;
			if (((LocType) class185).supports_items == 1)
				l_4_ |= l;
			if (i <= 11)
				method1241((byte) 127, -81, null, -45);
			if (((LocType) class185).aBool2601)
				l_4_ |= l_2_;
			l_4_ |= (long) class_f.method21(true) << 32;
			return l_4_;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("rl.F(" + i + ',' + i_0_ + ',' + (class_f != null ? "{...}" : "null") + ',' + i_1_ + ')'));
		}
	}
	...
	final Class173 method1243(int i, int i_6_) {
		try {
			...
			if (class173 != null)
				return class173;
			byte[] is = aClass_fs2672.get_file(i, 31);
			class173 = new Class173();
			if (is != null)
				class173.method1138(false, new Buffer(is));
			synchronized (aClass54_2663) {
	...
	Class189(Class101 class101, int i, CacheIndex class_fs) {
		try {
			aClass_fs2672 = class_fs;
			aClass_fs2672.child_count(31);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, ("rl.<init>(" + (class101 != null ? "{...}" : "null") + ',' + i
					+ ',' + (class_fs != null ? "{...}" : "null") + ')'));
		}
	}
}
