		...
		try {
			...
			if ((Class59_Sub2_Sub2.anInt6018 ^ 0xffffffff) < -1) {
				...
				if ((Class59_Sub2_Sub2.anInt6018 ^ 0xffffffff) < -2)
					i_3_ += ((Class59_Sub2_Sub2.anInt6018 - 1 + -Class91.anInt1188) * (-i_2_ + i_1_)
							/ (Class59_Sub2_Sub2.anInt6018 - 1));
				class260.O(Client.client_width - 16, i_3_, 12, i_2_, Class_q_Sub1.anInt6670 << 24 | 0x332277, 2);
				for (int i_4_ = Class91.anInt1188; ((i_4_ ^ 0xffffffff) > (Class91.anInt1188 - -i_0_ ^ 0xffffffff)
						&& (i_4_ ^ 0xffffffff) > (Class59_Sub2_Sub2.anInt6018 ^ 0xffffffff)); i_4_++) {
					String[] strings = Class60.method412((byte) -87, Class55.aStringArray786[i_4_], '\010');
					int i_5_ = ((-24 + Client.client_width) / strings.length);
					for (int i_6_ = 0; (i_6_ ^ 0xffffffff) > (strings.length ^ 0xffffffff); i_6_++) {
						int i_7_ = i_6_ * i_5_ + 8;
						class260.OA(i_7_, 0, -8 + i_7_ + i_5_, 350);
						FontCache.regular_font.draw_text(-16777216, -1, strings[i_6_], i_7_,
								(-((-Class91.anInt1188 + i_4_) * Class97.anInt1264) - 2 + (-Class200.anInt2852 + 350
										+ -(((FontMetric) Class246_Sub5.aClass73_3892).anInt946))),
								0);
					}
				}
			}
			class260.OA(0, 0, Client.client_width, 350);
			class260.method1697(Client.client_width, -126, -Class200.anInt2852 + 350, 0, -1);
			FontCache.bold_font.draw_text(-16777216, -1, "--> " + Class246_Sub14.aString4438, 10,
					-1 + -((FontMetric) CacheIndex.aClass73_148).anInt946 + 350, 0);
			int i_8_ = -1;
			if (Client.cycle % 30 > 15)
				i_8_ = 16777215;
			class260.method1681(0, -((FontMetric) CacheIndex.aClass73_148).anInt946 + 350 - 11, 12,
					((CacheIndex.aClass73_148.method459(-1,
							"--> " + Class246_Sub14.aString4438.substring(0, Class246_Sub1_Sub14.anInt6596))) + 10),
					i_8_);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					"vt.B(" + (class260 != null ? "{...}" : "null") + ',' + i + ')');
		}
	}
