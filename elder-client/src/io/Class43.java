...
final class Class43 {
	static ClickMaskNode aClass246_Sub27_635 = new ClickMaskNode(0, -1);
	static int anInt636;
	...
	static {
		new MultilingualString("The channel you tried to join does not exist.", "Der von dir gew\u00fcnschte Chatraum existiert nicht.", "Le canal que vous essayez de rejoindre n'existe pas.", "O canal que voc\u00ea tentou acessar n\u00e3o existe.");
