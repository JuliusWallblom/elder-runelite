...
final class Class198 {
	private AbstractSprite[] aClass_lArray2819;
	private int[] anIntArray2820 = new int[4];
	private int anInt2821;
	private static int anInt2822 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"\u00a3$%^&*()-_=+[{]};:'@#~,<.>/?\\| \u00c4\u00cb\u00cf\u00d6\u00dc\u00e4\u00eb\u00ef\u00f6\u00fc\u00ff\u00df\u00c1\u00c0\u00c9\u00c8\u00cd\u00cc\u00d3\u00d2\u00da\u00d9\u00e1\u00e0\u00e9\u00e8\u00ed\u00ec\u00f3\u00f2\u00fa\u00f9\u00c2\u00ca\u00ce\u00d4\u00db\u00e2\u00ea\u00ee\u00f4\u00fb\u00c6\u00e6\u00e3\u00c3\u00f5\u00d5\u00e7\u00c7"
			.length();
	...
	private final void method1302(SceneGraph class260, String string, int[] is, int i, int i_0_, int i_1_,
			boolean bool) {
		if (i_1_ == 0)
			bool = false;
		i_1_ |= ~0xffffff;
	...
	final void method1304(SceneGraph class260, String string, int i, int i_4_, int i_5_, boolean bool) {
		int i_6_ = method1305(string) / 2;
		class260.da(anIntArray2820);
		if (i - i_6_ <= anIntArray2820[2] && i + i_6_ >= anIntArray2820[0] && i_4_ - anInt2824 <= anIntArray2820[3]
				&& i_4_ + anInt2821 >= anIntArray2820[1])
	...
	private final void method1307(SceneGraph class260, Font font, FontMetrics fontmetrics, char c, int i,
			boolean bool) {
	...
	Class198(SceneGraph class260, int i, boolean bool, Component component) {
		aBool2823 = false;
		aClass_lArray2819 = new AbstractSprite[256];
		anIntArray2825 = new int[256];
		Font font = new Font("Helvetica", bool ? 1 : 0, i);
		FontMetrics fontmetrics = component.getFontMetrics(font);
		for (int i_19_ = 0; i_19_ < anInt2822; i_19_++)
			method1307(class260, font, fontmetrics,
