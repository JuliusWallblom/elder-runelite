...
final class Class31 {
	...
	private final void method233(Class260_Sub2 class260_sub2, int i, int i_5_) {
		do {
			try {
				...
				((Buffer) aStream_Sub2_417).position = 0;
					...
					for (int i_21_ = -1 + i; i_21_ >= 0; i_21_--) {
						...
						if ((i_22_ ^ 0xffffffff) < -1) {
							for (int i_23_ = -1 + i_22_; (i_23_ ^ 0xffffffff) <= -1; i_23_--) {
								...
								float f_29_ = (float) (((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7037 >> VarpType.anInt1225);
								float f_30_ = (float) (((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7048 >> VarpType.anInt1225);
								float f_31_ = (float) (((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7044 >> VarpType.anInt1225);
								int i_32_ = (((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7038 >> VarpType.anInt1225);
							...
							if (anIntArray429[i_21_] > 64) {
								...
								for (int i_34_ = anIntArray428[i_33_] - 1; i_34_ >= 0; i_34_--) {
									...
									float f_40_ = (float) ((((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7037) >> VarpType.anInt1225);
									float f_41_ = (float) ((((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7048) >> VarpType.anInt1225);
									float f_42_ = (float) ((((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7044) >> VarpType.anInt1225);
									int i_43_ = (((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7038 >> VarpType.anInt1225);
									aStream_Sub2_417.method2595(0.0F, (byte) 98);
									aStream_Sub2_417.method2595(0.0F, (byte) 98);
					...
					for (int i_44_ = -1 + i; i_44_ >= 0; i_44_--) {
						...
						if ((i_45_ ^ 0xffffffff) < -1) {
							for (int i_46_ = -1 + i_45_; i_46_ >= 0; i_46_--) {
								...
								float f_52_ = (float) (((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7037 >> VarpType.anInt1225);
								float f_53_ = (float) (((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7048 >> VarpType.anInt1225);
								float f_54_ = (float) (((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7044 >> VarpType.anInt1225);
								int i_55_ = (((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7038 >> VarpType.anInt1225);
							...
							if (anIntArray429[i_44_] > 64) {
								...
								for (int i_57_ = -1 + anIntArray428[i_56_]; i_57_ >= 0; i_57_--) {
									...
									float f_63_ = (float) ((((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7037) >> VarpType.anInt1225);
									float f_64_ = (float) ((((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7048) >> VarpType.anInt1225);
									float f_65_ = (float) ((((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7044) >> VarpType.anInt1225);
									int i_66_ = (((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7038 >> VarpType.anInt1225);
									aStream_Sub2_417.method2591(0.0F, 1739667504);
									aStream_Sub2_417.method2591(0.0F, 1739667504);
				...
				if (((Buffer) aStream_Sub2_417).position == 0)
					break;
				anInterface10_426.method33((byte) -87, ((Buffer) aStream_Sub2_417).position, 24,
						(((Buffer) aStream_Sub2_417).buffer));
				class260_sub2.method1934(aClass160_422, 114, null, aClass160_425, aClass160_424);
				class260_sub2.method1925(1, 0, 7, (((Buffer) aStream_Sub2_417).position / 24));
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception,
						("cm.E(" + (class260_sub2 != null ? "{...}" : "null") + ',' + i + ',' + i_5_ + ')'));
			}
			break;
		} while (false);
	}
	...
	final void method234(byte i, Class129 class129, Class260_Sub2 class260_sub2) {
		try {
				...
				try {
					if (((Class129) class129).aBool1812) {
						...
						while (class130_sub1 != class130_sub1_73_) {
							...
							for (/**/; class130_sub1 != class130_sub1_73_; class130_sub1_73_ = (((Class130_Sub1) class130_sub1_73_).aClass130_Sub1_3732)) {
								...
								if (bool_75_) {
									...
									bool_75_ = false;
								} else if ((((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7049 != i_74_)
										|| !bool != !(((Class130_Sub1_Sub1) class130_sub1_sub1).aBool7040)) {
									bool_75_ = true;
									break;
								}
								int i_78_ = ((int) (((float) ((((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7037) >> VarpType.anInt1225)
										* f)
										+ ((float) ((((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7048) >> VarpType.anInt1225)
												* f_67_)
										+ ((float) ((((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7044) >> VarpType.anInt1225)
												* f_68_)
										+ f_70_) - (((Class129) class129).anInt1810)) >> i_72_;
								if ((i_78_ ^ 0xffffffff) > -1601) {
									if ((anIntArray429[i_78_] ^ 0xffffffff) <= -65) {
										...
										aClass130_Sub1_Sub1ArrayArray431[-1
												+ (-64 + anIntArray429[i_78_])][anIntArray428[-64
														+ (anIntArray429[i_78_] - 1)]++] = class130_sub1_sub1;
									} else
										aClass130_Sub1_Sub1ArrayArray427[i_78_][anIntArray429[i_78_]++] = class130_sub1_sub1;
								}
							}
							if ((i_74_ ^ 0xffffffff) <= -1) {
								class260_sub2.method1905((byte) 78,
										((Class260_Sub2) class260_sub2).f_ie.method319(i_74_, -128));
								class260_sub2.method1900(7681,
										(((Material) ((SceneGraph) class260_sub2).anInterface6_3714.get_material(-31305,
												i_74_)).anInt3341));
							} else
						...
						for (Class130_Sub1 class130_sub1_82_ = (((Class130_Sub1) class130_sub1).aClass130_Sub1_3732); class130_sub1_82_ != class130_sub1; class130_sub1_82_ = (((Class130_Sub1) class130_sub1_82_).aClass130_Sub1_3732)) {
							...
							int i_83_ = (int) (f_70_
									+ ((float) ((((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7037) >> VarpType.anInt1225)
											* f
											+ (f_67_ * (float) ((((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7048) >> (VarpType.anInt1225)))
											+ ((float) ((((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7044) >> VarpType.anInt1225)
													* f_68_)));
						...
						while (class130_sub1_86_ != class130_sub1) {
							...
							for (/**/; class130_sub1_86_ != class130_sub1; class130_sub1_86_ = (((Class130_Sub1) class130_sub1_86_).aClass130_Sub1_3732)) {
								...
								if (i_79_ > 0 && (((i_87_
										^ 0xffffffff) != (((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7049
												^ 0xffffffff))
										|| bool == !(((Class130_Sub1_Sub1) class130_sub1_sub1).aBool7040))) {
									bool_88_ = true;
									break;
								...
								if ((i_91_ ^ 0xffffffff) > -1601) {
									if ((anIntArray429[i_91_] ^ 0xffffffff) > -65)
										...
										aClass130_Sub1_Sub1ArrayArray431[-65 + anIntArray429[i_91_]][anIntArray428[-1
												+ ((anIntArray429[i_91_]) - 64)]++] = class130_sub1_sub1;
									}
								}
							}
							if (i_87_ < 0)
								...
								class260_sub2.method1905((byte) 78,
										((Class260_Sub2) class260_sub2).f_ie.method319(i_87_, -128));
								class260_sub2.method1900(7681,
										(((Material) ((SceneGraph) class260_sub2).anInterface6_3714.get_material(-31305,
												i_87_)).anInt3341));
							}
			...
			throw Class193.method1272(runtimeexception, ("cm.C(" + i + ',' + (class129 != null ? "{...}" : "null") + ','
					+ (class260_sub2 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	final void method235(byte i, Class260_Sub2 class260_sub2) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("cm.H(" + i + ',' + (class260_sub2 != null ? "{...}" : "null") + ')'));
		}
	}

	static final Class59_Sub2 method236(int i, int i_92_, int i_93_) {
		Tile class147 = Class106.tiles[i][i_92_][i_93_];
		if (class147 == null)
			return null;
		return ((Tile) class147).aClass59_Sub2_2153;
	}
	...
	private final void method237(int i, Class260_Sub2 class260_sub2) {
		do {
			try {
				...
				throw Class193.method1272(runtimeexception,
						("cm.A(" + i + ',' + (class260_sub2 != null ? "{...}" : "null") + ')'));
			}
			break;
		} while (false);
	}
	...
	private final void method238(int i, Class260_Sub2 class260_sub2) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("cm.D(" + i + ',' + (class260_sub2 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	static {
		new MultilingualString("Invalid teleport!", "Unzul\u00e4ssiger Teleport!",
