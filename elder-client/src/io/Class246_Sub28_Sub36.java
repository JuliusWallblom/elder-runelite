...
public final class Class246_Sub28_Sub36 extends TextureOperation {
	...
	final void method2143(int i, int i_26_, Buffer stream) {
		try {
			if (i != 4)
				aClass201_7033 = null;
			int i_27_ = i_26_;
			while_52_: do {
				do {
					...
					anInt7023 = (stream.readByte() << 12) / 100;
					break while_52_;
				} while (false);
				anInt7028 = (stream.readByte() << 12) / 100;
			} while (false);
			anInt7019++;
		} catch (RuntimeException runtimeexception) {
	...
	final int[][] method2139(byte i, int i_28_) {
		try {
			anInt7026++;
			int[][] is = ((TextureOperation) this).aClass136_4933.method922((byte) 90, i_28_);
	...
	static {
		new MultilingualString("Please close the interface you have open before using 'Report Abuse'.", "Bitte schlie\u00df die momentan ge\u00f6ffnete Benutzeroberfl\u00e4che,", "Fermez l'interface que vous avez ouverte avant d'utiliser le bouton \u00ab Signaler un abus \u00bb.", "Feche a interface aberta antes de usar o recurso \"Denunciar abuso\".");
