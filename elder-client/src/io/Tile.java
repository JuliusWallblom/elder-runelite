...
final class Tile {
	...
	static final void method994(int i, int i_0_, boolean bool, int i_1_, int i_2_) {
		try {
			if ((((Renderer) Client.current_renderer).anInt602 ^ 0xffffffff) != -1 && i != 0 && Class59.anInt819 < 50
					&& i_1_ != -1)
	...
	static final boolean method996(int i, int i_4_, int i_5_) {
		try {
			...
			if (i_4_ != -1)
				return false;
			return ((Class59_Sub2_Sub3.method2720(i, i_5_, 2) | Class246_Sub28_Sub14.method2633(i_5_, -1376312589, i)
					| Class46.method310((byte) 101, i_5_, i)) & Class241.method1544(i, (byte) 126, i_5_));
		} catch (RuntimeException runtimeexception) {
	...
	final void method997(byte i) {
		try {
			anInt2163++;
			Class3 class3;
			for (/**/; ((Tile) this).aClass3_2160 != null; ((Tile) this).aClass3_2160 = class3) {
				class3 = ((Class3) ((Tile) this).aClass3_2160).aClass3_28;
				((Tile) this).aClass3_2160.method49(93);
			}
			((Tile) this).aByte2168 = i;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, "nt.F(" + i + ')');
		}
	}

	Tile(int i, int i_6_, int i_7_) {
		try {
			((Tile) this).aShort2157 = (short) i_7_;
			((Tile) this).aShort2161 = (short) i_6_;
			((Tile) this).aByte2174 = ((Tile) this).aByte2175 = (byte) i;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, ("nt.<init>(" + i + ',' + i_6_ + ',' + i_7_ + ')'));
		}
	}

	static final void method998(CacheIndex class_fs, TextureInterface interface6, byte i) {
		do {
			try {
				...
				throw Class193.method1272(runtimeexception, ("nt.B(" + (class_fs != null ? "{...}" : "null") + ','
