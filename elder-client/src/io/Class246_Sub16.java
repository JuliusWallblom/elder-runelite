...
final class Class246_Sub16 extends Node {
	int anInt4519;
	int anInt4520;
	static AbstractSprite aClass_l4521;
	int anInt4522;
	int anInt4523;
	int anInt4524;
	int anInt4525;
	...
	final AbstractModel method2017(int i, SceneGraph class260, int i_0_) {
		try {
			anInt4534++;
			...
			if (i_1_ != 0) {
				if (i_1_ != 1) {
					if (i_1_ == 2) {
						Class59_Sub3 class59_sub3 = (Class17.method168(((Class246_Sub16) this).anInt4528,
								((Class246_Sub16) this).anInt4520, ((Class246_Sub16) this).anInt4525,
								(aClass4538 != null ? aClass4538 : (aClass4538 = Client.getClassByName("Class_f")))));
						if (class59_sub3 instanceof Class59_Sub3_Sub1) {
							...
							if ((((Class59_Sub3_Sub1) class59_sub3_sub1).aClass59_Sub3_5732) != null)
								return ((Class_f) ((Class59_Sub3_Sub1) class59_sub3_sub1).aClass59_Sub3_5732)
										.method23(class260, i_0_, 115);
						}
					} else if ((i_1_ ^ 0xffffffff) == -4) {
						Class59_Sub1 class59_sub1 = (Class246_Sub14.method1997(((Class246_Sub16) this).anInt4528,
								((Class246_Sub16) this).anInt4520, ((Class246_Sub16) this).anInt4525));
						if (class59_sub1 instanceof Class59_Sub1_Sub1) {
							...
							if ((((Class59_Sub1_Sub1) class59_sub1_sub1).aClass59_Sub1_5982) != null)
								return ((Class_f) ((Class59_Sub1_Sub1) class59_sub1_sub1).aClass59_Sub1_5982)
										.method23(class260, i_0_, -118);
						}
					}
				} else {
					Class59_Sub2 class59_sub2 = Class31.method236(((Class246_Sub16) this).anInt4528,
							((Class246_Sub16) this).anInt4520, ((Class246_Sub16) this).anInt4525);
					if (class59_sub2 instanceof Class59_Sub2_Sub2) {
						...
						if ((((Class59_Sub2_Sub2) class59_sub2_sub2).aClass59_Sub2_6009) != null)
							return ((Class_f) (((Class59_Sub2_Sub2) class59_sub2_sub2).aClass59_Sub2_6009))
									.method23(class260, i_0_, 123);
					}
				}
			} else {
				Class59_Sub4 class59_sub4 = (Class246_Sub22.method2082(((Class246_Sub16) this).anInt4528,
						((Class246_Sub16) this).anInt4520, ((Class246_Sub16) this).anInt4525));
				if (class59_sub4 instanceof Class59_Sub4_Sub1) {
					...
					if ((((Class59_Sub4_Sub1) class59_sub4_sub1).aClass59_Sub4_6317) != null)
						return ((Class_f) (((Class59_Sub4_Sub1) class59_sub4_sub1).aClass59_Sub4_6317))
								.method23(class260, i_0_, 113);
				}
			}
			if (i != 1)
				return null;
			...
			throw Class193.method1272(runtimeexception,
					("ig.A(" + i + ',' + (class260 != null ? "{...}" : "null") + ',' + i_0_ + ')'));
		}
	}
	...
	public static void method2018(int i) {
		try {
			...
			Cache.client_cache.set(IndexConstants.PRE_EOC_634_WORLD_MAP_INDEX, null);
		} catch (RuntimeException runtimeexception) {
