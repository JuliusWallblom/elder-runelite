...
final class Class153 {
	...
	final void method1013(Buffer stream, int i) {
		try {
			anInt2206++;
			if (i != -1)
				method1013(null, 22);
	...
	private final void method1015(int i, int i_4_, Buffer stream) {
		try {
			if (i_4_ <= 23)
				method1014(null, 59);
			if ((i ^ 0xffffffff) != -2) {
				if ((i ^ 0xffffffff) == -3) {
					((Class153) this).anIntArray2211 = new int[stream.readUnsignedByte()];
					for (int i_5_ = 0; ((i_5_ ^ 0xffffffff) > (((Class153) this).anIntArray2211.length
							^ 0xffffffff)); i_5_++)
						((Class153) this).anIntArray2211[i_5_] = stream.readUnsignedShort();
				} else if ((i ^ 0xffffffff) == -4)
					((Class153) this).anInt2208 = stream.readUnsignedByte();
			} else
				((Class153) this).texture_id = stream.readUnsignedShort();
			anInt2210++;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("oh.B(" + i + ',' + i_4_ + ',' + (stream != null ? "{...}" : "null") + ')'));
		}
	}
