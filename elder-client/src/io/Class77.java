...
final class Class77 {
	...
	static final void method479(SceneGraph class260, int[] is, int i) {
	...
	private static final void method485(SceneGraph class260, int[] is, int i, int i_24_, int i_25_, int[] is_26_,
			int[] is_27_) {
	...
	static final void method487(SceneGraph class260, int[] is, int i, int[] is_42_, int[] is_43_) {
