...
final class KeyHandler extends Class232 implements KeyListener, FocusListener {
	...
	private final void method2323(byte i, int i_0_, char c, int id) {
		try {
			...
			((Class188_Sub1) class188_sub1).aLong3915 = TimeUtility.time();
			do {
			...
			for (Class188_Sub1 class188_sub1 = aClass188_Sub1_5540; class188_sub1 != null; class188_sub1 = ((Class188_Sub1) class188_sub1).aClass188_Sub1_3917) {
				if ((((Class188_Sub1) class188_sub1).anInt3922 ^ 0xffffffff) != -1) {
					if ((((Class188_Sub1) class188_sub1).anInt3922 ^ 0xffffffff) == -2)
						KeyHandler_pressedKeys[(((Class188_Sub1) class188_sub1).anInt3919)] = false;
					else if ((((Class188_Sub1) class188_sub1).anInt3922 ^ 0xffffffff) == 0) {
						for (int i_7_ = 0; (i_7_ ^ 0xffffffff) > -113; i_7_++)
							KeyHandler_pressedKeys[i_7_] = false;
					}
				} else {
					if (((Class188_Sub1) class188_sub1).anInt3919 >= 0)
						((Class188_Sub1) class188_sub1).aBool3920 = !(KeyHandler_pressedKeys[((Class188_Sub1) class188_sub1).anInt3919]);
					KeyHandler_pressedKeys[((Class188_Sub1) class188_sub1).anInt3919] = true;
				}
			}
			if (i < 13)
				aComponent5556 = null;
	...
	final boolean method1488(int i, int i_8_) {
		try {
			...
			if (i >= -70)
				method2324(5, 106, -32);
			return KeyHandler_pressedKeys[i_8_];
		} catch (RuntimeException runtimeexception) {
	...
	private final void key_pressed(KeyEvent keyevent, byte i, int released) {
		try {
			anInt5538++;
			if (i > -97)
				keyPressed(null);
			...
			if (key_code == 0)
				key_code = 0;
			else if ((key_code ^ 0xffffffff) <= -1 && ((Class169.key_codes.length ^ 0xffffffff) < (key_code ^ 0xffffffff))) {
				key_code = Class169.key_codes[key_code];
				if (released != 0 || (0x80 & key_code ^ 0xffffffff) == -1)
					key_code &= ~0x80;
				else
					key_code = 0;
			} else
				key_code = 0;
			if (key_code != 0) {
				method2323((byte) -23, released, '\0', key_code);
				keyevent.consume();
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		try {
			...
			if (aComponent5556 != null) {
				...
				for (int i_11_ = 0; i_11_ < 112; i_11_++)
					KeyHandler_pressedKeys[i_11_] = false;
				aClass188_Sub1_5540 = null;
				aClass188_Sub1_5543 = null;
				if (i != -87)
					method1485(97);
	...
	public final synchronized void keyPressed(KeyEvent keyevent) {
		try {
			key_pressed(keyevent, (byte) -116, 0);
			anInt5539++;
		} catch (RuntimeException runtimeexception) {
	...
	public final synchronized void keyReleased(KeyEvent keyevent) {
		try {
			key_pressed(keyevent, (byte) -105, 1);
			anInt5554++;
		} catch (RuntimeException runtimeexception) {
	...
	KeyHandler(Component component) {
		try {
	...
	static {
		new MultilingualString("If you are not, please change your password to something more obscure!", "nicht der Fall ist, \u00e4ndere dein Passwort zu einem ungew\u00f6hnlicheren Begriff!", "Si ce n'est pas le cas, remplacez votre mot de passe par une formule moins \u00e9vidente !", "Caso n\u00e3o esteja, altere sua senha para algo mais obscuro!");
	}
}
