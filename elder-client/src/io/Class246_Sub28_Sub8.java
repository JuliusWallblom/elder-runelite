...
final class Class246_Sub28_Sub8 extends TextureOperation {
	...
	static final void method2559(boolean bool) {
		try {
			...
			if (bool != true)
				method2559(false);
			MouseHandler.anInt4450 = Class246_Sub16.aInt92;
			Class_cs.anInt7145 = Class259_Sub1.anInt4509;
			ParamType.anInt1636 = 0;
			TextureLoader.anInt967 = -1;
			Class246_Sub30.anInt5031 = Client.cycle;
			Class130_Sub3.anInt4417 = 5;
			Class214.anInt2988 = 0;
			Class21_Sub2.anInt4494 = -1;
			Class21_Sub3.anInt4727 = Class244.anInt3456;
			Class96.anInt1259 = FontMetric.anInt961;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, "ev.C(" + bool + ')');
		}
	}

	static final void method2560(SceneGraph class260, Class59 class59, int i, int i_4_, int i_5_, int i_6_, int i_7_) {
		boolean bool = true;
		int i_8_ = i_4_;
		int i_9_ = i_4_ + i_6_;
		int i_10_ = i_5_ - 1;
		...
		for (int i_12_ = i; i_12_ <= i + 1; i_12_++) {
			if (i_12_ != Class154_Sub1.anInt4803) {
				for (int i_13_ = i_8_; i_13_ <= i_9_; i_13_++) {
					if (i_13_ >= 0 && i_13_ < Class240.xSize) {
						for (int i_14_ = i_10_; i_14_ <= i_11_; i_14_++) {
							if (i_14_ >= 0 && i_14_ < HDModel.ySize
									&& (!bool || i_13_ >= i_9_ || i_14_ >= i_11_ || i_14_ < i_5_ && i_13_ != i_4_)) {
								Tile class147 = (Class106.tiles[i_12_][i_13_][i_14_]);
								if (class147 != null) {
									int i_15_ = ((Class59_Sub3_Sub4.aClass210Array6993[i_12_].l(i_13_, i_14_)
											+ Class59_Sub3_Sub4.aClass210Array6993[i_12_].l(i_13_ + 1, i_14_)
											+ Class59_Sub3_Sub4.aClass210Array6993[i_12_].l(i_13_, i_14_ + 1)
											+ Class59_Sub3_Sub4.aClass210Array6993[i_12_].l(i_13_ + 1, i_14_ + 1)) / 4
											- ((Class59_Sub3_Sub4.aClass210Array6993[i].l(i_4_, i_5_)
													+ Class59_Sub3_Sub4.aClass210Array6993[i].l(i_4_ + 1, i_5_)
													+ Class59_Sub3_Sub4.aClass210Array6993[i].l(i_4_, i_5_ + 1)
													+ Class59_Sub3_Sub4.aClass210Array6993[i].l(i_4_ + 1, i_5_ + 1))
													/ 4));
									Class59_Sub4 class59_sub4 = (((Tile) class147).aClass59_Sub4_2172);
									Class59_Sub4 class59_sub4_16_ = (((Tile) class147).aClass59_Sub4_2152);
									if (class59_sub4 != null && class59_sub4.method406((byte) 127))
										class59.method405(
												(((i_14_ - i_5_) * NodeSub.anInt3744)
														+ ((1 - i_7_) * Class40_Sub7.anInt5174)),
												(((i_13_ - i_4_) * NodeSub.anInt3744)
														+ ((1 - i_6_) * Class40_Sub7.anInt5174)),
												class59_sub4, (byte) -99, bool, class260, i_15_);
									if (class59_sub4_16_ != null && class59_sub4_16_.method406((byte) 119))
										class59.method405(
												...
												(((i_13_ - i_4_) * NodeSub.anInt3744)
														+ ((1 - i_6_) * Class40_Sub7.anInt5174)),
												class59_sub4_16_, (byte) -99, bool, class260, i_15_);
									for (Class3 class3 = (((Tile) class147).aClass3_2160); class3 != null; class3 = ((Class3) class3).aClass3_28) {
										...
										if (class59_sub3 != null && class59_sub3.method406((byte) 116)
												&& (i_13_ == (((Class59_Sub3) class59_sub3).aShort5057)
														|| i_13_ == i_8_)
												&& (i_14_ == (((Class59_Sub3) class59_sub3).aShort5064)
														|| i_14_ == i_10_)) {
											int i_17_ = (((Class59_Sub3) class59_sub3).aShort5065
													- ((Class59_Sub3) class59_sub3).aShort5057 + 1);
											int i_18_ = (((Class59_Sub3) class59_sub3).aShort5062
													- ((Class59_Sub3) class59_sub3).aShort5064 + 1);
											class59.method405(
													(((((Class59_Sub3) class59_sub3).aShort5064 - i_5_)
															* NodeSub.anInt3744)
															+ ((i_18_ - i_7_) * (Class40_Sub7.anInt5174))),
													(((((Class59_Sub3) class59_sub3).aShort5057 - i_4_)
															* NodeSub.anInt3744)
															+ ((i_17_ - i_6_) * (Class40_Sub7.anInt5174))),
													class59_sub3, (byte) -99, bool, class260, i_15_);
										}
									}
								}
							}
	...
	final int[] method2135(int i, int i_19_) {
		try {
			anInt6059++;
			int[] is = ((TextureOperation) this).aClass66_4938.method435((byte) -112, i_19_);
			if (((Class66) ((TextureOperation) this).aClass66_4938).aBool887) {
				int[][] is_20_ = ((TextureOperation) this).aClass66_4938.method433(10);
				int i_21_ = 0;
				int i_22_ = 0;
				int i_23_ = 0;
				int i_24_ = 0;
				...
				int i_31_ = EnumLoader.anInt2044 * anInt6063 >> 12;
				int i_32_ = anInt6069 * EnumLoader.anInt2044 >> 12;
				...
				for (;;) {
					...
					if (i_37_ + i_39_ <= EnumLoader.anInt2044)
						bool = false;
					else
						i_37_ = EnumLoader.anInt2044 + -i_39_;
	...
	private final void method2562(int i, int i_61_, int i_62_, int i_63_, int[][] is, int i_64_, Random random) {
		try {
			anInt6070++;
			int i_65_ = ((anInt6058 ^ 0xffffffff) >= -1 ? 4096
					: 4096 + -Class122.method826((byte) 94, random, anInt6058));
						...
						if (i_71_ > i_74_) {
							...
							if (anInt6068 != 0) {
								for (int i_77_ = 0; i_77_ < i_70_; i_77_++) {
									...
									is_75_[PacketsDecoder.method184(i_64_ - -i_77_,
											(Class63_Sub1.anInt4719))] = is_75_[(PacketsDecoder.method184(
													(-1 + (-i_77_ + i_63_) + i_64_),
													Class63_Sub1.anInt4719))] = i_76_ > i_78_ ? i_78_ : i_76_;
								}
							} else {
								for (int i_79_ = 0; i_70_ > i_79_; i_79_++) {
									int i_80_ = i_79_ * i_65_ / i_70_;
									is_75_[PacketsDecoder.method184(i_79_ + i_64_,
											(Class63_Sub1.anInt4719))] = is_75_[(PacketsDecoder.method184(
													Class63_Sub1.anInt4719, -1 + (i_63_ + i_64_ - i_79_)))] = i_80_
															* i_76_ >> 12;
								}
							}
							...
							if ((i_71_ ^ 0xffffffff) < (i_82_ ^ 0xffffffff)) {
								...
								if (anInt6068 == 0) {
									for (int i_84_ = 0; i_70_ > i_84_; i_84_++) {
										...
										is_75_[PacketsDecoder.method184(i_84_ + i_64_,
												(Class63_Sub1.anInt4719))] = is_75_[(PacketsDecoder.method184(
														Class63_Sub1.anInt4719, (i_64_ + i_63_ + -i_84_ - 1)))] = i_85_
																* i_83_ >> 12;
									}
								} else {
									for (int i_86_ = 0; ((i_70_ ^ 0xffffffff) < (i_86_ ^ 0xffffffff)); i_86_++) {
										int i_87_ = i_65_ * i_86_ / i_70_;
										is_75_[PacketsDecoder.method184(i_86_ + i_64_,
												(Class63_Sub1.anInt4719))] = is_75_[(PacketsDecoder.method184(
														Class63_Sub1.anInt4719,
														(-i_86_ + i_63_ + (i_64_ - 1))))] = i_87_ >= i_83_ ? i_83_
																: i_87_;
									}
								}
								...
								for (int i_89_ = 0; ((i_70_ ^ 0xffffffff) < (i_89_ ^ 0xffffffff)); i_89_++)
									is_75_[PacketsDecoder.method184(i_89_ + i_64_,
											(Class63_Sub1.anInt4719))] = is_75_[(PacketsDecoder.method184(
													Class63_Sub1.anInt4719, i_63_ + i_64_ + (-i_89_ - 1)))] = i_89_
															* i_65_ / i_70_;
								if (i_72_ + i_73_ <= Class246_Sub37_Sub1.f_gb)
			...
			throw Class193.method1272(runtimeexception, ("ev.H(" + i + ',' + i_61_ + ',' + i_62_ + ',' + i_63_ + ','
					+ (is != null ? "{...}" : "null") + ',' + i_64_ + ',' + (random != null ? "{...}" : "null") + ')'));
		}
	}

	final void method2143(int i, int i_95_, Buffer stream) {
		try {
			int i_96_ = i_95_;
			while_83_: do {
				while_82_: do {
									...
									while_77_: do {
										do {
											if ((i_96_ ^ 0xffffffff) != -1) {
												...
												anInt6073 = stream.readUnsignedByte();
												break while_83_;
											}
											anInt6071 = stream.readUnsignedShort();
											break while_83_;
										} while (false);
										anInt6061 = stream.readUnsignedShort();
										break while_83_;
									} while (false);
									anInt6063 = stream.readUnsignedShort();
									break while_83_;
								} while (false);
								anInt6069 = stream.readUnsignedShort();
								break while_83_;
							} while (false);
							anInt6062 = stream.readUnsignedShort();
							break while_83_;
						} while (false);
						anInt6068 = stream.readUnsignedByte();
						break while_83_;
					} while (false);
					anInt6057 = stream.readUnsignedShort();
					break while_83_;
				} while (false);
				anInt6058 = stream.readUnsignedShort();
			} while (false);
			if (i != 4)
				OBJECT_CLICK_1_PACKET = null;
			anInt6064++;
