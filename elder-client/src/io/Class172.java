...
final class Class172 {
	...
	static final void method1133(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_) {
		try {
			...
			if (Class214.anInt2988 >= 100) {
				...
				FontMetric.anInt961 = 0x3fff & (int) (Math.atan2((double) i_9_, (double) i_11_) * -2607.5945876176133);
	...
	static {
		...
		new MultilingualString(null, "bevor du die Option 'Regelversto\u00df melden' benutzt.", null, null);
	}
}
