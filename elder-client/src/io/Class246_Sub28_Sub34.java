...
final class Class246_Sub28_Sub34 extends TextureOperation {
		...
		do {
			try {
				...
				if ((i_0_ ^ 0xffffffff) == -1)
					anInt7001 = stream.readUnsignedShort();
				if (i == 4)
					break;
				anInt7001 = 34;
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception,
						("vi.G(" + i + ',' + i_0_ + ',' + (stream != null ? "{...}" : "null") + ')'));
			}
			break;
		} while (false);
	}
	...
	final int[] method2135(int i, int i_1_) {
		try {
			anInt7003++;
			int[] is = ((TextureOperation) this).aClass66_4938.method435((byte) -112, i_1_);
			int i_2_ = 79 % ((i - 67) / 50);
			if (((Class66) ((TextureOperation) this).aClass66_4938).aBool887) {
				...
				for (int i_6_ = 0; Class246_Sub37_Sub1.f_gb > i_6_; i_6_++) {
					...
					int i_8_ = (anInt7001
							* (is_4_[Class63_Sub1.anInt4719 & i_6_ + 1] + -is_4_[-1 + i_6_ & Class63_Sub1.anInt4719]));
					int i_9_ = i_8_ >> 12;
					int i_10_ = i_7_ >> 12;
	...
	static final boolean method2872(boolean bool) {
		try {
			...
			if (bool != true)
				aClass13_7006 = null;
			if (Class208.aClass205_2930 == Class260_Sub2.aClass205_4297 && (Client.staff_level ^ 0xffffffff) > -3)
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
