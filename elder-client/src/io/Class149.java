...
final class Class149 {
	...
	static final synchronized byte[] method1003(int i, int i_0_) {
		try {
			anInt2189++;
			if ((i_0_ ^ 0xffffffff) == -101 && (NpcType.f_wb ^ 0xffffffff) < -1) {
				byte[] is = Class211_Sub1.aByteArrayArray5345[--NpcType.f_wb];
				Class211_Sub1.aByteArrayArray5345[NpcType.f_wb] = null;
				return is;
			}
			...
			if (i_0_ == 30000 && (Class195.anInt2727 ^ 0xffffffff) < -1) {
				byte[] is = RenderAnimation.f_cb[--Class195.anInt2727];
				RenderAnimation.f_cb[Class195.anInt2727] = null;
				return is;
			}
