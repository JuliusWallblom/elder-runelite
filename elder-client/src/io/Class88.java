...
abstract class Class88 {
	...
	static final boolean method559(boolean bool, int i) {
		try {
			anInt1149++;
			Class63_Sub1 class63_sub1 = Varbit.method746(i, (byte) -126);
			if (class63_sub1 == null)
				return false;
			if ((Signlink.anInt740 ^ 0xffffffff) != -4) {
				Client.world_id = ((Class63_Sub1) class63_sub1).anInt4713;
				Class174.aString2449 = ((Class63_Sub1) class63_sub1).aString4717;
				if (Class260_Sub2.aClass205_4297 != Class208.aClass205_2930) {
					Class246_Sub28_Sub7.anInt6047 = Client.world_id + 50000;
					Class172.anInt2433 = Client.world_id + 40000;
			...
			String string_2_ = ("http://" + ((Class63_Sub1) class63_sub1).aString4717 + string + "/l=" + Preferences.language_code + "/a=" + Class109_Sub4.anInt4573 + string_1_ + "/j" + (Class106_Sub2.aBool5333 ? "1" : "0") + ",o" + (!aBool1151 ? "0" : "1") + ",a2");
			try {
				Client.instance.getAppletContext().showDocument(new URL(string_2_), "_self");
				if (bool != false)
					aBool1151 = true;
	...
	static {
		new MultilingualString("Unable to add name - system busy.", "Der Name konnte nicht hinzugef\u00fcgt werden, das System ist derzeit ausgelastet.", "Impossible d'ajouter un nom - syst\u00e8me occup\u00e9.", "N\u00e3o foi poss\u00edvel adicionar o nome. O sistema est\u00e1 ocupado.");
		anInt1152 = 0;
	}
}
