...
final class Class170 {
	...
	static final void method1125(boolean bool, byte i, int i_0_, int i_1_, boolean bool_2_) {
		try {
			anInt2418++;
			if (bool_2_ || IdentityKitLoader.anInt1206 != i_1_ || (i_0_ ^ 0xffffffff) != (Class130_Sub8.anInt5618 ^ 0xffffffff) || (Class40_Sub6.anInt5103 != Class246_Sub28_Sub24.anInt6681 && !Client.current_renderer.method2052(Buffer.anInt5656, 111))) {
				IdentityKitLoader.anInt1206 = i_1_;
				...
				int i_4_ = Client.base_y;
				Client.base_y = 8 * (Class130_Sub8.anInt5618 - (Class152.anInt2205 >> 4));
				Class246_Sub28_Sub17.aClass246_Sub1_Sub5_6409 = Class79.method498(8 * IdentityKitLoader.anInt1206, 8 * Class130_Sub8.anInt5618);
				ScriptEvent.aClass178_4966 = null;
				int i_5_ = Client.base_x - i_3_;
				int i_6_ = Client.base_y + -i_4_;
				if (bool) {
					Class5.anInt55 = 0;
					int i_7_ = 128 * (Class38_Sub1_Sub1.anInt6770 - 1);
					int i_8_ = -128 + Class152.anInt2205 * 128;
					for (int i_9_ = 0; i_9_ < 32768; i_9_++) {
						Npc class_r_sub2 = VarcLoader.aClass_r_Sub2Array1002[i_9_];
						if (class_r_sub2 != null) {
							((Class59_Sub3) class_r_sub2).y -= i_6_ * 128;
							((Class59_Sub3) class_r_sub2).x -= i_5_ * 128;
							if ((((Class59_Sub3) class_r_sub2).x ^ 0xffffffff) <= -1 && ((i_7_ ^ 0xffffffff) <= (((Class59_Sub3) class_r_sub2).x ^ 0xffffffff)) && ((Class59_Sub3) class_r_sub2).y >= 0 && i_8_ >= (((Class59_Sub3) class_r_sub2).y)) {
								boolean bool_10_ = true;
								for (int i_11_ = 0; (i_11_ ^ 0xffffffff) > -11; i_11_++) {
									((Entity) class_r_sub2).f_mc[i_11_] -= i_5_;
									((Entity) class_r_sub2).f_nc[i_11_] -= i_6_;
									if ((((Entity) class_r_sub2).f_mc[i_11_] ^ 0xffffffff) > -1 || (Class38_Sub1_Sub1.anInt6770 <= (((Entity) class_r_sub2).f_mc[i_11_])) || ((((Entity) class_r_sub2).f_nc[i_11_]) ^ 0xffffffff) > -1 || ((Class152.anInt2205 ^ 0xffffffff) >= ((((Entity) class_r_sub2).f_nc[i_11_]) ^ 0xffffffff)))
										bool_10_ = false;
								}
								if (bool_10_)
									Class246_Sub28_Sub29.anIntArray6815[Class5.anInt55++] = i_9_;
								else {
									VarcLoader.aClass_r_Sub2Array1002[i_9_].method2934((byte) -124, null);
									VarcLoader.aClass_r_Sub2Array1002[i_9_] = null;
								}
							} else {
								VarcLoader.aClass_r_Sub2Array1002[i_9_].method2934((byte) -124, null);
								VarcLoader.aClass_r_Sub2Array1002[i_9_] = null;
					...
					for (int i_12_ = 0; i_12_ < 32768; i_12_++) {
						Npc class_r_sub2 = VarcLoader.aClass_r_Sub2Array1002[i_12_];
						if (class_r_sub2 != null) {
							for (int i_13_ = 0; (i_13_ ^ 0xffffffff) > -11; i_13_++) {
								((Entity) class_r_sub2).f_mc[i_13_] -= i_5_;
								((Entity) class_r_sub2).f_nc[i_13_] -= i_6_;
							}
							((Class59_Sub3) class_r_sub2).y -= i_6_ * 128;
							((Class59_Sub3) class_r_sub2).x -= 128 * i_5_;
						}
					}
				}
				for (int i_14_ = 0; (i_14_ ^ 0xffffffff) > -2049; i_14_++) {
					Player class_r_sub1 = Class143.players[i_14_];
					if (class_r_sub1 != null) {
						for (int i_15_ = 0; (i_15_ ^ 0xffffffff) > -11; i_15_++) {
							((Entity) class_r_sub1).f_mc[i_15_] -= i_5_;
							((Entity) class_r_sub1).f_nc[i_15_] -= i_6_;
						}
						((Class59_Sub3) class_r_sub1).y -= 128 * i_6_;
						((Class59_Sub3) class_r_sub1).x -= i_5_ * 128;
					}
				}
				...
				for (Class246_Sub6 class246_sub6 = ((Class246_Sub6) InvTypeLoader.aClass166_846.method1104(93)); class246_sub6 != null; class246_sub6 = ((Class246_Sub6) InvTypeLoader.aClass166_846.method1108((byte) -112))) {
		...
		try {
			...
			if (!Class168.aBool2400) {
				...
				if (!((Renderer) Client.current_renderer).aBool605)
					...
					Camera.camera_yaw = (float) (~0x7f & (int) Camera.camera_yaw - 65);
			}
		} catch (RuntimeException runtimeexception) {
	...
	final void method1129(byte i, byte[] is, Buffer stream) {
		try {
			anInt2421++;
			if (i != -33)
				SPAWN_WORLD_OBJECT_PACKET = null;
			if ((((Buffer) stream).buffer[((Buffer) stream).position] ^ 0xffffffff) != -32 || (((Buffer) stream).buffer[((Buffer) stream).position + 1]) != -117)
				throw new RuntimeException("Invalid GZIP header!");
			if (anInflater2415 == null)
				anInflater2415 = new Inflater(true);
			try {
				anInflater2415.setInput(((Buffer) stream).buffer, 10 + ((Buffer) stream).position, (-10 + -((Buffer) stream).position + (-8 + (((Buffer) stream).buffer).length)));
