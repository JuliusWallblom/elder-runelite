...
final class Class196 {
	...
	static final boolean method1280(int i, boolean bool) {
		try {
			anInt2753++;
			boolean bool_16_ = Client.sprite_loader.method1742();
			if (i != -14734)
				anInt2757 = -1;
			if (bool_16_ != !bool)
				return true;
			do {
				if (!bool) {
					Client.sprite_loader.method1677();
					if (!Client.f_ob)
						break;
				}
				if (!Client.sprite_loader.method1689())
					bool = false;
			} while (false);
			if (bool_16_ == bool)
				return false;
			((Renderer) Client.current_renderer).aBool596 = bool;
	...
	static {
		...
		new MultilingualString("Chat disabled", "Deaktiviert", "Messagerie d\u00e9sactiv\u00e9e", "Bate-papo desativado");
		anInt2757 = 765;
	}
}
