...
final class Class152 {
	...
	static Widget aClass235_2203 = null;
	...
	static final int method1010(boolean bool, int i, Class63_Sub1 class63_sub1, boolean bool_0_, Class63_Sub1 class63_sub1_1_) {
		try {
			...
			if ((i ^ 0xffffffff) == -3)
				return (Class19.method191(-39, (((Class5) class63_sub1_1_.method2072(-14839)).aString54), ((Class5) class63_sub1.method2072(-14839)).aString54, Preferences.language_code));
			if ((i ^ 0xffffffff) == -4) {
				...
				return Class19.method191(117, (((Class63_Sub1) class63_sub1_1_).aString4714), (((Class63_Sub1) class63_sub1).aString4714), Preferences.language_code);
			}
			if (i == 4) {
