...
final class Class246_Sub28_Sub15 extends TextureOperation {
	...
	static CacheIndex aClass_fs6368;
	...
	public static void method2645(boolean bool) {
		try {
			...
			MapRegion.DECODE_MAP_REGION_IN = null;
			aClass_fs6368 = null;
	...
	static final void method2646(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_) {
		try {
			...
			int i_13_ = i_1_;
			if (i_9_ != 0) {
				i_12_ = -i_13_ * MathUtils.SINE[i_9_] >> 15;
				i_13_ = MathUtils.COSINE[i_9_] * i_13_ >> 15;
			}
			if (i_10_ != 0) {
				i_11_ = i_13_ * MathUtils.SINE[i_10_] >> 15;
				i_13_ = MathUtils.COSINE[i_10_] * i_13_ >> 15;
			}
			Class244.anInt3456 = i_6_;
			Class246_Sub16.aInt92 = i_0_ - i_11_;
			Class106_Sub1.anInt4179 = 0;
			Class259_Sub1.anInt4509 = -i_13_ + i_2_;
			FontMetric.anInt961 = i_3_;
	...
	final void method2143(int i, int i_18_, Buffer stream) {
		while_126_: do {
			try {
				if (i == 4) {
					anInt6367++;
					...
					while_125_: do {
						...
						anInt6365 = stream.readUnsignedShort();
						return;
					} while (false);
	...
	final int[] method2135(int i, int i_28_) {
		try {
			...
			int[] is = ((TextureOperation) this).aClass66_4938.method435((byte) -112, i_28_);
