...
final class Class_e {
	...
	static final void method592(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_,
			int i_8_) {
		try {
			int i_9_ = 122 % ((10 - i_2_) / 34);
			anInt1209++;
			if ((i_7_ ^ 0xffffffff) != (i_6_ ^ 0xffffffff) || (i_3_ ^ 0xffffffff) != (i ^ 0xffffffff)
					|| (i_8_ ^ 0xffffffff) != (i_5_ ^ 0xffffffff) || i_1_ != i_4_) {
				int i_10_ = i_7_;
				int i_11_ = i;
				int i_12_ = 3 * i_7_;
				int i_13_ = 3 * i;
			...
			throw Class193.method1272(runtimeexception, ("e.C(" + i + ',' + i_0_ + ',' + i_1_ + ',' + i_2_ + ',' + i_3_
	...
	static final void method595(byte i, Buffer stream) {
		try {
			if (i > -117)
				anInt1219 = -3;
			anInt1213++;
	...
	static {
		new MultilingualString(null, "Dieses System darf nicht missbraucht werden!", null, null);
		anIntArray1215 = new int[14];
		INTERFACE_TEXT_IN = new IncomingPacket(1, -2);
		aClass170_1217 = new Class170();
		new MultilingualString("You can report that person under a different rule.",
