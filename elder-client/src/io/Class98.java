...
final class Class98 {
	...
	int anInt1271;
	static CacheIndex aClass_fs1272;
	static int anInt1273;
	static int anInt1274;
	int anInt1276 = 2;
	boolean aBool1277;
	int anInt1278;
	static AbstractSprite[] aClass_lArray1279;

	final void method618(int i, int i_0_, Buffer stream) {
		do {
			try {
				anInt1270++;
				for (;;) {
	...
	private final void method619(Buffer stream, int i, int i_2_, int i_3_) {
		do {
			try {
				if ((i ^ 0xffffffff) == -2) {
					((Class98) this).anInt1269 = stream.readUnsignedShort();
					if ((((Class98) this).anInt1269 ^ 0xffffffff) == -65536)
						((Class98) this).anInt1269 = -1;
				} else if ((i ^ 0xffffffff) == -3) {
					((Class98) this).anInt1271 = stream.readUnsignedShort() + 1;
					((Class98) this).anInt1278 = 1 + stream.readUnsignedShort();
				} else if ((i ^ 0xffffffff) == -4) {
					stream.readByte();
				} else if (i == 4) {
					((Class98) this).anInt1276 = stream.readUnsignedByte();
				} else if (i == 5) {
					((Class98) this).anInt1268 = stream.readUnsignedByte();
	...
	static final void method620(int i, boolean bool) {
		try {
			...
			MapScenes.anIntArray3625 = new int[i];
		} catch (RuntimeException runtimeexception) {
