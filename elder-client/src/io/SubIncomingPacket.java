...
final class SubIncomingPacket extends Class246_Sub1_Sub6 {
	...
	final int method2533(int i) {
		try {
			...
			if (((SubIncomingPacket) this).aStream7089 == null)
				return 0;
			return (100 * (((Buffer) ((SubIncomingPacket) this).aStream7089).position) / (-((SubIncomingPacket) this).aByte7092 + ((Buffer) (((SubIncomingPacket) this).aStream7089)).buffer.length));
		} catch (RuntimeException runtimeexception) {
	...
	final byte[] method2534(boolean bool) {
		try {
			...
			if (bool != false)
				return null;
			if (((Class246_Sub1_Sub6) this).aBool5960 || ((((Buffer) ((SubIncomingPacket) this).aStream7089).position) < ((((Buffer) ((SubIncomingPacket) this).aStream7089).buffer).length - ((SubIncomingPacket) this).aByte7092)))
				throw new RuntimeException();
			return (((Buffer) ((SubIncomingPacket) this).aStream7089).buffer);
		} catch (RuntimeException runtimeexception) {
