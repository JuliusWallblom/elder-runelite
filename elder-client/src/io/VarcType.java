...
final class VarcType {
	...
	final void method1447(Buffer stream, byte i) {
		try {
			for (;;) {
	...
	static final void method1449(int i, int i_2_, int i_3_, int i_4_, int i_5_) {
		try {
			for (int i_6_ = i_4_; i_6_ < SequenceType.anInt1738; i_6_++) {
	...
	static final Class246_Sub2 method1450(boolean bool) {
		try {
			...
			if (class246_sub2 == null)
				return null;
			MapFunction class140 = Class79.aClass165_1022.method1088(((Class246_Sub2) class246_sub2).anInt3808, (byte) -41);
			if (class140 != null && ((MapFunction) class140).aBool1991 && class140.method942(-11247, Class79.anInterface11_1025))
	...
	private final void method1451(byte i, int i_7_, Buffer stream) {
		try {
			do {
				if ((i_7_ ^ 0xffffffff) == -2) {
					((VarcType) this).aChar3108 = Class246_Sub1_Sub8_Sub1.method2923(32404, stream.readByte());
					if (!Client.f_ob)
						break;
				}
				if (i_7_ == 2)
					((VarcType) this).anInt3105 = 0;
			} while (false);
			if (i >= 117)
				anInt3112++;
		} catch (RuntimeException runtimeexception) {
