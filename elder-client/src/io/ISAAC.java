...
final class ISAAC {
	...
	public static void method288(int i) {
		try {
			...
			SEND_IGNORES_LIST_PACKET = null;
			aClass81_625 = null;
			Cache.reset_index(Revision.PRE_EOC_634, "config");
			Cache.reset_index(Revision.OSRS, "config");
	...
	final int method291(byte i) {
		try {
			...
			if (i > -77)
				return 65;
			return Constants.USE_ISAAC ? anIntArray632[--anInt631] : 0;
		} catch (RuntimeException runtimeexception) {
	...
	private final void method292(int i) {
		try {
			...
			for (int i_18_ = 0; i_18_ < 256; i_18_++) {
				...
				int i_20_;
				anIntArray629[i_18_] = i_20_ = (anInt620 + anIntArray629[PacketsDecoder.method184(255, i_19_ >> 2)]
						- -anInt622);
				anIntArray632[i_18_] = anInt620 = i_19_
						+ (anIntArray629[PacketsDecoder.method184(1020, i_20_ >> 8) >> 2]);
			}
		} catch (RuntimeException runtimeexception) {
	...
	final int method293(int i) {
		try {
			...
			if (i != 855258338)
				anInt630 = -67;
			return Constants.USE_ISAAC ? anIntArray632[-1 + anInt631] : 0;
		} catch (RuntimeException runtimeexception) {
