	...
	static final void method1118(int i, int i_0_, byte i_1_) {
		do {
			try {
				...
				if ((TextureLoader.anInt966 ^ 0xffffffff) < -1) {
				...
				for (Class246_Sub10 class246_sub10 = ((Class246_Sub10) Class211.aClass166_2963.method1104(58)); class246_sub10 != null; class246_sub10 = ((Class246_Sub10) Class211.aClass166_2963.method1108((byte) -112))) {
					MapFunction class140 = (Class79.aClass165_1022.method1088(((Class246_Sub2) (((Class246_Sub10) class246_sub10).aClass246_Sub2_4081)).anInt3808, (byte) -41));
					if (!class246_sub10.method1866(i_0_, -15997, i)) {
						if (((Class246_Sub2) (((Class246_Sub10) class246_sub10).aClass246_Sub2_4081)).aBool3802) {
							...
							ScriptExecutor.method993(Font.aClass169_1609, (((Class246_Sub2) (((Class246_Sub10) class246_sub10).aClass246_Sub2_4081)).anInt3808), (((MapFunction) class140).anInt2014), -1);
						}
					} else {
						if (((MapFunction) class140).aStringArray2029 != null) {
							if (((MapFunction) class140).aStringArray2029[4] != null)
								Class259_Sub2_Sub1.method2846(1006, (byte) -55, false, (long) ((Class246_Sub2) (((Class246_Sub10) class246_sub10).aClass246_Sub2_4081)).anInt3808, ((MapFunction) class140).anInt2014, ((MapFunction) class140).aString2016, true, ((MapFunction) class140).aStringArray2029[4], 0, -1, -1);
							if (((MapFunction) class140).aStringArray2029[3] != null)
								Class259_Sub2_Sub1.method2846(1001, (byte) -55, false, (long) ((Class246_Sub2) (((Class246_Sub10) class246_sub10).aClass246_Sub2_4081)).anInt3808, ((MapFunction) class140).anInt2014, ((MapFunction) class140).aString2016, true, ((MapFunction) class140).aStringArray2029[3], 0, -1, -1);
							if (((MapFunction) class140).aStringArray2029[2] != null)
								Class259_Sub2_Sub1.method2846(1008, (byte) -55, false, (long) ((Class246_Sub2) (((Class246_Sub10) class246_sub10).aClass246_Sub2_4081)).anInt3808, ((MapFunction) class140).anInt2014, ((MapFunction) class140).aString2016, true, ((MapFunction) class140).aStringArray2029[2], 0, -1, -1);
							if (((MapFunction) class140).aStringArray2029[1] != null)
								Class259_Sub2_Sub1.method2846(1012, (byte) -55, false, (long) ((Class246_Sub2) (((Class246_Sub10) class246_sub10).aClass246_Sub2_4081)).anInt3808, ((MapFunction) class140).anInt2014, ((MapFunction) class140).aString2016, true, ((MapFunction) class140).aStringArray2029[1], 0, -1, -1);
							if (((MapFunction) class140).aStringArray2029[0] != null)
								Class259_Sub2_Sub1.method2846(1004, (byte) -55, false, (long) ((Class246_Sub2) (((Class246_Sub10) class246_sub10).aClass246_Sub2_4081)).anInt3808, ((MapFunction) class140).anInt2014, ((MapFunction) class140).aString2016, true, ((MapFunction) class140).aStringArray2029[0], 0, -1, -1);
						}
						if (!((Class246_Sub2) (((Class246_Sub10) class246_sub10).aClass246_Sub2_4081)).aBool3802) {
							((Class246_Sub2) (((Class246_Sub10) class246_sub10).aClass246_Sub2_4081)).aBool3802 = true;
							ScriptExecutor.method993(Class171.aClass169_2425, (((Class246_Sub2) (((Class246_Sub10) class246_sub10).aClass246_Sub2_4081)).anInt3808), (((MapFunction) class140).anInt2014), -1);
						}
						if (((Class246_Sub2) (((Class246_Sub10) class246_sub10).aClass246_Sub2_4081)).aBool3802)
							ScriptExecutor.method993(Class51.aClass169_718, (((Class246_Sub2) (((Class246_Sub10) class246_sub10).aClass246_Sub2_4081)).anInt3808), (((MapFunction) class140).anInt2014), -1);
					}
				}
