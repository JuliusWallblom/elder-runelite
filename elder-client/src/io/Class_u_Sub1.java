...
final class Class_u_Sub1 extends Class_u {
	...
	static CacheIndex skeleton_data;
	static CacheIndex skeleton_data_550;
	static CacheIndex osrs_skeleton_data;
	...
	static final boolean method2419(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_) {
		if (i_0_ == i_1_ && i_2_ == i_3_) {
			...
			if (Class160.method1060(i_5_ + 1, Class59_Sub3_Sub4.aClass210Array6993[i].l(i_0_, i_2_) + i_4_, i_6_ + 1) && Class160.method1060(i_5_ + NodeSub.anInt3744 - 1, Class59_Sub3_Sub4.aClass210Array6993[i].l(i_0_ + 1, i_2_) + i_4_, i_6_ + 1) && Class160.method1060(i_5_ + NodeSub.anInt3744 - 1, Class59_Sub3_Sub4.aClass210Array6993[i].l(i_0_ + 1, i_2_ + 1) + i_4_, i_6_ + NodeSub.anInt3744 - 1) && Class160.method1060(i_5_ + 1, Class59_Sub3_Sub4.aClass210Array6993[i].l(i_0_, i_2_ + 1) + i_4_, i_6_ + NodeSub.anInt3744 - 1))
				return true;
			return false;
		}
		for (int i_7_ = i_0_; i_7_ <= i_1_; i_7_++) {
			for (int i_8_ = i_2_; i_8_ <= i_3_; i_8_++) {
				if (Class88.anIntArrayArrayArray1150[i][i_7_][i_8_] == -VarcLoader.anInt997)
					return false;
			}
		}
	...
	public static void method2420(int i) {
		try {
			skeleton_data = null;
			skeleton_data_550 = null;
			osrs_skeleton_data = null;
			aClass230_5685 = null;
