...
final class Class136 {
	...
	static IncomingPacket ROOT_INTER = new IncomingPacket(102, 9);
	...
	static final void method925(int i, SceneGraph class260, int i_5_, int i_6_) {
		try {
			...
			if (Class246_Sub28_Sub31.anIntArray6913 != null)
				Filestore.aClass211_2064 = (Class21_Sub3.method2078(Class246_Sub28_Sub31.anIntArray6913[4],
						Class246_Sub28_Sub31.anIntArray6913[2], Class246_Sub28_Sub31.anIntArray6913[5],
						Class246_Sub28_Sub31.anIntArray6913[0], Class246_Sub28_Sub31.anIntArray6913[3],
						Class246_Sub28_Sub31.anIntArray6913[1], -1101853054));
			Class22.aClass138_328 = new Class138();
			int i_7_ = 24 / ((i_6_ - 6) / 58);
			Filestore.method957((byte) 60);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("ms.B(" + i + ',' + (class260 != null ? "{...}" : "null") + ',' + i_5_ + ',' + i_6_ + ')'));
		}
	}
