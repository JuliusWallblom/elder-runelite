...
public final class Class193 {
	...
	private CacheIndex aClass_fs2723;

	public static void method1267(int i) {
		try {
			aByteArray2714 = null;
			Cache.client_cache.set(IndexConstants.PRE_EOC_634_EMPTY_15_INDEX, null);
			anIntArray2713 = null;
			MapRegion.anIntArray2717 = null;
	...
	static final void method1268(Class100 class100, int i, int i_1_, int i_2_, int i_3_, int i_4_) {
		...
		while_248_: for (int i_6_ = 0; i_6_ < ((Class100) class100).anInt1298; i_6_++) {
			long l = MapRegion.aLongArrayArrayArray3648[i][i_1_][i_2_];
			while (l != 0L) {
				Class174 class174 = StructLoader.aClass174Array811[(int) ((l & 0xffffL) - 1L)];
				l >>>= 16;
				if (((Class174) class174).aClass246_Sub41_2452 == ((Class100) class100).aClass246_Sub41Array1301[i_6_])
					continue while_248_;
			}
			l = MapRegion.aLongArrayArrayArray3648[i][i_3_][i_4_];
			while (l != 0L) {
				Class174 class174 = StructLoader.aClass174Array811[(int) ((l & 0xffffL) - 1L)];
				l >>>= 16;
				if (((Class174) class174).aClass246_Sub41_2452 == ((Class100) class100).aClass246_Sub41Array1301[i_6_])
	...
	Class193(Class101 class101, int i, CacheIndex class_fs) {
		do {
			try {
				aClass_fs2723 = class_fs;
				if (aClass_fs2723 == null)
					break;
				aClass_fs2723.child_count(35);
			} catch (RuntimeException runtimeexception) {
	...
	final Class84 method1273(byte i, int i_10_) {
		try {
			...
			if (class84 != null)
				return class84;
			byte[] is = aClass_fs2723.get_file(i_10_, 35);
			class84 = new Class84();
			if (is != null)
				class84.method537((byte) -78, new Buffer(is));
