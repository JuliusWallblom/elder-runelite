...
final class Class246_Sub1_Sub10 extends NodeSub {
	...
	static MultilingualString aClass67_6224;
	static long f_bb;
	static int f_cb;
	static int f_db;
	static ParamLoader f_eb;
	...
	static final void method2599(int i, int i_0_, int i_1_, int i_2_, int i_3_, boolean bool) {
		try {
			...
			Class246_Sub18 class246_sub18 = (Class246_Sub18) Class110.aClass85_1572.get(l);
			...
			throw Class193.method1272(runtimeexception,
					("hp.J(" + i + ',' + i_0_ + ',' + i_1_ + ',' + i_2_ + ',' + i_3_ + ',' + bool + ')'));
		}
	}
	...
	final void method2600(int i) {
		do {
			try {
				((NodeSub) this).aLong3739 |= ~0x7fffffffffffffffL;
				if (i == -25852) {
					anInt6202++;
	...
	final void method2604(byte i) {
		do {
			try {
				anInt6207++;
				((NodeSub) this).aLong3739 = (TimeUtility.time() - -500L
						| (~0x7fffffffffffffffL & ((NodeSub) this).aLong3739));
	...
	static final void method2606(int i, byte i_9_) {
		try {
			anInt6203++;
			int i_10_ = Client.cycle - Class246_Sub30.anInt5031;
			if (i_10_ >= 100)
				Class130_Sub3.anInt4417 = 1;
			else {
				int i_11_ = (int) Camera.camera_pitch;
				if (Stream_Sub2.anInt6188 >> 8 > i_11_)
					i_11_ = Stream_Sub2.anInt6188 >> 8;
				if (Class246_Sub28_Sub29.aBoolArray6817[4]
						&& (Class59_Sub5_Sub1.anIntArray5827[4] + 128 ^ 0xffffffff) < (i_11_ ^ 0xffffffff))
					i_11_ = Class59_Sub5_Sub1.anIntArray5827[4] + 128;
				int i_12_ = 0x3fff & Tile.anInt2147 + (int) Camera.camera_yaw;
				Class246_Sub28_Sub15
						.method2646(0, Class_c_Sub1.anInt5366, (i_11_ >> 3) * 3 + 600 << 0, Class246_Sub34.anInt5135,
								i_12_,
								-50 + Class6.getAverageHeight((((Class59_Sub3) Client.local_player).x), 46,
										Class246_Sub28_Sub24.anInt6681, (((Class59_Sub3) Client.local_player).y)),
								i, i_11_);
				float f = (-((float) ((100 - i_10_) * ((-i_10_ + 100) * (-i_10_ + 100))) / 1000000.0F) + 1.0F);
				Class259_Sub1.anInt4509 = (int) (f * (float) (-Class_cs.anInt7145 + Class259_Sub1.anInt4509)
						+ (float) Class_cs.anInt7145);
				if (i_9_ != 24)
					aClass48_6215 = null;
				Class246_Sub28_Sub8.anInt6077 = (int) ((float) Class56.anInt788
						+ (float) (-Class56.anInt788 + Class246_Sub28_Sub8.anInt6077) * f);
				Class244.anInt3456 = (int) ((float) Class21_Sub3.anInt4727
						+ (float) (-Class21_Sub3.anInt4727 + Class244.anInt3456) * f);
				Class246_Sub16.aInt92 = (int) ((float) (Class246_Sub16.aInt92 - MouseHandler.anInt4450) * f
						+ (float) MouseHandler.anInt4450);
				int i_13_ = -Class96.anInt1259 + FontMetric.anInt961;
				do {
				...
				FontMetric.anInt961 = (int) ((float) Class96.anInt1259 + (float) i_13_ * f);
	...
	final long method2607(int i) {
		try {
			...
			anInt6212++;
			return ((NodeSub) this).aLong3739 & 0x7fffffffffffffffL;
		} catch (RuntimeException runtimeexception) {
	...
	static {
		...
		aClass67_6224 = new MultilingualString("green:", "gr\u00fcn:", "vert:", "verde:");
		f_bb = 0L;
		f_cb = 0;
	}
}
