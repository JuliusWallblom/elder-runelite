...
public final class Class249 {
	...
	static MultilingualString aClass67_3497 = (new MultilingualString("Your ignore list is full, max of 100.", "Deine Ignorieren-Liste ist voll, du kannst nur 100 Spieler darauf eintragen.", "Votre liste noire est pleine (100 noms maximum).", "Sua lista de ignorados est\u00e1 cheia. O m\u00e1x. \u00e9 100."));
		...
		try {
			...
			if (aClass134_3496 != null) {
				if (class246_sub7.method1837((byte) 109) || class246_sub7.method1838((byte) 126)) {
					aClass166_3495.push_head(class246_sub7);
					method1589(i + 2);
