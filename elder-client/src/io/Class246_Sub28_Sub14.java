...
final class Class246_Sub28_Sub14 extends TextureOperation {
	static int anInt6299;
	static int anInt6300;
	static int anInt6301;
	static int anInt6302;
	static MultilingualString WALK_HERE_MS = new MultilingualString("Walk here", "Hierhin gehen", "Atteindre",
			"Caminhar para c\u00e1");
	...
	final int[] method2135(int i, int i_2_) {
		try {
			...
			if (((Class66) ((TextureOperation) this).aClass66_4938).aBool887) {
				int i_4_ = Varc.anIntArray6245[i_2_];
	...
	static final void method2636(Class59_Sub3 class59_sub3) {
		for (int i = ((Class59_Sub3) class59_sub3).aShort5057; i <= ((Class59_Sub3) class59_sub3).aShort5065; i++) {
			for (int i_9_ = ((Class59_Sub3) class59_sub3).aShort5064; i_9_ <= ((Class59_Sub3) class59_sub3).aShort5062; i_9_++) {
				Tile class147 = (Class106.tiles[((Class59_Sub3) class59_sub3).current_plane][i][i_9_]);
				if (class147 != null) {
					Class3 class3 = ((Tile) class147).aClass3_2160;
					...
					for (/**/; class3 != null; class3 = ((Class3) class3).aClass3_28) {
						if (((Class3) class3).aClass59_Sub3_24 == class59_sub3) {
							if (class3_10_ != null)
								...
								((Tile) class147).aClass3_2160 = ((Class3) class3).aClass3_28;
							class3.method49(35);
							break;
						}
						class3_10_ = class3;
					}
					((Tile) class147).aByte2168 = (byte) 0;
					for (Class3 class3_11_ = ((Tile) class147).aClass3_2160; class3_11_ != null; class3_11_ = ((Class3) class3_11_).aClass3_28)
						((Tile) class147).aByte2168 |= ((Class3) class3_11_).anInt31;
				}
			}
		}
	}
