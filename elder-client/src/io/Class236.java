...
final class Class236 {
	...
	static CacheIndex skin_data;
	static CacheIndex skin_data_550;
	static CacheIndex osrs_skin_data;
	...
	final boolean method1518(byte i, Class109 class109, int i_0_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("uv.A(" + i + ',' + (class109 != null ? "{...}" : "null") + ',' + i_0_ + ')'));
		}
	}
	...
	final void method1521(int i, int i_5_, boolean bool) {
		do {
			try {
				if (((anInt3310 ^ 0xffffffff) != (i ^ 0xffffffff) | i_5_ != anInt3318)
						& (anInt3313 ^ 0xffffffff) != -1) {
	...
	Class236(Class260_Sub2 class260_sub2) {
		...
		do {
			try {
				...
				throw Class193.method1272(runtimeexception,
						"uv.<init>(" + (class260_sub2 != null ? "{...}" : "null") + ')');
			}
			break;
		} while (false);
	}
