...
final class Class60 {
	...
	final void method410(Buffer stream, int i) {
		do {
			try {
				for (;;) {
	...
	static final void method411(Class138 class138, boolean bool, int i, int i_1_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("fn.D(" + (class138 != null ? "{...}" : "null") + ',' + bool + ',' + i + ',' + i_1_ + ')'));
		}
	}
	...
	private final void method414(int i, int i_8_, Buffer stream) {
		do {
			try {
				anInt825++;
				if (i == i_8_)
					anInt834 = stream.readUnsignedShort();
				else {
					if (i_8_ != 2)
						break;
					((Class60) this).anInt827 = stream.readUnsignedByte();
					((Class60) this).anInt826 = stream.readUnsignedByte();
				}
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception,
						("fn.E(" + i + ',' + i_8_ + ',' + (stream != null ? "{...}" : "null") + ')'));
			}
			break;
		} while (false);
	}
	...
	final synchronized LDSprite method415(int i) {
		try {
			anInt835++;
			LDSprite class10 = ((LDSprite) ((Cursors) ((Class60) this).aClass156_828).aClass54_2242
					.method379((long) anInt834, (byte) 58));
			if (class10 != null)
				return class10;
			class10 = LDSprite.get_sprite((((Cursors) ((Class60) this).aClass156_828).aClass_fs2239), anInt834, i);
			if (class10 != null)
				((Cursors) ((Class60) this).aClass156_828).aClass54_2242.method371(1, (long) anInt834, class10);
			return class10;
		} catch (RuntimeException runtimeexception) {
