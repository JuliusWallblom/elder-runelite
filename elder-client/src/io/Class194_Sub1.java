...
final class Class194_Sub1 extends Class194 implements Interface1 {
	...
	static Filestore aClass142_4140;
	...
	static final void method1882(int i, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_) {
		try {
			...
			for (int i_13_ = i_9_; i_13_ < i_11_; i_13_++)
				RenderAnimation.method918(i_4_, 124, i_6_, i_7_, (Class246_Sub28_Sub6.anIntArrayArray6042[i_13_]));
			for (int i_14_ = i; (i_10_ ^ 0xffffffff) > (i_14_ ^ 0xffffffff); i_14_--)
				RenderAnimation.method918(i_4_, 118, i_6_, i_7_, (Class246_Sub28_Sub6.anIntArrayArray6042[i_14_]));
			int i_15_ = -i_8_ + i_7_;
			int i_16_ = i_4_ + i_8_;
			for (int i_17_ = i_11_; (i_17_ ^ 0xffffffff) >= (i_10_ ^ 0xffffffff); i_17_++) {
				int[] is = Class246_Sub28_Sub6.anIntArrayArray6042[i_17_];
				RenderAnimation.method918(i_4_, 125, i_6_, i_16_, is);
				RenderAnimation.method918(i_15_, 123, i_6_, i_7_, is);
			}
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1883(Throwable throwable, String string, int i) {
		if(true) {
			while (throwable instanceof RuntimeException_Sub2) {
				throwable = ((RuntimeException_Sub2)throwable).aThrowable7152;
			}
