...
public final class NativeLibraryLoader {
	...
	static Hashtable<String, Class<Class_e>> idk1 = new Hashtable<String, Class<Class_e>>();

	static final boolean loadNative(String string) {
		return method454((aClass544 != null ? aClass544 : (aClass544 = Client.getClassByName("Class_e"))), string);
	}
	...
	static final boolean method454(Class var_class, String string) {
		...
		if (file != null) {
			try {
				...
				idk1.put(string, (aClass8466 != null ? aClass8466 : (aClass8466 = Client.getClassByName("Class_e"))));
				return true;
