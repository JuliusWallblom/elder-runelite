...
final class Class179 {
		...
		do {
			try {
				...
				if (WidgetParent.aClass123_5522 != null)
					WidgetParent.aClass123_5522.method843((byte) -118);
		...
		do {
			try {
				...
				if ((i_16_ ^ 0xffffffff) < (Class244.anInt3456 ^ 0xffffffff)) {
					Class244.anInt3456 += (Class214.anInt2988 * (-Class244.anInt3456 + i_16_ >> 3) / 1000) + ParamType.anInt1636 << 3;
					if ((i_16_ ^ 0xffffffff) > (Class244.anInt3456 ^ 0xffffffff))
				...
				int i_18_ = i_17_ + -FontMetric.anInt961;
				if (i_18_ > 8192)
					i_18_ -= 16384;
				...
				if ((i_18_ ^ 0xffffffff) < -1) {
					FontMetric.anInt961 += (ParamType.anInt1636 + i_18_ * Class214.anInt2988 / 1000) << 3;
					FontMetric.anInt961 &= 0x3fff;
				}
				if ((i_18_ ^ 0xffffffff) > -1) {
					FontMetric.anInt961 -= (ParamType.anInt1636 + Class214.anInt2988 * -i_18_ / 1000) << 3;
					FontMetric.anInt961 &= 0x3fff;
				}
				if (i == 488012003) {
					int i_19_ = i_17_ + -FontMetric.anInt961;
					if (i_19_ > 8192)
						i_19_ -= 16384;
					if (i_19_ < -8192)
						i_19_ += 16384;
	...
	static final String method1174(Widget class235, byte i) {
		try {
			anInt2511++;
			if (Widget.get_active_properties(class235).get_widget_flags(16693) == 0)
				return null;
			if (i != 120)
				method1169(-5, (byte) -2);
			if (((Widget) class235).selected_action_name == null || (((Widget) class235).selected_action_name.trim().length() ^ 0xffffffff) == -1) {
				if (RenderSequenceLoader.aBool1452)
					return "Hidden-use";
				return null;
			}
			return ((Widget) class235).selected_action_name;
		} catch (RuntimeException runtimeexception) {
