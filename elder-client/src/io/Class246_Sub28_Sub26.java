...
final class Class246_Sub28_Sub26 extends TextureOperation {
		...
		try {
			...
			if (((Class66) ((TextureOperation) this).aClass66_4938).aBool887) {
				for (int i_1_ = 0; ((Class246_Sub37_Sub1.f_gb ^ 0xffffffff) < (i_1_ ^ 0xffffffff)); i_1_++) {
					...
					int i_3_ = ((Varc.anIntArray6245[i_0_] << 12) / anInt6709 + anInt6710);
					int i_4_ = i_2_;
					int i_5_ = i_3_;
					int i_6_ = i_2_;
					int i_7_ = i_3_;
	...
	public static void method2752(int i) {
		try {
			...
			Client.low_priority_script_events = null;
			aClass123_6716 = null;
		} catch (RuntimeException runtimeexception) {
				...
				while_114_: do {
					do {
						if (i_13_ != 0) {
							...
							anInt6709 = stream.readUnsignedShort();
							break while_115_;
						}
						anInt6712 = stream.readUnsignedShort();
						break while_115_;
					} while (false);
					anInt6715 = stream.readUnsignedShort();
					break while_115_;
				} while (false);
				anInt6710 = stream.readUnsignedShort();
			} while (false);
			anInt6713++;
		} catch (RuntimeException runtimeexception) {
	...
	static {
		Client.low_priority_script_events = new Class166();
	}
}
