...
final class Class246_Sub28_Sub30 extends TextureOperation {
				...
				while_54_: do {
					do {
						if ((i_1_ ^ 0xffffffff) != -1) {
							...
							anInt6869 = stream.readUnsignedShort();
							break while_54_;
						}
						anInt6872 = stream.readUnsignedShort();
						break while_54_;
					} while (false);
	...
	final int[][] method2139(byte i, int i_2_) {
		try {
			...
			if (i < 33)
				method2135(47, -106);
			int[][] is = ((TextureOperation) this).aClass136_4933.method922((byte) -128, i_2_);
	...
	final int[] method2135(int i, int i_11_) {
		try {
			anInt6868++;
			int[] is = ((TextureOperation) this).aClass66_4938.method435((byte) -112, i_11_);
	...
	static final void method2833(byte i, SceneGraph class260) {
		do {
			try {
				do {
					...
					ContextMenus.draw_context_menu(class260);
				} while (false);
				anInt6866++;
				if (i == -7)
					break;
	...
	static final void method2834(byte i) {
		do {
			try {
				...
				int i_20_ = (Class246_Sub28_Sub35.anInt7014 + (-Client.client_width - i_18_));
				int i_21_ = -i_19_ + -Client.client_height + Class8.anInt101;
				if (i_18_ > 0 || i_20_ > 0 || i_19_ > 0 || (i_21_ ^ 0xffffffff) < -1) {
					try {
						...
						if (i_20_ > 0)
							graphics.fillRect((Class246_Sub28_Sub35.anInt7014 + (i_22_ - i_20_)), i_23_, i_20_,
									Class8.anInt101);
						if (i_21_ <= 0)
							break;
						graphics.fillRect(i_22_, -i_21_ + (i_23_ - -Class8.anInt101), Class246_Sub28_Sub35.anInt7014,
								i_21_);
	...
	static {
		new MultilingualString("Now talking in clan channel ", "Chatraum: ",
				"Vous participez actuellement au canal de clan ", "Falando no canal do cl\u00e3 agora ");
	}
}
