...
final class Class205 {
	...
	static AbstractSprite aClass_l2885;
	...
	static final void method1340(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, Entity class_r) {
		try {
			Class211.method1386(i_3_, ((Class59_Sub3) class_r).x, ((Class59_Sub3) class_r).y, i_2_, i_0_, i, i_4_, 503, ((Class59_Sub3) class_r).current_plane, i_1_);
			anInt2886++;
