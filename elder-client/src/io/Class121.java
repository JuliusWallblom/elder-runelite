...
final class Class121 {
	...
	static IncomingPacket CLOSE_INTERFACES_IN;
		...
		do {
			try {
				if (i_0_ >= -33)
					method822(-12);
				anInt1653++;
				if (i < ObjType.anInt2818 || (i ^ 0xffffffff) < (Class110.anInt1573 ^ 0xffffffff))
					break;
				i_1_ = Class180.method1176(Class109_Sub4.anInt4570, -24309, i_1_, AbstractModel.anInt1442);
				i_2_ = Class180.method1176(Class109_Sub4.anInt4570, -24309, i_2_, AbstractModel.anInt1442);
				Cursors.method1035((byte) -17, i_2_, i_1_, i, i_3_);
			} catch (RuntimeException runtimeexception) {
	...
	static {
		CLOSE_INTERFACES_IN = new IncomingPacket(44, 6);
	}
}
