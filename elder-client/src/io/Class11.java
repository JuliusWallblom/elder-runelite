...
final class Class11 {
	...
	final void method132(Buffer stream, Class49 class49) {
		int i = stream.readUnsignedByte();
		((Class11) this).anIntArray169[0] = i >> 4;
		((Class11) this).anIntArray169[1] = i & 0xf;
		if (i != 0) {
			anIntArray168[0] = stream.readUnsignedShort();
			anIntArray168[1] = stream.readUnsignedShort();
			int i_2_ = stream.readUnsignedByte();
			for (int i_3_ = 0; i_3_ < 2; i_3_++) {
				for (int i_4_ = 0; i_4_ < ((Class11) this).anIntArray169[i_3_]; i_4_++) {
					anIntArrayArrayArray167[i_3_][0][i_4_] = stream.readUnsignedShort();
					anIntArrayArrayArray164[i_3_][0][i_4_] = stream.readUnsignedShort();
				}
			}
			for (int i_5_ = 0; i_5_ < 2; i_5_++) {
				for (int i_6_ = 0; i_6_ < ((Class11) this).anIntArray169[i_5_]; i_6_++) {
					if ((i_2_ & 1 << i_5_ * 4 << i_6_) != 0) {
						anIntArrayArrayArray167[i_5_][1][i_6_] = stream.readUnsignedShort();
						anIntArrayArrayArray164[i_5_][1][i_6_] = stream.readUnsignedShort();
					} else {
