...
final class Class_l_Sub2 extends AbstractSprite {
	...
	static MultilingualString aClass67_5478 = new MultilingualString("Continue", "Weiter", "Continuer", "Continuar");
	...
	final void method730(float f, float f_0_, float f_1_, float f_2_, float f_3_, float f_4_, Class128 class128, int i,
			int i_5_) {
		try {
			anInt5455++;
			...
			float f_22_ = (((Class109_Sub1_Sub1) class109_sub1_sub1).aFloat6730
					/ (float) (((Class109_Sub1_Sub1) class109_sub1_sub1).anInt6724));
			float f_23_ = (((Class109_Sub1_Sub1) class109_sub1_sub1).aFloat6727
			...
			OpenGL.glMultiTexCoord2f(33985, f_22_ * (f - (float) i),
					(-(f_23_ * ((float) -i_5_ + f_0_)) + ((Class109_Sub1_Sub1) class109_sub1_sub1).aFloat6727));
			OpenGL.glVertex2f(f, f_0_);
			OpenGL.glMultiTexCoord2f(33984, 0.0F, 0.0F);
			OpenGL.glMultiTexCoord2f(33985, ((float) -i + f_3_) * f_22_,
					(-((f_4_ - (float) i_5_) * f_23_) + ((Class109_Sub1_Sub1) class109_sub1_sub1).aFloat6727));
			OpenGL.glVertex2f(f_3_, f_4_);
			OpenGL.glMultiTexCoord2f(33984, ((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).aFloat6730, 0.0F);
			OpenGL.glMultiTexCoord2f(33985, ((float) -i + f_20_) * f_22_,
					(-(((float) -i_5_ + f_21_) * f_23_) + ((Class109_Sub1_Sub1) class109_sub1_sub1).aFloat6727));
			OpenGL.glVertex2f(f_20_, f_21_);
			OpenGL.glMultiTexCoord2f(33984, ((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).aFloat6730,
					((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).aFloat6727);
			OpenGL.glMultiTexCoord2f(33985, f_22_ * (f_1_ - (float) i),
					(((Class109_Sub1_Sub1) class109_sub1_sub1).aFloat6727 - f_23_ * ((float) -i_5_ + f_2_)));
			...
			throw Class193.method1272(runtimeexception, ("ut.a(" + f + ',' + f_0_ + ',' + f_1_ + ',' + f_2_ + ',' + f_3_
					+ ',' + f_4_ + ',' + (class128 != null ? "{...}" : "null") + ',' + i + ',' + i_5_ + ')'));
		}
	}
	...
	static final void method2298(int i, int i_25_, int i_26_, int i_27_, int i_28_, int i_29_) {
		do {
			try {
				anInt5474++;
				if (i_27_ != -27348)
					Client.trade_chat_mode = -13;
				if ((((Renderer) Client.current_renderer).anInt602) == 0 || (i_28_ ^ 0xffffffff) == -1
						|| Class59.anInt819 >= 50 || i_25_ == -1)
					break;
				Class47.aClass258Array684[Class59.anInt819++] = new Class258((byte) 1, i_25_, i_28_, i_26_, i, i_29_);
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception,
						("ut.B(" + i + ',' + i_25_ + ',' + i_26_ + ',' + i_27_ + ',' + i_28_ + ',' + i_29_ + ')'));
			}
			break;
		} while (false);
	}
	...
	final void BA(int i, int i_30_, int i_31_) {
		try {
			...
			aClass109_Sub1_Sub1_5458 = Class79_Sub1.method2205(i_30_,
					((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).anInt6729, i,
					((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).anInt6724, -128, aClass260_Sub2_5472);
			anInt5456 = i_31_;
	...
	static final String method2299(int i, byte[] is, int i_32_, int i_33_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("ut.A(" + i + ',' + (is != null ? "{...}" : "null") + ',' + i_32_ + ',' + i_33_ + ')'));
		}
	}
	...
	static final void method2300(byte i) {
		try {
			...
			for (Class246_Sub16 class246_sub16 = ((Class246_Sub16) Class159.aClass166_2258.method1104(
					100)); class246_sub16 != null; class246_sub16 = ((Class246_Sub16) Class159.aClass166_2258
							.method1108((byte) -112))) {
				if (Class106.tiles == null)
					class246_sub16.remove();
				else if ((Client.cycle ^ 0xffffffff) > (((Class246_Sub16) class246_sub16).anInt4535 ^ 0xffffffff)) {
					if (((Class246_Sub16) class246_sub16).anInt4523 == Client.cycle) {
						...
						if ((i_39_ ^ 0xffffffff) != -1) {
							if ((i_39_ ^ 0xffffffff) == -2) {
								Class59_Sub2 class59_sub2 = (Class31.method236(
										(((Class246_Sub16) class246_sub16).anInt4528),
										(((Class246_Sub16) class246_sub16).anInt4520),
										(((Class246_Sub16) class246_sub16).anInt4525)));
								if (class59_sub2 instanceof Class59_Sub2_Sub2)
									class246_sub16.remove();
								else if (Class214.method1398((((Class246_Sub16) class246_sub16).anInt4528),
										(((Class246_Sub16) class246_sub16).anInt4520),
										(((Class246_Sub16) class246_sub16).anInt4525)) != null)
									class246_sub16.remove();
								else {
									Class59_Sub2_Sub2 class59_sub2_sub2 = (new Class59_Sub2_Sub2(
											(((Class246_Sub16) class246_sub16).anInt4527),
											(((Class246_Sub16) class246_sub16).anInt4522),
											(((Class246_Sub16) class246_sub16).anInt4530),
											(((Class246_Sub16) class246_sub16).anInt4519),
											(((Class246_Sub16) class246_sub16).anInt4536), class59_sub2));
									Class41.method285((((Class246_Sub16) class246_sub16).anInt4528),
											(((Class246_Sub16) class246_sub16).anInt4520),
											(((Class246_Sub16) class246_sub16).anInt4525), class59_sub2_sub2, null);
								}
							} else if (i_39_ == 2) {
								Class59_Sub3 class59_sub3 = (Class17.method168(
										(((Class246_Sub16) class246_sub16).anInt4528),
										(((Class246_Sub16) class246_sub16).anInt4520),
										(((Class246_Sub16) class246_sub16).anInt4525), (aClass5483 != null ? aClass5483
												: (aClass5483 = Client.getClassByName("Class_f")))));
								if (class59_sub3 instanceof Class59_Sub3_Sub1)
									class246_sub16.remove();
								else {
									Model.method653((((Class246_Sub16) class246_sub16).anInt4528),
											(((Class246_Sub16) class246_sub16).anInt4520),
											(((Class246_Sub16) class246_sub16).anInt4525),
											(aClass5483 != null ? aClass5483
													: (aClass5483 = Client.getClassByName("Class_f"))));
									LocType class185 = (Class143.aClass251_2067
											.list((((Class246_Sub16) class246_sub16).anInt4526), 0));
									int i_40_;
									int i_41_;
									if (((((Class246_Sub16) class246_sub16).anInt4522) ^ 0xffffffff) == -2
											|| ((((Class246_Sub16) class246_sub16).anInt4522) ^ 0xffffffff) == -4) {
										i_40_ = ((LocType) class185).size_x;
										i_41_ = ((LocType) class185).size_y;
									} else {
										i_40_ = ((LocType) class185).size_y;
										i_41_ = ((LocType) class185).size_x;
									}
									Class59_Sub3_Sub1 class59_sub3_sub1 = (new Class59_Sub3_Sub1(
											(((Class246_Sub16) class246_sub16).anInt4527),
											(((Class246_Sub16) class246_sub16).anInt4522),
											(((Class246_Sub16) class246_sub16).anInt4528),
											(((Class246_Sub16) class246_sub16).anInt4530),
											(((Class246_Sub16) class246_sub16).anInt4519),
											(((Class246_Sub16) class246_sub16).anInt4536),
											(((Class246_Sub16) class246_sub16).anInt4520),
											i_41_ + (((Class246_Sub16) class246_sub16).anInt4520 - 1),
											(((Class246_Sub16) class246_sub16).anInt4525),
											(((Class246_Sub16) class246_sub16).anInt4525) - -i_40_ - 1, class59_sub3));
									Class176.method1156(class59_sub3_sub1, false);
								}
							} else if ((i_39_ ^ 0xffffffff) == -4) {
								Class59_Sub1 class59_sub1 = (Class246_Sub14.method1997(
										(((Class246_Sub16) class246_sub16).anInt4528),
										(((Class246_Sub16) class246_sub16).anInt4520),
										(((Class246_Sub16) class246_sub16).anInt4525)));
								if (class59_sub1 instanceof Class59_Sub1_Sub1)
									...
									Class59_Sub1_Sub1 class59_sub1_sub1 = (new Class59_Sub1_Sub1(
											(((Class246_Sub16) class246_sub16).anInt4530),
											(((Class246_Sub16) class246_sub16).anInt4519),
											(((Class246_Sub16) class246_sub16).anInt4536), class59_sub1));
									Class213.method1393((((Class246_Sub16) class246_sub16).anInt4528),
											(((Class246_Sub16) class246_sub16).anInt4520),
											(((Class246_Sub16) class246_sub16).anInt4525), class59_sub1_sub1,
											-1);
								}
							}
						} else {
							Class59_Sub4 class59_sub4 = (Class246_Sub22.method2082(
									(((Class246_Sub16) class246_sub16).anInt4528),
									(((Class246_Sub16) class246_sub16).anInt4520),
									(((Class246_Sub16) class246_sub16).anInt4525)));
							if (class59_sub4 instanceof Class59_Sub4_Sub1)
								class246_sub16.remove();
							else if (FontMetric.method463((((Class246_Sub16) class246_sub16).anInt4528),
									(((Class246_Sub16) class246_sub16).anInt4520),
									(((Class246_Sub16) class246_sub16).anInt4525)) != null)
								class246_sub16.remove();
							else {
								Class59_Sub4_Sub1 class59_sub4_sub1 = (new Class59_Sub4_Sub1(
										(((Class246_Sub16) class246_sub16).anInt4527),
										(((Class246_Sub16) class246_sub16).anInt4522),
										(((Class246_Sub16) class246_sub16).anInt4530),
										(((Class246_Sub16) class246_sub16).anInt4519),
										(((Class246_Sub16) class246_sub16).anInt4536), class59_sub4));
								Class246_Sub2.method1785((((Class246_Sub16) class246_sub16).anInt4528),
										(((Class246_Sub16) class246_sub16).anInt4520),
										(((Class246_Sub16) class246_sub16).anInt4525), class59_sub4_sub1, null);
							}
						}
					}
				} else {
							...
							if ((i_42_ ^ 0xffffffff) != -3) {
								if ((i_42_ ^ 0xffffffff) == -4) {
									Class59_Sub1 class59_sub1 = (Class246_Sub14.method1997(
											...
											(((Class246_Sub16) class246_sub16).anInt4525)));
									if (class59_sub1 instanceof Class59_Sub1_Sub1) {
										Class232.method1490((((Class246_Sub16) class246_sub16).anInt4528),
												(((Class246_Sub16) class246_sub16).anInt4520),
												(((Class246_Sub16) class246_sub16).anInt4525));
										...
										if ((((Class59_Sub1_Sub1) class59_sub1_sub1).aClass59_Sub1_5982) != null)
											Class213.method1393(((Class246_Sub16) class246_sub16).anInt4528,
													((Class246_Sub16) class246_sub16).anInt4520,
													((Class246_Sub16) class246_sub16).anInt4525,
													(((Class59_Sub1_Sub1) class59_sub1_sub1).aClass59_Sub1_5982), -1);
									}
								}
							} else {
								Class59_Sub3 class59_sub3 = (Class17.method168(
								...
								if (class59_sub3 instanceof Class59_Sub3_Sub1) {
									...
									if (((Class59_Sub3_Sub1) class59_sub3_sub1).aClass59_Sub3_5732 != null)
										Class176.method1156(
												(((Class59_Sub3_Sub1) class59_sub3_sub1).aClass59_Sub3_5732), false);
								}
							}
						} else {
							Class59_Sub2 class59_sub2 = Class31.method236(((Class246_Sub16) class246_sub16).anInt4528,
									((Class246_Sub16) class246_sub16).anInt4520,
									(((Class246_Sub16) class246_sub16).anInt4525));
							if (class59_sub2 instanceof Class59_Sub2_Sub2) {
								Class40_Sub9.method2308((((Class246_Sub16) class246_sub16).anInt4528),
										(((Class246_Sub16) class246_sub16).anInt4520),
										(((Class246_Sub16) class246_sub16).anInt4525));
								...
								if ((((Class59_Sub2_Sub2) class59_sub2_sub2).aClass59_Sub2_6009) != null)
									Class41.method285((((Class246_Sub16) class246_sub16).anInt4528),
											(((Class246_Sub16) class246_sub16).anInt4520),
											(((Class246_Sub16) class246_sub16).anInt4525),
											(((Class59_Sub2_Sub2) class59_sub2_sub2).aClass59_Sub2_6009), null);
							}
						}
					} else {
						Class59_Sub4 class59_sub4 = (Class246_Sub22.method2082(
								...
								((Class246_Sub16) class246_sub16).anInt4525));
						if (class59_sub4 instanceof Class59_Sub4_Sub1) {
							ObjType.method1285(((Class246_Sub16) class246_sub16).anInt4528,
									((Class246_Sub16) class246_sub16).anInt4520,
									((Class246_Sub16) class246_sub16).anInt4525);
							...
							if ((((Class59_Sub4_Sub1) class59_sub4_sub1).aClass59_Sub4_6317) != null)
								Class246_Sub2.method1785((((Class246_Sub16) class246_sub16).anInt4528),
										(((Class246_Sub16) class246_sub16).anInt4520),
										(((Class246_Sub16) class246_sub16).anInt4525),
										(((Class59_Sub4_Sub1) class59_sub4_sub1).aClass59_Sub4_6317), null);
						}
					}
					class246_sub16.remove();
				}
	...
	final void a(float f, float f_43_, float f_44_, float f_45_, float f_46_, float f_47_, int i, int i_48_,
			int i_49_) {
		try {
			anInt5466++;
			if (aBool5454) {
			...
			OpenGL.glTexCoord2f(((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).aFloat6730,
					((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).aFloat6727);
			OpenGL.glVertex2f(f_44_, f_45_);
			OpenGL.glEnd();
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, ("ut.a(" + f + ',' + f_43_ + ',' + f_44_ + ',' + f_45_ + ','
					+ f_46_ + ',' + f_47_ + ',' + i + ',' + i_48_ + ',' + i_49_ + ')'));
		}
	}
	...
	final void method737(int i, int i_66_, Class128 class128, int i_67_, int i_68_) {
		try {
			...
			float f = (((Class109_Sub1_Sub1) class109_sub1_sub1).aFloat6730
					/ (float) (((Class109_Sub1_Sub1) class109_sub1_sub1).anInt6724));
			float f_71_ = (((Class109_Sub1_Sub1) class109_sub1_sub1).aFloat6727
					/ (float) (((Class109_Sub1_Sub1) class109_sub1_sub1).anInt6729));
			...
			OpenGL.glVertex2i(i + ((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).anInt6724,
					i_66_ + ((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).anInt6729);
			OpenGL.glMultiTexCoord2f(33984, ((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).aFloat6730,
					((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).aFloat6727);
			...
			throw Class193.method1272(runtimeexception, ("ut.r(" + i + ',' + i_66_ + ','
					+ (class128 != null ? "{...}" : "null") + ',' + i_67_ + ',' + i_68_ + ')'));
		}
	}
	...
	final void r(int i, int i_77_, int i_78_, int i_79_, int i_80_) {
		try {
			...
			if (aClass109_Sub1_Sub1_5458 == null) {
				...
				OpenGL.glTexCoord2f(((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).aFloat6730, 0.0F);
				OpenGL.glVertex2i(((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).anInt6724 + i,
						(((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).anInt6729 + i_77_));
				OpenGL.glTexCoord2f(((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).aFloat6730,
						((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).aFloat6727);
				...
				OpenGL.glTexCoord2f(((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).aFloat6730, 0.0F);
				OpenGL.glVertex2i(((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).anInt6724 + i,
						i_77_ - -(((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).anInt6729));
				OpenGL.glMultiTexCoord2f(33985, ((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).aFloat6730,
						(((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).aFloat6727));
				OpenGL.glTexCoord2f(((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).aFloat6730,
						((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).aFloat6727);
			...
			throw Class193.method1272(runtimeexception,
					("ut.r(" + i + ',' + i_77_ + ',' + i_78_ + ',' + i_79_ + ',' + i_80_ + ')'));
		}
	}
	...
	final void JA(int i, int i_81_, int i_82_, int i_83_, int i_84_, int i_85_, int i_86_) {
		try {
			...
			if (((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).aBool6732 && !aBool5454) {
				float f = ((float) i_83_ * (((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).aFloat6727)
						/ (float) ((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).anInt6729);
				float f_89_ = ((float) i_82_ * (((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).aFloat6730)
						/ (float) ((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).anInt6724);
				OpenGL.glBegin(7);
				...
				for (/**/; i_92_ <= i_88_; i_92_ += i_91_) {
					...
					if ((i_95_ ^ 0xffffffff) > (i_87_ ^ 0xffffffff)) {
						float f = ((((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).aFloat6730)
								* (float) (i_87_ + -i_95_)
								/ (float) ((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).anInt6724);
						OpenGL.glTexCoord2f(0.0F, (((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).aFloat6727));
						OpenGL.glVertex2i(i_95_, i_93_);
				...
				if (i_88_ > i_93_) {
					float f = ((float) (-i_88_ + i_93_ + ((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).anInt6729)
							* (((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).aFloat6727)
							/ (float) ((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).anInt6729);
					...
					if (i_87_ > i_97_) {
						float f_98_ = ((((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).aFloat6730)
								* (float) (-i_97_ + i_87_)
								/ (float) ((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).anInt6724);
						OpenGL.glTexCoord2f(0.0F, (((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_5465).aFloat6727));
						OpenGL.glVertex2i(i_97_, i_93_);
			...
			throw Class193.method1272(runtimeexception, ("ut.JA(" + i + ',' + i_81_ + ',' + i_82_ + ',' + i_83_ + ','
					+ i_84_ + ',' + i_85_ + ',' + i_86_ + ')'));
		}
	}
	...
	final void t(int i, int i_99_, int i_100_, int i_101_, int i_102_, int i_103_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("ut.t(" + i + ',' + i_99_ + ',' + i_100_ + ',' + i_101_ + ',' + i_102_ + ',' + i_103_ + ')'));
		}
	}
	...
	final void MA(int i, int i_104_, int i_105_, int i_106_) {
		try {
			...
			anInt5471++;
			anInt5457 = i_104_;
			aBool5454 = ((anInt5473 ^ 0xffffffff) != -1 || anInt5457 != 0 || anInt5453 != 0
					|| (anInt5459 ^ 0xffffffff) != -1);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("ut.MA(" + i + ',' + i_104_ + ',' + i_105_ + ',' + i_106_ + ')'));
		}
	}

	static final boolean method2302(int i, int i_107_, int i_108_, int i_109_, int i_110_, CollisionMap class199,
		...
		try {
			...
			IterableNodeHashTable.anIntArrayArray1119[i_118_][i_119_] = 99;
			...
			while (i_122_ != i_123_) {
				...
				int i_124_ = -((CollisionMap) class199).anInt2836 + i_116_;
				i_118_ = -i_120_ + i_116_;
				int i_125_ = i_117_ + -((CollisionMap) class199).anInt2841;
				int i_126_ = i_108_;
				while_36_: do {
					while_35_: do {
						while_34_: do {
							while_33_: do {
								do {
									if ((i_126_ ^ 0xffffffff) != 3) {
										if ((i_126_ ^ 0xffffffff) != 2) {
											if ((i_126_ ^ 0xffffffff) != 1) {
												if ((i_126_ ^ 0xffffffff) != 0) {
													if (i_126_ == 0 || i_126_ == 1 || (i_126_ ^ 0xffffffff) == -3
															|| (i_126_ ^ 0xffffffff) == -4 || i_126_ == 9)
														break while_34_;
													break while_35_;
												}
											} else
										...
										if (((i_110_ ^ 0xffffffff) == (i_116_ ^ 0xffffffff))
												&& ((i_111_ ^ 0xffffffff) == (i_117_ ^ 0xffffffff))) {
									...
									if (SceneGraph.method1746(1, i_111_, 1, i_113_, i, i_117_, i_116_, i_110_,
											(byte) 120)) {
										Class246_Sub28_Sub32.anInt6925 = i_116_;
										Class55.anInt785 = i_117_;
										return true;
				...
				if ((i_118_ ^ 0xffffffff) < -1
						&& (IterableNodeHashTable.anIntArrayArray1119[-1 + i_118_][i_119_] ^ 0xffffffff) == -1
						&& (is[-1 + i_124_][i_125_] & 0x42240000) == 0) {
					Class246_Sub28_Sub9.anIntArray6148[i_122_] = -1 + i_116_;
					Class246_Sub39.anIntArray5489[i_122_] = i_117_;
					IterableNodeHashTable.anIntArrayArray1119[i_118_ - 1][i_119_] = 2;
					i_122_ = i_122_ + 1 & 0xfff;
					Class7.anIntArrayArray94[i_118_ - 1][i_119_] = i_126_;
				}
				if ((i_118_ ^ 0xffffffff) > -128
						&& (IterableNodeHashTable.anIntArrayArray1119[i_118_ + 1][i_119_] ^ 0xffffffff) == -1
						&& ((0x60240000 & is[i_124_ + 1][i_125_] ^ 0xffffffff) == -1)) {
					Class246_Sub28_Sub9.anIntArray6148[i_122_] = i_116_ + 1;
					Class246_Sub39.anIntArray5489[i_122_] = i_117_;
					i_122_ = 0xfff & 1 + i_122_;
					IterableNodeHashTable.anIntArrayArray1119[1 + i_118_][i_119_] = 8;
					Class7.anIntArrayArray94[1 + i_118_][i_119_] = i_126_;
				}
				if (i_119_ > 0 && IterableNodeHashTable.anIntArrayArray1119[i_118_][-1 + i_119_] == 0
						&& ((is[i_124_][-1 + i_125_] & 0x40a40000 ^ 0xffffffff) == -1)) {
					Class246_Sub28_Sub9.anIntArray6148[i_122_] = i_116_;
					Class246_Sub39.anIntArray5489[i_122_] = -1 + i_117_;
					i_122_ = 0xfff & 1 + i_122_;
					IterableNodeHashTable.anIntArrayArray1119[i_118_][-1 + i_119_] = 1;
					Class7.anIntArrayArray94[i_118_][i_119_ - 1] = i_126_;
				}
				if ((i_119_ ^ 0xffffffff) > -128 && IterableNodeHashTable.anIntArrayArray1119[i_118_][i_119_ + 1] == 0
						&& ((is[i_124_][1 + i_125_] & 0x48240000 ^ 0xffffffff) == -1)) {
					Class246_Sub28_Sub9.anIntArray6148[i_122_] = i_116_;
					Class246_Sub39.anIntArray5489[i_122_] = i_117_ + 1;
					IterableNodeHashTable.anIntArrayArray1119[i_118_][i_119_ + 1] = 4;
					i_122_ = 0xfff & 1 + i_122_;
					Class7.anIntArrayArray94[i_118_][i_119_ + 1] = i_126_;
				}
				if ((i_118_ ^ 0xffffffff) < -1 && i_119_ > 0
						&& (IterableNodeHashTable.anIntArrayArray1119[-1 + i_118_][-1 + i_119_] ^ 0xffffffff) == -1
						&& ((is[i_124_ - 1][-1 + i_125_] & 0x43a40000 ^ 0xffffffff) == -1)
						&& (0x42240000 & is[-1 + i_124_][i_125_]) == 0
						&& ((is[i_124_][i_125_ - 1] & 0x40a40000 ^ 0xffffffff) == -1)) {
					Class246_Sub28_Sub9.anIntArray6148[i_122_] = -1 + i_116_;
					Class246_Sub39.anIntArray5489[i_122_] = -1 + i_117_;
					i_122_ = 0xfff & i_122_ + 1;
					IterableNodeHashTable.anIntArrayArray1119[-1 + i_118_][-1 + i_119_] = 3;
					Class7.anIntArrayArray94[i_118_ - 1][-1 + i_119_] = i_126_;
				}
				if (i_118_ < 127 && i_119_ > 0
						&& (IterableNodeHashTable.anIntArrayArray1119[i_118_ + 1][i_119_ - 1] ^ 0xffffffff) == -1
						&& (is[i_124_ + 1][i_125_ - 1] & 0x60e40000) == 0
						&& (0x60240000 & is[i_124_ + 1][i_125_] ^ 0xffffffff) == -1
						&& ((0x40a40000 & is[i_124_][-1 + i_125_] ^ 0xffffffff) == -1)) {
					Class246_Sub28_Sub9.anIntArray6148[i_122_] = 1 + i_116_;
					Class246_Sub39.anIntArray5489[i_122_] = -1 + i_117_;
					i_122_ = 1 + i_122_ & 0xfff;
					IterableNodeHashTable.anIntArrayArray1119[i_118_ + 1][i_119_ - 1] = 9;
					Class7.anIntArrayArray94[i_118_ + 1][i_119_ - 1] = i_126_;
				}
				if (i_118_ > 0 && (i_119_ ^ 0xffffffff) > -128
						&& IterableNodeHashTable.anIntArrayArray1119[i_118_ - 1][1 + i_119_] == 0
						&& (is[i_124_ - 1][1 + i_125_] & 0x4e240000) == 0
						&& (is[i_124_ - 1][i_125_] & 0x42240000 ^ 0xffffffff) == -1
						&& (is[i_124_][i_125_ + 1] & 0x48240000) == 0) {
					Class246_Sub28_Sub9.anIntArray6148[i_122_] = -1 + i_116_;
					Class246_Sub39.anIntArray5489[i_122_] = i_117_ + 1;
					i_122_ = 0xfff & i_122_ + 1;
					IterableNodeHashTable.anIntArrayArray1119[i_118_ - 1][i_119_ + 1] = 6;
					Class7.anIntArrayArray94[i_118_ - 1][1 + i_119_] = i_126_;
				}
				if ((i_118_ ^ 0xffffffff) > -128 && i_119_ < 127
						&& (IterableNodeHashTable.anIntArrayArray1119[i_118_ + 1][1 + i_119_] ^ 0xffffffff) == -1
						&& (is[1 + i_124_][i_125_ + 1] & 0x78240000) == 0 && (0x60240000 & is[1 + i_124_][i_125_]) == 0
						&& ((is[i_124_][i_125_ + 1] & 0x48240000 ^ 0xffffffff) == -1)) {
					Class246_Sub28_Sub9.anIntArray6148[i_122_] = i_116_ + 1;
					Class246_Sub39.anIntArray5489[i_122_] = 1 + i_117_;
					IterableNodeHashTable.anIntArrayArray1119[i_118_ + 1][i_119_ + 1] = 12;
					i_122_ = 0xfff & i_122_ + 1;
			...
			throw Class193.method1272(runtimeexception,
					("ut.C(" + i + ',' + i_107_ + ',' + i_108_ + ',' + i_109_ + ',' + i_110_ + ','
							+ (class199 != null ? "{...}" : "null") + ',' + i_111_ + ',' + i_112_ + ',' + i_113_ + ','
							+ i_114_ + ',' + i_115_ + ')'));
		}
	}
	...
	final void s(int i, int i_127_, int i_128_, int i_129_, int i_130_, int i_131_, int i_132_) {
		try {
			...
			throw Class193.method1272(runtimeexception, ("ut.s(" + i + ',' + i_127_ + ',' + i_128_ + ',' + i_129_ + ','
	...
	Class_l_Sub2(Class260_Sub2 class260_sub2, int i, int i_138_, int i_139_, int i_140_) {
		...
		try {
			...
			throw Class193.method1272(runtimeexception, ("ut.<init>(" + (class260_sub2 != null ? "{...}" : "null") + ','
					+ i + ',' + i_138_ + ',' + i_139_ + ',' + i_140_ + ')'));
		}
	}
	...
	Class_l_Sub2(Class260_Sub2 class260_sub2, int i, int i_141_, int[] is, int i_142_, int i_143_) {
		...
		try {
			...
			throw Class193.method1272(runtimeexception, ("ut.<init>(" + (class260_sub2 != null ? "{...}" : "null") + ','
					+ i + ',' + i_141_ + ',' + (is != null ? "{...}" : "null") + ',' + i_142_ + ',' + i_143_ + ')'));
		}
	}
}
