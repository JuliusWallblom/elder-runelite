...
final class Class69 {
	static AbstractSprite aClass_l907;
	static int anInt908;
	int anInt909 = 128;
	static int anInt910;
	int anInt911;
	...
	int anInt916 = 128;
	int anInt917;
	static OutgoingPacket run_script_packet = new OutgoingPacket(27, -1);
	static int anInt919;
	...
	static final void method448(int i) {
		try {
			Class104.aClass246_Sub35_1397 = new Class246_Sub35(FontMetric.aClass67_959.get(Preferences.language_code), "", Class83.anInt1089, 1011, -1, (long) i, 0, 0, true, false);
			anInt912++;
		} catch (RuntimeException runtimeexception) {
