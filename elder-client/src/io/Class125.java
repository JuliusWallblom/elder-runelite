...
final class Class125 {
	...
	final void method854(int i, byte i_1_, byte[] is, int i_2_) throws IOException {
		try {
			...
			try {
				...
				if ((aLong1758 ^ 0xffffffffffffffffL) != 0L && (aLong1758 > aLong1753
						|| ((aLong1753 ^ 0xffffffffffffffffL) < (aLong1758 + (long) anInt1770 ^ 0xffffffffffffffffL))))
					method862((byte) 48);
				if ((aLong1758 ^ 0xffffffffffffffffL) != 0L && ((aLong1753 + (long) i_2_
						^ 0xffffffffffffffffL) < (aLong1758 + (long) aByteArray1766.length ^ 0xffffffffffffffffL))) {
				...
				if ((i_2_ ^ 0xffffffff) < (aByteArray1766.length ^ 0xffffffff)) {
					...
					long l = -1L;
					long l_4_ = -1L;
					if (((aLong1753 ^ 0xffffffffffffffffL) > (aLong1767 ^ 0xffffffffffffffffL))
							|| ((aLong1767 + (long) anInt1773 ^ 0xffffffffffffffffL) >= (aLong1753
									^ 0xffffffffffffffffL))) {
						if (aLong1767 >= aLong1753 && ((aLong1767 ^ 0xffffffffffffffffL) > ((long) i_2_ + aLong1753
								^ 0xffffffffffffffffL)))
							l = aLong1767;
					} else
						l = aLong1753;
					if (((aLong1767 ^ 0xffffffffffffffffL) <= ((long) i_2_ + aLong1753 ^ 0xffffffffffffffffL))
							|| ((long) i_2_ + aLong1753 > (long) anInt1773 + aLong1767)) {
						if (((aLong1767 + (long) anInt1773 ^ 0xffffffffffffffffL) < (aLong1753 ^ 0xffffffffffffffffL))
								&& (aLong1753 - -(long) i_2_ >= aLong1767 + (long) anInt1773))
							l_4_ = (long) anInt1773 + aLong1767;
					} else
						l_4_ = (long) i_2_ + aLong1753;
					if (l > -1L && ((l ^ 0xffffffffffffffffL) > (l_4_ ^ 0xffffffffffffffffL))) {
						int i_5_ = (int) (-l + l_4_);
						Class117.method805(is, (int) (l + (long) i - aLong1753), aByteArray1774, (int) (-aLong1767 + l),
								i_5_);
					}
					aLong1753 += (long) i_2_;
			...
			throw Class193.method1272(runtimeexception,
					("lq.A(" + i + ',' + i_1_ + ',' + (is != null ? "{...}" : "null") + ',' + i_2_ + ')'));
		}
	}

	static final void method855(TextureInterface interface6, int i, SceneGraph class260) {
		try {
			anInt1754++;
			if (Class79.aClass246_Sub1_Sub5_1020 != null) {
				if (Renderer.anInt571 < 10) {
					if (!Class79.aClass_fs1023.method90(-1,
							((Class246_Sub1_Sub5) Class79.aClass246_Sub1_Sub5_1020).aString5846)) {
						Renderer.anInt571 = (Cache.client_cache.get(IndexConstants.PRE_EOC_634_WORLD_MAP_INDEX)
								.method100(((Class246_Sub1_Sub5) Class79.aClass246_Sub1_Sub5_1020).aString5846,
										(byte) 33))
								/ 10;
						return;
					}
					WidgetParent.method2312(false);
					Renderer.anInt571 = 10;
				}
				if (Renderer.anInt571 == 10) {
					...
					Class79.anInt1054 = 64 + (-Class79.anInt1057
							+ (((Class246_Sub1_Sub5) Class79.aClass246_Sub1_Sub5_1020).anInt5838 >> 6 << 6));
					Class79.anInt1058 = (64 + -Class79.anInt1041
							+ (((Class246_Sub1_Sub5) Class79.aClass246_Sub1_Sub5_1020).anInt5845 >> 6 << 6));
					int[] is = new int[3];
					int i_6_ = -1;
					int i_7_ = -1;
					if (Class79.aClass246_Sub1_Sub5_1020.method2471(false, is,
							((Class59_Sub3) Client.local_player).current_plane,
							(((Class59_Sub3) Client.local_player).y >> 7) + Client.base_y,
							(Client.base_x - -((((Class59_Sub3) Client.local_player).x) >> 7)))) {
						i_6_ = -Class79.anInt1057 + is[1];
						i_7_ = is[2] - Class79.anInt1041;
					}
					if (Class246_Sub8.aBool3980 || i_6_ < 0 || (Class79.anInt1054 ^ 0xffffffff) >= (i_6_ ^ 0xffffffff)
							|| (i_7_ ^ 0xffffffff) > -1 || Class79.anInt1058 <= i_7_) {
						if ((Class100_Sub1.anInt5072 ^ 0xffffffff) == 0 || Class246_Sub37_Sub1.f_ob == -1) {
							Class79.aClass246_Sub1_Sub5_1020.method2467(70, is,
									(((Class246_Sub1_Sub5) Class79.aClass246_Sub1_Sub5_1020).anInt5850 & 0x3fff),
									(0xfffc7a6
											& (((Class246_Sub1_Sub5) Class79.aClass246_Sub1_Sub5_1020).anInt5850)) >> 14);
							Class21.anInt322 = is[2] + -Class79.anInt1041;
							Class109_Sub1_Sub1.anInt6725 = is[1] + -Class79.anInt1057;
						} else {
							Class79.aClass246_Sub1_Sub5_1020.method2467(61, is, Class246_Sub37_Sub1.f_ob,
									Class100_Sub1.anInt5072);
							if (is != null) {
					...
					if ((((Class246_Sub1_Sub5) Class79.aClass246_Sub1_Sub5_1020).anInt5840 ^ 0xffffffff) == -38)
						...
						else if ((((Class246_Sub1_Sub5) Class79.aClass246_Sub1_Sub5_1020).anInt5840
								^ 0xffffffff) == -201)
					...
					Renderer.anInt571 = 20;
				} else if ((Renderer.anInt571 ^ 0xffffffff) == -21) {
					Class160.method1059(-49, true);
					Class79.method502(class260, Class79.anInt1029, Class79.anInt1038);
					Renderer.anInt571 = 60;
					Class160.method1059(-79, true);
					Class187_Sub1.method2109((byte) 111);
				} else {
					if (i > -22)
						anInt1768 = -21;
					if (Renderer.anInt571 == 60) {
						if (!Class79.aClass_fs1023
								.method94((((Class246_Sub1_Sub5) Class79.aClass246_Sub1_Sub5_1020).aString5846
										+ "_staticelements"), -1))
							...
							if (!Class79.aClass_fs1023.method90(-1,
									(((Class246_Sub1_Sub5) Class79.aClass246_Sub1_Sub5_1020).aString5846)
											+ "_staticelements"))
								return;
							Class79.aClass178_1031 = (Class259_Sub2_Sub1.method2847(Class79.aClass_fs1023, 48,
									(((Class246_Sub1_Sub5) Class79.aClass246_Sub1_Sub5_1020).aString5846)
											+ "_staticelements",
									Client.members_world));
						}
						Class79.method507();
						Renderer.anInt571 = 70;
			...
			throw Class193.method1272(runtimeexception, ("lq.J(" + (interface6 != null ? "{...}" : "null") + ',' + i
					+ ',' + (class260 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	static final boolean method858(int i, int i_10_, int i_11_) {
		try {
			if (i_11_ != 25926)
				return false;
			anInt1760++;
			return (((0x2000 & i_10_) != 0 | Class40_Sub3.method1863(i, 97, i_10_)
					| SubIncomingPacket.method2899(i, (byte) 124, i_10_)) & Class246_Sub7.method1835(i_10_, i, -122));
		} catch (RuntimeException runtimeexception) {
	...
	static final void decodeReceivedMapRegions(boolean bool) {
		try {
			...
			int map_size = Class78.packetStream.readUnsigned128Byte();
			int chunk_x = Class78.packetStream.readUnsignedShort128(952968608);
			int chunk_y = Class78.packetStream.readUnsignedShortLE128((byte) 55);
			boolean force_next_map_load_refresh = ((Class78.packetStream.readUnsignedByte128(27574)
					^ 0xffffffff) == -2);
			Class246_Sub28_Sub24.method2740((byte) 71, map_size);
			int regions = ((Class130_Sub1_Sub1.anInt7046 + -((Buffer) Class78.packetStream).position) / 16);
			MapRegion.xteas = new int[regions][4];
			for (int region_index = 0; region_index < regions; region_index++) {
				for (int key_index = 0; key_index < 4; key_index++) {
					MapRegion.xteas[region_index][key_index] = Class78.packetStream.readInt((byte) 113);
				}
			}
			...
			regions = 0;
			for (int x = (chunk_x - (Class38_Sub1_Sub1.anInt6770 >> 4))
					/ 8; x <= ((Class38_Sub1_Sub1.anInt6770 >> 4) + chunk_x) / 8; x++) {
				for (int y = (chunk_y - (Class152.anInt2205 >> 4)) / 8; y <= ((Class152.anInt2205 >> 4) + chunk_y)
						/ 8; y++) {
					MapRegion.region_ids[regions] = y + (x << 8);
					MapRegion.map_m[regions] = MapRegion.get_map_index(MapRegion.region_ids[regions])
							.method86(("m" + x + "_" + y));
					MapRegion.map_l[regions] = MapRegion.get_map_index(MapRegion.region_ids[regions])
							.method86("l" + x + "_" + y);
					MapRegion.map_um[regions] = MapRegion.get_map_index(MapRegion.region_ids[regions])
							.method86(("um" + x + "_" + y));
					MapRegion.map_ul[regions] = MapRegion.get_map_index(MapRegion.region_ids[regions])
							.method86(("ul" + x + "_" + y));
					regions++;
				}
			}
			Class170.method1125(bool, (byte) 104, chunk_y, chunk_x, force_next_map_load_refresh);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
		...
		try {
			...
			try {
				...
				if ((aLong1758 ^ 0xffffffffffffffffL) != 0L
						&& ((aLong1758 ^ 0xffffffffffffffffL) >= (aLong1753 ^ 0xffffffffffffffffL))
						&& (long) anInt1770 + aLong1758 >= aLong1753 + (long) i) {
				...
				int i_22_ = i_21_;
				int i_23_ = i;
				if (((aLong1767 ^ 0xffffffffffffffffL) >= (aLong1753 ^ 0xffffffffffffffffL)) && ((aLong1753
						^ 0xffffffffffffffffL) > (aLong1767 - -(long) anInt1773 ^ 0xffffffffffffffffL))) {
				...
				if (aLong1758 != -1L) {
					...
					long l_28_ = -1L;
					if (aLong1758 < l
							|| (((long) i_23_ + l ^ 0xffffffffffffffffL) >= (aLong1758 ^ 0xffffffffffffffffL))) {
						if (((aLong1758 ^ 0xffffffffffffffffL) >= (l ^ 0xffffffffffffffffL))
								&& ((aLong1758 - -(long) anInt1770 ^ 0xffffffffffffffffL) < (l ^ 0xffffffffffffffffL)))
							l_28_ = l;
					} else
						l_28_ = aLong1758;
					long l_29_ = -1L;
					if ((long) anInt1770 + aLong1758 > l && ((aLong1758 + (long) anInt1770
							^ 0xffffffffffffffffL) >= (l - -(long) i_23_ ^ 0xffffffffffffffffL)))
					...
					if (l_28_ > -1L && ((l_29_ ^ 0xffffffffffffffffL) < (l_28_ ^ 0xffffffffffffffffL))) {
						...
						Class117.method805(aByteArray1766, (int) (l_28_ + -aLong1758), is, i_22_ + (int) (l_28_ + -l),
								i_30_);
			...
			throw Class193.method1272(runtimeexception,
					("lq.C(" + i + ',' + i_20_ + ',' + (is != null ? "{...}" : "null") + ',' + i_21_ + ')'));
		}
	}
		...
		do {
			try {
				if (i == 48) {
					...
					long l = -1L;
					long l_31_ = -1L;
					if (((aLong1758 ^ 0xffffffffffffffffL) <= (aLong1767 ^ 0xffffffffffffffffL))
							&& aLong1767 - -(long) anInt1773 > aLong1758)
						l = aLong1758;
					else if (aLong1758 <= aLong1767 && (long) anInt1770 + aLong1758 > aLong1767)
						l = aLong1767;
					if (((aLong1758 - -(long) anInt1770 ^ 0xffffffffffffffffL) < (aLong1767 ^ 0xffffffffffffffffL))
							&& (aLong1758 + (long) anInt1770 <= (long) anInt1773 + aLong1767))
						l_31_ = (long) anInt1770 + aLong1758;
					else if (((aLong1758 ^ 0xffffffffffffffffL) > ((long) anInt1773 + aLong1767 ^ 0xffffffffffffffffL))
							&& (((long) anInt1770 + aLong1758 ^ 0xffffffffffffffffL) <= ((long) anInt1773 + aLong1767
									^ 0xffffffffffffffffL)))
						l_31_ = aLong1767 + (long) anInt1773;
					if ((l ^ 0xffffffffffffffffL) < 0L && l_31_ > l) {
						int i_32_ = (int) (-l + l_31_);
						Class117.method805(aByteArray1766, (int) (l + -aLong1758), aByteArray1774,
								(int) (-aLong1767 + l), i_32_);
					}
					aLong1758 = -1L;
					anInt1770 = 0;
				}
	...
	Class125(Class192 class192, int i, int i_33_) throws IOException {
		...
		try {
			...
			throw Class193.method1272(runtimeexception,
					("lq.<init>(" + (class192 != null ? "{...}" : "null") + ',' + i + ',' + i_33_ + ')'));
		}
	}

	static {
		aClass13_1756 = new IncomingPacket(8, -2);
		new MultilingualString("You have been temporarily muted due to breaking a rule.",
