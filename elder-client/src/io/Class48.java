...
final class Class48 {
	...
	static final void method321(byte i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_) {
		try {
			...
			if (i < -95) {
				...
				else if (ObjType.anInt2818 > i_3_ - i_1_ || Class110.anInt1573 < i_1_ + i_3_ || AbstractModel.anInt1442 > -i_4_ + i_0_ || ((Class109_Sub4.anInt4570 ^ 0xffffffff) > (i_4_ + i_0_ ^ 0xffffffff)))
	...
	public static void method322(int i) {
		try {
			...
			if (i != 10)
				method322(-105);
			Cache.reset_index(Revision.PRE_EOC_634, "binaries");
		} catch (RuntimeException runtimeexception) {
	...
	static final boolean method323(String string, int i) {
		try {
			anInt694++;
			return PlayerComposition.method221(string, 124, 10, true);
		} catch (RuntimeException runtimeexception) {
