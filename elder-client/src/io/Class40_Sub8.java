...
final class Class40_Sub8 extends Class40 {
	...
	static final String method2211(int i, Buffer stream, int i_0_) {
		try {
			anInt5191++;
			try {
				...
				((Buffer) stream).position += (Class246_Sub19_Sub2.aClass99_6812.method623(((Buffer) stream).buffer, i,
						is, i ^ 0xffffffff, i_1_, ((Buffer) stream).position));
			...
			throw Class193.method1272(runtimeexception,
					("sc.C(" + i + ',' + (stream != null ? "{...}" : "null") + ',' + i_0_ + ')'));
		}
	}

	public static void method2212(int i) {
		try {
			Widget.widget_data_index = null;
			Widget.osrs_widget_data_index = null;
			Widget.custom_osrs_widget_data_index = null;
			Widget.custom_pre_eoc_550_widget_data_index = null;
			Widget.pre_eoc_550_widget_index = null;
			aClass54_5195 = null;
		} catch (RuntimeException runtimeexception) {
	...
	final void method283(int i, Class109 class109, boolean bool) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("sc.B(" + i + ',' + (class109 != null ? "{...}" : "null") + ',' + bool + ')'));
		}
	}
	...
	static final boolean method2213(boolean bool) {
		for (int i = Class246_Sub37_Sub4.anInt6880; i < Class154_Sub1.anInt4803; i++) {
			Tile[][] class147s = Class106.tiles[i];
					...
					for (int i_7_ = -Class125.anInt1777; i_7_ <= 0; i_7_++) {
						...
						if (i_5_ >= Class56.anInt796) {
							if (i_8_ >= Class133.anInt1834) {
								Tile class147 = class147s[i_5_][i_8_];
								if (class147 != null && ((Tile) class147).aBool2166) {
							...
							if (i_9_ < Class246_Sub1_Sub10.f_db) {
								Tile class147 = class147s[i_5_][i_9_];
								if (class147 != null && ((Tile) class147).aBool2166) {
									Class81.aBool1068 = bool;
									Class245.aClass106_3462.method727(class147, 0);
									Class245.aClass106_3462.method721(5000);
						...
						if (i_6_ < Class188.anInt2662) {
							if (i_8_ >= Class133.anInt1834) {
								Tile class147 = class147s[i_6_][i_8_];
								if (class147 != null && ((Tile) class147).aBool2166) {
									Class81.aBool1068 = bool;
									Class245.aClass106_3462.method727(class147, 0);
									Class245.aClass106_3462.method721(5000);
							...
							if (i_9_ < Class246_Sub1_Sub10.f_db) {
								Tile class147 = class147s[i_6_][i_9_];
								if (class147 != null && ((Tile) class147).aBool2166) {
									Class81.aBool1068 = bool;
									Class245.aClass106_3462.method727(class147, 0);
									Class245.aClass106_3462.method721(5000);
