...
final class Class246_Sub34 extends Node {
	...
	static final int method2196(byte i, Npc class_r_sub2) {
		try {
			...
			if (i != -26)
				return -112;
			int i_0_ = ((NpcType) class253).duno3;
			RenderAnimation class135 = class_r_sub2.get_render_sequence(i + 25, class253);
			if (((Entity) class_r_sub2).aBool6450)
				i_0_ = ((NpcType) class253).duno;
			else if ((((Entity) class_r_sub2).anInt6470 != ((RenderAnimation) class135).anInt1894)
					&& (((RenderAnimation) class135).anInt1880 != ((Entity) class_r_sub2).anInt6470)
					&& (((RenderAnimation) class135).anInt1890 != ((Entity) class_r_sub2).anInt6470)
					&& (((Entity) class_r_sub2).anInt6470 != ((RenderAnimation) class135).anInt1914)) {
				if ((((Entity) class_r_sub2).anInt6470 == ((RenderAnimation) class135).anInt1892)
						|| (((RenderAnimation) class135).anInt1908 == ((Entity) class_r_sub2).anInt6470)
						|| ((((Entity) class_r_sub2).anInt6470 ^ 0xffffffff) == (((RenderAnimation) class135).anInt1917
								^ 0xffffffff))
						|| (((RenderAnimation) class135).anInt1900 == ((Entity) class_r_sub2).anInt6470))
					i_0_ = ((NpcType) class253).duno2;
			} else
				i_0_ = ((NpcType) class253).duno4;
			return i_0_;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					"qh.F(" + i + ',' + (class_r_sub2 != null ? "{...}" : "null") + ')');
		}
	}
	...
	static final int method2198(int i, int i_1_, int i_2_) {
		try {
			...
			if (i_2_ == 4 || (i_2_ ^ 0xffffffff) == -6)
				return ScriptEvent.anIntArray4980[0x3 & i_1_];
			return 256;
		} catch (RuntimeException runtimeexception) {
		...
		try {
			...
			for (int i_9_ = 0; i_9_ < class29s.length; i_9_++) {
				...
				if (class29 != null && ((Class29) class29).anInt391 == 2) {
					Class246_Sub1_Sub16.method2746(i_3_, ((Class29) class29).anInt392, ((Class29) class29).anInt394,
							((Class29) class29).anInt386, 2 * ((Class29) class29).anInt396, i_6_ >> 1, (byte) 41,
							i_5_ >> 1, i_7_);
					if (Class257.anIntArray3689[0] > -1 && ((Client.cycle % 20 ^ 0xffffffff) > -11))
						Class_cs.aClass_lArray7146[((Class29) class29).anInt385].draw_sprite(
								i_8_ - -Class257.anIntArray3689[0] - 12, i_4_ + (Class257.anIntArray3689[1] - 28));
				}
			}
			int i_10_ = -29 % ((i + 67) / 35);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("qh.D(" + i + ',' + i_3_ + ',' + i_4_ + ',' + i_5_ + ',' + i_6_ + ',' + i_7_ + ',' + i_8_ + ')'));
		}
	}
		...
		do {
			try {
				...
				if (Class230.anInt3147 < 400 && bool_11_ == false) {
					...
					if (((NpcType) class253).aBool3596) {
						String string = ((NpcType) class253).name;
						if (((NpcType) class253).combatLevel != 0) {
							String string_12_ = ((Class59_Sub4_Sub3.aClass101_6943 == Class40_Sub6.aClass101_5092)
						...
						if (!Class187.aBool2653) {
							if (!bool) {
								String[] strings = ((NpcType) class253).actions;
								if (Material.aBool3359)
									strings = MouseHandler.method2009(5, strings);
								if (strings != null) {
									for (int i = 4; (i ^ 0xffffffff) <= -1; i--) {
										if (strings[i] != null
												&& (((Class59_Sub4_Sub3.aClass101_6943) != (Class246_Sub28_Sub16.aClass101_6394))
														|| !(strings[i].equalsIgnoreCase(Class246_Sub11.aClass67_4107
											...
											if ((i ^ 0xffffffff) == -5)
												i_13_ = 50;
											if (((NpcType) class253).anInt3580 == i)
												i_14_ = (((NpcType) class253).f_pb);
											if (i == (((NpcType) class253).anInt3606))
												i_14_ = (((NpcType) class253).f_bb);
											Class259_Sub2_Sub1.method2846(i_13_, (byte) -55, false,
													(long) ((Entity) class_r_sub2).f_db, 0, "<col=ffff00>" + string,
													true, strings[i], 0, -1, i_14_);
								...
								if ((Class59_Sub4_Sub3.aClass101_6943 == Class246_Sub28_Sub16.aClass101_6394)
										&& strings != null) {
									for (int i = 4; (i ^ 0xffffffff) <= -1; i--) {
										if (strings[i] != null && (strings[i].equalsIgnoreCase(
											...
											Class259_Sub2_Sub1.method2846(i_16_, (byte) -55, false,
													(long) ((Entity) class_r_sub2).f_db, 0, "<col=ffff00>" + string,
													true, strings[i], 0, -1, (((NpcType) class253).anInt3592));
										}
									}
								}
							}
							Class259_Sub2_Sub1.method2846(1003, (byte) -55, bool, (long) ((Entity) class_r_sub2).f_db,
									0, "<col=ffff00>" + string, true,
									Class246_Sub1_Sub3.aClass67_5721.get(Preferences.language_code), 0, -1,
							...
							if ((0x2 & Node.anInt3469 ^ 0xffffffff) == -1)
								break;
							if (class118 == null || (class253.method1632((((ParamType) class118).default_int),
									(Class109_Sub1.anInt3754), 0) != ((ParamType) class118).default_int)) {
								Stream_Sub2.anInt6186++;
								Class259_Sub2_Sub1.method2846(22, (byte) -55, false,
										(long) ((Entity) class_r_sub2).f_db, 0,
										(Class246_Sub7.aString3964 + " -> <col=ffff00>" + string), true,
										Class218.aString3026, 0, -1, Tile.anInt2148);
							}
						}
					}
				}
				...
				throw Class193.method1272(runtimeexception,
						("qh.C(" + bool + ',' + (class_r_sub2 != null ? "{...}" : "null") + ',' + bool_11_ + ')'));
			}
			break;
		} while (false);
	}
	...
	static final Class256 method2201(byte i, Class260_Sub2 class260_sub2, int i_17_, String string) {
		try {
			...
			throw Class193.method1272(runtimeexception, ("qh.B(" + i + ',' + (class260_sub2 != null ? "{...}" : "null")
					+ ',' + i_17_ + ',' + (string != null ? "{...}" : "null") + ')'));
		}
	}
	...
	final boolean method2202(Class155 class155, int i, byte[] is, int[] is_18_) {
		try {
			...
			throw Class193.method1272(runtimeexception, ("qh.E(" + (class155 != null ? "{...}" : "null") + ',' + i + ','
					+ (is != null ? "{...}" : "null") + ',' + (is_18_ != null ? "{...}" : "null") + ')'));
		}
	}
	...
	Class246_Sub34(byte[] is) {
		try {
			...
			int i;
			for (i = 0; (((Buffer) stream).buffer[((Buffer) stream).position - -i] ^ 0xffffffff) != -1; i++) {
				/* empty */
			}
			byte[] is_22_ = new byte[i];
			for (int i_23_ = 0; i_23_ < i; i_23_++)
				is_22_[i_23_] = stream.readByte();
			i++;
			((Buffer) stream).position++;
			int i_24_ = ((Buffer) stream).position;
			((Buffer) stream).position += i;
			int i_25_;
			for (i_25_ = 0; (((((Buffer) stream).buffer[i_25_ + ((Buffer) stream).position])
					^ 0xffffffff) != -1); i_25_++) {
				/* empty */
			}
			byte[] is_26_ = new byte[i_25_];
			for (int i_27_ = 0; (i_25_ ^ 0xffffffff) < (i_27_ ^ 0xffffffff); i_27_++)
				is_26_[i_27_] = stream.readByte();
			((Buffer) stream).position++;
			i_25_++;
			int i_28_ = ((Buffer) stream).position;
			((Buffer) stream).position += i_25_;
			int i_29_;
			for (i_29_ = 0; (((((Buffer) stream).buffer[((Buffer) stream).position - -i_29_])
					^ 0xffffffff) != -1); i_29_++) {
				/* empty */
			}
			byte[] is_30_ = new byte[i_29_];
			for (int i_31_ = 0; (i_31_ ^ 0xffffffff) > (i_29_ ^ 0xffffffff); i_31_++)
				is_30_[i_31_] = stream.readByte();
			((Buffer) stream).position++;
			...
			for (int i_53_ = 0; (i_53_ ^ 0xffffffff) > -129; i_53_++) {
				if ((anIntArray5128[i_53_] ^ 0xffffffff) != -1) {
					if (i_48_ == 0) {
						i_52_ = ((Buffer) stream).buffer[i_24_++] - 1;
			...
			for (int i_55_ = 0; i_55_ < 128; i_55_++) {
				if ((anIntArray5128[i_55_] ^ 0xffffffff) != -1) {
					if ((i_48_ ^ 0xffffffff) == -1) {
						i_54_ = (16 + ((Buffer) stream).buffer[i_28_++] << 2);
			...
			for (int i_58_ = 0; i_58_ < 128; i_58_++) {
				if ((i_48_ ^ 0xffffffff) == -1) {
					...
					if (anIntArray5128[i_58_] > 0)
						i_57_ = stream.readUnsignedByte() + 1;
				}
				((Class246_Sub34) this).aByteArray5126[i_58_] = (byte) i_57_;
				i_48_--;
			}
			((Class246_Sub34) this).anInt5136 = stream.readUnsignedByte() + 1;
			...
			for (int i_68_ = 0; (i_33_ ^ 0xffffffff) < (i_68_ ^ 0xffffffff); i_68_++) {
				...
				if (((Class239) class239_69_).aByteArray3363 != null) {
					...
					for (int i_70_ = 2; (i_70_ < ((Class239) class239_69_).aByteArray3363.length); i_70_ += 2) {
						i_45_ = stream.readUnsignedByte() + 1 + i_45_;
			...
			if (is_40_ != null) {
				...
				for (int i_71_ = 2; (i_71_ ^ 0xffffffff) > (is_40_.length ^ 0xffffffff); i_71_ += 2) {
					i_45_ = 1 + (i_45_ + stream.readUnsignedByte());
					is_40_[i_71_] = (byte) i_45_;
				}
				int i_72_ = is_40_[0];
				int i_73_ = is_40_[1];
				for (int i_74_ = 0; (i_72_ ^ 0xffffffff) < (i_74_ ^ 0xffffffff); i_74_++)
					((Class246_Sub34) this).aByteArray5126[i_74_] = (byte) (32
							+ i_73_ * (((Class246_Sub34) this).aByteArray5126[i_74_]) >> 6);
				int i_75_ = 2;
				while (is_40_.length > i_75_) {
					...
					for (int i_79_ = i_72_; (i_76_ ^ 0xffffffff) < (i_79_ ^ 0xffffffff); i_79_++) {
						...
						((Class246_Sub34) this).aByteArray5126[i_79_] = (byte) (32
								+ (((Class246_Sub34) this).aByteArray5126[i_79_]) * i_80_ >> 6);
						i_78_ += i_77_ + -i_73_;
					}
					i_75_ += 2;
					i_73_ = i_77_;
				...
				for (int i_81_ = i_72_; (i_81_ ^ 0xffffffff) > -129; i_81_++)
					((Class246_Sub34) this).aByteArray5126[i_81_] = (byte) ((((Class246_Sub34) this).aByteArray5126[i_81_])
							* i_73_ + 32 >> 6);
			}
			if (is_41_ != null) {
				i_45_ = stream.readUnsignedByte();
			...
			for (int i_102_ = 0; (i_102_ ^ 0xffffffff) > (i_33_ ^ 0xffffffff); i_102_++) {
				...
				if (((Class239) class239_103_).anInt3368 > 0)
					((Class239) class239_103_).anInt3374 = stream.readUnsignedByte();
			}
		} catch (RuntimeException runtimeexception) {
