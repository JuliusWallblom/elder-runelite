...
class Class79 {
	...
	private static IterableNodeHashTable aClass85_1021 = new IterableNodeHashTable(16);
	static MapFunctions aClass165_1022;
	static CacheIndex aClass_fs1023;
	static MapScenes aClass254_1024;
	static Interface11 anInterface11_1025;
	private static OverlayLoader aClass175_1026;
	private static UnderlayLoader aClass105_1027;
	...
	private static IterableNodeHashTable aClass85_1046;
	...
	static final void method496(int i) {
		aClass246_Sub1_Sub5_1020 = (Class246_Sub1_Sub5) aClass85_1021.get((long) i);
	}

	private static final void method497(SceneGraph class260, int i, int i_0_, int i_1_, int i_2_) {
				...
				if (i_9_ < 0 || i_9_ >= anInt1054) {
					for (int i_10_ = 0; i_10_ < i_4_; i_10_++) {
						...
						if ((((Class246_Sub1_Sub5) aClass246_Sub1_Sub5_1020).anInt5841) != -1)
							...
							i_14_ = anIntArray1043[(((UnderlayLoader) aClass105_1027).anInt1467) + 1];
						if (i_14_ == 0)
							i_14_ = -16777216;
						...
						if (i_18_ > 0) {
							...
							if (i_21_ == 0 && i_22_ == 0 && i_23_ == 0) {
								if (((Class246_Sub1_Sub5) aClass246_Sub1_Sub5_1020).anInt5841 != -1)
									...
									i_21_ = (anIntArray1043[(((UnderlayLoader) aClass105_1027).anInt1467) + 1]);
								if (i_21_ == 0)
									i_21_ = -16777216;
								class260.O(i_6_, i_16_, i_8_, i_18_, i_21_, 0);
							} else if (i_23_ > 0) {
								if (i_23_ == 65535) {
									Class246_Sub21 class246_sub21 = ((Class246_Sub21) (aClass85_1046
											.get((long) (i_9_ << 16 | i_19_))));
									if (class246_sub21 != null)
										method501(class260, i_6_, i_16_, i_8_, i_18_, i_21_, i_22_,
												aByteArray1050[i_20_],
												(((Class246_Sub21) class246_sub21).aShortArray4747),
												(((Class246_Sub21) class246_sub21).aByteArray4746), true);
								} else {
									aShortArray1035[0] = (short) (i_23_ - 1);
									aByteArray1037[0] = aByteArray1053[i_20_];
									method501(class260, i_6_, i_16_, i_8_, i_18_, i_21_, i_22_, aByteArray1050[i_20_],
											aShortArray1035, aByteArray1037, true);
								}
							} else
								method501(class260, i_6_, i_16_, i_8_, i_18_, i_21_, i_22_, aByteArray1050[i_20_], null,
										null, true);
						}
					}
				}
						...
						if (i_32_ > 0) {
							...
							if (i_33_ >= 0 && i_33_ < anInt1058) {
								...
								if (i_34_ > 0) {
									if (i_34_ == 65535) {
										Class246_Sub21 class246_sub21 = ((Class246_Sub21) (aClass85_1046
												.get((long) (i_28_ << 16 | i_33_))));
										if (class246_sub21 != null)
											method508(class260, i_25_, i_30_, i_27_, i_32_,
													(((Class246_Sub21) class246_sub21).aShortArray4747),
													(((Class246_Sub21) class246_sub21).aByteArray4746));
									} else {
										aShortArray1035[0] = (short) (i_34_ - 1);
										aByteArray1037[0] = (aByteArray1053[i_28_ + i_33_ * anInt1054]);
										method508(class260, i_25_, i_30_, i_27_, i_32_, aShortArray1035,
												aByteArray1037);
									}
								} else
			...
			for (int i_40_ = i_35_; i_40_ <= i_37_; i_40_++) {
				for (int i_41_ = i_36_; i_41_ <= i_38_; i_41_++) {
					...
					if (class68 != null) {
						...
						for (Class130_Sub7 class130_sub7 = (Class130_Sub7) class68
								.method445(62); class130_sub7 != null; class130_sub7 = ((Class130_Sub7) class68
										.method442((byte) -66))) {
							...
							method501(class260, i_46_, i_48_, i_47_ - i_46_, i_49_ - i_48_,
									(((Class130_Sub7) class130_sub7).anInt5414),
									(((Class130_Sub7) class130_sub7).aByte5410) & 0xff,
									(((Class130_Sub7) class130_sub7).aByte5412),
									(((Class130_Sub7) class130_sub7).aShortArray5411),
									(((Class130_Sub7) class130_sub7).aByteArray5413), false);
						}
					}
				}
			}
				...
				for (int i_51_ = i_36_; i_51_ <= i_38_; i_51_++) {
					...
					if (class68 != null) {
						...
						for (Class130_Sub7 class130_sub7 = (Class130_Sub7) class68
							...
							method508(class260, i_56_, i_58_, i_57_ - i_56_, i_59_ - i_58_,
									(((Class130_Sub7) class130_sub7).aShortArray5411),
									(((Class130_Sub7) class130_sub7).aByteArray5413));
						}
					}
				}
			}
	...
	static final Class246_Sub1_Sub5 method498(int i, int i_60_) {
		for (Class246_Sub1_Sub5 class246_sub1_sub5 = (Class246_Sub1_Sub5) aClass85_1021
				.first((byte) -23); class246_sub1_sub5 != null; class246_sub1_sub5 = (Class246_Sub1_Sub5) aClass85_1021
						.next((byte) -20)) {
		...
		for (int i_69_ = -5; i_69_ < anInt1054; i_69_++) {
			...
			for (int i_72_ = 0; i_72_ < anInt1058; i_72_++) {
				if (i_70_ < anInt1054) {
					...
					if (i_73_ > 0) {
						FloorDefinition class207 = aClass175_1026.list(-18411, i_73_ - 1);
						is_64_[i_72_] += ((FloorDefinition) class207).blendHue;
						is_65_[i_72_] += ((FloorDefinition) class207).saturation;
						is_66_[i_72_] += ((FloorDefinition) class207).luminance;
						is_67_[i_72_] += ((FloorDefinition) class207).blendHueMultiplier;
						is_68_[i_72_]++;
					}
				}
				if (i_71_ >= 0) {
					...
					if (i_74_ > 0) {
						FloorDefinition class207 = aClass175_1026.list(-18411, i_74_ - 1);
						is_64_[i_72_] -= ((FloorDefinition) class207).blendHue;
						is_65_[i_72_] -= ((FloorDefinition) class207).saturation;
						is_66_[i_72_] -= ((FloorDefinition) class207).luminance;
						is_67_[i_72_] -= ((FloorDefinition) class207).blendHueMultiplier;
				...
				for (int i_80_ = -5; i_80_ < anInt1058; i_80_++) {
					...
					if (i_80_ >= 0 && i_79_ > 0) {
						if ((is[i_69_ + i_80_ * anInt1054] & 0xff) == 0) {
							...
							int i_84_ = (i_78_ == 0 ? 0
									: FloorDefinition.hsl24to16(i_76_ / i_79_, (i_75_ * 256 / i_78_), 2,
											i_77_ / i_79_));
							...
							int i_88_ = (Entity.f_eb[((Class_e.method594(127, Class221.method1431(i_86_, 96, -1669)))
									& 0xffff)]);
	...
	private static final void method501(SceneGraph class260, int i, int i_89_, int i_90_, int i_91_, int i_92_,
			int i_93_, int i_94_, short[] is, byte[] is_95_, boolean bool) {
		if (bool || i_92_ != 0 || i_93_ > 0) {
			if (i_93_ == 0)
				...
				if (i_96_ == 0 || i_90_ <= 1 || i_91_ <= 1) {
					...
					int i_98_ = bool ? 0 : 1;
					Class251.method1613(i_94_ >> 6 & 0x3, anInt1030, class260, 6, i_92_, i_90_, i_91_, i_98_, i, i_89_,
							i_96_, anIntArray1043[i_93_], aByteArrayArrayArray1032);
				}
			}
		}
		if (is != null) {
			...
			for (int i_101_ = 0; i_101_ < is.length; i_101_++) {
				...
				if (i_102_ == 0 || i_102_ == 2 || i_102_ == 3 || i_102_ == 9) {
					LocType class185 = aClass251_1028.list(is[i_101_] & 0xffff, 0);
					if (((LocType) class185).map_scene == -1) {
						int i_103_ = -3355444;
						if (((LocType) class185).wall_or_door == 1)
							i_103_ = -3407872;
	...
	static final void method502(SceneGraph class260, int i, int i_107_) {
		Buffer stream = new Buffer(
				aClass_fs1023.method96((((Class246_Sub1_Sub5) aClass246_Sub1_Sub5_1020).aString5846), false, "area"));
		int i_108_ = stream.readUnsignedByte();
		int[] is = new int[i_108_];
		for (int i_109_ = 0; i_109_ < i_108_; i_109_++)
			is[i_109_] = stream.readUnsignedByte();
		int i_110_ = stream.readUnsignedByte();
		int[] is_111_ = new int[i_110_];
		for (int i_112_ = 0; i_112_ < i_110_; i_112_++)
			is_111_[i_112_] = stream.readUnsignedByte();
		while (((Buffer) stream).position < ((Buffer) stream).buffer.length) {
			if (stream.readUnsignedByte() == 0) {
				int i_113_ = stream.readUnsignedByte();
				...
				int i_119_ = stream.readUnsignedByte();
				...
				for (int i_130_ = 0; i_130_ < aClass68ArrayArrayArray1060[i_127_][0].length; i_130_++) {
					...
					if (class68 != null) {
						for (Class130_Sub7 class130_sub7 = (Class130_Sub7) class68
								.method445(62); class130_sub7 != null; class130_sub7 = ((Class130_Sub7) class68
										.method442((byte) -64)))
							is_128_[(i_129_ * 64 + (((Class130_Sub7) class130_sub7).aByte5409)
									+ (i_130_ * 64 + (((Class130_Sub7) class130_sub7).aByte5408))
											* anInt1054)] = (byte) (((Class130_Sub7) class130_sub7).anInt5414);
					}
				}
			}
				...
				for (int i_132_ = 0; i_132_ < aClass68ArrayArrayArray1060[i_127_][0].length; i_132_++) {
					...
					if (class68 != null) {
						for (Class130_Sub7 class130_sub7 = (Class130_Sub7) class68
								.method445(62); class130_sub7 != null; class130_sub7 = ((Class130_Sub7) class68
										.method442((byte) -64))) {
							int i_133_ = (i_131_ * 64 + ((Class130_Sub7) class130_sub7).aByte5409
									+ (i_132_ * 64 + (((Class130_Sub7) class130_sub7).aByte5408)) * anInt1054);
							((Class130_Sub7) class130_sub7).anInt5414 = ((aByteArray1051[i_133_] & 0xff) << 16
									| aShortArray1059[i_133_] & 0xffff);
	...
	private static final void method503(SceneGraph class260, Class246_Sub2 class246_sub2, int i, int i_134_, int i_135_,
			int i_136_) {
		((Class246_Sub2) class246_sub2).anInt3810 = (anInt1040
				+ (i_135_ + i * (((Class246_Sub2) class246_sub2).anInt3807 - anInt1048) >> 16));
		((Class246_Sub2) class246_sub2).anInt3805 = (anInt1055
				- (i_136_ + i_134_ * (((Class246_Sub2) class246_sub2).anInt3801 - anInt1047) >> 16));
	}

	private static final void method504(SceneGraph class260, Buffer stream, int i, int i_137_, int i_138_, int i_139_,
			int[] is, int[] is_140_) {
		...
		if ((i_141_ & 0x1) == 0) {
			...
			if (i_142_ != 62) {
				if (i_142_ == 63)
					i_142_ = stream.readUnsignedByte();
				else if (bool)
					i_142_ = is[i_142_];
				else
				...
				if (bool) {
					...
					aByteArray1044[i_138_ + i_139_ * anInt1054] = stream.readByte();
				}
			}
		} else {
			...
			for (int i_145_ = 0; i_145_ < i_143_; i_145_++) {
				...
				int i_148_ = 0;
				if (bool) {
					i_147_ = stream.readUnsignedByte();
					i_148_ = stream.readUnsignedByte();
				}
				int i_149_ = 0;
				if (bool_144_)
					i_149_ = stream.readUnsignedByte();
				if (i_145_ == 0) {
					...
					if (i_149_ == 1) {
						aShortArray1042[i_138_ + i_139_ * anInt1054] = (short) (stream.readUnsignedShort() + 1);
						aByteArray1053[i_138_ + i_139_ * anInt1054] = stream.readByte();
					} else if (i_149_ > 1) {
						...
						for (int i_152_ = 0; i_152_ < i_149_; i_152_++) {
							is_150_[i_152_] = (short) stream.readUnsignedShort();
							is_151_[i_152_] = stream.readByte();
						}
						aClass85_1046.method547((long) (i_138_ << 16 | i_139_), -2301,
								new Class246_Sub21(is_150_, is_151_));
					}
				} else {
					short[] is_153_ = null;
					byte[] is_154_ = null;
					if (i_149_ > 0) {
						...
						for (int i_155_ = 0; i_155_ < i_149_; i_155_++) {
							is_153_[i_155_] = (short) stream.readUnsignedShort();
							is_154_[i_155_] = stream.readByte();
						}
					}
					if ((aClass68ArrayArrayArray1060[i_145_ - 1][i - (anInt1057 >> 6)][i_137_
							- (anInt1041 >> 6)]) == null)
						aClass68ArrayArrayArray1060[i_145_ - 1][i - (anInt1057 >> 6)][i_137_
								- (anInt1041 >> 6)] = new Class68();
					Class130_Sub7 class130_sub7 = new Class130_Sub7(i_138_ & 0x3f, i_139_ & 0x3f, i_146_, i_147_,
							i_148_, is_153_, is_154_);
					aClass68ArrayArrayArray1060[i_145_ - 1][i - (anInt1057 >> 6)][i_137_ - (anInt1041 >> 6)]
							.method438(51, class130_sub7);
				}
			}
		}
	}

	static final Class166 method505(SceneGraph class260) {
	...
	static final void method506() {
		...
		aClass85_1046 = new IterableNodeHashTable(1024);
		aClass68ArrayArrayArray1060 = new Class68[3][anInt1054 >> 6][anInt1058 >> 6];
		anIntArray1043 = new int[((UnderlayLoader) aClass105_1027).anInt1461 + 1];
	}

	static final void method507() {
		int[] is = new int[3];
		for (int i = 0; i < ((Class178) aClass178_1031).anInt2504; i++) {
			boolean bool = (aClass246_Sub1_Sub5_1020.method2471(false, is,
					((Class178) aClass178_1031).anIntArray2505[i] >> 28 & 0x3,
					((Class178) aClass178_1031).anIntArray2505[i] & 0x3fff,
					(((Class178) aClass178_1031).anIntArray2505[i] >> 14 & 0x3fff)));
			if (bool) {
				...
				aClass166_1034.push_head(class246_sub2);
			}
		}
	}

	private static final void method508(SceneGraph class260, int i, int i_159_, int i_160_, int i_161_, short[] is,
			byte[] is_162_) {
		if (is != null) {
			for (int i_163_ = 0; i_163_ < is.length; i_163_++) {
				LocType class185 = aClass251_1028.list(is[i_163_] & 0xffff, 0);
				int i_164_ = ((LocType) class185).map_scene;
				if (i_164_ != -1) {
					Sprite class32 = aClass254_1024.method1638(1409, i_164_);
					AbstractSprite class_l = class32.method240(
							(((LocType) class185).aBool2604 ? ((LocType) class185).rotated : false), class260,
							(((LocType) class185).aBool2619 ? is_162_[i_163_] >> 6 & 0x3 : 0), 16306, class185);
					if (class_l != null) {
						int i_165_ = i_160_ * class_l.j() >> 2;
						int i_166_ = i_161_ * class_l.T() >> 2;
						if (((Sprite) class32).aBool440) {
							int i_167_ = ((LocType) class185).size_x;
							int i_168_ = ((LocType) class185).size_y;
						...
						if (i_165_ != 0 && i_166_ != 0) {
							if (((Sprite) class32).anInt437 != 0)
								class_l.s(i, i_159_ - i_166_ + i_161_, i_165_, i_166_, 0,
	...
	private static final void method509() {
		for (int i = 0; i < anInt1054; i++) {
			for (int i_170_ = 0; i_170_ < anInt1058; i_170_++) {
				...
				if (i_171_ != 0) {
					if (i_171_ == 65535) {
						Class246_Sub21 class246_sub21 = ((Class246_Sub21) aClass85_1046.get((long) (i << 16 | i_170_)));
						if (class246_sub21 != null) {
							for (int i_172_ = 0; i_172_ < (((Class246_Sub21) class246_sub21).aShortArray4747).length; i_172_++) {
								LocType class185 = (aClass251_1028
										.list((((Class246_Sub21) class246_sub21).aShortArray4747[i_172_]) & 0xffff, 0));
								int i_173_ = ((LocType) class185).map_function;
								if (((LocType) class185).f_bb != null) {
									class185 = (class185.method1205(anInterface11_1025, (byte) -84));
									if (class185 != null)
										i_173_ = ((LocType) class185).map_function;
								}
								if (i_173_ != -1) {
						...
						LocType class185 = aClass251_1028.list(i_171_ - 1, 0);
						int i_174_ = ((LocType) class185).map_function;
						if (((LocType) class185).f_bb != null) {
							class185 = class185.method1205(anInterface11_1025, (byte) 97);
							if (class185 != null)
								i_174_ = ((LocType) class185).map_function;
						}
						if (i_174_ != -1) {
						...
						for (Class130_Sub7 class130_sub7 = (Class130_Sub7) class68
							...
							if (((Class130_Sub7) class130_sub7).aShortArray5411 != null) {
								for (int i_177_ = 0; i_177_ < (((Class130_Sub7) class130_sub7).aShortArray5411).length; i_177_++) {
									LocType class185 = (aClass251_1028.list(
											((((Class130_Sub7) class130_sub7).aShortArray5411[i_177_]) & 0xffff), 0));
									int i_178_ = ((LocType) class185).map_function;
									if (((LocType) class185).f_bb != null) {
										class185 = (class185.method1205(anInterface11_1025, (byte) -10));
										if (class185 != null)
											i_178_ = (((LocType) class185).map_function);
									}
									if (i_178_ != -1) {
										Class246_Sub2 class246_sub2 = new Class246_Sub2(i_178_);
										((Class246_Sub2) class246_sub2).anInt3807 = ((i_175_ + (anInt1057 >> 6)) * 64
												+ ((Class130_Sub7) class130_sub7).aByte5409 - anInt1057);
										((Class246_Sub2) class246_sub2).anInt3801 = ((i_176_ + (anInt1041 >> 6)) * 64
												+ ((Class130_Sub7) class130_sub7).aByte5408 - anInt1041);
										aClass166_1034.push_head(class246_sub2);
									}
								}
							}
	...
	private static final Class166 method511(SceneGraph class260, int i, int i_180_, int i_181_, int i_182_) {
		for (Class246_Sub2 class246_sub2 = (Class246_Sub2) aClass166_1034.method1104(
				97); class246_sub2 != null; class246_sub2 = (Class246_Sub2) aClass166_1034.method1108((byte) -112))
			method503(class260, class246_sub2, i, i_180_, i_181_, i_182_);
		return aClass166_1034;
	}

	static final void method512(SceneGraph class260) {
		int i = anInt1052 - anInt1048;
	...
	private static final int method513(TextureInterface interface6, int i, int i_186_, int i_187_) {
		PacketsDecoder class_is = aClass105_1027.method703(4, i);
		if (class_is == null)
			return 0;
		int i_188_ = ((PacketsDecoder) class_is).anInt279;
		if (i_188_ >= 0 && !TextureLoader.osrs(i_188_)
				&& ((Material) interface6.get_material(-31305, i_188_)).aBool3339)
			i_188_ = -1;
		int i_189_;
		if (((PacketsDecoder) class_is).anInt271 >= 0) {
			...
			i_189_ = ~0xffffff
					| (Entity.f_eb[Class_e.method594(127, (Class246_Sub1_Sub2.method2426(96, (byte) 66, i_192_)))
							& 0xffff]);
		} else if (i_188_ >= 0)
			i_189_ = (~0xffffff
					| (Entity.f_eb[Class_e
							.method594(125,
									(Class246_Sub1_Sub2.method2426(96, (byte) 66,
											(((Material) interface6.get_material(-31305, i_188_)).aShort3354))))
							& 0xffff]));
			...
			i_189_ = ~0xffffff
					| (Entity.f_eb[Class_e.method594(-52, (Class246_Sub1_Sub2.method2426(96, (byte) 66, i_195_)))
							& 0xffff]);
		}
		return i_189_;
	}
	...
	static final Class246_Sub1_Sub5 method515(int i) {
		return (Class246_Sub1_Sub5) aClass85_1021.get((long) i);
	}

	static final void method516(TextureInterface interface6, int i, int i_196_) {
		for (int i_197_ = 0; i_197_ < ((UnderlayLoader) aClass105_1027).anInt1461; i_197_++)
			anIntArray1043[i_197_ + 1] = method513(interface6, i_197_, i, i_196_);
	}

	static final void method517(int i, int i_198_, int i_199_, int i_200_, int i_201_, int i_202_, int i_203_,
			int i_204_) {
	...
	static final void method518(CacheIndex class_fs, UnderlayLoader class105, OverlayLoader class175, Class251 class251,
			MapFunctions class165, MapScenes class254, Interface11 interface11) {
		...
		int i = aClass_fs1023.method86("details");
		...
		for (int i_205_ = 0; i_205_ < is.length; i_205_++) {
			...
			aClass85_1021.method547((long) ((Class246_Sub1_Sub5) class246_sub1_sub5).anInt5836, -2301,
					class246_sub1_sub5);
		}
