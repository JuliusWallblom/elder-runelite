...
final class Class59_Sub4_Sub3 extends Class59_Sub4 implements Class_f {
	...
	final Class130_Sub3 method407(SceneGraph class260, int i) {
		try {
			anInt6951++;
			AbstractModel class_t = (((Class59_Sub4_Sub3) this).aClass14_6952.method147(((Class59_Sub4) this).anInt5186,
					true, class260, ((Class59_Sub4) this).anInt5184, 2048, (byte) 119, false));
			if (class_t == null)
				return null;
			...
			do {
				if ((((Class14) ((Class59_Sub4_Sub3) this).aClass14_6952).aClass130_Sub2_214) != null) {
					Class129 class129 = ((Class14) ((Class59_Sub4_Sub3) this).aClass14_6952).aClass130_Sub2_214
							.method1779();
			...
			((Class59_Sub4_Sub3) this).aClass14_6952.method155(true, i_1_, 50401, class_t, i_0_, class260, i_1_, i_0_);
			return class130_sub3;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					"tt.H(" + (class260 != null ? "{...}" : "null") + ',' + i + ')');
		}
	}

	static final Class21_Sub1 method2858(Buffer stream, byte i) {
		try {
			if (i <= 93)
				return null;
			anInt6942++;
			return new Class21_Sub1(stream.method2375((byte) 1), stream.method2375((byte) 1),
					stream.method2375((byte) 1), stream.method2375((byte) 1), stream.method2375((byte) 1),
					stream.method2375((byte) 1), stream.method2375((byte) 1), stream.method2375((byte) 1),
					stream.read24BitInteger((byte) 29), stream.readUnsignedByte());
		} catch (RuntimeException runtimeexception) {
	...
	final void method405(int i, int i_2_, Class59 class59, byte i_3_, boolean bool, SceneGraph class260, int i_4_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("tt.L(" + i + ',' + i_2_ + ',' + (class59 != null ? "{...}" : "null") + ',' + i_3_ + ',' + bool
	...
	public final void method19(SceneGraph class260, int i) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					"tt.U(" + (class260 != null ? "{...}" : "null") + ',' + i + ')');
		}
	}

	final boolean method409(int i, int i_6_, SceneGraph class260, int i_7_) {
		try {
			anInt6939++;
			if (i_6_ != 0)
				return false;
			AbstractModel class_t = (((Class59_Sub4_Sub3) this).aClass14_6952.method147(((Class59_Sub4) this).anInt5186,
					false, class260, ((Class59_Sub4) this).anInt5184, 131072, (byte) 118, false));
			if (class_t == null)
				return false;
			Class_c class_c = class260.method1730();
			class_c.j(((Class59_Sub4) this).anInt5184, ((Class59_Sub4) this).anInt5188,
			...
			throw Class193.method1272(runtimeexception,
					("tt.A(" + i + ',' + i_6_ + ',' + (class260 != null ? "{...}" : "null") + ',' + i_7_ + ')'));
		}
	}
	...
	public final AbstractModel method23(SceneGraph class260, int i, int i_8_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("tt.D(" + (class260 != null ? "{...}" : "null") + ',' + i + ',' + i_8_ + ')'));
		}
	}

	Class59_Sub4_Sub3(SceneGraph class260, LocType class185, int i, int i_10_, int i_11_, int i_12_, int i_13_,
			boolean bool, int i_14_, int i_15_, int i_16_) {
		super(i_11_, i_12_, i_13_, SequenceLoader.method2762(false, i_14_, i_15_));
		try {
			((Class59_Sub4_Sub3) this).aClass14_6952 = new Class14(class260, class185, i_14_, i_15_, i, i_10_,
					((Class59_Sub4) this).anInt5184, ((Class59_Sub4) this).anInt5186, bool, i_16_);
			aBool6941 = ((LocType) class185).wall_or_door != 0 && !bool;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("tt.<init>(" + (class260 != null ? "{...}" : "null") + ',' + (class185 != null ? "{...}" : "null")
	...
	final void method403(SceneGraph class260, int i) {
		do {
			try {
				...
				if (i < 53)
					method401(-52);
				AbstractModel class_t = (((Class59_Sub4_Sub3) this).aClass14_6952.method147(
						((Class59_Sub4) this).anInt5186, true, class260, ((Class59_Sub4) this).anInt5184, 262144,
						(byte) 126, true));
				if (class_t == null)
					break;
				int i_19_ = ((Class59_Sub4) this).anInt5184 >> 7;
				int i_20_ = ((Class59_Sub4) this).anInt5186 >> 7;
				((Class59_Sub4_Sub3) this).aClass14_6952.method155(false, i_20_, 50401, class_t, i_19_, class260, i_20_,
						i_19_);
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception,
						("tt.B(" + (class260 != null ? "{...}" : "null") + ',' + i + ')'));
			}
			break;
		} while (false);
	}
