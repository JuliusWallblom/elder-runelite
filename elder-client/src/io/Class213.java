...
final class Class213 {
	...
	int anInt2978;
	static MultilingualString aClass67_2979 = new MultilingualString("Loaded interfaces",
			"Benutzeroberfl\u00e4che geladen.", "Interfaces charg\u00e9es", "Interfaces carregadas");
	...
	static boolean[][] aBoolArrayArray2983 = { new boolean[13],
	...
	static final void method1393(int i, int i_0_, int i_1_, Class59_Sub1 class59_sub1, int objectId) {
		Tile class147 = Class187.method1222(i, i_0_, i_1_);
		if (class147 != null) {
			((Tile) class147).floorDecorationIThink = class59_sub1;
		}
	}
	...
	Class213(Class260_Sub2 class260_sub2, int i, int i_3_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("td.<init>(" + (class260_sub2 != null ? "{...}" : "null") + ',' + i + ',' + i_3_ + ')'));
		}
	}
