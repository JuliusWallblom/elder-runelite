...
abstract class Class188 {
	...
	static final void method1231(byte i) {
		try {
			...
			if (Class260_Sub2.aClass205_4297 != Class155.aClass205_2228) {
				try {
					Class80.method521(Client.instance, "tbrefresh", 122);
	...
	static final String method1235(boolean bool, long l, int i, int i_0_, int i_1_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("ri.G(" + bool + ',' + l + ',' + i + ',' + i_0_ + ',' + i_1_ + ')'));
		}
	}

	abstract char method1236();
	...
	static {
		new MultilingualString("Select", "Ausw\u00e4hlen", "S\u00e9lectionner", "Selecionar");
		anInt2657 = -1;
		anInt2658 = -1;
	}
}
