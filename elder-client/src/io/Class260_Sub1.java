...
final class Class260_Sub1 extends SceneGraph {
	private boolean aBool3825 = false;
	private Canvas aCanvas3826;
	private boolean aBool3827 = false;
	private IterableNodeHashTable aClass85_3828 = new IterableNodeHashTable(4);
	...
	int f_hb;
	int f_ib;
	private AbstractSprite f_jb;
	private HashMap f_kb;
	int f_lb;
	private int f_mb;
	int f_nb;
	private AbstractSprite f_ob;
	private int f_pb;
	...
	final void method1728(int i, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, Class128 class128, int i_8_,
			int i_9_) {
		...
		int i_12_ = (((Class260_Sub1) this).anInt3856 < i_9_ + is.length ? ((Class260_Sub1) this).anInt3856
				: i_9_ + is.length);
		i_4_ -= i;
		i_5_ -= i_3_;
		if (i_4_ + i_5_ < 0) {
		...
		if (i_4_ > i_5_) {
			...
			if (i_7_ == 1) {
				i_6_ = (((i_6_ & 0xff00ff) * i_14_ >> 8 & 0xff00ff) + ((i_6_ & 0xff00) * i_14_ >> 8 & 0xff00)
						+ (i_14_ << 24));
				int i_18_ = 256 - i_14_;
				for (/**/; i <= i_4_; i++) {
					int i_19_ = i_3_ >> 16;
					...
					if (i_19_ >= i_11_ && i_19_ < i_12_) {
						...
						if (i >= i_21_ && i < i_21_ + is_10_[i_20_]) {
							...
							i_23_ = (((i_23_ & 0xff00ff) * i_18_ >> 8 & 0xff00ff)
									+ ((i_23_ & 0xff00) * i_18_ >> 8 & 0xff00));
		...
		if (i_7_ == 0 || i_7_ == 1 && i_32_ == 255) {
			for (/**/; i_3_ <= i_5_; i_3_++) {
				...
				if (i_33_ >= ((Class260_Sub1) this).f_lb && i_33_ < ((Class260_Sub1) this).anInt3832 && i_33_ >= i_35_
						&& i_33_ < i_35_ + is_10_[i_34_])
					((Class260_Sub1) this).anIntArray3834[i_33_ + i_3_ * ((Class260_Sub1) this).f_nb] = i_6_;
				i += i_31_;
			}
		} else if (i_7_ == 1) {
			i_6_ = (((i_6_ & 0xff00ff) * i_32_ >> 8 & 0xff00ff) + ((i_6_ & 0xff00) * i_32_ >> 8 & 0xff00)
					+ (i_32_ << 24));
			int i_36_ = 256 - i_32_;
			for (/**/; i_3_ <= i_5_; i_3_++) {
				int i_37_ = i >> 16;
				...
				if (i_37_ >= ((Class260_Sub1) this).f_lb && i_37_ < ((Class260_Sub1) this).anInt3832 && i_37_ >= i_39_
						&& i_37_ < i_39_ + is_10_[i_38_]) {
			...
			for (/**/; i_3_ <= i_5_; i_3_++) {
				...
				if (i_42_ >= ((Class260_Sub1) this).f_lb && i_42_ < ((Class260_Sub1) this).anInt3832 && i_42_ >= i_44_
						&& i_42_ < i_44_ + is_10_[i_43_]) {
	...
	private final void method1793() {
		...
		for (int i = 0; i < ((Class260_Sub1) this).anInt3855; i++) {
			Rasterizer3D class184 = ((Class36) aClass36Array3835[i]).aClass184_494;
			((Rasterizer3D) class184).anInt2562 = ((Class260_Sub1) this).f_cb - ((Class260_Sub1) this).f_lb;
			((Rasterizer3D) class184).anInt2568 = (((Class260_Sub1) this).anInt3858 - ((Class260_Sub1) this).f_eb);
			((Rasterizer3D) class184).anInt2557 = (((Class260_Sub1) this).anInt3832 - ((Class260_Sub1) this).f_lb);
			((Rasterizer3D) class184).clip_bottom = (((Class260_Sub1) this).anInt3856 - ((Class260_Sub1) this).f_eb);
		}
		...
		for (int i_49_ = ((Class260_Sub1) this).f_eb; i_49_ < ((Class260_Sub1) this).anInt3856; i_49_++) {
			for (int i_50_ = 0; i_50_ < ((Class260_Sub1) this).anInt3855; i_50_++)
				((Rasterizer3D) ((Class36) aClass36Array3835[i_50_]).aClass184_494).anIntArray2569[i_49_
						- ((Class260_Sub1) this).f_eb] = i;
			i += ((Class260_Sub1) this).f_nb;
		}
	}

	final int method1794(int i) {
		return (((Material) ((SceneGraph) this).anInterface6_3714.get_material(-31305, i)).aShort3354 & 0xffff);
	}
	...
	final void NA(int i, int i_65_, int i_66_, int i_67_, int i_68_) {
		...
		if (i_68_ == 0 || i_68_ == 1 && i_77_ == 255) {
			...
			i_67_ = (((i_67_ & 0xff00ff) * i_77_ >> 8 & 0xff00ff) + ((i_67_ & 0xff00) * i_77_ >> 8 & 0xff00)
					+ (i_77_ << 24));
			int i_86_ = 256 - i_77_;
			while (i_71_ < i_65_) {
				for (/**/; i_76_ <= i_72_ || i_75_ <= i_72_; i_76_ += i_73_++ + i_73_)
	...
	private final void method1795() {
		if (f_bb != 0.0F) {
			...
			((Class260_Sub1) this).anInt3833 = (int) (0.5F
					+ (((float) anInt3837 - f_112_ * f_114_) / ((f + f_111_) / (f - f_111_) - f_115_)));
		} else
	...
	final void O(int i, int i_116_, int i_117_, int i_118_, int i_119_, int i_120_) {
		...
		if (i_117_ > 0 && i_118_ > 0 && i <= ((Class260_Sub1) this).anInt3832
				&& i_116_ <= ((Class260_Sub1) this).anInt3856) {
			...
			if (i_120_ == 0 || i_120_ == 1 && i_123_ == 255) {
				...
				i_119_ = (((i_119_ & 0xff00ff) * i_123_ >> 8 & 0xff00ff) + ((i_119_ & 0xff00) * i_123_ >> 8 & 0xff00)
						+ (i_123_ << 24));
				...
				for (int i_128_ = 0; i_128_ < i_118_; i_128_++) {
					for (int i_129_ = -i_117_; i_129_ < 0; i_129_++) {
						...
						i_130_ = (((i_130_ & 0xff00ff) * i_127_ >> 8 & 0xff00ff)
								+ ((i_130_ & 0xff00) * i_127_ >> 8 & 0xff00));
	...
	final boolean method1796(int i) {
		return ((SceneGraph) this).anInterface6_3714.method13(i, 19378);
	}
	...
	private Class260_Sub1(int i, TextureInterface interface6) {
		super(i, interface6);
	...
	final void DA(int i, int i_140_, int i_141_, int i_142_, int i_143_, int i_144_, byte[] is, int i_145_,
			int i_146_) {
			...
			if (i_146_ == 0 || i_146_ == 1 && i_156_ == 255 && i_157_ == 255) {
				...
				for (int i_163_ = -i_142_; i_163_ < 0; i_163_++) {
					...
					for (int i_165_ = -i_141_; i_165_ < 0; i_165_++) {
						...
						((Class260_Sub1) this).anIntArray3834[i_151_++] = ((((i_166_ & 0xff00ff) * i_167_
								+ (i_169_ & 0xff00ff) * i_168_) & ~0xff00ff)
								+ (((i_166_ & 0xff00) * i_167_ + (i_169_ & 0xff00) * i_168_) & 0xff0000)) >> 8;
						i_147_ += i_149_;
					}
					i_148_ += i_150_;
					i_147_ = i_162_;
	...
	private final int[] get_texture_data_2(int texture_id) {
		Class246_Sub36 class246_sub36;
		synchronized (f_kb) {
			class246_sub36 = (Class246_Sub36) f_kb.method379((long) texture_id, (byte) 58);
			if (class246_sub36 == null) {
				if (!((SceneGraph) this).anInterface6_3714.method13(texture_id, 19378))
					return null;
				int i_386_;
				if (TextureLoader.osrs(texture_id)) {
					i_386_ = f_gb ? 64 : 128;
					class246_sub36 = (new Class246_Sub36(texture_id, i_386_,
							((SceneGraph) this).anInterface6_3714.method16(true, texture_id, false, 0.5F, i_386_,
									i_386_),
							false));
				} else {
					Material class238 = ((SceneGraph) this).anInterface6_3714.get_material(-31305, texture_id);
					i_386_ = ((Material) class238).aBool3335 || f_gb ? 64 : 128;
					class246_sub36 = (new Class246_Sub36(texture_id, i_386_,
							((SceneGraph) this).anInterface6_3714.method16(true, texture_id, false, 0.7F, i_386_,
									i_386_),
							((Material) class238).aBool3347));
				}
				f_kb.method371(1, (long) texture_id, class246_sub36);
			}
		}
	...
	final AbstractSprite method1706(int[] is, int i, int i_182_, int i_183_, int i_184_) {
		boolean bool = false;
		int i_185_ = i;
	...
	final AbstractSprite method1706_osrs(int[] is, int i, int i_182_, int i_183_, int i_184_) {
		boolean bool = false;
		int i_185_ = i;
		while_157_: for (int i_186_ = 0; i_186_ < i_184_; i_186_++) {
			for (int i_187_ = 0; i_187_ < i_183_; i_187_++) {
	...
	final void method1687(int i) {
		...
		for (Object object = f_kb.method381((byte) -119); object != null; object = f_kb.method374(-17845)) {
			...
			if (((Class246_Sub36) class246_sub36).aBool5247) {
				...
				if (i_190_ > 0) {
					int textureId = ((Class246_Sub36) class246_sub36).anInt5243;
					if (TextureLoader.osrs(textureId)) {
						Texture tex = ((TextureLoader) Class246_Sub37_Sub1.textureLoader).get_texture(textureId,
								Revision.OSRS, 1);
						class246_sub36.animateTexture(tex.animationDirection,
								tex.animationSpeed, true);
					} else {
						Material class238 = (((SceneGraph) this).anInterface6_3714.get_material(-31305,
								textureId));
						class246_sub36.animateTexture((((Material) class238).animationDirection * i_189_ * 50 / 1000),
								(((Material) class238).animationSpeed * i_189_ * 50 / 1000), false);
					}
	...
	final void method1748(AbstractModel[] class_ts, Class_c class_c, Class130_Sub5[] class130_sub5s, int i) {
		LDModel[] class_t_sub2s = new LDModel[class_ts.length];
		for (int i_193_ = 0; i_193_ < class_ts.length; i_193_++) {
			if (class_ts[i_193_] != null)
				class_t_sub2s[i_193_] = (LDModel) class_ts[i_193_];
		}
		LDModel class_t_sub2 = LDModel.method2237(this, class_t_sub2s);
	...
	final void method1718(Class129 class129) {
		...
		for (Class130_Sub1 class130_sub1_194_ = ((Class130_Sub1) class130_sub1).aClass130_Sub1_3732; class130_sub1_194_ != class130_sub1; class130_sub1_194_ = ((Class130_Sub1) class130_sub1_194_).aClass130_Sub1_3732) {
			...
			int i_197_ = ((((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5593)
					+ ((((Class_c_Sub2) (((Class260_Sub1) this).aClass_c_Sub2_3857)).anInt5583 * i
							+ (((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5590 * i_195_)
							+ (((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5585 * i_196_)) >> 15));
			if (i_197_ >= ((Class260_Sub1) this).anInt3839 && i_197_ <= ((Class260_Sub1) this).anInt3846) {
				int i_198_ = (((Class260_Sub1) this).f_cb + (((Class260_Sub1) this).anInt3851
						* (((Class_c_Sub2) (((Class260_Sub1) this).aClass_c_Sub2_3857)).anInt5589
								+ (((((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5594) * i
										+ (((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5588)
												* i_195_
										+ (((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5592)
												* i_196_) >> 15))
						/ i_197_));
				int i_199_ = (((Class260_Sub1) this).anInt3858 + (((Class260_Sub1) this).anInt3852
						* (((Class_c_Sub2) (((Class260_Sub1) this).aClass_c_Sub2_3857)).anInt5584
								+ (((((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5591) * i
										+ (((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5586)
												* i_195_
										+ (((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5587)
												* i_196_) >> 15))
						/ i_197_));
				if (i_198_ >= ((Class260_Sub1) this).f_lb && i_198_ <= ((Class260_Sub1) this).anInt3832
						&& i_199_ >= ((Class260_Sub1) this).f_eb && i_199_ <= ((Class260_Sub1) this).anInt3856) {
					if (i_197_ == 0)
						i_197_ = 1;
					method1801(class130_sub1_sub1, i_198_, i_199_,
							((((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7038) >> 2) / i_197_);
				}
			}
		}
	}
	...
	final void method1743(int i, int i_202_, int i_203_, int i_204_, int i_205_, int i_206_) {
		...
		if (i_204_ == 0) {
			...
			if (i_203_ > i_204_) {
				...
				if (i_206_ == 1) {
					i_205_ = (((i_205_ & 0xff00ff) * i_208_ >> 8 & 0xff00ff)
							+ ((i_205_ & 0xff00) * i_208_ >> 8 & 0xff00) + (i_208_ << 24));
					...
					for (/**/; i <= i_203_; i++) {
						...
						if (i_211_ >= ((Class260_Sub1) this).f_eb && i_211_ < ((Class260_Sub1) this).anInt3856) {
							...
							i_213_ = (((i_213_ & 0xff00ff) * i_210_ >> 8 & 0xff00ff)
									+ ((i_213_ & 0xff00) * i_210_ >> 8 & 0xff00));
			...
			if (i_206_ == 0 || i_206_ == 1 && i_220_ == 255) {
				...
				i_205_ = (((i_205_ & 0xff00ff) * i_220_ >> 8 & 0xff00ff) + ((i_205_ & 0xff00) * i_220_ >> 8 & 0xff00)
						+ (i_220_ << 24));
				...
				for (/**/; i_202_ <= i_204_; i_202_++) {
					...
					if (i_223_ >= ((Class260_Sub1) this).f_lb && i_223_ < ((Class260_Sub1) this).anInt3832) {
						...
						i_225_ = (((i_225_ & 0xff00ff) * i_222_ >> 8 & 0xff00ff)
								+ ((i_225_ & 0xff00) * i_222_ >> 8 & 0xff00));
						((Class260_Sub1) this).anIntArray3834[i_223_ + i_202_ * ((Class260_Sub1) this).f_nb] = i_205_
								+ i_225_;
					}
					i += i_219_;
				}
	...
	final void method1690(Canvas canvas) {
		Class246_Sub19 class246_sub19 = ((Class246_Sub19) aClass85_3828.get((long) canvas.hashCode()));
	...
	final void method1680() {
		if (aBool3827) {
			Texture.method2701(true, 478210754, false);
			aBool3827 = false;
		}
	...
	final boolean method1800(int i) {
		return (((Material) ((SceneGraph) this).anInterface6_3714.get_material(-31305, i)).aBool3340);
	}
	...
	final void method1801(Class130_Sub1_Sub1 class130_sub1_sub1, int i, int i_239_, int i_240_) {
		...
		if (i_241_ == -1)
			...
			if (f_pb != i_241_) {
				AbstractSprite class_l = ((AbstractSprite) aClass54_3838.method379((long) i_241_, (byte) 58));
				if (class_l == null) {
					int[] is = get_texture_data_2(i_241_);
					if (is != null) {
			...
			f_ob.s(i - i_242_, i_239_ - i_242_, i_240_, i_240_, 0, ((Class130_Sub1_Sub1) class130_sub1_sub1).anInt7043,
					1);
		}
	}

	Class260_Sub1(int i, Canvas canvas, TextureInterface interface6) {
		this(i, interface6);
		method1690(canvas);
		method1691(canvas);
	}
	...
	final void method1703(AbstractModel class_t, Class129 class129, Class_c class_c, Class130_Sub5 class130_sub5,
			int i) {
		((LDModel) class_t).method2225(class_c, class130_sub5, class129, i);
	}
	...
	final void X(int i, int i_248_, int i_249_, int[] is) {
		int i_250_ = ((((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5593)
				+ (((((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5583) * i
						+ ((Class_c_Sub2) (((Class260_Sub1) this).aClass_c_Sub2_3857)).anInt5590 * i_248_
						+ ((Class_c_Sub2) (((Class260_Sub1) this).aClass_c_Sub2_3857)).anInt5585 * i_249_) >> 15));
		if (i_250_ < ((Class260_Sub1) this).anInt3839 || i_250_ > anInt3837)
			is[0] = is[1] = is[2] = -1;
		else {
			int i_251_ = (((Class260_Sub1) this).anInt3851
					* (((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5589
							+ ((((Class_c_Sub2) (((Class260_Sub1) this).aClass_c_Sub2_3857)).anInt5594 * i
									+ (((Class_c_Sub2) (((Class260_Sub1) this).aClass_c_Sub2_3857)).anInt5588 * i_248_)
									+ (((Class_c_Sub2) (((Class260_Sub1) this).aClass_c_Sub2_3857)).anInt5592
											* i_249_)) >> 15))
					/ i_250_);
			int i_252_ = (((Class260_Sub1) this).anInt3852
					* (((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5584
							+ ((((Class_c_Sub2) (((Class260_Sub1) this).aClass_c_Sub2_3857)).anInt5591 * i
									+ (((Class_c_Sub2) (((Class260_Sub1) this).aClass_c_Sub2_3857)).anInt5586 * i_248_)
									+ (((Class_c_Sub2) (((Class260_Sub1) this).aClass_c_Sub2_3857)).anInt5587
											* i_249_)) >> 15))
					/ i_250_);
			if (i_251_ >= ((Class260_Sub1) this).f_ab && i_251_ <= ((Class260_Sub1) this).f_ib
					&& i_252_ >= ((Class260_Sub1) this).anInt3850 && i_252_ <= ((Class260_Sub1) this).anInt3842) {
	...
	final AbstractSprite ld_to_abstract_sprite(LDSprite class10, boolean bool) {
		int[] is = ((LDSprite) class10).anIntArray160;
		byte[] is_259_ = ((LDSprite) class10).aByteArray157;
		int i = ((LDSprite) class10).anInt156;
		int i_260_ = ((LDSprite) class10).anInt155;
		Class_l_Sub1 class_l_sub1;
		if (bool && ((LDSprite) class10).aByteArray161 == null) {
			...
			byte[] is_268_ = ((LDSprite) class10).aByteArray161;
			if (is_268_ != null) {
				for (int i_269_ = 0; i_269_ < i_260_; i_269_++) {
					int i_270_ = i_269_ * i;
					for (int i_271_ = 0; i_271_ < i; i_271_++)
						is_267_[i_270_ + i_271_] = (is[is_259_[i_270_ + i_271_] & 0xff]
								| is_268_[i_270_ + i_271_] << 24);
				}
		...
		class_l_sub1.MA(((LDSprite) class10).anInt158, ((LDSprite) class10).anInt162, ((LDSprite) class10).anInt159,
	...
	final AbstractSprite method1721(int i, int i_278_, int i_279_, int i_280_, boolean bool) {
	...
	final boolean method1803(int i) {
		if (f_gb || ((Material) ((SceneGraph) this).anInterface6_3714.get_material(-31305, i)).aBool3335)
			return true;
		return false;
	}

	final void method1804(int i, int i_286_, int i_287_, int i_288_, int i_289_, int i_290_, int i_291_, int i_292_,
			int i_293_) {
		if (i_287_ != 0 && i_288_ != 0) {
			if (i_290_ != 65535
					&& (TextureLoader.osrs(i_290_) || !((Material) ((SceneGraph) this).anInterface6_3714
							.get_material(-31305, i_290_)).aBool3339)) {
				if (f_pb != i_290_) {
					AbstractSprite class_l = ((AbstractSprite) aClass54_3838.method379((long) i_290_, (byte) 58));
					if (class_l == null) {
						int[] is = get_texture_data_2(i_290_);
						if (is == null)
							return;
	...
	final AbstractModel method1695(Model class103, int i, int i_302_, int i_303_, int i_304_) {
		return new LDModel(this, class103, i, i_303_, i_304_, i_302_);
	}
	...
	final void method1717(int i, int i_305_, int i_306_, int i_307_, int i_308_, int i_309_, int i_310_, int i_311_,
	...
	final void TA(int i, int i_315_, int i_316_, int i_317_, int i_318_) {
		if (i >= ((Class260_Sub1) this).f_lb && i < ((Class260_Sub1) this).anInt3832) {
			...
			if (i_318_ == 0 || i_318_ == 1 && i_320_ == 255) {
				...
				i_317_ = (((i_317_ & 0xff00ff) * i_320_ >> 8 & 0xff00ff) + ((i_317_ & 0xff00) * i_320_ >> 8 & 0xff00)
						+ (i_320_ << 24));
				...
				for (int i_323_ = 0; i_323_ < i_316_; i_323_++) {
					...
					i_325_ = (((i_325_ & 0xff00ff) * i_322_ >> 8 & 0xff00ff)
							+ ((i_325_ & 0xff00) * i_322_ >> 8 & 0xff00));
	...
	final void b(int i, int i_335_, int i_336_, int i_337_, int i_338_) {
		if (i_335_ >= ((Class260_Sub1) this).f_eb && i_335_ < ((Class260_Sub1) this).anInt3856) {
			...
			if (i_338_ == 0 || i_338_ == 1 && i_340_ == 255) {
				...
				i_337_ = (((i_337_ & 0xff00ff) * i_340_ >> 8 & 0xff00ff) + ((i_337_ & 0xff00) * i_340_ >> 8 & 0xff00)
						+ (i_340_ << 24));
				int i_342_ = 256 - i_340_;
				for (int i_343_ = 0; i_343_ < i_336_; i_343_++) {
					int i_344_ = (((Class260_Sub1) this).anIntArray3834[i_339_ + i_343_]);
					i_344_ = (((i_344_ & 0xff00ff) * i_342_ >> 8 & 0xff00ff)
							+ ((i_344_ & 0xff00) * i_342_ >> 8 & 0xff00));
	...
	final void method1694(int i, int i_354_, int i_355_, int i_356_, int i_357_, int i_358_, int i_359_) {
		...
		if (i_364_ != 0) {
			...
			if (i_359_ == 0)
				...
				((Rasterizer3D) class184).alpha = 255 - (i_357_ >> 24);
			else
				throw new IllegalArgumentException();
			((Rasterizer3D) class184).aBool2560 = (i_371_ < 0 || i_371_ > ((Rasterizer3D) class184).anInt2557
					|| i_372_ < 0 || i_372_ > ((Rasterizer3D) class184).anInt2557 || i_373_ < 0
					|| i_373_ > ((Rasterizer3D) class184).anInt2557);
			class184.drawTexturedTriangle(i_375_, i_376_, i_377_, i_371_, i_372_, i_373_, i_357_);
			((Rasterizer3D) class184).aBool2560 = (i_371_ < 0 || i_371_ > ((Rasterizer3D) class184).anInt2557
					|| i_372_ < 0 || i_372_ > ((Rasterizer3D) class184).anInt2557 || i_374_ < 0
					|| i_374_ > ((Rasterizer3D) class184).anInt2557);
			class184.drawTexturedTriangle(i_375_, i_377_, i_378_, i_371_, i_373_, i_374_, i_357_);
		}
	}
	...
	final Font method1716(FontMetric class73, LDSprite[] class10s, boolean bool) {
		...
		for (int i = 0; i < class10s.length; i++) {
			is[i] = ((LDSprite) class10s[i]).anInt156;
			is_384_[i] = ((LDSprite) class10s[i]).anInt155;
			if (((LDSprite) class10s[i]).aByteArray161 != null)
				bool_385_ = true;
		}
		if (bool)
	...
	final int[] get_texture_data_1(int texture_id) {
		Class246_Sub36 class246_sub36;
		synchronized (f_kb) {
			class246_sub36 = (Class246_Sub36) f_kb.method379((long) texture_id, (byte) 60);
			if (class246_sub36 == null) {
				if (!((SceneGraph) this).anInterface6_3714.method13(texture_id, 19378))
					return null;
				int i_386_;
				if (TextureLoader.osrs(texture_id)) {
					i_386_ = f_gb ? 64 : 128;
					class246_sub36 = (new Class246_Sub36(texture_id, i_386_,
							((SceneGraph) this).anInterface6_3714.method14(true, 5754, texture_id, 0.5F, i_386_,
									i_386_),
							false));
				} else {
					Material class238 = ((SceneGraph) this).anInterface6_3714.get_material(-31305, texture_id);
					i_386_ = ((Material) class238).aBool3335 || f_gb ? 64 : 128;
					class246_sub36 = (new Class246_Sub36(texture_id, i_386_,
							((SceneGraph) this).anInterface6_3714.method14(true, 5754, texture_id, 0.7F, i_386_,
									i_386_),
							((Material) class238).aBool3347));
				}
				f_kb.method371(1, (long) texture_id, class246_sub36);
	...
	final void method1731(Rectangle[] rectangles, int i) {
		...
		try {
			...
			for (int i_392_ = 0; i_392_ < i; i_392_++) {
				...
				if (rectangle.x <= ((Class260_Sub1) this).f_nb && rectangle.y <= anInt3853
						&& rectangle.x + rectangle.width > 0 && rectangle.y + rectangle.height > 0)
					aClass246_Sub19_3830.method2064(rectangle.y, rectangle.width, rectangle.x, graphics, (byte) -104,
							rectangle.height);
			}
		} catch (Exception exception) {
			aCanvas3826.repaint();
	...
	final boolean JA(int i, int i_393_, int i_394_, int i_395_, int i_396_, int i_397_) {
		int i_398_ = ((((((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5583) * i
				+ (((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5590) * i_393_
				+ (((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5585) * i_394_) >> 15)
				+ (((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5593));
		if (i_398_ < 1)
			i_398_ = 1;
		int i_399_ = ((((((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5583) * i_395_
				+ (((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5590) * i_396_
				+ (((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5585) * i_397_) >> 15)
				+ (((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5593));
		if (i_399_ < 1)
			i_399_ = 1;
		if ((i_398_ < ((Class260_Sub1) this).anInt3839 && i_399_ < ((Class260_Sub1) this).anInt3839)
				|| i_398_ > anInt3837 && i_399_ > anInt3837)
			return false;
		int i_400_ = (((Class260_Sub1) this).anInt3851
				* ((((((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5594) * i
						+ ((Class_c_Sub2) (((Class260_Sub1) this).aClass_c_Sub2_3857)).anInt5588 * i_393_
						+ (((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5592 * i_394_)) >> 15)
						+ (((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5589))
				/ i_398_);
		int i_401_ = (((Class260_Sub1) this).anInt3851
				* ((((((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5594) * i_395_
						+ ((Class_c_Sub2) (((Class260_Sub1) this).aClass_c_Sub2_3857)).anInt5588 * i_396_
						+ (((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5592 * i_397_)) >> 15)
						+ (((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5589))
				/ i_399_);
		if ((i_400_ < ((Class260_Sub1) this).f_ab && i_401_ < ((Class260_Sub1) this).f_ab)
				|| (i_400_ > ((Class260_Sub1) this).f_ib && i_401_ > ((Class260_Sub1) this).f_ib))
			return false;
		int i_402_ = (((Class260_Sub1) this).anInt3852
				* ((((((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5591) * i
						+ ((Class_c_Sub2) (((Class260_Sub1) this).aClass_c_Sub2_3857)).anInt5586 * i_393_
						+ (((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5587 * i_394_)) >> 15)
						+ (((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5584))
				/ i_398_);
		int i_403_ = (((Class260_Sub1) this).anInt3852
				* ((((((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5591) * i_395_
						+ ((Class_c_Sub2) (((Class260_Sub1) this).aClass_c_Sub2_3857)).anInt5586 * i_396_
						+ (((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5587 * i_397_)) >> 15)
						+ (((Class_c_Sub2) ((Class260_Sub1) this).aClass_c_Sub2_3857).anInt5584))
				/ i_399_);
		if ((i_402_ < ((Class260_Sub1) this).anInt3850 && i_403_ < ((Class260_Sub1) this).anInt3850)
				|| (i_402_ > ((Class260_Sub1) this).anInt3842 && i_403_ > ((Class260_Sub1) this).anInt3842))
			return false;
		return true;
	}
	...
	final void method1740(AbstractModel[] class_ts, Class129 class129, Class_c class_c, Class130_Sub5[] class130_sub5s,
		...
		for (int i_404_ = 0; i_404_ < class_ts.length; i_404_++) {
			if (class_ts[i_404_] != null)
				class_t_sub2s[i_404_] = (LDModel) class_ts[i_404_];
		}
		LDModel class_t_sub2 = LDModel.method2237(this, class_t_sub2s);
