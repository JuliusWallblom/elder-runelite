...
abstract class Class211 {
	...
	static Widget aClass235_2962;
	static Class166 aClass166_2963;
	static int anInt2964;
	static int anInt2965;

	static final void method1386(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_,
			int i_8_) {
		try {
			anInt2961++;
			if (i_0_ < 128 || (i_1_ ^ 0xffffffff) > -129 || (Class38_Sub1_Sub1.anInt6770 - 2) * 128 < i_0_
					|| (-2 + Class152.anInt2205) * 128 < i_1_)
				...
				Client.sprite_loader.X(i_0_, i_9_, i_1_, Class257.anIntArray3689);
				if (i_6_ != 503)
					aClass235_2962 = null;
				Class130_Sub3.aClass_c4413.o(-i_3_, 0, 0);
				Client.sprite_loader.ea(Class130_Sub3.aClass_c4413);
			...
			throw Class193.method1272(runtimeexception, ("tb.G(" + i + ',' + i_0_ + ',' + i_1_ + ',' + i_2_ + ',' + i_3_
					+ ',' + i_4_ + ',' + i_5_ + ',' + i_6_ + ',' + i_7_ + ',' + i_8_ + ')'));
		}
	}

	static final void method1387(int i, CacheIndex class_fs) {
		try {
			CollisionMap.anInt2846 = 0;
			if (i >= -105)
				aClass166_2963 = null;
			anInt2964++;
			MapFunctions.anInt2335 = 0;
	...
	static final boolean method1389(int i, int i_10_, int i_11_) {
		try {
			...
			if ((Class45.tileRenderFlags[1][i][i_11_] & 0x2 ^ 0xffffffff) != -1)
				return true;
			return false;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1391(int i, byte[] is, int i_15_, byte[] is_16_, int i_17_, int i_18_, int i_19_,
			byte i_20_, int i_21_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("tb.J(" + i + ',' + (is != null ? "{...}" : "null") + ',' + i_15_ + ','
							+ (is_16_ != null ? "{...}" : "null") + ',' + i_17_ + ',' + i_18_ + ',' + i_19_ + ','
							+ i_20_ + ',' + i_21_ + ')'));
		}
	}
