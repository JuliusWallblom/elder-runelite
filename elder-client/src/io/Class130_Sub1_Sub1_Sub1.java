...
final class Class130_Sub1_Sub1_Sub1 extends Class130_Sub1_Sub1 {
	...
	private final void method2901() {
		...
		Class246_Sub43.aClass130_Sub1_Sub1_Sub1Array5600[MapFunctions.anInt2335] = this;
		MapFunctions.anInt2335 = MapFunctions.anInt2335 + 1 & 0x3ff;
		this.method886(1024);
	...
	final void method2902(long l) {
		...
		int i_1_ = ((Class130_Sub1_Sub1) this).anInt7048 >> VarpType.anInt1225;
		if (i_1_ > 0 || i_1_ < -262144 || i < 0 || i >= Class240.xSize || i_0_ < 0 || i_0_ >= HDModel.ySize)
			method2901();
		else {
			...
			if (((Class104) class104).aBool1404) {
				...
				if (((Class104) class104).anInt1403 >= 0
						&& i_1_ > class210s[((Class104) class104).anInt1403].l(i, i_0_)) {
					method2901();
					return;
				}
			...
			if (i < ((Class130_Sub2) class130_sub2).anInt3795 || i > ((Class130_Sub2) class130_sub2).anInt3798
					|| i_0_ < ((Class130_Sub2) class130_sub2).anInt3799
					|| i_0_ > ((Class130_Sub2) class130_sub2).anInt3793 || i_1_ > i_2_ || i_1_ < i_3_) {
				int i_4_;
				...
				if (i_4_ == 0 && i_1_ > class210s[0].l(i, i_0_))
					method2901();
				else if (i_4_ == Class154_Sub1.anInt4803 - 1
						&& (class210s[i_4_].l(i, i_0_) - i_1_ > 8 << Class126.anInt1781))
					method2901();
				else {
					Tile class147 = Class106.tiles[i_4_][i][i_0_];
					if (class147 == null) {
						if (i_4_ == 0)
							class147 = Class106.tiles[0][i][i_0_] = new Tile(0, i, i_0_);
						boolean bool = (((Tile) (Class106.tiles[0][i][i_0_])).aClass147_2165 != null);
						if (i_4_ == 3 && bool) {
							method2901();
							return;
						}
						for (int i_5_ = 1; i_5_ <= i_4_; i_5_++) {
							if ((Class106.tiles[i_5_][i][i_0_]) == null) {
								class147 = Class106.tiles[i_5_][i][i_0_] = new Tile(i_5_, i, i_0_);
								if (bool)
					...
					if (((Tile) class147).aClass129_2173 == null) {
						((Tile) class147).aClass129_2173 = new Class129();
						((Tile) class147).aByte2154 = (byte) (int) (l & 0xffL);
					} else if (((Tile) class147).aByte2154 != (byte) (int) (l & 0xffL)) {
						((Class129) ((Tile) class147).aClass129_2173).aClass220_1802.method1424(124);
						((Class129) ((Tile) class147).aClass129_2173).aBool1812 = false;
						((Tile) class147).aByte2154 = (byte) (int) (l & 0xffL);
					}
					((Class129) ((Tile) class147).aClass129_2173).aClass220_1802.method1428(true, this);
				}
			} else
	...
	final void method2903(Class130_Sub6 class130_sub6, int i, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_,
			int i_11_, int i_12_, int i_13_, int i_14_, int i_15_, boolean bool, boolean bool_16_) {
		aClass130_Sub6_7103 = class130_sub6;
		((Class130_Sub1_Sub1) this).anInt7037 = i << VarpType.anInt1225;
		((Class130_Sub1_Sub1) this).anInt7048 = i_6_ << VarpType.anInt1225;
		((Class130_Sub1_Sub1) this).anInt7044 = i_7_ << VarpType.anInt1225;
	...
	private final void method2904() {
		...
		if ((((Class130_Sub2) ((Class130_Sub6) aClass130_Sub6_7103).aClass130_Sub2_4859).aClass130_Sub1_Sub1_Sub1Array3787[i]) != null)
			((Class130_Sub2) ((Class130_Sub6) aClass130_Sub6_7103).aClass130_Sub2_4859).aClass130_Sub1_Sub1_Sub1Array3787[i]
					.method2901();
	...
	final void method2905(long l, int i) {
		...
		if (aShort7104 <= 0)
			...
			int i_17_ = ((Class130_Sub1_Sub1) this).anInt7037 >> VarpType.anInt1225;
			int i_18_ = ((Class130_Sub1_Sub1) this).anInt7048 >> VarpType.anInt1225;
			int i_19_ = ((Class130_Sub1_Sub1) this).anInt7044 >> VarpType.anInt1225;
			Class130_Sub2 class130_sub2 = ((Class130_Sub6) aClass130_Sub6_7103).aClass130_Sub2_4859;
			Class104 class104 = ((Class130_Sub6) aClass130_Sub6_7103).aClass104_4856;
			if (((Class104) class104).anInt1392 != 0) {
				if (aShort7100 - aShort7104 <= ((Class104) class104).anInt1411) {
					int i_20_ = ((((Class130_Sub1_Sub1) this).anInt7043 >> 8 & 0xff00) + (anInt7096 >> 16 & 0xff)
							+ ((Class104) class104).anInt1421 * i);
					int i_21_ = ((((Class130_Sub1_Sub1) this).anInt7043 & 0xff00) + (anInt7096 >> 8 & 0xff)
							+ ((Class104) class104).f_gb * i);
					int i_22_ = ((((Class130_Sub1_Sub1) this).anInt7043 << 8 & 0xff00) + (anInt7096 & 0xff)
							+ ((Class104) class104).anInt1388 * i);
					if (i_20_ < 0)
						i_20_ = 0;
					else if (i_20_ > 65535)
						i_20_ = 65535;
					...
					((Class130_Sub1_Sub1) this).anInt7043 |= (((i_20_ & 0xff00) << 8) + (i_21_ & 0xff00)
							+ ((i_22_ & 0xff00) >> 8));
					anInt7096 &= ~0xffffff;
					anInt7096 |= (((i_20_ & 0xff) << 16) + ((i_21_ & 0xff) << 8) + (i_22_ & 0xff));
				}
				if (aShort7100 - aShort7104 <= ((Class104) class104).anInt1389) {
					int i_23_ = ((((Class130_Sub1_Sub1) this).anInt7043 >> 16 & 0xff00) + (anInt7096 >> 24 & 0xff)
							+ ((Class104) class104).f_qb * i);
					if (i_23_ < 0)
						i_23_ = 0;
					else if (i_23_ > 65535)
						i_23_ = 65535;
			...
			if (((Class104) class104).anIntArray1386 != null) {
				...
				for (Node class246_37_ = ((Node) class246).next; class246_37_ != class246; class246_37_ = ((Node) class246_37_).next) {
					Varc class246_sub1_sub11 = (Varc) class246_37_;
					Class4 class4 = (((Varc) class246_sub1_sub11).aClass4_6237);
					if (((Class4) class4).anInt36 != 1) {
						...
						if (bool_38_) {
							int i_40_ = i_17_ - ((Varc) class246_sub1_sub11).anInt6240;
							int i_41_ = i_18_ - ((Varc) class246_sub1_sub11).anInt6242;
							int i_42_ = i_19_ - ((Varc) class246_sub1_sub11).anInt6247;
							long l_43_ = (long) (i_40_ * i_40_ + i_41_ * i_41_ + i_42_ * i_42_);
							if (l_43_ <= ((Class4) class4).aLong35) {
								int i_44_ = (int) Math.sqrt((double) l_43_);
								if (i_44_ == 0)
									i_44_ = 1;
								long l_45_ = ((long) (i_40_ * (((Varc) class246_sub1_sub11).anInt6238)
										+ (i_41_ * ((Class4) class4).anInt40)
										+ (i_42_ * (((Varc) class246_sub1_sub11).anInt6241))) * 65535L
										/ (long) (((Class4) class4).anInt33 * i_44_));
								if (l_45_ >= (long) ((Class4) class4).anInt39) {
									...
									if (((Class4) class4).anInt38 == 0) {
										if (((Class4) class4).anInt42 == 0) {
											i_24_ += ((((Varc) class246_sub1_sub11).anInt6238) - i_46_) * i;
											i_25_ += (((Class4) class4).anInt40 - i_46_) * i;
											i_26_ += ((((Varc) class246_sub1_sub11).anInt6241) - i_46_) * i;
											bool = true;
										} else {
											((Class130_Sub1_Sub1) this).anInt7037 += ((((Varc) class246_sub1_sub11).anInt6238)
													- i_46_) * i;
											((Class130_Sub1_Sub1) this).anInt7048 += (((Class4) class4).anInt40 - i_46_)
													* i;
											((Class130_Sub1_Sub1) this).anInt7044 += ((((Varc) class246_sub1_sub11).anInt6241)
													- i_46_) * i;
										}
									} else {
			...
			if (((Class104) class104).anIntArray1378 != null) {
				for (int i_50_ = 0; i_50_ < ((Class104) class104).anIntArray1378.length; i_50_++) {
					Varc class246_sub1_sub11 = ((Varc) (Class90.aClass83_1170
							.method529((long) (((Class104) class104).anIntArray1378[i_50_]), -13373)));
					while (class246_sub1_sub11 != null) {
						Class4 class4 = (((Varc) class246_sub1_sub11).aClass4_6237);
						int i_51_ = i_17_ - ((Varc) class246_sub1_sub11).anInt6240;
						int i_52_ = i_18_ - ((Varc) class246_sub1_sub11).anInt6242;
						int i_53_ = i_19_ - ((Varc) class246_sub1_sub11).anInt6247;
						long l_54_ = (long) (i_51_ * i_51_ + i_52_ * i_52_ + i_53_ * i_53_);
						if (l_54_ > ((Class4) class4).aLong35)
							class246_sub1_sub11 = ((Varc) Class90.aClass83_1170.method528(true));
						else {
							int i_55_ = (int) Math.sqrt((double) l_54_);
							if (i_55_ == 0)
								i_55_ = 1;
							long l_56_ = ((long) (i_51_ * (((Varc) class246_sub1_sub11).anInt6238)
									+ i_52_ * ((Class4) class4).anInt40
									+ i_53_ * (((Varc) class246_sub1_sub11).anInt6241)) * 65535L
									/ (long) (((Class4) class4).anInt33 * i_55_));
							if (l_56_ < (long) ((Class4) class4).anInt39)
								...
								if (((Class4) class4).anInt38 == 0) {
									if (((Class4) class4).anInt42 == 0) {
										i_24_ += (((Varc) class246_sub1_sub11).anInt6238 - i_57_) * i;
										i_25_ += (((Class4) class4).anInt40 - i_57_) * i;
										i_26_ += (((Varc) class246_sub1_sub11).anInt6241 - i_57_) * i;
										bool = true;
									} else {
										((Class130_Sub1_Sub1) this).anInt7037 += (((Varc) class246_sub1_sub11).anInt6238
												- i_57_) * i;
										((Class130_Sub1_Sub1) this).anInt7048 += (((Class4) class4).anInt40 - i_57_)
												* i;
										((Class130_Sub1_Sub1) this).anInt7044 += (((Varc) class246_sub1_sub11).anInt6241
												- i_57_) * i;
									}
			...
			if (((Class104) class104).anIntArray1399 != null) {
				if (((Class104) class104).anIntArray1423 == null) {
					...
					for (int i_61_ = 0; i_61_ < ((Class104) class104).anIntArray1399.length; i_61_++) {
						...
						((Class104) class104).anIntArray1423[i_61_] = ((SwitchInt) (SwitchInt) (Class246_Sub2.aClass85_3813
								.get((long) (((Class104) class104).anIntArray1399[i_61_])))).value;
					}
				}
			...
			if (bool) {
				while (i_24_ > 32767 || i_25_ > 32767 || i_26_ > 32767 || i_24_ < -32767 || i_25_ < -32767
						|| i_26_ < -32767) {
					i_24_ >>= 1;
					i_25_ >>= 1;
					i_26_ >>= 1;
	...
	Class130_Sub1_Sub1_Sub1(Class130_Sub6 class130_sub6, int i, int i_63_, int i_64_, int i_65_, int i_66_, int i_67_,
			int i_68_, int i_69_, int i_70_, int i_71_, int i_72_, boolean bool, boolean bool_73_) {
		aClass130_Sub6_7103 = class130_sub6;
		((Class130_Sub1_Sub1) this).anInt7037 = i << VarpType.anInt1225;
		((Class130_Sub1_Sub1) this).anInt7048 = i_63_ << VarpType.anInt1225;
		((Class130_Sub1_Sub1) this).anInt7044 = i_64_ << VarpType.anInt1225;
