...
final class Class_c_Sub2 extends Class_c {
	...
	final void N(int i) {
		...
		((Class_c_Sub2) this).anInt5586 = ((Class_c_Sub2) this).anInt5585 = MathUtils.COSINE[i & 0x3fff];
		((Class_c_Sub2) this).anInt5590 = MathUtils.SINE[i & 0x3fff];
	...
	final void O(int i) {
		...
		((Class_c_Sub2) this).anInt5594 = ((Class_c_Sub2) this).anInt5586 = MathUtils.COSINE[i & 0x3fff];
		((Class_c_Sub2) this).anInt5591 = MathUtils.SINE[i & 0x3fff];
	...
	final void ka(int i) {
		int i_0_ = MathUtils.COSINE[i & 0x3fff];
		int i_1_ = MathUtils.SINE[i & 0x3fff];
	...
	final void ja(int i) {
		int i_9_ = MathUtils.COSINE[i & 0x3fff];
		int i_10_ = MathUtils.SINE[i & 0x3fff];
	...
	final void ra(int i) {
		...
		((Class_c_Sub2) this).anInt5594 = ((Class_c_Sub2) this).anInt5585 = MathUtils.COSINE[i & 0x3fff];
		((Class_c_Sub2) this).anInt5592 = MathUtils.SINE[i & 0x3fff];
	...
	final void s(int i, int i_21_, int i_22_, int i_23_, int i_24_, int i_25_) {
		int i_26_ = MathUtils.COSINE[i_23_ & 0x3fff];
		int i_27_ = MathUtils.SINE[i_23_ & 0x3fff];
		int i_28_ = MathUtils.COSINE[i_24_ & 0x3fff];
		int i_29_ = MathUtils.SINE[i_24_ & 0x3fff];
		int i_30_ = MathUtils.COSINE[i_25_ & 0x3fff];
		int i_31_ = MathUtils.SINE[i_25_ & 0x3fff];
