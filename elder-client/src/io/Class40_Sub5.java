...
final class Class40_Sub5 extends Class40 {
			...
			try {
				...
				try {
					if ((Class12.anInt182 ^ 0xffffffff) == -2) {
						int i_0_ = Sprite.aClass246_Sub37_Sub1_433.method2512(0);
						if ((i_0_ ^ 0xffffffff) < -1 && Sprite.aClass246_Sub37_Sub1_433.method2509((byte) -125)) {
							i_0_ -= Class22.anInt327;
							if (i_0_ < 0)
								i_0_ = 0;
							Sprite.aClass246_Sub37_Sub1_433.method2503(true, i_0_);
							break;
						}
						Sprite.aClass246_Sub37_Sub1_433.method2515(2);
						Sprite.aClass246_Sub37_Sub1_433.method2516((byte) -113);
	...
	static final Class104 method2128(int i, int i_6_) {
		try {
			...
			if (class104 != null)
				return class104;
			byte[] is = Class78.aClass_fs1019.get_file(i_6_, 0);
			if (i <= 42)
				anInt4913 = 50;
			class104 = new Class104();
			if (is != null)
				class104.method666(new Buffer(is), 28201);
	...
	static {
		new MultilingualString("For that rule you can only report players who have spoken or traded recently.", "Mit dieser Option k\u00f6nnen nur Spieler gemeldet werden,", "Cette r\u00e8gle n'est invocable que pour les discussions ou \u00e9changes r\u00e9cents.", "Para essa regra, voc\u00ea s\u00f3 pode denunciar jogadores com quem tenha falado ou negociado recentemente.");
		new MultilingualString("You already sent an abuse report under 60 secs ago! Do not abuse this system!", "Du hast bereits vor weniger als 60 Sekunden einen Regelversto\u00df gemeldet!", "Vous avez d\u00e9j\u00e0 signal\u00e9 un abus il y a moins d'une minute ! N'abusez pas du syst\u00e8me !", "Voc\u00ea j\u00e1 enviou uma den\u00fancia de abuso h\u00e1 menos de um minuto. N\u00e3o abuse deste sistema!");
	}
}
