...
final class Class59_Sub2_Sub1 extends Class59_Sub2 implements Class_f {
			...
			try {
				...
				if (bool == true) {
					if (class246_sub1_sub4 == null)
						break;
					Class246_Sub12.method1980(class246_sub1_sub4, aByte5780, ((Class59_Sub2) this).anInt4563,
							((Class59_Sub2) this).anInt4542, null);
				}
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception,
						("bh.W(" + bool + ',' + (class260 != null ? "{...}" : "null") + ')'));
			}
			break;
		} while (false);
	}

	private final Class133 method2449(int i, boolean bool, int i_0_, SceneGraph class260) {
		try {
			anInt5776++;
			if (i_0_ != 1590)
				return null;
			LocType class185 = Class143.aClass251_2067.list(f_db & 0xffff, 0);
			Class210 class210;
			...
			return class185.method1210(class260, ((Class59_Sub2) this).anInt4563, 3, i, ((Class59_Sub2) this).anInt4552,
					bool, aByte5774, class210, ((Class59_Sub2) this).anInt4542, aByte5775, class210_1_);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("bh.R(" + i + ',' + bool + ',' + i_0_ + ',' + (class260 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	final void method403(SceneGraph class260, int i) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					"bh.B(" + (class260 != null ? "{...}" : "null") + ',' + i + ')');
		}
	}

	public final AbstractModel method23(SceneGraph class260, int i, int i_2_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("bh.D(" + (class260 != null ? "{...}" : "null") + ',' + i + ',' + i_2_ + ')'));
		}
	}
	...
	static final int method2450(int i, String string) {
		try {
			...
			if (string == null)
				return -1;
			for (int i_5_ = 0; (Client.anInt3969 ^ 0xffffffff) < (i_5_ ^ 0xffffffff); i_5_++) {
				if (string.equalsIgnoreCase(Model.f_gb[i_5_]))
					return i_5_;
			}
			return -1;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("bh.C(" + i + ',' + (string != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public final void method19(SceneGraph class260, int i) {
		do {
			try {
				...
				if (class246_sub1_sub4 == null)
					break;
				Class29.method230(class246_sub1_sub4, aByte5780, ((Class59_Sub2) this).anInt4563,
						((Class59_Sub2) this).anInt4542, null);
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception,
						("bh.U(" + (class260 != null ? "{...}" : "null") + ',' + i + ')'));
			}
			break;
		} while (false);
	}
	...
	Class59_Sub2_Sub1(SceneGraph class260, LocType class185, int i, int i_6_, int i_7_, int i_8_, boolean bool,
		...
		do {
			try {
				...
				f_db = (short) ((LocType) class185).id;
				((Class59_Sub2) this).anInt4542 = i_8_;
				aBool5782 = bool;
				((Class59_Sub2) this).anInt4563 = i_6_;
				aByte5775 = (byte) i_12_;
				aBool5772 = ((LocType) class185).wall_or_door != 0 && !bool;
				aByte5780 = (byte) i;
				aBool5769 = (class260.method1683() && ((LocType) class185).aBool2583 && !aBool5782
				...
				throw Class193.method1272(runtimeexception, ("bh.<init>(" + (class260 != null ? "{...}" : "null") + ','
						+ (class185 != null ? "{...}" : "null") + ',' + i + ',' + i_6_ + ',' + i_7_ + ',' + i_8_ + ','
						+ bool + ',' + i_9_ + ',' + i_10_ + ',' + i_11_ + ',' + i_12_ + ',' + i_13_ + ')'));
			}
			break;
		} while (false);
	}
	...
	final boolean method409(int i, int i_14_, SceneGraph class260, int i_15_) {
		try {
			...
			if (i_14_ != 0)
				return true;
			AbstractModel class_t = method2451(131072, class260, (byte) -125);
			if (class_t != null) {
				Class_c class_c = class260.method1730();
				class_c.j(((Class59_Sub2) this).anInt4563, ((Class59_Sub2) this).anInt4552,
						((Class59_Sub2) this).anInt4542);
				return class_t.method685(i_15_, i, class_c, false);
			}
			return false;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("bh.A(" + i + ',' + i_14_ + ',' + (class260 != null ? "{...}" : "null") + ',' + i_15_ + ')'));
		}
	}
	...
	private final AbstractModel method2451(int i, SceneGraph class260, byte i_16_) {
		try {
			anInt5781++;
			...
			throw Class193.method1272(runtimeexception,
					("bh.S(" + i + ',' + (class260 != null ? "{...}" : "null") + ',' + i_16_ + ')'));
		}
	}
	...
	final Class130_Sub3 method407(SceneGraph class260, int i) {
		try {
			...
			class_c.j((((Class59_Sub2) this).anInt4563 + ((Class59_Sub2) this).anInt4540),
					...
					(((Class59_Sub2) this).anInt4541 + ((Class59_Sub2) this).anInt4542));
			Class130_Sub3 class130_sub3 = null;
			if (aBool5772)
				class130_sub3 = Class18.method177(1, (byte) -95);
			f_eb.method680(class_c,
					(class130_sub3 != null ? (((Class130_Sub3) class130_sub3).aClass130_Sub5Array4415[0]) : null), 0);
			return class130_sub3;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					"bh.H(" + (class260 != null ? "{...}" : "null") + ',' + i + ')');
		}
	}
}
