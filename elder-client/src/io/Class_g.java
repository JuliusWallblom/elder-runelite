...
final class Class_g extends Class59_Sub3 {
	...
	private SequenceType aClass124_6507;
	...
	final Class130_Sub3 method407(SceneGraph class260, int i) {
		try {
			anInt6487++;
			AbstractModel class_t = method2685(2048, class260, -126);
			if (class_t == null)
				return null;
	...
	final void method403(SceneGraph class260, int i) {
		try {
			anInt6484++;
			AbstractModel class_t = method2685(0, class260, -127);
			if (class_t != null) {
				Class_c class_c = class260.method1730();
				class_c.N(anInt6491);
				if (i <= 53)
	...
	private final void method2684(int i, AbstractModel class_t, SceneGraph class260) {
		do {
			try {
				anInt6496++;
				if (i != 0)
				...
				if ((aClass130_Sub2_6488 == null || ((Class130_Sub2) aClass130_Sub2_6488).aBool3789)
						&& (class19s != null || class162s != null))
					aClass130_Sub2_6488 = new Class130_Sub2(Client.cycle);
				if (aClass130_Sub2_6488 == null)
					break;
				aClass130_Sub2_6488.method1777(class260, (long) (Client.cycle), class19s, class162s, false);
				aClass130_Sub2_6488.method1782(((Class59_Sub3) this).current_plane, ((Class59_Sub3) this).aShort5057,
						((Class59_Sub3) this).aShort5065, ((Class59_Sub3) this).aShort5064,
						((Class59_Sub3) this).aShort5062);
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception, ("g.V(" + i + ',' + (class_t != null ? "{...}" : "null")
						+ ',' + (class260 != null ? "{...}" : "null") + ')'));
			}
			break;
		} while (false);
	...
	private final AbstractModel method2685(int i, SceneGraph class260, int i_0_) {
		try {
			anInt6504++;
			if (i_0_ > -125)
				method401(-41);
			SpotAnimType class144 = Class195.aClass177_2745.list(-137, anInt6508, gfx_rev, 1);
			return class144.method965(anInt6485, f_eb, Class59_Sub3_Sub3.aClass45_6275, (byte) -117, anInt6490, i,
					class260);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("g.R(" + i + ',' + (class260 != null ? "{...}" : "null") + ',' + i_0_ + ')'));
		}
	}

	final boolean method409(int i, int i_1_, SceneGraph class260, int i_2_) {
		try {
			f_lb++;
			if (i_1_ != 0)
			...
			throw Class193.method1272(runtimeexception,
					("g.A(" + i + ',' + i_1_ + ',' + (class260 != null ? "{...}" : "null") + ',' + i_2_ + ')'));
		}
	}

	final void method405(int i, int i_3_, Class59 class59, byte i_4_, boolean bool, SceneGraph class260, int i_5_) {
		try {
			f_kb++;
			if (i_4_ != -99)
				aBool6497 = true;
			...
			throw Class193.method1272(runtimeexception,
					("g.L(" + i + ',' + i_3_ + ',' + (class59 != null ? "{...}" : "null") + ',' + i_4_ + ',' + bool
							+ ',' + (class260 != null ? "{...}" : "null") + ',' + i_5_ + ')'));
		}
	}
	...
	final void method2686(int i, int i_6_, int i_7_, int i_8_, int i_9_) {
		try {
			...
			do {
				if (!aBool6489) {
					double d = (double) (-((Class59_Sub3) this).x + i_6_);
					double d_10_ = (double) (-((Class59_Sub3) this).y + i_8_);
					double d_11_ = Math.sqrt(d * d + d_10_ * d_10_);
					aDouble6510 = (d_10_ * (double) f_ab / d_11_ + (double) ((Class59_Sub3) this).y);
					aDouble6483 = (d * (double) f_ab / d_11_ + (double) ((Class59_Sub3) this).x);
					if (!aBool6497) {
						aDouble6495 = (double) ((Class59_Sub3) this).anInt5052;
						if (!Client.f_ob)
							break;
					}
					aDouble6495 = (double) (Class6.getAverageHeight((int) aDouble6483, -43,
							(((Class59_Sub3) this).current_plane), (int) aDouble6510) - f_mb);
				}
			} while (false);
	...
	final void method2687(byte i, int i_13_) {
		do {
			try {
				...
				if (aBool6497)
					aDouble6495 = (double) (Class6.getAverageHeight((int) aDouble6483, -106,
							(((Class59_Sub3) this).current_plane), (int) aDouble6510) + -f_mb);
				...
				if (aClass124_6507 == null)
					break;
				f_eb += i_13_;
				while ((((SequenceType) aClass124_6507).frameLenghts[anInt6485] ^ 0xffffffff) > (f_eb ^ 0xffffffff)) {
					f_eb -= (((SequenceType) aClass124_6507).frameLenghts[anInt6485]);
					anInt6485++;
					if ((anInt6485 ^ 0xffffffff) <= (((SequenceType) aClass124_6507).frameIDs.length ^ 0xffffffff)) {
						anInt6485 -= ((SequenceType) aClass124_6507).frameStep;
						if ((anInt6485 ^ 0xffffffff) > -1 || ((((SequenceType) aClass124_6507).frameIDs).length
								^ 0xffffffff) >= (anInt6485 ^ 0xffffffff))
							anInt6485 = 0;
					}
					anInt6490 = 1 + anInt6485;
					if (anInt6490 >= ((SequenceType) aClass124_6507).frameIDs.length) {
						anInt6490 -= ((SequenceType) aClass124_6507).frameStep;
						if (anInt6490 < 0 || anInt6490 >= (((SequenceType) aClass124_6507).frameIDs).length)
							anInt6490 = -1;
					}
				}
			} catch (RuntimeException runtimeexception) {
	...
	Class_g(int i, int i_15_, int i_16_, int i_17_, int i_18_, int i_19_, int i_20_, int i_21_, int i_22_, int i_23_,
			int i_24_, boolean bool, int revision) {
		super(i_15_, i_16_, Class6.getAverageHeight(i_16_, -103, i_15_, i_17_) + -i_18_, i_17_, i_16_ >> 7, i_16_ >> 7,
				i_17_ >> 7, i_17_ >> 7, false, (byte) 0);
		anInt6485 = 0;
		f_gb = -32768;
		f_eb = 0;
		try {
			...
			int i_25_ = (((SpotAnimType) Class195.aClass177_2745.list(-137, anInt6508, gfx_rev, 0)).animationId);
			if (i_25_ != -1)
				aClass124_6507 = Class59_Sub3_Sub3.aClass45_6275.list(3, i_25_,
						gfx_rev < 200 ? Revision.OSRS : gfx_rev == 550 ? Revision.PRE_EOC_550 : Revision.PRE_EOC_634);
			else
				aClass124_6507 = null;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("g.<init>(" + i + ',' + i_15_ + ',' + i_16_ + ',' + i_17_ + ',' + i_18_ + ',' + i_19_ + ',' + i_20_
							+ ',' + i_21_ + ',' + i_22_ + ',' + i_23_ + ',' + i_24_ + ',' + bool + ')'));
		}
	}
