...
public final class Class133 {
	...
	AbstractModel aClass_t1837;
	static int anInt1838;
	static int anInt1839;
	static int anInt1840;
	static MultilingualString aClass67_1841 = new MultilingualString("Starting 3d Library", "Starte 3D-Softwarebibliothek.", "D\u00e9marrage de la librairie 3D", "Iniciando biblioteca 3D");
	static int anInt1842 = 20;
	static MultilingualString aClass67_1843 = new MultilingualString("wave:", "welle:", "ondulation:", "onda:");
	...
	static final void method894(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_) {
		try {
			...
			RenderAnimation.method918(-i_1_ + i_5_, 124, i_2_, -i_10_ + i_5_, is);
			RenderAnimation.method918(-i_10_ + i_5_, 118, i_6_, i_5_ - -i_10_, is);
			RenderAnimation.method918(i_5_ + i_10_, -93, i_2_, i_5_ - -i_1_, is);
			while (i_8_ > 0) {
				...
				int i_41_ = i_5_ - i_7_;
				if (!bool) {
					RenderAnimation.method918(i_41_, -24, i_2_, i_40_, (Class246_Sub28_Sub6.anIntArrayArray6042[i_38_]));
					RenderAnimation.method918(i_41_, 127, i_2_, i_40_, (Class246_Sub28_Sub6.anIntArrayArray6042[i_39_]));
				} else {
					int i_42_ = i_5_ + i_9_;
					int i_43_ = -i_9_ + i_5_;
					RenderAnimation.method918(i_41_, -99, i_2_, i_43_, (Class246_Sub28_Sub6.anIntArrayArray6042[i_38_]));
					RenderAnimation.method918(i_43_, 126, i_6_, i_42_, (Class246_Sub28_Sub6.anIntArrayArray6042[i_38_]));
					RenderAnimation.method918(i_42_, 126, i_2_, i_40_, (Class246_Sub28_Sub6.anIntArrayArray6042[i_38_]));
					RenderAnimation.method918(i_41_, -107, i_2_, i_43_, (Class246_Sub28_Sub6.anIntArrayArray6042[i_39_]));
					RenderAnimation.method918(i_43_, -127, i_6_, i_42_, (Class246_Sub28_Sub6.anIntArrayArray6042[i_39_]));
					RenderAnimation.method918(i_42_, -13, i_2_, i_40_, (Class246_Sub28_Sub6.anIntArrayArray6042[i_39_]));
				}
			}
	...
	static final void method897(byte i, String string, boolean bool) {
		try {
			...
			int i_44_ = 0;
			for (int i_45_ = 0; ((i_45_ ^ 0xffffffff) > (((Class191) MapRegion.aClass191_3663).anInt2690 ^ 0xffffffff)); i_45_++) {
				ObjType class197 = MapRegion.aClass191_3663.list(i + 22778, i_45_);
				if ((!bool || ((ObjType) class197).isTradeable) && (((ObjType) class197).certTemplate ^ 0xffffffff) == 0 && ((ObjType) class197).boughtTemplateId == -1 && ((ObjType) class197).anInt2801 == 0 && (((ObjType) class197).name.toLowerCase().indexOf(string) ^ 0xffffffff) != 0) {
			...
			for (int i_48_ = 0; ((i_48_ ^ 0xffffffff) > (Class246_Sub38.anInt5445 ^ 0xffffffff)); i_48_++)
				strings[i_48_] = (((ObjType) MapRegion.aClass191_3663.list(i + 22778, is[i_48_])).name);
