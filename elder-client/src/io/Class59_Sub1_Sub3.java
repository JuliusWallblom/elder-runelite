...
final class Class59_Sub1_Sub3 extends Class59_Sub1 implements Class_f {
	...
	private AbstractModel aClass_t6355;
	...
	private final AbstractModel method2641(SceneGraph class260, boolean bool, int i) {
		try {
			anInt6333++;
			...
			throw Class193.method1272(runtimeexception,
					("jp.R(" + (class260 != null ? "{...}" : "null") + ',' + bool + ',' + i + ')'));
		}
	}
	...
	static final boolean method2642(Class205 class205, byte i) {
		try {
			...
			if (i >= -26)
				return true;
			if (Client.f_fb != class205 && class205 != Class130_Sub4.aClass205_4740
					&& class205 != Material.aClass205_3351 && class205 != SequenceType.aClass205_1735)
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					"jp.T(" + (class205 != null ? "{...}" : "null") + ',' + i + ')');
		}
	}
	...
	private final Class133 method2643(int i, boolean bool, int i_1_, SceneGraph class260) {
		try {
			anInt6342++;
			if (i_1_ != -1)
				aBool6336 = true;
			LocType class185 = Class143.aClass251_2067.list(0xffff & aShort6348, 0);
			Class210 class210;
			...
			return class185.method1210(class260, ((Class59_Sub1) this).anInt4515, 3, i, ((Class59_Sub1) this).anInt4518,
					bool, aByte6344, class210, ((Class59_Sub1) this).anInt4517, 22, class210_2_);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("jp.S(" + i + ',' + bool + ',' + i_1_ + ',' + (class260 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	final void method405(int i, int i_3_, Class59 class59, byte i_4_, boolean bool, SceneGraph class260, int i_5_) {
		do {
			try {
				...
				throw Class193.method1272(runtimeexception,
						("jp.L(" + i + ',' + i_3_ + ',' + (class59 != null ? "{...}" : "null") + ',' + i_4_ + ',' + bool
	...
	public final AbstractModel method23(SceneGraph class260, int i, int i_7_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("jp.D(" + (class260 != null ? "{...}" : "null") + ',' + i + ',' + i_7_ + ')'));
		}
	}
		...
		do {
			try {
				...
				if (class246_sub1_sub4 == null)
					break;
				Class29.method230(class246_sub1_sub4, aByte6335, ((Class59_Sub1) this).anInt4515,
						((Class59_Sub1) this).anInt4517, null);
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception,
						("jp.U(" + (class260 != null ? "{...}" : "null") + ',' + i + ')'));
			}
			break;
		} while (false);
	}
	...
	Class59_Sub1_Sub3(SceneGraph class260, LocType class185, int i, int i_9_, int i_10_, int i_11_, boolean bool,
			int i_12_, boolean bool_13_) {
		super(i_9_, i_10_, i_11_, ((LocType) class185).aBool2584, ((LocType) class185).aBool2601);
		do {
			try {
				aBool6336 = bool_13_;
				aShort6348 = (short) ((LocType) class185).id;
				aByte6344 = (byte) i_12_;
				aBool6339 = ((LocType) class185).wall_or_door != 0 && !bool;
				aByte6335 = (byte) i;
				aBool6350 = bool;
				((Class59_Sub1) this).anInt4515 = i_9_;
				((Class59_Sub1) this).anInt4517 = i_11_;
				aBool6346 = (class260.method1683() && ((LocType) class185).aBool2583 && !aBool6350
				...
				throw Class193.method1272(runtimeexception,
						("jp.<init>(" + (class260 != null ? "{...}" : "null") + ','
								+ (class185 != null ? "{...}" : "null") + ',' + i + ',' + i_9_ + ',' + i_10_ + ','
								+ i_11_ + ',' + bool + ',' + i_12_ + ',' + bool_13_ + ')'));
			}
			break;
		} while (false);
	}
	...
	final boolean method409(int i, int i_16_, SceneGraph class260, int i_17_) {
		try {
			...
			if (i_16_ != 0)
				method22(-27);
			AbstractModel class_t = method2641(class260, true, 131072);
			if (class_t != null) {
			...
			throw Class193.method1272(runtimeexception,
					("jp.A(" + i + ',' + i_16_ + ',' + (class260 != null ? "{...}" : "null") + ',' + i_17_ + ')'));
		}
	}
	...
	public final void method20(boolean bool, SceneGraph class260) {
		do {
			try {
				...
				if (class246_sub1_sub4 != null)
					Class246_Sub12.method1980(class246_sub1_sub4, aByte6335, ((Class59_Sub1) this).anInt4515,
							((Class59_Sub1) this).anInt4517, null);
				if (bool == true)
					break;
				aBool6350 = true;
	...
	static {
		new MultilingualString(null, "geschickt werden.", null, null);
	}
}
