...
final class Class123_Sub1 extends Class123 {
	...
	final void method831(int i) throws LineUnavailableException {
		try {
			try {
				DataLine.Info info = (new DataLine.Info((aClass3999 == null ? (aClass3999 = (Client.getClassByName("javax.sound.sampled.SourceDataLine"))) : aClass3999), anAudioFormat3996, i << (Class240.aBool3387 ? 2 : 1)));
	...
	final void method832(Component component) {
		try {
			...
			anAudioFormat3996 = new AudioFormat((float) MapFunction.anInt2024, 16, !Class240.aBool3387 ? 1 : 2, true, false);
	...
	final void method838() throws LineUnavailableException {
		try {
			...
			if (aBool3994) {
				...
				aSourceDataLine3995 = null;
				DataLine.Info info = (new DataLine.Info((aClass3999 == null ? (aClass3999 = (Client.getClassByName("javax.sound.sampled.SourceDataLine"))) : aClass3999), anAudioFormat3996, anInt3998 << (!Class240.aBool3387 ? 1 : 2)));
				aSourceDataLine3995 = (SourceDataLine) AudioSystem.getLine(info);
				aSourceDataLine3995.open();
				aSourceDataLine3995.start();
			}
