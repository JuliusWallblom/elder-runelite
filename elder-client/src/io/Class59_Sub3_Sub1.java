...
final class Class59_Sub3_Sub1 extends Class59_Sub3 implements Class_f {
	...
	static MultilingualString aClass67_5728;
	...
	static boolean[] varcs_loaded_634, varcs_loaded_550, varcs_loaded_osrs;
		...
		do {
			try {
				...
				throw Class193.method1272(runtimeexception,
						("av.U(" + (class260 != null ? "{...}" : "null") + ',' + i + ')'));
			}
			break;
		} while (false);
	}

	final boolean method409(int i, int i_0_, SceneGraph class260, int i_1_) {
		try {
			anInt5723++;
			if (i_0_ != 0)
				method18((byte) 91);
			...
			throw Class193.method1272(runtimeexception,
					("av.A(" + i + ',' + i_0_ + ',' + (class260 != null ? "{...}" : "null") + ',' + i_1_ + ')'));
		}
	}
	...
	final void method405(int i, int i_2_, Class59 class59, byte i_3_, boolean bool, SceneGraph class260, int i_4_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("av.L(" + i + ',' + i_2_ + ',' + (class59 != null ? "{...}" : "null") + ',' + i_3_ + ',' + bool
	...
	static final void method2440(int i, int i_22_, SceneGraph class260, int map_function, Widget class235, int i_24_,
			Class128 class128, int i_25_, int i_26_) {
		do {
			try {
				anInt5742++;
				MapFunction class140 = Client.map_functions.method1088(map_function, (byte) -41);
				if (i_22_ == -14698) {
					if (class140 == null || !((MapFunction) class140).aBool2028
							|| !class140.method942(-11247, (Varbit.aClass95_6658)))
						break;
					if (((MapFunction) class140).anIntArray2027 != null) {
						...
						for (int i_27_ = 0; is.length / 2 > i_27_; i_27_++) {
							...
							if (Class130_Sub3.anInt4417 == 4)
								i_28_ = 0x3fff & (int) Camera.camera_yaw;
							else
								i_28_ = ((int) Camera.camera_yaw - -Class95.anInt1253) & 0x3fff;
							int i_29_ = MathUtils.SINE[i_28_];
							int i_30_ = MathUtils.COSINE[i_28_];
							...
							is[i_27_ * 2] = (((Widget) class235).screen_width / 2 + i_25_
									+ ((((i + 4 * (((MapFunction) class140).anIntArray2027[i_27_ * 2])) * i_30_)
											+ i_29_ * (4 * (((MapFunction) class140).anIntArray2027[i_27_ * 2 + 1])
													+ i_24_)) >> 15));
							is[2 * i_27_ + 1] = (i_26_ - (-(((Widget) class235).screen_height / 2)
									+ (((i_24_ - -(4 * (((MapFunction) class140).anIntArray2027[i_27_ * 2 + 1])))
											* i_30_
											- (i + 4 * (((MapFunction) class140).anIntArray2027[2 * i_27_]))
													* i_29_) >> 15)));
						}
						Class77.method487(class260, is, ((MapFunction) class140).anInt2023, ((Widget) class235).f_ld,
								((Widget) class235).f_hc);
						for (int i_31_ = 0; is.length / 2 - 1 > i_31_; i_31_++)
							class260.method1728(is[i_31_ * 2], is[2 * i_31_ + 1], is[2 * i_31_ + 2],
									is[(1 + i_31_) * 2 + 1], (((MapFunction) class140).anInt2000), 1, class128, i_25_,
									i_26_);
						class260.method1728(is[-2 + is.length], is[-1 + is.length], is[0], is[1],
								((MapFunction) class140).anInt2000, 1, class128, i_25_, i_26_);
					}
					...
					if ((((MapFunction) class140).anInt2026 ^ 0xffffffff) != 0) {
						...
						if (class_l != null) {
							NpcType.method1635(i_25_, true, class_l, class235, class128, i_24_, i, i_26_);
						}
					}
					...
					if (class_l != null)
						i_32_ = class_l.ma();
					Font class116 = FontCache.small_font;
					FontMetric class73 = Class217.aClass73_3022;
					if (((MapFunction) class140).anInt1994 == 1) {
						class116 = FontCache.regular_font;
						class73 = Class246_Sub5.aClass73_3892;
					}
					if ((((MapFunction) class140).anInt1994 ^ 0xffffffff) == -3) {
						class116 = FontCache.bold_font;
						class73 = CacheIndex.aClass73_148;
					}
					Class148.method1002(i_25_, ((MapFunction) class140).aString1998, 3, i, i_32_, class116, i_26_,
							class235, i_24_, ((MapFunction) class140).anInt2022, class73, class128);
				}
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception,
						("av.T(" + i + ',' + i_22_ + ',' + (class260 != null ? "{...}" : "null") + ',' + map_function
								+ ',' + (class235 != null ? "{...}" : "null") + ',' + i_24_ + ','
								+ (class128 != null ? "{...}" : "null") + ',' + i_25_ + ',' + i_26_ + ')'));
			}
			break;
		} while (false);
	}
	...
	public static void method2441(int i) {
		try {
			...
			if (i != 0)
				method2442(31, 20);
			aClass116_5747 = null;
			varcs_loaded_634 = null;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, "av.AA(" + i + ')');
		}
	}

	Class59_Sub3_Sub1(int i, int i_33_, int i_34_, int i_35_, int i_36_, int i_37_, int i_38_, int i_39_, int i_40_,
			int i_41_, Class59_Sub3 class59_sub3) {
		super(i_34_, i_35_, i_36_, i_37_, i_38_, i_39_, i_40_, i_41_, false,
				Class246_Sub1_Sub6.method2532((byte) 120, i_33_, i));
		try {
			((Class59_Sub3_Sub1) this).aClass59_Sub3_5732 = class59_sub3;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("av.<init>(" + i + ',' + i_33_ + ',' + i_34_ + ',' + i_35_ + ',' + i_36_ + ',' + i_37_ + ','
							+ i_38_ + ',' + i_39_ + ',' + i_40_ + ',' + i_41_ + ','
							+ (class59_sub3 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public final AbstractModel method23(SceneGraph class260, int i, int i_43_) {
		try {
			anInt5741++;
			...
			throw Class193.method1272(runtimeexception,
					("av.D(" + (class260 != null ? "{...}" : "null") + ',' + i + ',' + i_43_ + ')'));
		}
	}
		...
		try {
			...
			if (Client.f_fb != Class260_Sub2.aClass205_4297) {
				if (Class130_Sub4.aClass205_4740 == Class260_Sub2.aClass205_4297)
					string = "www-wtqa";
				else if (Class260_Sub2.aClass205_4297 == Material.aClass205_3351)
					string = "www-wtwip";
			} else
				string = "www-wtrc";
			String string_51_ = "";
			...
			return ("http://" + string + "" + ((Class101) Class59_Sub4_Sub3.aClass101_6943).aString1315 + ".com/l="
					+ Preferences.language_code + "/a=" + Class109_Sub4.anInt4573 + string_51_ + "/");
		} catch (RuntimeException runtimeexception) {
	...
	static {
		aClass67_5728 = new MultilingualString("Loading config - ", "Lade Konfiguration - ",
