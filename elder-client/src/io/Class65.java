...
final class Class65 {
	...
	int anInt865;
	static int anInt866;
	private CacheIndex aClass_fs867;
	private CacheIndex aClass_fs868;
	int anInt869 = 0;
		...
		try {
			...
			do {
				if ((i ^ 0xffffffff) <= -32769) {
					is = aClass_fs868.get_file(0x7fff & i, 1);
					if (!Client.f_ob)
						break;
				}
				is = aClass_fs867.get_file(i, 1);
			} while (false);
			class246_sub1_sub3 = new Class246_Sub1_Sub3();
			((Class246_Sub1_Sub3) class246_sub1_sub3).aClass65_5711 = this;
			if (is != null)
				class246_sub1_sub3.method2434(new Buffer(is), 9536);
			if (i >= 32768)
	...
	Class65(int i, CacheIndex class_fs, CacheIndex class_fs_2_, Interface7 interface7) {
		...
		do {
			try {
				...
				if (aClass_fs867 != null)
					((Class65) this).anInt865 = aClass_fs867.child_count(1);
				if (aClass_fs868 == null)
					break;
				((Class65) this).anInt869 = aClass_fs868.child_count(1);
			} catch (RuntimeException runtimeexception) {
