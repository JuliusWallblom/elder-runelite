...
abstract class Class154 {
			...
			if ((Class228.anInt3137 ^ 0xffffffff) != -1) {
				try {
					...
					if ((Class228.anInt3137 ^ 0xffffffff) == -2) {
						Class17.aClass182_242 = Client.sign_link.method364(i ^ ~0x4, (Class6.aString68),
								(Class172.anInt2432));
					...
					if (Class228.anInt3137 == 3) {
						if ((Class65.aClass6_864.method67(3) ^ 0xffffffff) <= -3) {
							int i_1_ = (Class65.aClass6_864.method73(i ^ ~0x5d) << 8
									| Class65.aClass6_864.method73(125));
							Class88.method559(false, i_1_);
							if (Client.world_id == -1) {
								Class228.anInt3137 = 0;
	...
	static final Entity method1020(int i, int i_4_, byte i_5_, int i_6_) {
		try {
			anInt2213++;
			Tile class147 = Class106.tiles[i_6_][i_4_][i];
			if (class147 == null)
				return null;
			Entity class_r = null;
			if (i_5_ < 74)
			...
			for (Class3 class3 = ((Tile) class147).aClass3_2160; class3 != null; class3 = ((Class3) class3).aClass3_28) {
				...
				if (class59_sub3 instanceof Entity) {
					Entity class_r_8_ = (Entity) class59_sub3;
					int i_9_ = (-1 + class_r_8_.method2670((byte) 127)) * 64 + 60;
					int i_10_ = ((Class59_Sub3) class_r_8_).x - i_9_ >> 7;
					int i_11_ = ((Class59_Sub3) class_r_8_).y + -i_9_ >> 7;
					int i_12_ = i_9_ + ((Class59_Sub3) class_r_8_).x >> 7;
					int i_13_ = ((Class59_Sub3) class_r_8_).y + i_9_ >> 7;
					if (i_10_ <= i_4_ && (i_11_ ^ 0xffffffff) >= (i ^ 0xffffffff) && i_4_ <= i_12_
							&& (i ^ 0xffffffff) >= (i_13_ ^ 0xffffffff)) {
