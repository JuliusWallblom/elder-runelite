...
final class Class259_Sub1 extends Class259 {
	...
	static final void method2016(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_) {
		try {
			...
			for (Class246_Sub6 class246_sub6_9_ = (Class246_Sub6) InvTypeLoader.aClass166_846.method1104(63); class246_sub6_9_ != null; class246_sub6_9_ = ((Class246_Sub6) InvTypeLoader.aClass166_846.method1108((byte) -112))) {
			...
			if (class246_sub6 == null) {
				...
				InvTypeLoader.aClass166_846.push_head(class246_sub6);
			}
