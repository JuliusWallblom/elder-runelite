...
abstract class Class59 {
	...
	abstract void method403(SceneGraph class260, int i);
	...
	static final boolean method404(byte i) {
		try {
			...
			if (Class12.anInt182 != 0)
				return true;
			int i_0_ = -48 % ((i + 48) / 34);
			return Sprite.aClass246_Sub37_Sub1_433.method2509((byte) -105);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, "fi.N(" + i + ')');
		}
	}

	abstract void method405(int i, int i_1_, Class59 class59_2_, byte i_3_, boolean bool, SceneGraph class260,
			int i_4_);
	...
	abstract Class130_Sub3 method407(SceneGraph class260, int i);

	static final void method408(int i, int i_5_, int i_6_, byte i_7_, int i_8_) {
		do {
			try {
				if ((AbstractModel.anInt1442 ^ 0xffffffff) >= (i ^ 0xffffffff) && i <= Class109_Sub4.anInt4570) {
					i_5_ = Class180.method1176(Class110.anInt1573, -24309, i_5_, ObjType.anInt2818);
					i_8_ = Class180.method1176(Class110.anInt1573, -24309, i_8_, ObjType.anInt2818);
				...
				throw Class193.method1272(runtimeexception,
						("fi.Q(" + i + ',' + i_5_ + ',' + i_6_ + ',' + i_7_ + ',' + i_8_ + ')'));
			}
			break;
		} while (false);
	}

	abstract boolean method409(int i, int i_9_, SceneGraph class260, int i_10_);
