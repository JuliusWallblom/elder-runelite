...
final class Class44 {
	...
	static final Class21_Sub3 method296(byte i, Buffer stream) {
		try {
			anInt643++;
			if (i <= 82)
				return null;
			return new Class21_Sub3(stream.method2375((byte) 1), stream.method2375((byte) 1), stream.method2375((byte) 1), stream.method2375((byte) 1), stream.read24BitInteger((byte) 29), stream.read24BitInteger((byte) 29), stream.readUnsignedByte());
