...
final class Class90 {
	...
	static Widget[] aClass235Array1168;
	...
	static final boolean method570(int i, int i_0_, int i_1_, int i_2_, boolean bool, int i_3_, int i_4_, int i_5_, int i_6_) {
		try {
			anInt1169++;
			int i_7_ = ((Entity) Client.local_player).f_mc[0];
			int i_8_ = ((Entity) Client.local_player).f_nc[0];
			...
			if (i_6_ <= 98)
				return false;
			int i_9_ = (CS2Script.method2416((byte) -106, (Class95.aClass199Array1235[((Class59_Sub3) Client.local_player).current_plane]), i_7_, i_1_, i_3_, i_0_, Client.local_player.method2670((byte) 127), i_4_, Class246_Sub4.anIntArray3865, i, bool, Class220.anIntArray3049, i_8_, i_2_, i_5_));
	...
	static final void method571(int i, int i_10_, int i_11_, int i_12_, byte i_13_, int i_14_, int i_15_) {
		do {
			try {
				anInt1171++;
				if ((i_14_ ^ 0xffffffff) <= (ObjType.anInt2818 ^ 0xffffffff) && Class110.anInt1573 >= i && AbstractModel.anInt1442 <= i_15_ && Class109_Sub4.anInt4570 >= i_12_) {
