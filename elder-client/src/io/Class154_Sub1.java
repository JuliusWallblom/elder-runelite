...
final class Class154_Sub1 extends Class154 {
	...
	private IterableNodeHashTable aClass85_4787;
	...
	private final Class246_Sub1_Sub6 method2088(int i, int i_1_, int i_2_) {
		try {
			anInt4777++;
			Class246_Sub1_Sub6 class246_sub1_sub6 = ((Class246_Sub1_Sub6) aClass85_4787.get((long) i_2_));
			if (class246_sub1_sub6 != null && (i ^ 0xffffffff) == -1
					&& !((Class246_Sub1_Sub6) class246_sub1_sub6).aBool5964
					&& ((Class246_Sub1_Sub6) class246_sub1_sub6).aBool5960) {
				class246_sub1_sub6.remove();
			...
			if (!(class246_sub1_sub6 instanceof Clan)) {
				try {
					...
					if (((Class246_Sub1_Sub6) class246_sub1_sub6).aBool5964 && !aClass242_4784.method1549(0)) {
						SubIncomingPacket class246_sub1_sub6_sub1 = aClass242_4784.method1554(anInt4782, (byte) 2,
								(byte) -57, true, i_2_);
	...
	static final void method2089(int i) {
		do {
			try {
				...
				Class109_Sub4.anInt4566 -= -NpcType.f_nb + l;
				do {
					if (Class109_Sub4.anInt4566 <= 0) {
						Node.aFloat3470 = (((Class138) Class40_Sub9.aClass138_5495).aFloat1980);
						Settings.fog_color = (((Class138) Class40_Sub9.aClass138_5495).anInt1973);
					...
					Class222.anInt3069 = ((0xff0000
							& (i_8_ * (0xff00 & (((Class138) Class40_Sub9.aClass138_5495).anInt1970))
									+ i_7_ * (OutputStream_Sub1.anInt4490 & 0xff00)))
							+ (~0xff00ff & (((((Class138) Class40_Sub9.aClass138_5495).anInt1970) & 0xff00ff) * i_8_
									+ ((0xff00ff & OutputStream_Sub1.anInt4490) * i_7_)))) >>> 8;
					float f_9_ = -f + 1.0F;
					Class193.aFloat2718 = (Class246_Sub1_Sub15_Sub2.aFloat7083
							+ ((((Class138) Class40_Sub9.aClass138_5495).aFloat1975)
									- Class246_Sub1_Sub15_Sub2.aFloat7083) * f_9_);
					Class3.anInt29 = (i_7_ * Player.f_od
							+ i_8_ * (((Class138) Class40_Sub9.aClass138_5495).anInt1978)) >> 8;
					Class126.aFloat1782 = (Canvas_Sub1.aFloat6895
							+ ((((Class138) Class40_Sub9.aClass138_5495).aFloat1966) - Canvas_Sub1.aFloat6895) * f_9_);
					Settings.fog_color = ((0xff0000 & ((Class19.anInt313 & 0xff00) * i_7_
							+ (0xff00 & (((Class138) Class40_Sub9.aClass138_5495).anInt1973)) * i_8_))
							+ (~0xff00ff & ((Class19.anInt313 & 0xff00ff) * i_7_
									- -((0xff00ff & (((Class138) Class40_Sub9.aClass138_5495).anInt1973))
											* i_8_)))) >>> 8;
					Class246_Sub28_Sub19.aFloat6549 = f_9_
							* ((((Class138) Class40_Sub9.aClass138_5495).aFloat1972) - Class56.aFloat790)
							+ Class56.aFloat790;
					Class259_Sub3_Sub1.aFloat6901 = (Class39_Sub1.aFloat4668
							+ ((((Class138) Class40_Sub9.aClass138_5495).aFloat1963) - Class39_Sub1.aFloat4668) * f_9_);
					Node.aFloat3470 = (Class122.aFloat1686
							+ f_9_ * ((((Class138) Class40_Sub9.aClass138_5495).aFloat1980) - Class122.aFloat1686));
					Class31.aFloat420 = (((Class138) Class40_Sub9.aClass138_5495).aFloat1969 - MapFunctions.aFloat2339)
							* f_9_ + MapFunctions.aFloat2339;
					if (Class210_Sub2.aClass211_5015 != (((Class138) Class40_Sub9.aClass138_5495).aClass211_1974))
						Class_u.aClass211_4701 = (Class33.aClass260_444.method1739(Class210_Sub2.aClass211_5015,
								(((Class138) Class40_Sub9.aClass138_5495).aClass211_1974), f_9_,
								Class_u.aClass211_4701));
				} while (false);
				NpcType.f_nb = l;
			} catch (RuntimeException runtimeexception) {
			...
			try {
				...
				if (aClass166_4806 != null) {
					...
					if (!aBool4802) {
						if (aBool4804) {
							boolean bool = true;
							for (Node class246 = aClass166_4806.method1104(
									i - 23627); class246 != null; class246 = aClass166_4806.method1108((byte) -112)) {
							...
							while (anInt4808 < (((Class195) aClass195_4792).anIntArray2726).length) {
								if ((((Class195) aClass195_4792).anIntArray2726[anInt4808]) == 0)
									...
									if ((aByteArray4786[anInt4808] ^ 0xffffffff) != -2) {
										...
										bool = false;
										aClass166_4806.push_head(class246);
									}
									anInt4808++;
								}
							}
						...
						boolean bool = true;
						for (Node class246 = aClass166_4806.method1104(
								i ^ 0x5cf7); class246 != null; class246 = aClass166_4806.method1108((byte) -112)) {
						...
						while ((anInt4808 ^ 0xffffffff) > ((((Class195) aClass195_4792).anIntArray2726).length
								^ 0xffffffff)) {
							if ((((Class195) aClass195_4792).anIntArray2726[anInt4808]) == 0)
								anInt4808++;
							else {
				...
				if (!aBool4809 || aLong4810 > TimeUtility.time())
					break;
				for (Class246_Sub1_Sub6 class246_sub1_sub6 = ((Class246_Sub1_Sub6) aClass85_4787.first(
						(byte) -23)); class246_sub1_sub6 != null; class246_sub1_sub6 = ((Class246_Sub1_Sub6) aClass85_4787
								.next((byte) -20))) {
					if (!((Class246_Sub1_Sub6) class246_sub1_sub6).aBool5960) {
				...
				aLong4810 = TimeUtility.time() + 1000L;
			} catch (RuntimeException runtimeexception) {
	...
	final int method1022(int i, byte i_13_) {
		try {
			anInt4801++;
			Class246_Sub1_Sub6 class246_sub1_sub6 = (Class246_Sub1_Sub6) aClass85_4787.get((long) i);
			if (i_13_ <= 113)
				method2089(117);
			if (class246_sub1_sub6 != null)
	...
	final void method2092(byte i) {
		try {
			...
			if (aClass166_4806 != null && method1021((byte) -120) != null && i <= -85) {
				for (Node class246 = aClass166_4805.method1104(68); class246 != null; class246 = aClass166_4805
						.method1108((byte) -112)) {
					int i_14_ = (int) ((Node) class246).hash;
					if (i_14_ < 0 || i_14_ >= ((Class195) aClass195_4792).anInt2738
							|| (((Class195) aClass195_4792).anIntArray2726[i_14_] ^ 0xffffffff) == -1)
						class246.remove();
					else {
	...
	static final void method2093(Class255_Sub1 class255_sub1, byte[][] is, int i) {
		try {
			...
			for (int i_17_ = 0; (i_16_ ^ 0xffffffff) < (i_17_ ^ 0xffffffff); i_17_++) {
				...
				if (is_18_ != null) {
					Buffer stream = new Buffer(is_18_);
					int i_19_ = MapRegion.region_ids[i_17_] >> 8;
					int i_20_ = 0xff & MapRegion.region_ids[i_17_];
					int i_21_ = -Client.base_x + i_19_ * 64;
					int i_22_ = i_20_ * 64 - Client.base_y;
					IterableNodeHashTable.method545((byte) -109);
					class255_sub1.method1651(-115, Client.base_x, Client.base_y, stream, i_21_,
							Class95.aClass199Array1235, i_22_);
					class255_sub1.method2336(0, is_15_, i_22_, Client.sprite_loader, i_21_, stream);
					if (!((MapRegion) class255_sub1).aBool3658
							&& (i_19_ ^ 0xffffffff) == (IdentityKitLoader.anInt1206 / 8 ^ 0xffffffff)
							&& (i_20_ ^ 0xffffffff) == (Class130_Sub8.anInt5618 / 8 ^ 0xffffffff)
							&& (is_15_[0] ^ 0xffffffff) != 0) {
						Class_u_Sub1.aClass230_5685 = (Class246_Sub31.aClass203_5038.method1335(is_15_[1], is_15_[0],
								120, is_15_[2], is_15_[3], Class246_Sub1_Sub14.aClass214_6597));
			...
			if (i == -32652) {
				for (int i_23_ = 0; i_16_ > i_23_; i_23_++) {
					int i_24_ = (-Client.base_x + (MapRegion.region_ids[i_23_] >> 8) * 64);
					int i_25_ = (-Client.base_y + (MapRegion.region_ids[i_23_] & 0xff) * 64);
			...
			throw Class193.method1272(runtimeexception, ("lv.O(" + (class255_sub1 != null ? "{...}" : "null") + ','
					+ (is != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}
	...
	final void method1019(int i, int i_27_) {
		try {
			anInt4797++;
			if (aClass208_4780 != null) {
				for (Node class246 = aClass166_4805.method1104(61); class246 != null; class246 = aClass166_4805
						.method1108((byte) -112)) {
				...
				aClass166_4805.push_head(class246);
			}
		} catch (RuntimeException runtimeexception) {
	...
	final Class195 method1021(byte i) {
		try {
			...
			if (!(aClass246_Sub1_Sub6_4796 instanceof Clan)) {
				try {
					if (is == null)
						throw new RuntimeException();
					...
					if (aClass242_4784.method1549(0))
						...
						aClass246_Sub1_Sub6_4796 = aClass242_4784.method1554(255, (byte) 0, (byte) -101, true,
								anInt4782);
					return null;
				}
	...
	Class154_Sub1(int i, Class208 class208, Class208 class208_28_, Class242 class242, Class241 class241, int i_29_,
			int i_30_, boolean bool) {
		aClass85_4787 = new IterableNodeHashTable(16);
		anInt4808 = 0;
		...
		do {
			try {
				...
				throw Class193.method1272(runtimeexception,
						("lv.<init>(" + i + ',' + (class208 != null ? "{...}" : "null") + ','
								+ (class208_28_ != null ? "{...}" : "null") + ','
								+ (class242 != null ? "{...}" : "null") + ',' + (class241 != null ? "{...}" : "null")
								+ ',' + i_29_ + ',' + i_30_ + ',' + bool + ')'));
			}
			break;
		} while (false);
