...
final class Class215 implements Runnable {
	...
	static Buffer aStream3001 = new Buffer(1);
		...
		try {
			if (i < -112) {
				...
				if (string != null) {
					...
					if (string_0_ != null) {
						for (int i_1_ = 0; i_1_ < Client.anInt3969; i_1_++) {
							String string_2_ = Model.f_gb[i_1_];
							...
							if (string_2_ != null && string_2_.equals(string_0_)) {
								Client.anInt3969--;
								for (int i_3_ = i_1_; i_3_ < Client.anInt3969; i_3_++) {
									Model.f_gb[i_3_] = Model.f_gb[i_3_ + 1];
									...
									WidgetParent.aBoolArray5520[i_3_] = (WidgetParent.aBoolArray5520[i_3_ + 1]);
								}
								Class246_Sub28_Sub15.anInt6358++;
								Class246_Sub1_Sub15.anInt6602 = Client.cycleCntr;
								Class243.writePacket(-69, Class69.run_script_packet);
