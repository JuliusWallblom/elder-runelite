...
final class Class211_Sub1_Sub2 extends Class211_Sub1 {
	...
	static float[][] aFloatArrayArray6530 = { { -0.333333F, -0.333333F, -0.333333F },
	...
	static final void method2689(int i) {
		try {
			anInt6523++;
			int i_0_ = Client.current_renderer.method2049(Buffer.anInt5656, 28);
			if (i_0_ != i) {
				if ((i_0_ ^ 0xffffffff) == -2) {
					Class39_Sub1.method2051(-93, (byte) 0);
					Class98.method620(512, true);
					if (Class45.tileRenderFlags != null)
	...
	final Class109_Sub4 method2265(int i) {
		try {
			...
			if (aClass109_Sub4_6527 == null) {
				TextureInterface interface6 = ((SceneGraph) aClass260_Sub2_6529).anInterface6_3714;
				Class_q_Sub1.texture_array[2] = anInt6522;
				Class_q_Sub1.texture_array[5] = anInt6521;
				Class_q_Sub1.texture_array[0] = anInt6525;
				Class_q_Sub1.texture_array[4] = anInt6526;
				Class_q_Sub1.texture_array[1] = anInt6519;
				Class_q_Sub1.texture_array[3] = anInt6524;
				boolean bool = false;
				int i_1_ = 0;
				for (int i_2_ = 0; (i_2_ ^ 0xffffffff) > -7; i_2_++) {
					if (!interface6.method13(Class_q_Sub1.texture_array[i_2_], 19378))
						return null;
					Material class238 = interface6.get_material(i - 31307, (Class_q_Sub1.texture_array[i_2_]));
					int i_3_ = ((Material) class238).aBool3335 ? 64 : 128;
					if ((((Material) class238).aByte3349 ^ 0xffffffff) < -1)
						bool = true;
					if ((i_1_ ^ 0xffffffff) > (i_3_ ^ 0xffffffff))
						i_1_ = i_3_;
				}
				for (int i_4_ = 0; (i_4_ ^ 0xffffffff) > -7; i_4_++)
					OutgoingPacket.anIntArrayArray2864[i_4_] = interface6.method14(false, 5754,
							(Class_q_Sub1.texture_array[i_4_]), 1.0F, i_1_, i_1_);
				aClass109_Sub4_6527 = new Class109_Sub4(aClass260_Sub2_6529, 6407, i_1_, bool,
						OutgoingPacket.anIntArrayArray2864);
			}
	...
	Class211_Sub1_Sub2(Class260_Sub2 class260_sub2, int i, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_) {
		try {
			...
			throw Class193.method1272(runtimeexception, ("kr.<init>(" + (class260_sub2 != null ? "{...}" : "null") + ','
					+ i + ',' + i_5_ + ',' + i_6_ + ',' + i_7_ + ',' + i_8_ + ',' + i_9_ + ')'));
		}
	}
}
