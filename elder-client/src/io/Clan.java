...
final class Clan extends Class246_Sub1_Sub6 {
	...
	final byte[] method2534(boolean bool) {
		try {
			...
			return ((Clan) this).aByteArray7108;
	...
	static final void method2907(CacheIndex class_fs, int i) {
		do {
			try {
				anInt7113++;
				if (i == 14564)
	...
	static {
		...
		new MultilingualString("You have been permanently muted due to breaking a rule.", "Du wurdest permanent stumm geschaltet, da du gegen eine Regel versto\u00dfen hast.", "L'acc\u00e8s \u00e0 la messagerie instantan\u00e9e vous a d\u00e9finitivement \u00e9t\u00e9 retir\u00e9 suite \u00e0 une infraction.", "Voc\u00ea foi permanentemente vetado por ter violado uma regra.");
	}
}
