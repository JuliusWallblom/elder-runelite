...
class Class123 {
	...
	private long aLong1697 = TimeUtility.time();
	...
	static AbstractSprite aClass_l1710;
		...
		do {
			try {
				...
				try {
					...
					method837();
					aLong1721 = 2000L + TimeUtility.time();
				}
				if (i == 2000)
					break;
				method834((byte) -2);
		...
		do {
			try {
				...
				if (i == 14) {
					...
					try {
						Class182 class182 = Client.sign_link.method365((byte) -73, "2");
						...
						if (class182.anInt2539 == 1) {
							...
							Canvas_Sub1.decode(-2, new Buffer(is));
						}
					} catch (Exception exception) {
						/* empty */
					}
			...
			if (!aBool1694) {
				...
				try {
					if ((l ^ 0xffffffffffffffffL) < (500000L + aLong1697 ^ 0xffffffffffffffffL))
						aLong1697 = l + -500000L;
					for (/**/; ((aLong1697 + 5000L ^ 0xffffffffffffffffL) > (l ^ 0xffffffffffffffffL)); aLong1697 += (long) (256000 / MapFunction.anInt2024))
						method828(256, 1);
				} catch (Exception exception) {
					aLong1697 = l;
				}
	...
	private final void method842(int[] is, int i) {
		...
		if (aClass246_Sub37_1692 != null && anInt1714 <= 0) {
			anInt1714 += MapFunction.anInt2024 >> 4;
