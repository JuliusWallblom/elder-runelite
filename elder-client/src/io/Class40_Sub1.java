...
final class Class40_Sub1 extends Class40 {
	...
	static IterableNodeHashTable aClass85_3776 = new IterableNodeHashTable(8);
	...
	Class40_Sub1(Class260_Sub2 class260_sub2, Class_m class_m) {
		...
		do {
			try {
				...
				if (((Class_m) aClass_m3774).aClass109_Sub3_1542 == null
				...
				Class256 class256_0_ = (Class246_Sub34.method2201((byte) 121, ((Class40) this).aClass260_Sub2_613,
						35632,
				...
				aClass196_3772 = Class138.method935(new Class256[] { class256, class256_0_ },
						((Class40) this).aClass260_Sub2_613, -1);
				aBool3780 = aClass196_3772 != null;
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception, ("aj.<init>(" + (class260_sub2 != null ? "{...}" : "null")
						+ ',' + (class_m != null ? "{...}" : "null") + ')'));
			}
			break;
		} while (false);
	...
	final void method278(int i, boolean bool) {
		do {
			try {
				...
				if (i != 0)
					method1771(-87, -40, -112, -121, -33, -94, 120, (byte) 5, -29, 634);
				...
				OpenGL.glUniform4fARB(OpenGL.glGetUniformLocationARB(l, "sunColour"),
						(((Class260_Sub2) ((Class40) this).aClass260_Sub2_613).f_tg),
						(((Class260_Sub2) ((Class40) this).aClass260_Sub2_613).aFloat4332),
						(((Class260_Sub2) ((Class40) this).aClass260_Sub2_613).aFloat4367), 1.0F);
				OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(l, "sunExponent"),
	...
	final void method280(int i) {
		do {
			try {
				...
				if (i == 0)
					break;
				method1771(-106, 12, -35, -121, 67, -95, -27, (byte) -102, 65, 634);
			} catch (RuntimeException runtimeexception) {
	...
	final void method283(int i, Class109 class109, boolean bool) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("aj.B(" + i + ',' + (class109 != null ? "{...}" : "null") + ',' + bool + ')'));
		}
	}

	static final TextureOperation method1770(int i, int i_1_) {
		try {
			anInt3771++;
			int i_2_ = i;
			while_213_: do {
	...
	static final void method1771(int i, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, byte i_9_,
			int i_10_, int revision) {
		if (i_9_ == 27) {
			anInt3775++;
			if (!Widget.load_widget(i_6_, revision, 5)) {
				if (i_3_ == -1) {
			...
			} else if (Widget.get_some_widgets(revision)[i_6_] != null)
				Class246_Sub1_Sub9.method2588(i_4_, i_5_, i_10_, i_3_, (Widget.get_some_widgets(revision)[i_6_]), i, -1,
						i_7_, i_8_, -1268043624);
			else
				Class246_Sub1_Sub9.method2588(i_4_, i_5_, i_10_, i_3_, (Widget.get_widget_cache(revision)[i_6_]), i, -1,
						i_7_, i_8_,
						-1268043624);
		}
	}
			...
			try {
				...
				if (aBool3778) {
					...
					OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(l, "time"),
							(float) (((Class260_Sub2) ((Class40) this).aClass260_Sub2_613).f_qe * i_14_ % 40000)
									/ 40000.0F);
