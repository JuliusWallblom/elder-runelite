...
class Class246_Sub28_Sub5 extends TextureOperation {
	...
	public int texture_item_sprite = -1;
	public boolean osrs;
	int anInt6005;
	...
	int[][] method2139(byte i, int i_0_) {
		try {
			...
			if (i < 33)
				return null;
			if (((Class136) ((TextureOperation) this).aClass136_4933).aBool1946 && method2544(-1121128860)) {
				int[] is_1_ = is[0];
				int[] is_2_ = is[1];
				int[] is_3_ = is[2];
				int i_4_ = (((EnumLoader.anInt2044 != ((Class246_Sub28_Sub5) this).anInt6005)
						? (((Class246_Sub28_Sub5) this).anInt6005 * i_0_ / EnumLoader.anInt2044)
						: i_0_) * ((Class246_Sub28_Sub5) this).anInt5997);
				if ((Class246_Sub37_Sub1.f_gb ^ 0xffffffff) != (((Class246_Sub28_Sub5) this).anInt5997 ^ 0xffffffff)) {
					for (int i_5_ = 0; Class246_Sub37_Sub1.f_gb > i_5_; i_5_++) {
						...
						int i_7_ = (((Class246_Sub28_Sub5) this).pixels[i_4_ - -i_6_]);
					...
					for (int i_8_ = 0; ((i_8_ ^ 0xffffffff) > (Class246_Sub37_Sub1.f_gb ^ 0xffffffff)); i_8_++) {
						int i_9_ = (((Class246_Sub28_Sub5) this).pixels[i_4_++]);
	...
	static final void method2543(boolean bool) {
		try {
			...
			synchronized (Clan.aClass54_7109) {
				Clan.aClass54_7109.method369(bool);
			}
			anInt6000++;
		} catch (RuntimeException runtimeexception) {
	...
	public Class246_Sub28_Sub5(int texture_item_sprite) {
		super(0, false);
		this.texture_item_sprite = texture_item_sprite;
		this.osrs = true;
	}
	...
	final void method2142(int i) {
		try {
			...
			((Class246_Sub28_Sub5) this).pixels = null;
		} catch (RuntimeException runtimeexception) {
	...
	final boolean method2544(int i) {
		try {
			anInt5998++;
			if (((Class246_Sub28_Sub5) this).pixels != null)
				return true;
			if (i != -1121128860) {
				return false;
			}
			if (texture_item_sprite >= 0) {
				LDSprite ld_sprite = ((Texture.spriteId ^ 0xffffffff) <= -1
						? LDSprite.get_sprite(Class19.sprite_data, Texture.spriteId, texture_item_sprite)
						: LDSprite.method130(Class19.sprite_data, texture_item_sprite));
				ld_sprite.method124();
				if (osrs) {
					ld_sprite.method122();
					ld_sprite.method122();
				}
				((Class246_Sub28_Sub5) this).pixels = ld_sprite.get_pixels();
				((Class246_Sub28_Sub5) this).anInt6005 = ((LDSprite) ld_sprite).anInt155;
				((Class246_Sub28_Sub5) this).anInt5997 = ((LDSprite) ld_sprite).anInt156;
				return true;
			}
			return false;
		} catch (RuntimeException runtimeexception) {
	...
	final void method2143(int i, int i_10_, Buffer stream) {
		do {
			try {
				anInt6002++;
				if (i_10_ == 0)
					texture_item_sprite = stream.readUnsignedShort();
				if (i == 4)
					break;
				method2136(-108);
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception,
						("el.G(" + i + ',' + i_10_ + ',' + (stream != null ? "{...}" : "null") + ')'));
			}
			break;
		} while (false);
	}
