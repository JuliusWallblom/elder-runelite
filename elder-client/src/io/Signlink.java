...
public class Signlink implements Runnable {
	...
	public final Class182 method342(int var1, int var2, int var3, boolean var4, int var5) {
		try {
			...
			return this.method344(6, (Object) null, (byte) 99, var1 + (var5 << -149711472),
					var2 + (var3 << -695361872));
	...
	public final void method346(Class var1, int var2) throws Exception {
		try {
			...
			Method var6 = Class.forName("java.lang.reflect.Method").getMethod("setAccessible",
			...
			while (true) {
				...
				try {
					...
					if (1 != var1) {
						if (2 != var1) {
							if (var1 != 4) {
								...
								if (var1 == 8) {
									...
									var2.anObject2535 = ((Class) var3[0]).getDeclaredMethod((String) var3[1],
											(Class[]) ((Class[]) var3[2]));
								} else if (var1 != 9) {
									if (var1 != 18) {
										if (~var1 == -20) {
											...
											if (~var1 != -4) {
												if (-22 != ~var1) {
													if (~var1 != -6) {
														if (var1 == 6) {
															Frame var19 = new Frame(
																	GameConstants.NAME + " Full Screen");
															var2.anObject2535 = var19;
															var19.setResizable(false);
															this.aClass28_746.method226(113,
																	var2.anInt2534 >>> -1757097072, var19,
																	var2.anInt2540 >> 1428037648,
																	'\uffff' & var2.anInt2540,
																	'\uffff' & var2.anInt2534);
														} else if (-8 != ~var1) {
															...
															if (11 == var1) {
																/*
																 * Field var20 = Class .forName(
																 * "java.lang.ClassLoader") .getDeclaredField(
																 * "nativeLibraries"); var20.setAccessible(true);
																 * Vector var21 = (Vector) var20 .get(((Class)
																 * var2.anObject2536) .getClassLoader());
																 * 
																 * for (var5 = 0; ~var21 .size() < ~var5; ++var5) {
																 * Object var6 = var21 .elementAt(var5); Method var7 =
																 * var6 .getClass()
																 * .getDeclaredMethod( "finalize", new Class[0]);
																 * var7.setAccessible(true); var7.invoke( var6, new
																 * Object[0]);
																 * var7.setAccessible(false); Field var8 = var6
																 * .getClass() .getDeclaredField( "handle");
																 * var8.setAccessible(true); var8.set(
																...
																Class192 var22 = method351((String) var2.anObject2536,
																		this.aString745, this.anInt744, 0);
																...
																var3 = (Object[]) ((Object[]) var2.anObject2536);
																this.aClass26_749.method211((int[]) ((int[]) var3[1]),
																		var2.anInt2534, (Component) var3[0],
																		var2.anInt2540, (byte) 109, (Point) var3[2]);
															} else if (16 == var1) {
																try {
																	if (!osName.startsWith("win")) {
																		throw new Exception();
																	...
																	if (!var29.startsWith("http://")
																			&& !var29.startsWith("https://")) {
																		throw new Exception();
																	}
																...
																/*
																 * 
																 * try { Class[] var30 = new Class[] {
																 * Class.forName("java.lang.Class"),
																 * Class.forName("java.lang.String") }; Runtime var28 =
																 * Runtime .getRuntime(); Method var31 = Class .forName(
																 * "java.lang.Runtime") .getDeclaredMethod( "load0",
																 * var30);
																 * var31.setAccessible(true); if (osName
																 * .startsWith("win")) { if (!osArch
																 * .startsWith("amd64") && !osArch
																 * .startsWith("x86_64")) { var31.invoke( var28, new
																 * Object[] { var2.anObject2536, this.method343(
																 * "jagmisc.dll", false)
																 * .toString() }); } else { var31.invoke( var28, new
																 * Object[] { var2.anObject2536, this.method343(
																 * "jagmisc64.dll", false)
																 * .toString() }); } }
																 * 
																 * var31.setAccessible(false); } catch (Throwable var12)
																 * { var2.anObject2535 = var12; } /
																 */
															}
														} else {
													...
													if (TimeUtility.time() < aLong752) {
														throw new IOException();
													}

													var2.anObject2535 = InetAddress
															.getByName((String) var2.anObject2536).getAddress();
												}
											} else {
												if (~TimeUtility.time() > ~aLong752) {
													throw new IOException();
												...
												var29 = (var2.anInt2534 >> -1578467176 & 255) + ""
														+ (255 & var2.anInt2534 >> -1030710640) + "."
														+ (255 & var2.anInt2534 >> -26172504) + "."
														+ (var2.anInt2534 & 255);
						...
						if (aLong752 > TimeUtility.time()) {
							throw new IOException();
						}

						var2.anObject2535 = new Socket(InetAddress.getByName((String) var2.anObject2536),
								var2.anInt2534);
					}
	...
	private static final Class192 method351(String var0, String var1, int var2, int var3) {
		try {
			String var4;
			if (var2 == 33) {
				var4 = GameConstants.NAME + "_" + "preferences" + var0 + "_rc.dat";
			} else if (var2 != 34) {
				var4 = GameConstants.NAME + "_" + "preferences" + var0 + ".dat";
			} else {
				var4 = GameConstants.NAME + "_" + "preferences" + var0 + "_wip.dat";
			}

			String[] var5 = new String[] { "c:/rscache/", "/rscache/", aString741, "c:/windows/", "c:/winnt/", "c:/",
					"/tmp/", "" };
	...
	public static final File method358(String var0, int var1, int var2, String var3) {
		try {
			...
			if (null != var4) {
				...
				String[] var5 = new String[] { "c:/rscache/", "/rscache/", "c:/windows/", "c:/winnt/", "c:/",
						aString741, "/tmp/", "" };
				String[] var6 = new String[] { "." + GameConstants.NAME + "_cache_" + var2, ".file_store_" + var2 };
	...
	public final void method361(byte var1) {
		try {
			aLong752 = TimeUtility.time() + 5000L;
			if (var1 != 62) {
	...
	public Signlink(Applet var1, int var2, String var3, int var4) throws Exception {
		try {
			...
			try {
				if (var1 == null) {
					aMethod750 = Class.forName("java.awt.Component").getDeclaredMethod("setFocusTraversalKeysEnabled",
							new Class[] { Boolean.TYPE });
				} else {
					aMethod750 = var1.getClass().getMethod("setFocusTraversalKeysEnabled",
							new Class[] { Boolean.TYPE });
				}
			...
			try {
				if (null == var1) {
					aMethod751 = Class.forName("java.awt.Container").getDeclaredMethod("setFocusCycleRoot",
							new Class[] { Boolean.TYPE });
				} else {
			...
			for (int var5 = 0; ~var4 < ~var5; ++var5) {
				this.aClass192Array727[var5] = new Class192(this.method343("main_file_cache.idx" + var5, false), "rw",
						1048576L);
			}
