...
final class Class_w extends TextureOperation {
				...
				while_37_: do {
					do {
						if (i_1_ != 0) {
							...
							anInt6377 = stream.readUnsignedByte();
							break while_37_;
						}
						anInt6378 = stream.readUnsignedShort();
						break while_37_;
					} while (false);
					anInt6373 = stream.readUnsignedByte();
				} while (false);
				if (i == 4)
					break;
				aBool6388 = false;
	...
	static final void method2650(boolean bool, String string, Font class116, int i) {
		do {
			int i_2_ = 4;
			int i_3_ = 6 - -i_2_;
			int i_4_ = i_2_ + 6;
			...
			Client.sprite_loader.O(-i_2_ + i_3_, i_4_ - i_2_, i_2_ + i_2_ + i_5_, i_2_ + i_6_ + i_2_, -16777216, 0);
			Client.sprite_loader.method1753(-i_2_ + i_3_, -i_2_ + i_4_, i_2_ + i_2_ + i_5_, i_2_ + (i_2_ + i_6_), -1, 0);
			class116.method799(-1, 0, null, 0, 1, null, i_4_, i_3_, 0, 0, i_6_, i_5_, -1, 1, string, null);
			Class303.method1075(i_3_ + -i_2_, true, i_2_ + (i_6_ - -i_2_), i_2_ + i_5_ + i_2_, -i_2_ + i_4_);
			if (!bool)
				break;
	...
	final int[] method2135(int i, int i_12_) {
		try {
			anInt6374++;
			int[] is = ((TextureOperation) this).aClass66_4938.method435((byte) -112, i_12_);
			int i_13_ = 20 % ((67 - i) / 50);
			if (((Class66) ((TextureOperation) this).aClass66_4938).aBool887) {
				int i_14_ = Varc.anIntArray6245[i_12_];
				if (anInt6373 != 0) {
