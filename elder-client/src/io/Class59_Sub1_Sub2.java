...
final class Class59_Sub1_Sub2 extends Class59_Sub1 implements Class_f {
	...
	static MultilingualString aClass67_6128;
	...
	static final CS2Script weird_list(int i, int i_0_, int i_1_, Class169 class169, int widget_id) {
		try {
			...
			CS2Script class246_sub1_sub1 = ((CS2Script) (osrs ? Class109_Sub3.cs2_cache_osrs
					: Class109_Sub3.cs2_cache_550).get((long) i_2_ << 16));
			if (class246_sub1_sub1 != null)
				return class246_sub1_sub1;
			byte[] is = (Cache.get_index(osrs ? Revision.OSRS : Revision.PRE_EOC_634, "cs2").method109(
					Cache.get_index(osrs ? Revision.OSRS : Revision.PRE_EOC_634, "cs2").method104(-14943, i_2_),
					i ^ ~0x2d77));
			if (i != 11639)
				return null;
			if (is != null) {
				if (is.length <= 1)
					return null;
				if (osrs) {
					class246_sub1_sub1 = Class122.decode(is);
				} else {
					class246_sub1_sub1 = Class122.decode((byte) -51, is);
				}
				((CS2Script) class246_sub1_sub1).aClass169_5681 = class169;
				(osrs ? Class109_Sub3.cs2_cache_osrs : Class109_Sub3.cs2_cache_550).method869((long) i_2_ << 16,
						class246_sub1_sub1, -8869);
				return class246_sub1_sub1;
			}
			i_2_ = ((Class169) class169).anInt2406 | i_0_ - -65536 << 8;
			class246_sub1_sub1 = ((CS2Script) (osrs ? Class109_Sub3.cs2_cache_osrs : Class109_Sub3.cs2_cache_550)
					.get((long) i_2_ << 16));
			if (class246_sub1_sub1 != null)
				return class246_sub1_sub1;
			is = (Cache.get_index(osrs ? Revision.OSRS : Revision.PRE_EOC_634, "cs2").method109(
					Cache.get_index(osrs ? Revision.OSRS : Revision.PRE_EOC_634, "cs2").method104(i ^ ~0x1729, i_2_),
					-1));
			if (is != null) {
				if (is.length <= 1)
					return null;
			...
			if (class246_sub1_sub1 != null)
				return class246_sub1_sub1;
			is = (Cache.get_index(osrs ? Revision.OSRS : Revision.PRE_EOC_634, "cs2").method109(
					Cache.get_index(osrs ? Revision.OSRS : Revision.PRE_EOC_634, "cs2").method104(-14943, i_2_), -1));
			if (is != null) {
			...
			throw Class193.method1272(runtimeexception,
					("ft.K(" + i + ',' + i_0_ + ',' + i_1_ + ',' + (class169 != null ? "{...}" : "null") + ')'));
		}
	}

	public final AbstractModel method23(SceneGraph class260, int i, int i_3_) {
		try {
			anInt6119++;
			...
			throw Class193.method1272(runtimeexception,
					("ft.D(" + (class260 != null ? "{...}" : "null") + ',' + i + ',' + i_3_ + ')'));
		}
	}

	final void method405(int i, int i_5_, Class59 class59, byte i_6_, boolean bool, SceneGraph class260, int i_7_) {
		try {
			anInt6111++;
			if (i_6_ == -99)
			...
			throw Class193.method1272(runtimeexception,
					("ft.L(" + i + ',' + i_5_ + ',' + (class59 != null ? "{...}" : "null") + ',' + i_6_ + ',' + bool
							+ ',' + (class260 != null ? "{...}" : "null") + ',' + i_7_ + ')'));
		}
	}
	...
	Class59_Sub1_Sub2(SceneGraph class260, LocType class185, int i, int i_10_, int i_11_, int i_12_, int i_13_,
			boolean bool, int i_14_, int i_15_) {
		super(i_11_, i_12_, i_13_, ((LocType) class185).aBool2584, ((LocType) class185).aBool2601);
		try {
			((Class59_Sub1_Sub2) this).aClass14_6124 = new Class14(class260, class185, 22, i_14_, i, i_10_, i_11_,
					i_13_, bool, i_15_);
			aBool6129 = ((((LocType) class185).wall_or_door ^ 0xffffffff) != -1 && !bool);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("ft.<init>(" + (class260 != null ? "{...}" : "null") + ',' + (class185 != null ? "{...}" : "null")
							+ ',' + i + ',' + i_10_ + ',' + i_11_ + ',' + i_12_ + ',' + i_13_ + ',' + bool + ',' + i_14_
							+ ',' + i_15_ + ')'));
		}
	}
	...
	final boolean method409(int i, int i_16_, SceneGraph class260, int i_17_) {
		try {
			anInt6114++;
			AbstractModel class_t = (((Class59_Sub1_Sub2) this).aClass14_6124.method147(((Class59_Sub1) this).anInt4517,
					false, class260, ((Class59_Sub1) this).anInt4515, 131072, (byte) 124, false));
			if (i_16_ != 0)
				return false;
			if (class_t == null)
				return false;
			Class_c class_c = class260.method1730();
			class_c.j(((Class59_Sub1) this).anInt4515, ((Class59_Sub1) this).anInt4518,
					((Class59_Sub1) this).anInt4517);
			return class_t.method685(i_17_, i, class_c, false);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("ft.A(" + i + ',' + i_16_ + ',' + (class260 != null ? "{...}" : "null") + ',' + i_17_ + ')'));
		}
	}
		...
		do {
			try {
				if (i < 53)
					method20(true, null);
				anInt6121++;
				AbstractModel class_t = (((Class59_Sub1_Sub2) this).aClass14_6124.method147(
						((Class59_Sub1) this).anInt4517, true, class260, ((Class59_Sub1) this).anInt4515, 262144,
						(byte) 125, true));
				if (class_t == null)
					break;
				int i_18_ = ((Class59_Sub1) this).anInt4515 >> 7;
				int i_19_ = ((Class59_Sub1) this).anInt4517 >> 7;
				((Class59_Sub1_Sub2) this).aClass14_6124.method155(false, i_19_, 50401, class_t, i_18_, class260, i_19_,
						i_18_);
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception,
						("ft.B(" + (class260 != null ? "{...}" : "null") + ',' + i + ')'));
			}
			break;
		} while (false);
	}
	...
	static final void method2571(int i) {
		do {
			try {
				anInt6122++;
				int i_20_ = 0;
				if (Client.current_renderer.method275(29083, Buffer.anInt5656)) {
					i_20_ |= 0x1;
					i_20_ |= 0x10;
					i_20_ |= 0x20;
					i_20_ |= 0x2;
				...
				if (!((Renderer) Client.current_renderer).texture)
					i_20_ |= 0x40;
	...
	final Class130_Sub3 method407(SceneGraph class260, int i) {
		try {
			anInt6117++;
			AbstractModel class_t = (((Class59_Sub1_Sub2) this).aClass14_6124.method147(((Class59_Sub1) this).anInt4517,
					true, class260, ((Class59_Sub1) this).anInt4515, 2048, (byte) 123, false));
			if (class_t == null)
				return null;
			Class_c class_c = class260.method1730();
			class_c.j(((Class59_Sub1) this).anInt4515, ((Class59_Sub1) this).anInt4518,
			...
			do {
				if ((((Class14) ((Class59_Sub1_Sub2) this).aClass14_6124).aClass130_Sub2_214) != null) {
					Class129 class129 = ((Class14) ((Class59_Sub1_Sub2) this).aClass14_6124).aClass130_Sub2_214
							.method1779();
					class260.method1703(class_t, class129, class_c, (class130_sub3 == null ? null
							: (((Class130_Sub3) class130_sub3).aClass130_Sub5Array4415[0])), 0);
					if (!Client.f_ob)
						break;
				}
			...
			((Class59_Sub1_Sub2) this).aClass14_6124.method155(true, i_26_, 50401, class_t, i_25_, class260, i_26_,
					i_25_);
			return class130_sub3;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					"ft.H(" + (class260 != null ? "{...}" : "null") + ',' + i + ')');
		}
	}
	...
	static {
		new MultilingualString("Already attempting to join a channel - please wait...",
		...
		anInt6125 = 0;
		aClass154_Sub1Array6127 = new Class154_Sub1[Constants.MAX_INDEX_COUNT];
		aClass67_6128 = new MultilingualString("Loaded world list data", "Liste der Welten geladen",
