...
final class MouseHandler extends Class102 implements MouseListener, MouseMotionListener {
	...
	private final void handleMouse(boolean bool) {
		try {
			anInt4456++;
	...
	static final void method2003(byte i, boolean bool) {
		try {
			...
			SomeClass.decodeLocalNPCMasks((byte) 127);
			for (int i_3_ = 0; (i_3_ ^ 0xffffffff) > (Class48.anInt695 ^ 0xffffffff); i_3_++) {
				int i_4_ = Class246_Sub28_Sub1.anIntArray5791[i_3_];
				if ((Client.cycle ^ 0xffffffff) != ((((Entity) VarcLoader.aClass_r_Sub2Array1002[i_4_]).anInt6418) ^ 0xffffffff)) {
					if (((Npc) VarcLoader.aClass_r_Sub2Array1002[i_4_]).aClass253_7184.method1628(-94))
						Class246_Sub28_Sub35.method2874(VarcLoader.aClass_r_Sub2Array1002[i_4_], 16777216);
					VarcLoader.aClass_r_Sub2Array1002[i_4_].method2934((byte) -121, null);
					VarcLoader.aClass_r_Sub2Array1002[i_4_] = null;
				}
			}
			if ((((Buffer) Class78.packetStream).position ^ 0xffffffff) != (Class130_Sub1_Sub1.anInt7046 ^ 0xffffffff))
				throw new RuntimeException("gnp1 pos:" + ((Buffer) Class78.packetStream).position + " psize:" + Class130_Sub1_Sub1.anInt7046);
			for (int i_5_ = 0; Class5.anInt55 > i_5_; i_5_++) {
				if ((VarcLoader.aClass_r_Sub2Array1002[Class246_Sub28_Sub29.anIntArray6815[i_5_]]) == null)
		...
		if (i_8_ == 1) {
			if (i_9_ > Class246_Sub1_Sub10.anInt6199) {
				...
				if (!Class160.method1060(i_9_, i_11_, i_10_ + Class40_Sub7.anInt5174))
					return false;
				if (!Class160.method1060(i_9_, i_11_, i_10_ + NodeSub.anInt3744))
					return false;
			}
			if (i > 0) {
				...
				if (!Class160.method1060(i_9_, i_12_, i_10_ + Class40_Sub7.anInt5174))
					return false;
				if (!Class160.method1060(i_9_, i_12_, i_10_ + NodeSub.anInt3744))
					return false;
			}
			...
			if (!Class160.method1060(i_9_, i_13_, i_10_ + Class40_Sub7.anInt5174))
				return false;
			if (!Class160.method1060(i_9_, i_13_, i_10_ + NodeSub.anInt3744))
				return false;
			return true;
		}
		if (i_8_ == 2) {
			if (i_10_ < Class111.anInt1576) {
				if (!Class160.method1060(i_9_, i_11_, i_10_ + NodeSub.anInt3744))
					return false;
				if (!Class160.method1060(i_9_ + Class40_Sub7.anInt5174, i_11_, i_10_ + NodeSub.anInt3744))
					return false;
				if (!Class160.method1060(i_9_ + NodeSub.anInt3744, i_11_, i_10_ + NodeSub.anInt3744))
					return false;
			}
			if (i > 0) {
				if (!Class160.method1060(i_9_, i_12_, i_10_ + NodeSub.anInt3744))
					return false;
				if (!Class160.method1060(i_9_ + Class40_Sub7.anInt5174, i_12_, i_10_ + NodeSub.anInt3744))
					return false;
				if (!Class160.method1060(i_9_ + NodeSub.anInt3744, i_12_, i_10_ + NodeSub.anInt3744))
					return false;
			}
			if (!Class160.method1060(i_9_, i_13_, i_10_ + NodeSub.anInt3744))
				return false;
			if (!Class160.method1060(i_9_ + Class40_Sub7.anInt5174, i_13_, i_10_ + NodeSub.anInt3744))
				return false;
			if (!Class160.method1060(i_9_ + NodeSub.anInt3744, i_13_, i_10_ + NodeSub.anInt3744))
				return false;
			return true;
		}
		if (i_8_ == 4) {
			if (i_9_ < Class246_Sub1_Sub10.anInt6199) {
				if (!Class160.method1060(i_9_ + NodeSub.anInt3744, i_11_, i_10_))
					return false;
				if (!Class160.method1060(i_9_ + NodeSub.anInt3744, i_11_, i_10_ + Class40_Sub7.anInt5174))
					return false;
				if (!Class160.method1060(i_9_ + NodeSub.anInt3744, i_11_, i_10_ + NodeSub.anInt3744))
					return false;
			}
			if (i > 0) {
				if (!Class160.method1060(i_9_ + NodeSub.anInt3744, i_12_, i_10_))
					return false;
				if (!Class160.method1060(i_9_ + NodeSub.anInt3744, i_12_, i_10_ + Class40_Sub7.anInt5174))
					return false;
				if (!Class160.method1060(i_9_ + NodeSub.anInt3744, i_12_, i_10_ + NodeSub.anInt3744))
					return false;
			}
			if (!Class160.method1060(i_9_ + NodeSub.anInt3744, i_13_, i_10_))
				return false;
			if (!Class160.method1060(i_9_ + NodeSub.anInt3744, i_13_, i_10_ + Class40_Sub7.anInt5174))
				return false;
			if (!Class160.method1060(i_9_ + NodeSub.anInt3744, i_13_, i_10_ + NodeSub.anInt3744))
				return false;
			return true;
	...
	private final void method2005(int i, int i_15_, byte i_16_, int i_17_) {
		try {
			...
			((Class246_Sub30_Sub1) class246_sub30_sub1).aLong5754 = TimeUtility.time();
			if (i_16_ != 100)
				aBool4480 = false;
			aClass166_4476.push_head(class246_sub30_sub1);
		} catch (RuntimeException runtimeexception) {
	...
	public final synchronized void mouseDragged(MouseEvent mouseevent) {
		try {
			anInt4453++;
			mouse_entered(mouseevent, false);
			if (Settings.middle_mouse_camera_control) {
				if (dragging) {
					int x = (mouseWheelX - mouseevent.getX());
					int y = (mouseWheelY - mouseevent.getY());
					mouse_wheel_dragged(x, -y);
	...
	private final void mouse_entered(MouseEvent mouseevent, boolean bool) {
		do {
			try {
				anInt4471++;
	...
	private void mouse_wheel_dragged(int x, int y) {
		if (!dragging) {
			return;
		}
		Camera.camera_yaw += x * 9;
		Camera.camera_pitch += (y << 2);
	}
	...
	MouseHandler(Component component, boolean bool) {
		try {
