	...
	static final Class246_Sub1_Sub10 method336(int i) {
		try {
			...
			if (class246_sub1_sub10 != null) {
				class246_sub1_sub10.remove();
				class246_sub1_sub10.removeDual();
			...
			do {
				...
				if (class246_sub1_sub10 == null)
					return null;
				if (class246_sub1_sub10.method2607(i - 1162) > TimeUtility.time())
					return null;
				class246_sub1_sub10.remove();
				class246_sub1_sub10.removeDual();
			} while ((((NodeSub) class246_sub1_sub10).aLong3739 & ~0x7fffffffffffffffL) == 0L);
			return class246_sub1_sub10;
		} catch (RuntimeException runtimeexception) {
