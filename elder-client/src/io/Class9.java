...
final class Class9 {
	...
	static int[] anIntArray107 = { 0, 1, 3, 7, 15, 31, 63, 127, 255, 511, 1023, 2047, 4095, 8191, 16383, 32767, 65535,
		...
		try {
			...
			if (Class106.tiles != null) {
				...
				if (((Class246_Sub6) class246_sub6).anInt3927 == 0)
					class_f = ((Class_f) (Class246_Sub22.method2082(((Class246_Sub6) class246_sub6).anInt3936,
							((Class246_Sub6) class246_sub6).anInt3928, ((Class246_Sub6) class246_sub6).anInt3925)));
				if (((Class246_Sub6) class246_sub6).anInt3927 == 1)
					class_f = ((Class_f) Class31.method236((((Class246_Sub6) class246_sub6).anInt3936),
							(((Class246_Sub6) class246_sub6).anInt3928), (((Class246_Sub6) class246_sub6).anInt3925)));
				if ((((Class246_Sub6) class246_sub6).anInt3927 ^ 0xffffffff) == -3)
					class_f = ((Class_f) (Class17.method168(((Class246_Sub6) class246_sub6).anInt3936,
							((Class246_Sub6) class246_sub6).anInt3928, ((Class246_Sub6) class246_sub6).anInt3925,
							(aClass114 != null ? aClass114 : (aClass114 = Client.getClassByName("Class_f"))))));
				if (i >= 13) {
					if (((Class246_Sub6) class246_sub6).anInt3927 == 3)
						class_f = ((Class_f) (Class246_Sub14.method1997(((Class246_Sub6) class246_sub6).anInt3936,
								((Class246_Sub6) class246_sub6).anInt3928, ((Class246_Sub6) class246_sub6).anInt3925)));
					if (class_f == null) {
			...
			throw Class193.method1272(runtimeexception,
					("at.B(" + i + ',' + (class246_sub6 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	static {
		aCharArray106 = new char[] { '_', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o',
