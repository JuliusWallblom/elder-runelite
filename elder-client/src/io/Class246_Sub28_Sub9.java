...
final class Class246_Sub28_Sub9 extends TextureOperation {
	...
	final void method2573(int[] is, byte i, int i_0_) {
		try {
			anInt6134++;
			int i_1_ = (Varc.anIntArray6245[i_0_] * ((Class246_Sub28_Sub9) this).anInt6149);
			if (i <= 114)
				method2134(false);
			if (((Class246_Sub28_Sub9) this).anInt6136 != 1) {
				...
				if ((i_2_ ^ 0xffffffff) < -9 || (i_2_ ^ 0xffffffff) > 7) {
					...
					int i_10_ = InvTypeLoader.anIntArray839[i_4_];
				...
				for (int i_15_ = 1; ((Class246_Sub28_Sub9) this).anInt6136 > i_15_; i_15_++) {
					...
					if (i_2_ > 8 || (i_2_ ^ 0xffffffff) > 7) {
						...
						if (i_19_ <= i_21_)
							i_21_ = 0;
						i_18_ &= 0xfff;
						int i_22_ = InvTypeLoader.anIntArray839[i_18_];
				...
				if (i_37_ >= i_34_)
					i_37_ = 0;
				int i_38_ = InvTypeLoader.anIntArray839[i_33_];
	...
	private final int method2574(int i, int i_47_, int i_48_, int i_49_, int i_50_, int i_51_, int i_52_) {
		try {
			...
			int i_57_ = InvTypeLoader.anIntArray839[i_51_];
	...
	final void method2143(int i, int i_65_, Buffer stream) {
		try {
			int i_66_ = i_65_;
			while_88_: do {
				while_87_: do {
					while_86_: do {
						while_85_: do {
							while_84_: do {
								do {
									if ((i_66_ ^ 0xffffffff) != -1) {
										...
										((Class246_Sub28_Sub9) this).aBool6150 = (stream.readUnsignedByte() ^ 0xffffffff) == -2;
										break while_88_;
									}
									((Class246_Sub28_Sub9) this).anInt6136 = stream.readUnsignedByte();
									break while_88_;
								} while (false);
							...
							((Class246_Sub28_Sub9) this).anInt6137 = ((Class246_Sub28_Sub9) this).anInt6149 = stream.readUnsignedByte();
							break while_88_;
						} while (false);
						((Class246_Sub28_Sub9) this).anInt6151 = stream.readUnsignedByte();
						break while_88_;
					} while (false);
					((Class246_Sub28_Sub9) this).anInt6137 = stream.readUnsignedByte();
					break while_88_;
				} while (false);
				((Class246_Sub28_Sub9) this).anInt6149 = stream.readUnsignedByte();
			} while (false);
			if (i != 4)
	...
	final int[] method2135(int i, int i_70_) {
		try {
			anInt6152++;
			int[] is = ((TextureOperation) this).aClass66_4938.method435((byte) -112, i_70_);
