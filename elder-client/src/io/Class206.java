...
public final class Class206 {
	...
	private IterableNodeHashTable aClass85_2893;
	...
	private final void method1344(int i, Interface2 interface2) {
		try {
			...
			Class246_Sub1_Sub15 class246_sub1_sub15 = (Class246_Sub1_Sub15) aClass85_2893.get(l);
			if (i <= 33)
				aClass217_2904 = null;
		...
		do {
			try {
				...
				if (class246_sub1_sub15 == null)
					break;
				class246_sub1_sub15.remove();
				class246_sub1_sub15.removeDual();
	...
	final Object method1347(Interface2 interface2, int i) {
		try {
			...
			if (i != 14278)
				method1345(88);
			for (Class246_Sub1_Sub15 class246_sub1_sub15 = (Class246_Sub1_Sub15) aClass85_2893.get(l); class246_sub1_sub15 != null; class246_sub1_sub15 = (Class246_Sub1_Sub15) aClass85_2893.method541(-1)) {
				if (((Class246_Sub1_Sub15) class246_sub1_sub15).anInterface2_6604.method5(interface2, i + 13120)) {
					...
					if (object == null) {
						...
						if (class246_sub1_sub15.method2714((byte) 114)) {
							...
							((NodeSub) class246_sub1_sub15_sub2).aLong3739 = 0L;
							class246_sub1_sub15.remove();
							class246_sub1_sub15.removeDual();
						} else {
							aClass217_2904.method1407(-115, class246_sub1_sub15);
							((NodeSub) class246_sub1_sub15).aLong3739 = 0L;
						}
						return object;
					}
				}
			...
			try {
				...
				for (Class246_Sub1_Sub15 class246_sub1_sub15 = ((Class246_Sub1_Sub15) aClass217_2904.method1408((byte) 87)); class246_sub1_sub15 != null; class246_sub1_sub15 = ((Class246_Sub1_Sub15) aClass217_2904.method1411(true))) {
					if (!class246_sub1_sub15.method2714((byte) 95)) {
						if ((++((NodeSub) class246_sub1_sub15).aLong3739 ^ 0xffffffffffffffffL) < ((long) i_3_ ^ 0xffffffffffffffffL)) {
							...
							ParamType.method813(true, class246_sub1_sub15, class246_sub1_sub15_5_);
							class246_sub1_sub15.remove();
							class246_sub1_sub15.removeDual();
						}
	...
	Class206(int i) {
		try {
			...
			aClass85_2893 = new IterableNodeHashTable(i_7_);
		} catch (RuntimeException runtimeexception) {
