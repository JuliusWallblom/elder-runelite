...
final class qa extends SceneGraph implements Class_d {
	long nativeid = 0L;
	...
	private IterableNodeHashTable L;
	private boolean N;
	private int O;
	private Class_n[] P;
	...
	final AbstractSprite ld_to_abstract_sprite(LDSprite class10, boolean bool) {
		...
		byte[] is_12_ = ((LDSprite) class10).aByteArray157;
		int i = ((LDSprite) class10).anInt156;
		int i_13_ = ((LDSprite) class10).anInt155;
		AbstractSprite class_l;
		if (bool && ((LDSprite) class10).aByteArray161 == null)
			class_l = new Class_k(this, u, is, is_12_, 0, ((LDSprite) class10).anInt156, ((LDSprite) class10).anInt156,
					((LDSprite) class10).anInt155);
		else {
			int i_14_ = i * i_13_;
			int[] is_15_ = new int[i_14_];
			byte[] is_16_ = ((LDSprite) class10).aByteArray161;
			if (is_16_ != null) {
				...
				for (int i_21_ = 0; i_21_ < i_14_; i_21_++) {
					int i_22_ = (((LDSprite) class10).anIntArray160[is_12_[i_21_] & 0xff]);
					if (i_22_ >>> 24 != 255)
						bool_20_ = true;
					is_15_[i_21_] = i_22_;
				}
				if (bool_20_)
					class_l = new ra(this, u, is_15_, 0, ((LDSprite) class10).anInt156, ((LDSprite) class10).anInt156,
							((LDSprite) class10).anInt155);
				else
					class_l = new ia(this, u, is_15_, 0, ((LDSprite) class10).anInt156, ((LDSprite) class10).anInt156,
							((LDSprite) class10).anInt155);
			}
		}
	...
	private final native void A(int i, int i_23_, int i_24_, int i_25_, int i_26_, int i_27_, Class128 class128,
			int i_28_, int i_29_);
	...
	final AbstractSprite method1721(int i, int i_58_, int i_59_, int i_60_, boolean bool) {
		if (bool)
	...
	final void method1690(Canvas canvas) {
		za var_za = (za) L.get((long) canvas.hashCode());
		if (var_za == null) {
			try {
	...
	final AbstractSprite method1706(int[] is, int i, int i_79_, int i_80_, int i_81_) {
		boolean bool = false;
		int i_82_ = i;
	...
	final AbstractSprite method1706_osrs(int[] is, int i, int i_79_, int i_80_, int i_81_) {
		boolean bool = false;
		int i_82_ = i;
		while_149_: for (int i_83_ = 0; i_83_ < i_81_; i_83_++) {
			for (int i_84_ = 0; i_84_ < i_80_; i_84_++) {
	...
	final void method1740(AbstractModel[] class_ts, Class129 class129, Class_c class_c, Class130_Sub5[] class130_sub5s,
		...
		if (class130_sub5s == null)
			E().Y(this, class_ts, class_c, null, i, J, B, w, G, D, ((Class129) class129).aClass220_1802.method1430(-75),
					E);
		else {
	...
	final void method1728(int i, int i_88_, int i_89_, int i_90_, int i_91_, int i_92_, Class128 class128, int i_93_,
			int i_94_) {
	...
	final void method1717(int i, int i_99_, int i_100_, int i_101_, int i_102_, int i_103_, int i_104_, int i_105_,
	...
	private final native void K(TextureInterface interface6, int i, int i_118_);
	...
	final void method1703(AbstractModel class_t, Class129 class129, Class_c class_c, Class130_Sub5 class130_sub5,
		...
		if (class130_sub5 == null)
			E().ba(this, class_t, class_c, null, i, J, B, w, G, D, ((Class129) class129).aClass220_1802.method1430(-77),
					E);
		else {
			v[5] = 0;
	...
	private final native void aa(short i, byte i_143_, byte i_144_, boolean bool, boolean bool_145_, boolean bool_146_,
			byte i_147_, byte i_148_, byte i_149_, int i_150_, int i_151_, boolean bool_152_, boolean bool_153_);

	final native void da(int[] is);

	private final native void q(short i, byte i_154_, byte i_155_, boolean bool, boolean bool_156_, boolean bool_157_,
			byte i_158_, byte i_159_, byte i_160_, int i_161_, int i_162_, boolean bool_163_, boolean bool_164_,
			int[] is);
	...
	private final boolean R(short i) {
		synchronized (this) {
			Material class238 = ((SceneGraph) this).anInterface6_3714.get_material(-31305, i);
			if (class238 == null)
				return false;
			aa(i, ((Material) class238).aByte3344, ((Material) class238).brightness, ((Material) class238).aBool3340,
					((Material) class238).aBool3339, ((Material) class238).aBool3348,
					((Material) class238).animationDirection,
					((Material) class238).animationSpeed, ((Material) class238).aByte3343,
					((Material) class238).aShort3354,
					((Material) class238).anInt3341, ((Material) class238).aBool3352, ((Material) class238).aBool3353);
		}
		return true;
	}
	...
	final AbstractModel method1695(Model class103, int i, int i_179_, int i_180_, int i_181_) {
	...
	public qa(int i, Canvas canvas, TextureInterface interface6, Signlink class52) {
		super(i, interface6);
		z = 4096;
		L = new IterableNodeHashTable(4);
		N = false;
		try {
			...
			K(((SceneGraph) this).anInterface6_3714, 0, 0);
	...
	private final boolean sa(short texture_id) {
		synchronized (((SceneGraph) this).anInterface6_3714) {
			...
			if (class238 == null)
				return false;
			int[] is;
			if (!TextureLoader.osrs(texture_id) && ((Material) class238).aBool3339 && ((Material) class238).aBool3340)
				is = ((SceneGraph) this).anInterface6_3714.method14(true, 5754, texture_id, 0.7F, 128, 128);
			else
				is = ((SceneGraph) this).anInterface6_3714.method16(true, texture_id, false, 0.7F, 128, 128);
			q(texture_id, ((Material) class238).aByte3344, ((Material) class238).brightness,
					((Material) class238).aBool3340, ((Material) class238).aBool3339, ((Material) class238).aBool3348,
					((Material) class238).animationDirection, ((Material) class238).animationSpeed,
					((Material) class238).aByte3343,
					((Material) class238).aShort3354, ((Material) class238).anInt3341, ((Material) class238).aBool3352,
					((Material) class238).aBool3353, is);
		}
		return true;
	}
