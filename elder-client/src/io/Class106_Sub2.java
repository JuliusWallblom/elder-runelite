...
final class Class106_Sub2 extends Class106 {
	...
	static AbstractSprite[] aClass_lArray5340;
	...
	static final void method2262(int i) {
		try {
			Class82.underlay_loader.method704(i - 20379);
			anInt5334++;
			ContextMenus.overlay_loader.method1154(7);
			Material.aClass92_3358.method591(false);
			Class143.aClass251_2067.method1607((byte) 72);
			Class179.aClass228_2518.method1454((byte) 107);
			MapRegion.aClass191_3663.method1250(36);
			...
			ParamType.aClass_v1641.method693(-26);
			Client.map_scenes.method1646((byte) -127);
			Client.map_functions.method1096(i + 6028);
			...
			CacheIndex.aClass156_150.method1034(64);
			Class246_Sub28_Sub25.struct_loader.method395(-2049);
			NodeSub.method1758((byte) -60);
			ContextMenus.method2708((byte) 25);
			Class180.method1177((byte) 30);
			Class187.method1225((byte) -57);
			if (i == 20378) {
				MapFunction.aClass54_2034.method383(87);
				...
				ScriptExecutor.aClass54_2139.method383(127);
			}
		} catch (RuntimeException runtimeexception) {
	...
	private final void method2263(int i) {
		try {
			...
			if ((anInt5327 ^ 0xffffffff) != -22) {
				if (anInt5327 != 20) {
					if ((anInt5327 ^ 0xffffffff) > -31 || anInt5327 > 33) {
						if ((anInt5327 ^ 0xffffffff) > -41 || (anInt5327 ^ 0xffffffff) < -44) {
							...
							((Class210) object).method1384(Class244.anInt3454, Class59_Sub2_Sub2.anInt6025,
									Class125.anInt1777, Class251.aBoolArrayArray3556,
									(-40 + anInt5327 ^ 0xffffffff) == -1);
						}
					} else {
						Class259_Sub3.aClass260_5357.g(3000.0F, (((Class106) this).aFloatArray1495[i_0_]) * 1.5F);
						((Class210) object).method1384(Class244.anInt3454, Class59_Sub2_Sub2.anInt6025,
								Class125.anInt1777, Class187_Sub1.aBoolArrayArray4866,
								(-30 + anInt5327 ^ 0xffffffff) == -1);
					}
				} else {
					Tile class147 = (Tile) object;
					if (((Tile) class147).aClass59_Sub4_2172 != null)
						((Tile) class147).aClass59_Sub4_2172.method403(Class259_Sub3.aClass260_5357, 57);
					if (((Tile) class147).aClass59_Sub4_2152 != null)
						((Tile) class147).aClass59_Sub4_2152.method403(Class259_Sub3.aClass260_5357, 115);
					if (((Tile) class147).aClass59_Sub2_2153 != null)
						((Tile) class147).aClass59_Sub2_2153.method403(Class259_Sub3.aClass260_5357, 85);
					if (((Tile) class147).aClass59_Sub2_2159 != null)
						((Tile) class147).aClass59_Sub2_2159.method403(Class259_Sub3.aClass260_5357, 115);
					if (((Tile) class147).floorDecorationIThink != null)
						((Tile) class147).floorDecorationIThink.method403(Class259_Sub3.aClass260_5357, 111);
				...
				Class303.method1073(aClass100_5325, (Tile) object);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	final void method726(int i, boolean bool, Class210 class210, float f, byte i_1_) {
		do {
			try {
				...
				throw Class193.method1272(runtimeexception, ("tl.E(" + i + ',' + bool + ','
						+ (class210 != null ? "{...}" : "null") + ',' + f + ',' + i_1_ + ')'));
			}
			break;
		} while (false);
	}
	...
	final void method723(Tile class147, byte i) {
		do {
			try {
				anInt5332++;
				...
				throw Class193.method1272(runtimeexception,
						("tl.H(" + (class147 != null ? "{...}" : "null") + ',' + i + ')'));
			}
			break;
		} while (false);
	}

	final void method725(byte i, Tile class147) {
		do {
			try {
				((Class106) this).anInt1489--;
				anInt5326++;
	...
	final void method727(Tile class147, int i) {
		do {
			try {
		...
		try {
			...
			for (int i_7_ = 0; i_7_ < Class38_Sub1_Sub1.anInt6770; i_7_++) {
				for (int i_8_ = 0; (Class152.anInt2205 ^ 0xffffffff) < (i_8_ ^ 0xffffffff); i_8_++) {
					if (Class166.method1099(i_7_, true, i + 61820, i_8_, i_6_, (tiles)))
						i_6_++;
	...
	static {
		...
		new MultilingualString("You are temporarily banned from this clan channel.",
