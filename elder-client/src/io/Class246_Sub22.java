...
final class Class246_Sub22 extends Node {
	...
	static final void method2081(Class100 class100, int i, int i_0_, int i_1_) {
		long l = MapRegion.aLongArrayArrayArray3648[i][i_0_][i_1_];
		long l_2_ = 0L;
		...
		for (/**/; l_2_ <= 48L; l_2_ += 16L) {
			...
			if (i_3_ <= 0)
				break;
			((Class100) class100).aClass246_Sub41Array1301[((Class100) class100).anInt1298++] = (((Class174) StructLoader.aClass174Array811[i_3_
					- 1]).aClass246_Sub41_2452);
		}
	...
	static final Class59_Sub4 method2082(int i, int i_5_, int i_6_) {
		Tile class147 = Class106.tiles[i][i_5_][i_6_];
		if (class147 == null)
			return null;
		return ((Tile) class147).aClass59_Sub4_2172;
	}
	...
	static final int method2083(int i, int i_7_, int i_8_, int i_9_, byte i_10_) {
		try {
			...
			if (i_10_ != -79)
				return -36;
			int i_11_ = 65536 + -MathUtils.COSINE[i * 8192 / i_7_] >> 1;
			return (i_9_ * i_11_ >> 16) + ((65536 - i_11_) * i_8_ >> 16);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("lm.D(" + i + ',' + i_7_ + ',' + i_8_ + ',' + i_9_ + ',' + i_10_ + ')'));
		}
	}
	...
	static final void method2084(int i, byte i_12_, int i_13_, int i_14_) {
		try {
			...
			if ((Class130_Sub3.anInt4417 ^ 0xffffffff) == -3) {
				FontMetric.anInt961 = i_13_;
				Class244.anInt3456 = i;
				Class106_Sub1.anInt4179 = i_14_;
			}
			Camera.camera_pitch = (float) i;
			Camera.camera_yaw = (float) i_13_;
	...
	static {
		new MultilingualString("You have been kicked from the channel.", "Du wurdest aus dem Chatraum rausgeworfen.",
