...
final class Class21_Sub4 extends Class21 {
	...
	static final SceneGraph method2130(int i, Canvas canvas, int i_0_, Signlink class52, int i_1_,
			TextureInterface interface6) {
		try {
			anInt4928++;
			if (i_0_ != -3210)
				return null;
			...
			throw Class193.method1272(runtimeexception,
					("ob.G(" + i + ',' + (canvas != null ? "{...}" : "null") + ',' + i_0_ + ','
							+ (class52 != null ? "{...}" : "null") + ',' + i_1_ + ','
	...
	final void method196(int i, int i_8_, int i_9_) {
		try {
			...
			Class128.method874(((Class21) this).anInt317, ((Class21) this).anInt319, i_10_, ((Class21) this).anInt321,
					i_12_, i_11_, 19173, i_13_);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, ("ob.D(" + i + ',' + i_8_ + ',' + i_9_ + ')'));
		}
	}

	static final void method2132(SceneGraph class260) {
		for (int i = Class246_Sub37_Sub4.anInt6880; i < Class154_Sub1.anInt4803; i++) {
			for (int i_14_ = 0; i_14_ < Class240.xSize; i_14_++) {
				for (int i_15_ = 0; i_15_ < HDModel.ySize; i_15_++) {
					Tile class147 = (Class106.tiles[i][i_14_][i_15_]);
					if (class147 != null) {
						...
						for (Class3 class3 = ((Tile) class147).aClass3_2160; class3 != null; class3 = ((Class3) class3).aClass3_28) {
							...
							if (class59_sub3 != null && class59_sub3.method406((byte) 109)) {
								Class246_Sub28_Sub8.method2560(class260, class59_sub3, i, i_14_, i_15_,
						...
						if (class59_sub1 != null && class59_sub1.method406((byte) 123)) {
							MapFunction.method951(class260, class59_sub1, i, i_14_, i_15_);
	...
	Class21_Sub4(int i, int i_17_, int i_18_, int i_19_, int i_20_, int i_21_, int i_22_) {
		...
		try {
			...
			throw Class193.method1272(runtimeexception, ("ob.<init>(" + i + ',' + i_17_ + ',' + i_18_ + ',' + i_19_
					+ ',' + i_20_ + ',' + i_21_ + ',' + i_22_ + ')'));
		}
	}
