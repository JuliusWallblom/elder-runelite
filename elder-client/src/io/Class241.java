...
import io.osrs_chat.ChatChannel;
...
final class Class241 implements Runnable {
	...
	final Clan method1538(int i, Class208 class208, int i_0_) {
		try {
			anInt3393++;
			Clan class246_sub1_sub6_sub2 = new Clan();
			((Class246_Sub1_Sub6) class246_sub1_sub6_sub2).aBool5964 = false;
			((Clan) class246_sub1_sub6_sub2).aClass208_7107 = class208;
			((Clan) class246_sub1_sub6_sub2).anInt7110 = 3;
			((NodeSub) class246_sub1_sub6_sub2).aLong3739 = (long) i_0_;
			method1541(i, class246_sub1_sub6_sub2);
			return class246_sub1_sub6_sub2;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("vl.G(" + i + ',' + (class208 != null ? "{...}" : "null") + ',' + i_0_ + ')'));
		}
	}

	final Clan method1539(Class208 class208, int i, int i_1_) {
		try {
			anInt3390++;
			Clan class246_sub1_sub6_sub2 = new Clan();
			((Clan) class246_sub1_sub6_sub2).anInt7110 = 1;
			synchronized (aClass217_3396) {
				for (Clan class246_sub1_sub6_sub2_2_ = ((Clan) aClass217_3396.method1408(
						(byte) 87)); class246_sub1_sub6_sub2_2_ != null; class246_sub1_sub6_sub2_2_ = ((Clan) aClass217_3396
								.method1411(true))) {
					if ((((long) i_1_ ^ 0xffffffffffffffffL) == ((((NodeSub) class246_sub1_sub6_sub2_2_).aLong3739)
							^ 0xffffffffffffffffL)) && (((Clan) class246_sub1_sub6_sub2_2_).aClass208_7107 == class208)
							&& (((Clan) class246_sub1_sub6_sub2_2_).anInt7110 ^ 0xffffffff) == -3) {
						((Class246_Sub1_Sub6) class246_sub1_sub6_sub2).aBool5960 = false;
						((Clan) class246_sub1_sub6_sub2).aByteArray7108 = ((Clan) class246_sub1_sub6_sub2_2_).aByteArray7108;
						return class246_sub1_sub6_sub2;
					}
				}
			}
			((Clan) class246_sub1_sub6_sub2).aByteArray7108 = class208.method1366(407064624, i_1_);
			...
			throw Class193.method1272(runtimeexception,
					("vl.D(" + (class208 != null ? "{...}" : "null") + ',' + i + ',' + i_1_ + ')'));
		}
	}
	...
	public final void run() {
		try {
			anInt3395++;
			while (!aBool3405) {
				Clan class246_sub1_sub6_sub2;
				synchronized (aClass217_3396) {
					class246_sub1_sub6_sub2 = ((Clan) aClass217_3396.method1410((byte) 93));
				...
				try {
					if ((((Clan) class246_sub1_sub6_sub2).anInt7110) != 2) {
						if (((Clan) class246_sub1_sub6_sub2).anInt7110 == 3)
							((Clan) class246_sub1_sub6_sub2).aByteArray7108 = (((Clan) class246_sub1_sub6_sub2).aClass208_7107
									.method1366(407064624, (int) (((NodeSub) class246_sub1_sub6_sub2).aLong3739)));
					} else
						((Clan) class246_sub1_sub6_sub2).aClass208_7107.method1367(
								((Clan) class246_sub1_sub6_sub2).aByteArray7108, false,
								(int) (((NodeSub) class246_sub1_sub6_sub2).aLong3739),
								((Clan) class246_sub1_sub6_sub2).aByteArray7108.length);
	...
	private final void method1541(int i, Clan class246_sub1_sub6_sub2) {
		try {
			synchronized (aClass217_3396) {
			...
			throw Class193.method1272(runtimeexception,
					("vl.H(" + i + ',' + (class246_sub1_sub6_sub2 != null ? "{...}" : "null") + ')'));
		}
	}

	final Clan method1542(int i, int i_3_, byte[] is, Class208 class208) {
		try {
			anInt3399++;
			Clan class246_sub1_sub6_sub2 = new Clan();
			((NodeSub) class246_sub1_sub6_sub2).aLong3739 = (long) i_3_;
			((Clan) class246_sub1_sub6_sub2).anInt7110 = 2;
			((Clan) class246_sub1_sub6_sub2).aByteArray7108 = is;
			((Clan) class246_sub1_sub6_sub2).aClass208_7107 = class208;
			((Class246_Sub1_Sub6) class246_sub1_sub6_sub2).aBool5964 = false;
			method1541(-1, class246_sub1_sub6_sub2);
			return class246_sub1_sub6_sub2;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, ("vl.E(" + i + ',' + i_3_ + ','
					+ (is != null ? "{...}" : "null") + ',' + (class208 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	static final void method1545(byte i, int i_7_, String string, String message, String string_9_, int i_10_,
			String string_11_, int type) {
		try {
			ChatChannel var4 = (ChatChannel) Message.channels.get(type);
			if (var4 == null) {
				var4 = new ChatChannel();
				Message.channels.put(type, var4);
			}
			Message var5 = var4.addMessage(message, string, type, "");
			Message.messages.method547((long) var5.count, -2301, var5);
			Message.queue.add(var5);
			...
			throw Class193.method1272(runtimeexception,
					("vl.B(" + i + ',' + i_7_ + ',' + (string != null ? "{...}" : "null") + ','
							+ (message != null ? "{...}" : "null") + ',' + (string_9_ != null ? "{...}" : "null") + ','
							+ i_10_ + ',' + (string_11_ != null ? "{...}" : "null") + ',' + type + ')'));
		}
	}

	static final void method1546(int i, int i_14_, int revision) {
		do {
			try {
				anInt3394++;
				if (Widget.load_widget(i, revision, 4)) {
					Widget[] class235s = Widget.get_widget_cache(revision)[i];
					for (int i_15_ = 0; ((class235s.length ^ 0xffffffff) < (i_15_ ^ 0xffffffff)); i_15_++) {
						Widget class235 = class235s[i_15_];
						if (class235 != null) {
