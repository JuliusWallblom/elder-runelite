...
final class Class109_Sub4 extends Class109 {
	...
	static MultilingualString aClass67_4568;
	...
	Class109_Sub4(Class260_Sub2 class260_sub2, int i, int i_0_, boolean bool, byte[][] is, int i_1_) {
		...
		try {
			...
			for (int i_2_ = 0; (i_2_ ^ 0xffffffff) > -7; i_2_++)
				OpenGL.glTexImage2Dub(i_2_ + 34069, 0, ((Class109) this).anInt1556, i_0_, i_0_, 0, i_1_, 5121, is[i_2_],
						0);
			this.method753(80, true);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, ("im.<init>(" + (class260_sub2 != null ? "{...}" : "null") + ','
					+ i + ',' + i_0_ + ',' + bool + ',' + (is != null ? "{...}" : "null") + ',' + i_1_ + ')'));
		}
	}
		...
		try {
			...
			if (!bool) {
				for (int i_9_ = 0; (i_9_ ^ 0xffffffff) > -7; i_9_++)
					OpenGL.glTexImage2Di(i_9_ + 34069, 0, ((Class109) this).anInt1556, i_8_, i_8_, 0, 32993,
							((Class260_Sub2) (((Class109) this).aClass260_Sub2_1552)).f_sg, is[i_9_], 0);
			} else {
				for (int i_10_ = 0; (i_10_ ^ 0xffffffff) > -7; i_10_++)
					Class21_Sub1.method1815(32993, is[i_10_], ((Class109) this).anInt1556, i_8_, i_8_,
							((Class260_Sub2) (((Class109) this).aClass260_Sub2_1552)).f_sg, i_10_ + 34069, 17054);
			}
			this.method753(94, true);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, ("im.<init>(" + (class260_sub2 != null ? "{...}" : "null") + ','
					+ i + ',' + i_8_ + ',' + bool + ',' + (is != null ? "{...}" : "null") + ')'));
		}
	}
	...
	Class109_Sub4(Class260_Sub2 class260_sub2, int i, int i_11_) {
		...
		try {
			...
			for (int i_12_ = 0; i_12_ < 6; i_12_++)
				OpenGL.glTexImage2Dub(34069 + i_12_, 0, ((Class109) this).anInt1556, i_11_, i_11_, 0,
						ParamLoader.method1086((((Class109) this).anInt1556), 13519), 5121, null, 0);
			this.method753(104, true);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("im.<init>(" + (class260_sub2 != null ? "{...}" : "null") + ',' + i + ',' + i_11_ + ')'));
		}
	}
	...
	static {
		new MultilingualString("Unable to add friend - unknown player.",
		...
		anInt4570 = 100;
		aClass67_4568 = (new MultilingualString("Please wait - attempting to reestablish.",
