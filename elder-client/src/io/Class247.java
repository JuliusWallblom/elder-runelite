...
final class Class247 {
	...
	static final Class98 method1578(boolean bool, int i) {
		try {
			...
			if (class98 != null)
				return class98;
			byte[] is = Class166.aClass_fs2344.get_file(i, 0);
			class98 = new Class98();
			if (is != null)
				class98.method618(8554, i, new Buffer(is));
		...
		try {
			...
			for (int i_1_ = 0; (i_1_ ^ 0xffffffff) > (is.length ^ 0xffffffff); i_1_++) {
				...
				if (((Class84) class84).anInt1107 != -1) {
					AbstractSprite class_l = ((AbstractSprite) Class56.aClass54_793.method379((long) (((Class84) class84).anInt1107), (byte) 58));
					if (class_l == null) {
						LDSprite class10 = LDSprite.get_sprite(Cache.get_index(Settings.gamefonts, "sprites"), ((Class84) class84).anInt1107, 0);
						if (class10 != null) {
							class_l = Client.sprite_loader.ld_to_abstract_sprite(class10, true);
	...
	static {
		new MultilingualString(null, "der Spieler ist momentan nicht verf\u00fcgbar.", null, null);
