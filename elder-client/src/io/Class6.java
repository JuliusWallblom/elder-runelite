...
final class Class6 implements Runnable {
	...
	static final int getAverageHeight(int worldX, int worldZ, int plane, int i_5_) {
		try {
			...
			int x = worldX >> 7;
			int z = i_5_ >> 7;
			if ((x ^ 0xffffffff) > -1 || (z ^ 0xffffffff) > -1 || Class38_Sub1_Sub1.anInt6770 - 1 < x
					|| (Class152.anInt2205 - 1 ^ 0xffffffff) > (z ^ 0xffffffff))
				return 0;
			int y = plane;
			if (y < 3 && (0x2 & Class45.tileRenderFlags[1][x][z] ^ 0xffffffff) != -1)
				y++;
			return Class59_Sub3_Sub4.aClass210Array6993[y].a(worldX, i_5_);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("al.A(" + worldX + ',' + worldZ + ',' + plane + ',' + i_5_ + ')'));
		}
	}
	...
	static final boolean method71(int i, int i_11_, int i_12_) {
		try {
			...
			if (i != -20147)
				aString68 = null;
			if ((i_12_ & 0xb000) != 0 | Class59_Sub2_Sub2.method2545(i_11_, i_12_, (byte) 107)
					| Class246_Sub1_Sub5.method2470(i_12_, i_11_, (byte) -60))
				return true;
			return ((Class40_Sub3.method1863(i_11_, i ^ 0x4ece, i_12_)
					| SubIncomingPacket.method2899(i_11_, (byte) 107, i_12_)) & (0x37 & i_11_ ^ 0xffffffff) == -1);
		} catch (RuntimeException runtimeexception) {
	...
	final void method76(int i, int i_14_, byte[] is, int i_15_) throws IOException {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("al.D(" + i + ',' + i_14_ + ',' + (is != null ? "{...}" : "null") + ',' + i_15_ + ')'));
		}
	}
	...
	Class6(Socket socket, Signlink class52) throws IOException {
		...
		try {
			...
			throw Class193.method1272(runtimeexception, ("al.<init>(" + (socket != null ? "{...}" : "null") + ','
					+ (class52 != null ? "{...}" : "null") + ')'));
		}
	}
}
