...
abstract class Class38 {
	...
	static final void method262(int i, int i_0_, SceneGraph class260, int i_1_, int i_2_, int i_3_) {
		do {
			try {
				...
				if (Renderer.anInt571 >= 100) {
					...
					i_1_ += (-i_4_ + i) / 2;
					i_2_ += (i_3_ + -i_5_) / 2;
					if (SequenceType.aClass_l1733 == null
							|| (i ^ 0xffffffff) != (SequenceType.aClass_l1733.la() ^ 0xffffffff)
							|| SequenceType.aClass_l1733.ma() != i_3_) {
						Class79.method517(Class79.anInt1057, (Class79.anInt1041 + Class79.anInt1058),
								(Class79.anInt1057 - -Class79.anInt1054), Class79.anInt1041, i_1_, i_2_, i_1_ - -i_4_,
								i_2_ - -i_5_);
						Class79.method512(class260);
						SequenceType.aClass_l1733 = class260.method1721(i_1_, i_2_, i_4_, i_5_, false);
					}
					SequenceType.aClass_l1733.draw_sprite(i_1_, i_2_);
					...
					int i_10_ = -i_7_ + (-(SceneGraph.anInt3724 * i_5_ / Class79.anInt1058) + i_5_) + i_2_;
					...
					for (Class246_Sub2 class246_sub2 = ((Class246_Sub2) Class79.aClass166_1034.method1104(
							110)); class246_sub2 != null; class246_sub2 = (Class246_Sub2) Class79.aClass166_1034
									.method1108((byte) -112)) {
						MapFunction class140 = (Class79.aClass165_1022
								.method1088(((Class246_Sub2) class246_sub2).anInt3808, (byte) -41));
						if (Class242.method1562(class140, 2)) {
							if (((Class246_Sub2) class246_sub2).anInt3808 != Class246_Sub28_Sub4.anInt5975) {
								if ((Class246_Sub28_Sub33.anInt6968 ^ 0xffffffff) != 0
										&& (Class246_Sub28_Sub33.anInt6968 == ((MapFunction) class140).anInt2014)) {
									int i_13_ = (i_1_ - -((((Class246_Sub2) class246_sub2).anInt3807) * i_4_
											/ Class79.anInt1054));
									int i_14_ = ((i_5_
											* (Class79.anInt1058 + -((Class246_Sub2) class246_sub2).anInt3801)
											/ Class79.anInt1058) + i_2_);
									class260.method1734(-2 + i_13_, 4, i_14_ - 2, (byte) 58, i_12_ << 24 | 0xffff00, 4);
								}
							} else {
								int i_15_ = i_1_
										- -((((Class246_Sub2) class246_sub2).anInt3807) * i_4_ / Class79.anInt1054);
								int i_16_ = ((i_5_ * (Class79.anInt1058 - (((Class246_Sub2) class246_sub2).anInt3801))
										/ Class79.anInt1058) + i_2_);
				...
				throw Class193.method1272(runtimeexception, ("df.O(" + i + ',' + i_0_ + ','
						+ (class260 != null ? "{...}" : "null") + ',' + i_1_ + ',' + i_2_ + ',' + i_3_ + ')'));
			}
			break;
		} while (false);
	}
					...
					for (int i_27_ = 0; (i_27_ ^ 0xffffffff) > (i_17_ ^ 0xffffffff); i_27_++) {
						for (int i_28_ = 0; ((Class38) this).anInt556 > i_28_; i_28_++) {
							...
							if (i_32_ > i_39_)
								...
								i_39_ = 0;
							int i_42_ = InvTypeLoader.anIntArray839[i_30_];
							int i_43_ = aShortArray560[i_41_];
							int i_44_ = -4096 + i_33_;
							int i_45_ = i_30_ - 4096;
							int i_46_ = -4096 + i_34_;
							int i_47_ = aShortArray560[i_40_];
							int i_48_ = InvTypeLoader.anIntArray839[i_34_];
							int i_49_ = InvTypeLoader.anIntArray839[i_33_];
	...
	public static void method269(int i) {
		try {
			if (i != 385672172)
				method266(-103);
			Cache.client_cache.set(IndexConstants.PRE_EOC_634_QUICK_CHAT_INDEX, null);
		} catch (RuntimeException runtimeexception) {
	...
	Class38(int i, int i_67_, int i_68_, int i_69_, int i_70_) {
		...
		try {
			...
			throw Class193.method1272(runtimeexception,
					("df.<init>(" + i + ',' + i_67_ + ',' + i_68_ + ',' + i_69_ + ',' + i_70_ + ')'));
		}
	}

	static {
		new MultilingualString("Unable to delete friend - system busy.",
