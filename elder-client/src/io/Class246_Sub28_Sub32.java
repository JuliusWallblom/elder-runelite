...
final class Class246_Sub28_Sub32 extends TextureOperation {
	...
	static AbstractSprite aClass_l6928;
	...
	final int[] method2135(int i, int i_0_) {
		try {
			...
			if (((Class66) ((TextureOperation) this).aClass66_4938).aBool887) {
				int i_2_ = (2048 + anInt6931 * Varc.anIntArray6245[i_0_]);
				int i_3_ = i_2_ >> 12;
				int i_4_ = 1 + i_3_;
				int i_5_ = 0;
	...
	final void method2143(int i, int i_19_, Buffer stream) {
		try {
			if (i != 4)
				method2855(7);
			int i_20_ = i_19_;
							...
							while_63_: do {
								do {
									if (i_20_ != 0) {
										...
										anInt6924 = anInt6931 = stream.readUnsignedByte();
										break while_67_;
									}
									anInt6922 = stream.readUnsignedByte();
									break while_67_;
								} while (false);
								anInt6926 = stream.readUnsignedShort();
								break while_67_;
							} while (false);
							anInt6929 = stream.readUnsignedByte();
							break while_67_;
						} while (false);
						anInt6930 = stream.readUnsignedByte();
						break while_67_;
					} while (false);
					anInt6924 = stream.readUnsignedByte();
					break while_67_;
				} while (false);
				anInt6931 = stream.readUnsignedByte();
			} while (false);
			anInt6934++;
		} catch (RuntimeException runtimeexception) {
