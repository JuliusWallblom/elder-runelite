...
final class Class246_Sub28_Sub31 extends TextureOperation {
	...
	static final Class48[] method2849(boolean bool) {
		try {
			...
			if (bool != true)
				return null;
			return new Class48[] { Class246_Sub1_Sub10.aClass48_6204, Class246_Sub1_Sub10.aClass48_6213,
					Class246_Sub1_Sub10.aClass48_6215, Class246_Sub1_Sub10.aClass48_6216,
					Class246_Sub1_Sub10.aClass48_6217, Class246_Sub1_Sub10.aClass48_6218,
					Class246_Sub1_Sub10.aClass48_6219, Class246_Sub1_Sub10.aClass48_6220,
					Class246_Sub1_Sub10.aClass48_6221, Class246_Sub1_Sub10.aClass48_6222 };
		...
		try {
			...
			if (!Class15.aBool231) {
				...
				do {
					...
					Camera.camera_pitch = (float) (~0xf & -17 + (int) Camera.camera_pitch);
				} while (false);
	...
	static final void method2851(Class166 class166, int i, SceneGraph class260, int i_0_, int i_1_) {
		try {
			...
			if (!Class100_Sub1.aBool5070) {
				if (i != 3)
					anInt6919 = 15;
				for (Class246_Sub2 class246_sub2 = (Class246_Sub2) class166.method1104(
						70); class246_sub2 != null; class246_sub2 = (Class246_Sub2) class166.method1108((byte) -112)) {
					...
					if (Class242.method1562(class140, 2)) {
						boolean bool = ClickMaskNode.method2123(class260, (byte) -83, class246_sub2, class140, i_0_,
								i_1_);
						if (bool)
							Class303.method1074(class140, class246_sub2, (byte) 55, class260);
					}
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, ("tg.C(" + (class166 != null ? "{...}" : "null") + ',' + i + ','
					+ (class260 != null ? "{...}" : "null") + ',' + i_0_ + ',' + i_1_ + ')'));
		}
	}
	...
	static final void method2852(int i, boolean bool, int i_2_, int i_3_) {
		try {
			if (i != 1004) {
				if (i == 1012)
					ScriptExecutor.method993(Client.f_mb, i_3_, i_2_, -1);
				else if (i == 1008)
					ScriptExecutor.method993(Class246_Sub28_Sub6.aClass169_6040, i_3_, i_2_, -1);
	...
	final void method2143(int i, int i_4_, Buffer stream) {
		try {
			if (i != 4)
				anInt6916 = 94;
			int i_5_ = i_4_;
			while_68_: do {
				do {
					if (i_5_ != 0) {
						...
						anInt6910 = stream.readUnsignedByte();
						break while_68_;
					}
					anInt6912 = stream.readUnsignedByte();
					break while_68_;
				} while (false);
				anInt6916 = stream.readUnsignedByte();
			} while (false);
			anInt6915++;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("tg.G(" + i + ',' + i_4_ + ',' + (stream != null ? "{...}" : "null") + ')'));
		}
	}
	...
	final int[] method2135(int i, int i_6_) {
		try {
			...
			if (((Class66) ((TextureOperation) this).aClass66_4938).aBool887) {
				int i_8_ = Varc.anIntArray6245[i_6_];
