...
final class Class40_Sub6 extends Class40 {
	...
	static final void method2182(byte i) {
		do {
			try {
				anInt5097++;
				Class33.aClass260_444.UA(Settings.fog_color, ((Settings.draw_fog) ? Class3.anInt29 + 256 << 0 : -1), 256);
				if (i == -98)
					break;
				aClass101_5092 = null;
			} catch (RuntimeException runtimeexception) {
	...
	static final int method2183(byte i) {
		try {
			...
			synchronized (NpcType.aClass54_3600) {
				return NpcType.aClass54_3600.method378((byte) -120);
			}
		} catch (RuntimeException runtimeexception) {
	...
	final void method278(int i, boolean bool) {
		do {
			try {
				...
				if (i == 0)
					break;
				method2185(49, null, null, null, null, null, null);
			} catch (RuntimeException runtimeexception) {
	...
	static final void method2185(int i, CacheIndex skeleton_index, CacheIndex skin_index, CacheIndex osrs_skeleton_index, CacheIndex osrs_skin_index, CacheIndex skeleton_index_550, CacheIndex skin_index_550) {
		try {
			if (i != 3168)
				aClass101_5092 = null;
			anInt5088++;
			Class_u_Sub1.skeleton_data = skeleton_index;
			Class_u_Sub1.skeleton_data_550 = skeleton_index_550;
			Class_u_Sub1.osrs_skeleton_data = osrs_skeleton_index;
			Class236.skin_data = skin_index;
			Class236.skin_data_550 = skin_index_550;
			Class236.osrs_skin_data = osrs_skin_index;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, ("pv.F(" + (skeleton_index != null ? "{...}" : "null") + ',' + i + ',' + (skin_index != null ? "{...}" : "null") + ')'));
		}
	}
	...
	final void method277(int i, int i_13_, int i_14_) {
		do {
			try {
				...
				if (i_13_ >= 76)
					break;
				method2185(-58, null, null, null, null, null, null);
			} catch (RuntimeException runtimeexception) {
