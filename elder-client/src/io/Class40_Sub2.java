...
final class Class40_Sub2 extends Class40 {
	static MultilingualString aClass67_4034;
		...
		do {
			try {
				...
				if (!aBool4042 || class109_sub4 == null)
					break;
				float f = ((1.0F - Math.abs(((Class260_Sub2) ((Class40) this).aClass260_Sub2_613).aFloatArray4374[1]))
						* 2.0F + 1.0F);
				...
				OpenGL.glUniform3fARB(OpenGL.glGetUniformLocationARB(l, "sunDir"),
						-(((Class260_Sub2) ((Class40) this).aClass260_Sub2_613).aFloatArray4374[0]),
						-(((Class260_Sub2) ((Class40) this).aClass260_Sub2_613).aFloatArray4374[1]),
						-(((Class260_Sub2) ((Class40) this).aClass260_Sub2_613).aFloatArray4374[2]));
				OpenGL.glUniform4fARB(OpenGL.glGetUniformLocationARB(l, "sunColour"),
						f * (((Class260_Sub2) ((Class40) this).aClass260_Sub2_613).f_tg),
						(((Class260_Sub2) ((Class40) this).aClass260_Sub2_613).aFloat4332) * f,
						(((Class260_Sub2) ((Class40) this).aClass260_Sub2_613).aFloat4367) * f, 1.0F);
				OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(l, "sunExponent"), (64.0F
						+ 928.0F * Math.abs(((Class260_Sub2) ((Class40) this).aClass260_Sub2_613).aFloatArray4374[1])));
				aBool4046 = true;
	...
	static final void method1858(long l, SceneGraph class260, int i) {
		do {
			try {
				anInt4039++;
				ClickMaskNode.anInt4906 = Class247.anInt3480;
				Class148.anInt2176 = 0;
				if (i >= 65) {
					Class247.anInt3480 = 0;
					long l_0_ = TimeUtility.time();
					for (Class130_Sub2 class130_sub2 = ((Class130_Sub2) Class216.aClass68_3008.method445(
							62)); class130_sub2 != null; class130_sub2 = (Class130_Sub2) Class216.aClass68_3008
									.method442((byte) -119)) {
					...
					if (!Class14.aBool201 || (l % 100L ^ 0xffffffffffffffffL) != -1L)
						break;
					System.out.println("Particle system count: " + Class216.aClass68_3008.method440((byte) -122)
							+ ", running: " + Class148.anInt2176 + ". Particles: " + Class247.anInt3480
							+ ". Time taken: " + (TimeUtility.time() + -l_0_) + "ms");
				}
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception,
						("dk.C(" + l + ',' + (class260 != null ? "{...}" : "null") + ',' + i + ')'));
			}
			break;
		} while (false);
	}
		...
		try {
			if (aBool4046) {
				...
				OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(l, "time"),
						(float) (((Class260_Sub2) (((Class40) this).aClass260_Sub2_613)).f_qe * i_3_ % 40000)
								/ 40000.0F);
	...
	final void method283(int i, Class109 class109, boolean bool) {
		do {
			try {
				...
				throw Class193.method1272(runtimeexception,
						("dk.B(" + i + ',' + (class109 != null ? "{...}" : "null") + ',' + bool + ')'));
			}
			break;
		} while (false);
	}
	...
	Class40_Sub2(Class260_Sub2 class260_sub2, Class_m class_m) {
		...
		do {
			try {
				...
				if (((Class_m) aClass_m4045).aClass109_Sub3_1542 == null
						|| !(((Class260_Sub2) ((Class40) this).aClass260_Sub2_613).f_bh)
						|| !(((Class260_Sub2) ((Class40) this).aClass260_Sub2_613).aBool4391))
					break;
				Class256 class256 = (Class246_Sub34.method2201((byte) 121, ((Class40) this).aClass260_Sub2_613, 35633,
						"uniform float time;\nuniform float scale;\nvarying vec3 wvVertex;\nvarying float waterDepth;\nvoid main() {\nwaterDepth = gl_MultiTexCoord0.z;\nvec4 ecVertex = gl_ModelViewMatrix*gl_Vertex;\nwvVertex.x = dot(gl_NormalMatrix[0], ecVertex.xyz);\nwvVertex.y = dot(gl_NormalMatrix[1], ecVertex.xyz);\nwvVertex.z = dot(gl_NormalMatrix[2], ecVertex.xyz);\ngl_TexCoord[0].x = dot(gl_TextureMatrix[0][0], gl_MultiTexCoord0)*scale;\ngl_TexCoord[0].y = dot(gl_TextureMatrix[0][1], gl_MultiTexCoord0)*scale;\ngl_TexCoord[0].z = time;\ngl_TexCoord[0].w = 1.0;\ngl_FogFragCoord = 1.0-clamp((gl_Fog.end+ecVertex.z)*gl_Fog.scale, 0.0, 1.0);\ngl_Position = ftransform();\n}\n"));
				Class256 class256_9_ = (Class246_Sub34.method2201((byte) 121, ((Class40) this).aClass260_Sub2_613,
						35632,
				...
				aClass196_4036 = Class138.method935(new Class256[] { class256, class256_9_ },
						((Class40) this).aClass260_Sub2_613, -1);
				aBool4042 = aClass196_4036 != null;
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception, ("dk.<init>(" + (class260_sub2 != null ? "{...}" : "null")
						+ ',' + (class_m != null ? "{...}" : "null") + ')'));
			}
			break;
		} while (false);
	...
	static {
		...
		aClass67_4034 = new MultilingualString(" more options", " weitere Optionen", " autres options",
				" mais op\u00e7\u00f5es");
		aClass81_4049 = new Class81(2, 4, 4, 0);
		aShortArrayArray4050 = (new short[][] {
				...
				{ 8741, 12, -1506, -22374, 7735, 8404, 1701, -27106, 24094, 10153, -8915, 4783, 1341, 16578, -30533,
						25239, 8, 5281, 10438, 3650, -27322, -21845, 200, 571, 908, 21830, 28946, -15701, -14010 },
				{ 25238, 8742, 12, -1506, -22374, 7735, 8404, 1701, -27106, 24094, 10153, -8915, 4783, 1341, 16578,
						-30533, 8, 5281, 10438, 3650, -27322, -21845, 200, 571, 908, 21830, 28946, -15701, -14010 },
