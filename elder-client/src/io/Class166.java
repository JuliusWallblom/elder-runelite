...
final class Class166 {
	...
	static CacheIndex aClass_fs2344;
	...
	final void method1097(int i, Node class246) {
		try {
			if (class246.prev != null)
				class246.remove();
			if (i != 1245184)
				method1097(17, null);
			anInt2351++;
			class246.next = ((Node) ((Class166) this).aClass246_2343).next;
			class246.prev = ((Class166) this).aClass246_2343;
			((Node) class246.prev).next = class246;
			((Node) class246.next).prev = class246;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("pk.A(" + i + ',' + (class246 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	static final void method1098(boolean bool, int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_) {
		try {
			...
			int i_13_ = -i_6_ + i_1_;
			RenderAnimation.method918(-i_0_ + i_1_, -112, i, i_13_, is);
			if (bool == true) {
				int i_14_ = i_1_ + i_6_;
				RenderAnimation.method918(i_13_, 125, i_3_, i_14_, is);
				RenderAnimation.method918(i_14_, -89, i, i_0_ + i_1_, is);
				while ((i_7_ ^ 0xffffffff) < (i_5_ ^ 0xffffffff)) {
					...
					if ((i_8_ ^ 0xffffffff) <= -1) {
						...
						if (i_7_ < i_6_) {
							...
							RenderAnimation.method918(i_19_, 118, i, i_21_, is_15_);
							RenderAnimation.method918(i_21_, -127, i_3_, i_20_, is_15_);
							RenderAnimation.method918(i_20_, -37, i, i_18_, is_15_);
							RenderAnimation.method918(i_19_, 123, i, i_21_, is_16_);
							RenderAnimation.method918(i_21_, 124, i_3_, i_20_, is_16_);
							RenderAnimation.method918(i_20_, -62, i, i_18_, is_16_);
						} else {
							int[] is_22_ = (Class246_Sub28_Sub6.anIntArrayArray6042[i_7_ + i_4_]);
							int[] is_23_ = (Class246_Sub28_Sub6.anIntArrayArray6042[-i_7_ + i_4_]);
							int i_24_ = i_1_ + i_5_;
							int i_25_ = i_1_ + -i_5_;
							RenderAnimation.method918(i_25_, 119, i, i_24_, is_22_);
							RenderAnimation.method918(i_25_, -8, i, i_24_, is_23_);
						}
					}
					...
					int i_29_ = -i_7_ + i_1_;
					if (i_6_ <= i_5_) {
						RenderAnimation.method918(i_29_, 123, i, i_28_, is_26_);
						RenderAnimation.method918(i_29_, -117, i, i_28_, is_27_);
					} else {
						int i_30_ = (i_9_ >= i_5_ ? i_9_ : Class120.anIntArray1649[i_5_]);
						int i_31_ = i_1_ - -i_30_;
						int i_32_ = i_1_ - i_30_;
						RenderAnimation.method918(i_29_, -68, i, i_32_, is_26_);
						RenderAnimation.method918(i_32_, -24, i_3_, i_31_, is_26_);
						RenderAnimation.method918(i_31_, 118, i, i_28_, is_26_);
						RenderAnimation.method918(i_29_, 118, i, i_32_, is_27_);
						RenderAnimation.method918(i_32_, -74, i_3_, i_31_, is_27_);
						RenderAnimation.method918(i_31_, -63, i, i_28_, is_27_);
					}
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("pk.K(" + bool + ',' + i + ',' + i_0_ + ',' + i_1_ + ',' + i_2_ + ',' + i_3_ + ',' + i_4_ + ')'));
		}
	}

	static final boolean method1099(int i, boolean bool, int i_33_, int i_34_, int i_35_, Tile[][][] class147s) {
		try {
			anInt2364++;
			...
			if (i_36_ == (Class5.aByteArrayArrayArray56[Class246_Sub28_Sub24.anInt6681][i][i_34_]))
				return false;
			if ((0x4 & (Class45.tileRenderFlags[Class246_Sub28_Sub24.anInt6681][i][i_34_])) == 0)
				return false;
			int i_37_ = 0;
			int i_38_ = 0;
			if (i_33_ != 32582)
			...
			while ((i_37_ ^ 0xffffffff) != (i_38_ ^ 0xffffffff)) {
				...
				if (((Class45.tileRenderFlags[Class246_Sub28_Sub24.anInt6681][i_39_][i_42_]) & 0x4) == 0)
					bool_44_ = true;
				boolean bool_45_ = false;
				while_172_: for (int i_46_ = Class246_Sub28_Sub24.anInt6681 + 1; (i_46_ ^ 0xffffffff) >= -4; i_46_++) {
					if ((0x8 & (Class45.tileRenderFlags[i_46_][i_39_][i_42_]) ^ 0xffffffff) == -1) {
						if (bool_44_ && class147s[i_46_][i_39_][i_42_] != null) {
							if ((((Tile) class147s[i_46_][i_39_][i_42_]).aClass59_Sub4_2172) != null) {
								int i_47_ = Filestore.method959(i_40_, 20268);
								if (i_47_ == ((Class59_Sub4) (((Tile) class147s[i_46_][i_39_][i_42_]).aClass59_Sub4_2172)).anInt5185
										|| ((((Tile) class147s[i_46_][i_39_][i_42_]).aClass59_Sub4_2152) != null
												&& ((((Class59_Sub4) (((Tile) class147s[i_46_][i_39_][i_42_]).aClass59_Sub4_2152)).anInt5185
														^ 0xffffffff) == (i_47_ ^ 0xffffffff))))
									continue;
								if (i_41_ != 0) {
									int i_48_ = Filestore.method959(i_41_, i_33_ - 12314);
									if ((((Class59_Sub4) (((Tile) class147s[i_46_][i_39_][i_42_]).aClass59_Sub4_2172)).anInt5185
											^ 0xffffffff) == (i_48_ ^ 0xffffffff)
											|| ((((Tile) class147s[i_46_][i_39_][i_42_]).aClass59_Sub4_2152) != null
													&& (((Class59_Sub4) (((Tile) (class147s[i_46_][i_39_][i_42_])).aClass59_Sub4_2152)).anInt5185) == i_48_))
										continue;
								}
								if ((i_43_ ^ 0xffffffff) != -1) {
									int i_49_ = Filestore.method959(i_43_, 20268);
									if (((i_49_
											^ 0xffffffff) == (((Class59_Sub4) (((Tile) class147s[i_46_][i_39_][i_42_]).aClass59_Sub4_2172)).anInt5185
													^ 0xffffffff))
											|| ((((Tile) class147s[i_46_][i_39_][i_42_]).aClass59_Sub4_2152) != null
													&& (i_49_ == (((Class59_Sub4) (((Tile) (class147s[i_46_][i_39_][i_42_])).aClass59_Sub4_2152)).anInt5185))))
										continue;
								}
							}
							Tile class147 = class147s[i_46_][i_39_][i_42_];
							if (((Tile) class147).aClass3_2160 != null) {
								for (Class3 class3 = ((Tile) class147).aClass3_2160; class3 != null; class3 = ((Class3) class3).aClass3_28) {
									...
									if (class59_sub3 instanceof Class_f) {
										...
										if (i_52_ == i_40_
												|| (i_41_ != 0 && ((i_41_ ^ 0xffffffff) == (i_52_ ^ 0xffffffff)))
												|| (i_43_ != 0 && ((i_52_ ^ 0xffffffff) == (i_43_ ^ 0xffffffff))))
											continue while_172_;
									}
								}
							}
						...
						Tile class147 = class147s[i_46_][i_39_][i_42_];
						if (class147 != null && ((Tile) class147).aClass3_2160 != null) {
							for (Class3 class3 = ((Tile) class147).aClass3_2160; class3 != null; class3 = ((Class3) class3).aClass3_28) {
								Class59_Sub3 class59_sub3 = ((Class3) class3).aClass59_Sub3_24;
								if ((((Class59_Sub3) class59_sub3).aShort5057 != (((Class59_Sub3) class59_sub3).aShort5065))
										|| ((((Class59_Sub3) class59_sub3).aShort5064) != (((Class59_Sub3) class59_sub3).aShort5062))) {
									for (int i_53_ = ((Class59_Sub3) class59_sub3).aShort5057; (i_53_ <= (((Class59_Sub3) class59_sub3).aShort5065)); i_53_++) {
										for (int i_54_ = (((Class59_Sub3) class59_sub3).aShort5064); ((i_54_
												^ 0xffffffff) >= (((Class59_Sub3) class59_sub3).aShort5062
														^ 0xffffffff)); i_54_++)
				...
				if (bool_45_) {
					int i_55_ = Class59_Sub3_Sub4.aClass210Array6993[1 + Class246_Sub28_Sub24.anInt6681].l(i_39_,
							i_42_);
					...
					else if ((MapScenes.anIntArray3625[i_35_] ^ 0xffffffff) > (i_56_ ^ 0xffffffff))
						MapScenes.anIntArray3625[i_35_] = i_56_;
					int i_57_ = i_42_ << 7;
				...
				if (!bool_44_) {
					if (i_39_ >= 1 && (Class5.aByteArrayArrayArray56[Class246_Sub28_Sub24.anInt6681][i_39_
							- 1][i_42_]) != i_36_) {
						Class64.anIntArray858[i_37_] = Class236.method1523(Class236.method1523((i_39_ - 1), 1179648),
								-754974720);
					...
					if ((++i_42_ ^ 0xffffffff) > (Class152.anInt2205 ^ 0xffffffff)) {
						if ((-1 + i_39_ ^ 0xffffffff) <= -1
								&& i_36_ != (Class5.aByteArrayArrayArray56[Class246_Sub28_Sub24.anInt6681][-1
										+ i_39_][i_42_])
								&& (0x4 & (Class45.tileRenderFlags[Class246_Sub28_Sub24.anInt6681][i_39_][i_42_])
										^ 0xffffffff) == -1
								&& ((Class45.tileRenderFlags[Class246_Sub28_Sub24.anInt6681][-1 + i_39_][-1
										+ i_42_]) & 0x4 ^ 0xffffffff) == -1) {
							Class64.anIntArray858[i_37_] = (Class236.method1523(Class236.method1523(1179648, i_39_ - 1),
									1375731712));
							Class230.anIntArray3151[i_37_] = Class236.method1523(i_42_, 1245184);
						...
						if (i_36_ != (Class5.aByteArrayArrayArray56[Class246_Sub28_Sub24.anInt6681][i_39_][i_42_])) {
							Class64.anIntArray858[i_37_] = (Class236.method1523(318767104,
									Class236.method1523(5373952, i_39_)));
						...
						if (Class38_Sub1_Sub1.anInt6770 > 1 + i_39_
								&& i_36_ != (Class5.aByteArrayArrayArray56[Class246_Sub28_Sub24.anInt6681][1
										+ i_39_][i_42_])
								&& (0x4 & (Class45.tileRenderFlags[Class246_Sub28_Sub24.anInt6681][i_39_][i_42_])
										^ 0xffffffff) == -1
								&& ((Class45.tileRenderFlags[Class246_Sub28_Sub24.anInt6681][1 + i_39_][i_42_
										- 1]) & 0x4) == 0) {
							Class64.anIntArray858[i_37_] = (Class236.method1523(Class236.method1523(i_39_ + 1, 5373952),
									-1845493760));
							Class230.anIntArray3151[i_37_] = Class236.method1523(i_42_, 5439488);
							i_37_ = 0xfff & 1 + i_37_;
							Class5.aByteArrayArrayArray56[Class246_Sub28_Sub24.anInt6681][1 + i_39_][i_42_] = i_36_;
					...
					i_42_--;
					if ((i_39_ + 1 ^ 0xffffffff) > (Class38_Sub1_Sub1.anInt6770 ^ 0xffffffff)
							&& i_36_ != (Class5.aByteArrayArrayArray56[Class246_Sub28_Sub24.anInt6681][i_39_
									+ 1][i_42_])) {
						Class64.anIntArray858[i_37_] = (Class236.method1523(1392508928,
								Class236.method1523(1 + i_39_, 9568256)));
						Class230.anIntArray3151[i_37_] = Class236.method1523(9633792, i_42_);
						Class5.aByteArrayArrayArray56[Class246_Sub28_Sub24.anInt6681][i_39_ + 1][i_42_] = i_36_;
						i_37_ = 0xfff & i_37_ + 1;
					}
					if (--i_42_ >= 0) {
						if ((-1 + i_39_ ^ 0xffffffff) <= -1 && ((i_36_
								^ 0xffffffff) != ((Class5.aByteArrayArrayArray56[Class246_Sub28_Sub24.anInt6681][i_39_
										- 1][i_42_]) ^ 0xffffffff))
								&& (0x4 & (Class45.tileRenderFlags[Class246_Sub28_Sub24.anInt6681][i_39_][i_42_])
										^ 0xffffffff) == -1
								&& (0x4 & (Class45.tileRenderFlags[Class246_Sub28_Sub24.anInt6681][-1
										+ i_39_][i_42_ + 1]) ^ 0xffffffff) == -1) {
							Class64.anIntArray858[i_37_] = (Class236.method1523(301989888,
									Class236.method1523(13762560, -1 + i_39_)));
						...
						if ((Class5.aByteArrayArrayArray56[Class246_Sub28_Sub24.anInt6681][i_39_][i_42_]) != i_36_) {
							Class64.anIntArray858[i_37_] = (Class236.method1523(Class236.method1523(i_39_, 13762560),
									-1828716544));
							Class230.anIntArray3151[i_37_] = Class236.method1523(13828096, i_42_);
							Class5.aByteArrayArrayArray56[Class246_Sub28_Sub24.anInt6681][i_39_][i_42_] = i_36_;
							i_37_ = 0xfff & 1 + i_37_;
						}
						if (i_39_ + 1 < Class38_Sub1_Sub1.anInt6770 && ((i_36_
								^ 0xffffffff) != ((Class5.aByteArrayArrayArray56[Class246_Sub28_Sub24.anInt6681][i_39_
										+ 1][i_42_]) ^ 0xffffffff))
								&& (0x4 & (Class45.tileRenderFlags[Class246_Sub28_Sub24.anInt6681][i_39_][i_42_])) == 0
								&& ((Class45.tileRenderFlags[Class246_Sub28_Sub24.anInt6681][i_39_ + 1][i_42_
										+ 1]) & 0x4) == 0) {
							Class64.anIntArray858[i_37_] = (Class236.method1523(-771751936,
									Class236.method1523(9568256, i_39_ + 1)));
							Class230.anIntArray3151[i_37_] = Class236.method1523(9633792, i_42_);
							i_37_ = 0xfff & i_37_ + 1;
							Class5.aByteArrayArrayArray56[Class246_Sub28_Sub24.anInt6681][i_39_ + 1][i_42_] = i_36_;
						}
			...
			if ((anIntArray2354[i_35_] ^ 0xffffffff) != 999999) {
				...
				MapScenes.anIntArray3625[i_35_] += 50;
				Class173.anIntArray2442[i_35_] += 50;
				Class29.anIntArray395[i_35_] -= 50;
			}
			return true;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, ("pk.P(" + i + ',' + bool + ',' + i_33_ + ',' + i_34_ + ','
					+ i_35_ + ',' + (class147s != null ? "{...}" : "null") + ')'));
		}
	}
	...
	final void push_head(Node node) {
		try {
			if (node.prev != null)
				node.remove();
			node.next = ((Class166) this).aClass246_2343;
			node.prev = ((Node) ((Class166) this).aClass246_2343).prev;
			node.prev.next = node;
			node.next.prev = node;
		} catch (Exception e) {
			e.printStackTrace();
	...
	private final void method1105(Node class246, boolean bool, Class166 class166_58_) {
		do {
			try {
				...
				((Node) ((Class166) this).aClass246_2343).prev = class246.prev;
				((Node) class246.prev).next = ((Class166) this).aClass246_2343;
				if (bool == false) {
					if (class246 == ((Class166) this).aClass246_2343)
						break;
					class246.prev = ((Node) (((Class166) class166_58_).aClass246_2343)).prev;
					((Node) class246.prev).next = class246;
					((Node) ((Class166) class166_58_).aClass246_2343).prev = class246_59_;
					((Node) class246_59_).next = ((Class166) class166_58_).aClass246_2343;
				}
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception, ("pk.J(" + (class246 != null ? "{...}" : "null") + ','
						+ bool + ',' + (class166_58_ != null ? "{...}" : "null") + ')'));
			}
			break;
		} while (false);
	}
	...
	final int method1112(int i) {
		try {
			anInt2346++;
			int i_60_ = i;
			for (Node class246 = (((Node) ((Class166) this).aClass246_2343).next); ((Class166) this).aClass246_2343 != class246; class246 = class246.next)
				i_60_++;
			return i_60_;
		} catch (RuntimeException runtimeexception) {
