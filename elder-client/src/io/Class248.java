...
abstract class Class248 {
	...
	static final int method1583(boolean bool, int i, boolean bool_0_, String string) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("wa.D(" + bool + ',' + i + ',' + bool_0_ + ',' + (string != null ? "{...}" : "null") + ')'));
		}
	}
	...
	static final void method1584(int i) {
		do {
			try {
				if ((Client.reboot_timer ^ 0xffffffff) < -2) {
					...
					if (VarcType.anInt3103 == 30) {
						...
						if (Class_j.aClass246_Sub39_1488 == null) {
							if (Class40_Sub9.aLong5507 <= TimeUtility.time())
								Class_j.aClass246_Sub39_1488 = (Class246_Sub28_Sub33.aClass243_6959
										.method1568(i ^ 0x300f, Class174.aString2449));
						} else if (((Class246_Sub39) Class_j.aClass246_Sub39_1488).anInt5485 != -1) {
							Class243.writePacket(-78, Class12.aClass201_176);
							Class130_Sub1.stream.writeShort((byte) 67,
									((Class246_Sub39) Class_j.aClass246_Sub39_1488).anInt5485);
							Class_j.aClass246_Sub39_1488 = null;
							Class40_Sub9.aLong5507 = TimeUtility.time() - -30000L;
						}
						Class246_Sub30 class246_sub30 = (Class246_Sub30) Widget.f_qb.method1104(60);
						if (class246_sub30 != null || ((TimeUtility.time() - 2000L
								^ 0xffffffffffffffffL) < (ScriptEvent.aLong4970 ^ 0xffffffffffffffffL))) {
							boolean bool = false;
							int i_9_ = (((Buffer) Class130_Sub1.stream).position);
							for (Class246_Sub30 class246_sub30_10_ = (Class246_Sub30) Class246_Sub28_Sub30.aClass166_6865
									.method1104(
											74); class246_sub30_10_ != null; class246_sub30_10_ = ((Class246_Sub30) Class246_Sub28_Sub30.aClass166_6865
													.method1108((byte) -112))) {
								if (-i_9_ + (((Buffer) Class130_Sub1.stream).position) >= 240)
									break;
								class246_sub30_10_.remove();
								...
								if ((class246_sub30_10_.method2161((byte) -87) == -1)
										&& (class246_sub30_10_.method2160(-107) ^ 0xffffffff) == 0) {
									i_11_ = -1;
									bool_13_ = true;
									i_12_ = -1;
								}
								if (i_12_ != Class246_Sub43.anInt5604
										|| ((i_11_ ^ 0xffffffff) != (Class233.anInt3183 ^ 0xffffffff))) {
									if (!bool) {
										RenderAnimation.anInt1891++;
										Class243.writePacket(i - 12442, (TransformList.aClass201_4890));
										Class130_Sub1.stream.writeByte(255, 0);
										bool = true;
										i_9_ = (((Buffer) (Class130_Sub1.stream)).position);
									}
									...
									int i_16_ = (int) ((class246_sub30_10_.method2158((byte) 122)
											+ -ScriptEvent.aLong4970) / 20L);
									if ((i_16_ ^ 0xffffffff) > -9 && (i_14_ ^ 0xffffffff) <= 31 && i_14_ <= 31
											&& i_15_ >= -32 && (i_15_ ^ 0xffffffff) >= -32) {
										i_15_ += 32;
										i_14_ += 32;
										Class130_Sub1.stream.writeShort((byte) 67,
												i_15_ + ((i_16_ << 12) + (i_14_ << 6)));
									} else if ((i_16_ ^ 0xffffffff) > -33 && (i_14_ ^ 0xffffffff) <= 127 && i_14_ <= 127
											&& i_15_ >= -128 && i_15_ <= 127) {
									...
									ScriptEvent.aLong4970 = class246_sub30_10_.method2158((byte) 117);
								}
							}
							if (bool)
								Class130_Sub1.stream.method2408(-1591647264,
										(((Buffer) Class130_Sub1.stream).position + -i_9_));
						}
						...
						if (Settings.gameframe == Revision.OSRS) {
							...
							if (KeyHandler.KeyHandler_pressedKeys[96]) { // L: 4232
								camAngleDY += (-72 - camAngleDY);
							} else if (KeyHandler.KeyHandler_pressedKeys[97]) { // L: 4233
								camAngleDY += (72 - camAngleDY);
							}

							if (KeyHandler.KeyHandler_pressedKeys[98]) { // L: 4235
								camAngleDX += (32 - camAngleDX);
							} else if (KeyHandler.KeyHandler_pressedKeys[99]) { // L: 4236
								camAngleDX += (-32 - camAngleDX);
							}
							int camAngleY = (int) Camera.camera_yaw;
							int camAngleX = (int) Camera.camera_pitch;
							camAngleY = camAngleDY + camAngleY; // L: 4241
							camAngleX += camAngleDX; // L: 4242

							Camera.camera_yaw = camAngleY;
							Camera.camera_pitch = camAngleX;
						}
						if ((Client.total_characters ^ 0xffffffff) < -1) {
							int i_21_ = 0;
							for (int i_22_ = 0; Client.total_characters > i_22_; i_22_++) {
								if (Client.characters[i_22_].method1228(false))
									i_21_++;
							}
							if ((i_21_ ^ 0xffffffff) < -1) {
								...
								for (int i_23_ = 0; ((i_23_ ^ 0xffffffff) > (Client.total_characters
										^ 0xffffffff)); i_23_++) {
									Class188 class188 = (Client.characters[i_23_]);
						...
						if ((Class176.anInt2481 ^ 0xffffffff) < -1)
							Class176.anInt2481--;
						if (RenderAnimation.aBool1929 && (Class176.anInt2481 ^ 0xffffffff) >= -1) {
							RenderAnimation.aBool1929 = false;
							Class176.anInt2481 = 20;
							Class38.anInt565++;
							Class243.writePacket(-81, (Class246_Sub28_Sub22.aClass201_6632));
							Class130_Sub1.stream.writeShort128((byte) -120, (int) Camera.camera_yaw >> 3);
							Class130_Sub1.stream.writeShortLE128((byte) -57, (int) Camera.camera_pitch >> 3);
						}
						if (Filestore.aBool2049 != false && !Class59_Sub5_Sub1.aBool5824 != false) {
						...
						if (!RuntimeException_Sub2.aBool7148) {
							...
							Class130_Sub1.stream.writeByte(255, 0);
							int i_24_ = (((Buffer) Class130_Sub1.stream).position);
							Buffer stream = Client.current_renderer.get_preference_buffer();
							Class130_Sub1.stream.writeBytes(0, true, ((Buffer) stream).buffer,
									((Buffer) stream).position);
							Class130_Sub1.stream.method2408(i + -1591659626,
									(-i_24_ + (((Buffer) Class130_Sub1.stream).position)));
						...
						if (VarcType.anInt3103 == 30) {
							...
							if ((Class233.anInt3184 ^ 0xffffffff) < -751)
								...
								for (int i_25_ = Varbit.aClass95_6658.method608(true,
									...
									Class3.anIntArray27[PacketsDecoder.method184(31, ScriptEvent.anInt4981++)] = i_25_;
								}
								for (Class246_Sub1_Sub10 class246_sub1_sub10 = Class51.method336(
										0); class246_sub1_sub10 != null; class246_sub1_sub10 = Class51.method336(0)) {
									int i_26_ = class246_sub1_sub10.method2602((byte) 94);
									int i_27_ = class246_sub1_sub10.method2605((byte) -10);
									if (i_26_ != 1) {
										if ((i_26_ ^ 0xffffffff) != -3) {
											if (i_26_ == 3) {
												Widget class235 = (Widget.get_widget(i_27_,
														class246_sub1_sub10.aRevision6209));
												if (!((Class246_Sub1_Sub10) class246_sub1_sub10).aString6209
														.equals(((Widget) class235).text)) {
													((Widget) class235).text = (((Class246_Sub1_Sub10) class246_sub1_sub10).aString6209);
												...
												if (i_26_ == 5) {
													Widget class235 = (Widget.get_widget(i_27_,
															class246_sub1_sub10.aRevision6209));
													if (((((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6211) != (((Widget) class235).sequence_id))
															|| ((((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6211)
																	^ 0xffffffff) == 0) {
														((Widget) class235).model_frame = 0;
														((Widget) class235).model_frame_cycle = 0;
														((Widget) class235).anInt3221 = 1;
														((Widget) class235).sequence_id = (((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6211);
														Widget.redraw_widget(class235);
													}
													...
													Widget class235 = (Widget.get_widget(i_27_,
															class246_sub1_sub10.aRevision6209));
													if ((((Widget) class235).color) != i_32_) {
														((Widget) class235).color = i_32_;
														Widget.redraw_widget(class235);
													}
												} else if (i_26_ != 7) {
													if ((i_26_ ^ 0xffffffff) == -9) {
														Widget class235 = (Widget.get_widget(i_27_,
																class246_sub1_sub10.aRevision6209));
														if ((((((Widget) class235).model_rotation_x)
																^ 0xffffffff) != ((((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6211)
																		^ 0xffffffff))
																|| (((((Widget) class235).model_rotation_y)
																		^ 0xffffffff) != ((((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6210)
																				^ 0xffffffff))
																|| (((((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6206)
																		^ 0xffffffff) != ((((Widget) class235).model_zoom)
																				^ 0xffffffff))) {
															((Widget) class235).model_zoom = (((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6206);
															((Widget) class235).model_rotation_y = (((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6210);
															((Widget) class235).model_rotation_x = (((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6211);
															if (((((Widget) class235).item_id) ^ 0xffffffff) != 0) {
																if (((((Widget) class235).dynamic_width)
																		^ 0xffffffff) >= -1) {
																	if ((((Widget) class235).original_width) > 0)
																		((Widget) class235).model_zoom = ((Widget) class235).model_zoom
																				* 32
																				/ ((Widget) class235).original_width;
																} else
																	((Widget) class235).model_zoom = (((Widget) class235).model_zoom
																			* 32 / ((Widget) class235).dynamic_width);
															}
															Widget.redraw_widget(class235);
														}
														...
														if (i_26_ == 10) {
															Widget class235 = (Widget.get_widget(i_27_,
																	class246_sub1_sub10.aRevision6209));
															if (((((Widget) class235).anInt3255) != (((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6211))
																	|| (((((Widget) class235).anInt3271)
																			^ 0xffffffff) != ((((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6210)
																					^ 0xffffffff))
																	|| (((((Widget) class235).model_rotation_z)
																			^ 0xffffffff) != ((((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6206)
																					^ 0xffffffff))) {
																((Widget) class235).anInt3255 = (((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6211);
																((Widget) class235).anInt3271 = (((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6210);
																((Widget) class235).model_rotation_z = (((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6206);
																Widget.redraw_widget(class235);
															}
														} else if (i_26_ == 11) {
															Widget class235 = (Widget.get_widget(i_27_,
																	class246_sub1_sub10.aRevision6209));
															((Widget) class235).alignment_x = (byte) 0;
															((Widget) class235).x = ((Widget) class235).original_x = (((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6211);
															((Widget) class235).alignment_y = (byte) 0;
															((Widget) class235).y = ((Widget) class235).original_y = (((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6210);
															Widget.redraw_widget(class235);
															...
															if (i_26_ != 14) {
																if ((i_26_ ^ 0xffffffff) == -16) {
																	...
																	Widget class235 = (Widget.get_widget(i_27_,
																			class246_sub1_sub10.aRevision6209));
																	((Widget) class235).font_id = (((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6211);
																}
															} else {
																Widget class235 = (Widget.get_widget(i_27_,
																		class246_sub1_sub10.aRevision6209));
																((Widget) class235).disabled_sprite = (((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6211);
															}
														} else {
															Widget class235 = (Widget.get_widget(i_27_,
																	class246_sub1_sub10.aRevision6209));
															int i_33_ = (((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6211);
															if ((class235 != null) && (((((Widget) class235).type)
																	^ 0xffffffff) == -1)) {
																if (i_33_ > ((((Widget) class235).scroll_height)
																		- (((Widget) class235).screen_height)))
																	i_33_ = (-((Widget) class235).screen_height
																			+ ((Widget) class235).scroll_height);
																if ((i_33_ ^ 0xffffffff) > -1)
																	i_33_ = 0;
																if ((((Widget) class235).vertical_scroll_position) != i_33_) {
																	((Widget) class235).vertical_scroll_position = i_33_;
																	Widget.redraw_widget(class235);
																}
															}
														}
														...
														Widget class235 = (Widget.get_widget(i_27_,
																class246_sub1_sub10.aRevision6209));
														if (((((Widget) class235).item_id) != (((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6211))
																|| (((((Widget) class235).item_quantity)
																		^ 0xffffffff) != ((((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6210)
																				^ 0xffffffff))) {
															((Widget) class235).item_quantity = (((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6210);
															((Widget) class235).item_id = (((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6211);
															Widget.redraw_widget(class235);
														}
													}
												} else {
													Widget class235;
													try {
														class235 = Widget.get_widget(i_27_,
																class246_sub1_sub10.aRevision6209);
													} catch (Exception e) {
														class235 = null;
														e.printStackTrace();
													...
													if (!bool == ((Widget) class235).hidden) {
														((Widget) class235).hidden = bool;
														Widget.redraw_widget(class235);
													}
												}
											} else {
												...
												if ((i_34_ != (((Widget) class235).model_type))
														|| (((Widget) class235).model_id) != i_35_
														|| ((i_36_ ^ 0xffffffff) != ((((Widget) class235).anInt3289)
																^ 0xffffffff))) {
													((Widget) class235).model_id = i_35_;
													((Widget) class235).anInt3289 = i_36_;
													((Widget) class235).model_type = i_34_;
													Widget.redraw_widget(class235);
												}
											}
										} else {
										...
										Varc.varcs_634[i_27_] = ((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6211;
										Class246_Sub28_Sub10.aBool6159 |= (Class59_Sub3_Sub1.varcs_loaded_634[i_27_]);
										VarcLoader.anIntArray996[(PacketsDecoder.method184(
												Class109_Sub1_Sub1.anInt6728++,
												31))] = i_27_;
									}
								}
								...
								if (Class211.aClass235_2962 != null) {
									...
									if ((Class246_Sub28_Sub5.anInt6006 ^ 0xffffffff) <= -16) {
										Widget.redraw_widget(Class211.aClass235_2962);
								...
								Client.cycleCntr++;
								if (Font.aBool1620) {
									ClickMaskNode.anInt4892++;
									Class243.writePacket(-85, (Class_ss.aClass201_7060));
									Class130_Sub1.stream.writeIntV1((Class128_Sub1.anInt5560
											| ((Class246_Sub28_Sub24.anInt6675 << 14) | Class59_Sub1.anInt4513 << 28)),
											690087856);
									Font.aBool1620 = false;
								}
								for (;;) {
									ScriptEvent class246_sub29 = ((ScriptEvent) Class128.aClass166_1796
											.method1100(i - 8267));
									if (class246_sub29 == null)
										break;
									Widget class235 = (((ScriptEvent) class246_sub29).source);
									if ((((Widget) class235).index ^ 0xffffffff) <= -1) {
										Widget class235_37_ = (Widget.get_widget((((Widget) class235).parent_id),
												class235.revision));
										if (class235_37_ == null || (((Widget) class235_37_).components == null)
												|| ((((Widget) class235_37_).components).length <= ((Widget) class235).index)
												|| (class235 != (((Widget) class235_37_).components[(((Widget) class235).index)])))
											continue;
									}
									ScriptExecutor.excute_script_event(class246_sub29, class235);
								}
								for (;;) {
									ScriptEvent class246_sub29 = ((ScriptEvent) Class246_Sub28_Sub2.aClass166_5809
											.method1100(4095));
									if (class246_sub29 == null)
										break;
									Widget class235 = (((ScriptEvent) class246_sub29).source);
									if ((((Widget) class235).index ^ 0xffffffff) <= -1) {
										Widget class235_38_ = (Widget.get_widget((((Widget) class235).parent_id),
												class235.revision));
										if (class235_38_ == null || (((Widget) class235_38_).components == null)
												|| ((((Widget) class235).index
														^ 0xffffffff) <= ((((Widget) class235_38_).components).length
																^ 0xffffffff))
												|| ((((Widget) class235_38_).components[((Widget) class235).index]) != class235))
											continue;
									}
									ScriptExecutor.excute_script_event(class246_sub29, class235);
								}
								for (;;) {
									ScriptEvent script_event = ((ScriptEvent) Client.low_priority_script_events
											.method1100(4095));
									if (script_event == null)
										break;
									Widget widget = script_event.source;
									if ((widget.index ^ 0xffffffff) <= -1) {
										Widget class235_39_ = (Widget.get_widget((((Widget) widget).parent_id),
												widget.revision));
										if (class235_39_ == null || (((Widget) class235_39_).components == null)
												|| ((((Widget) widget).index
														^ 0xffffffff) <= ((((Widget) class235_39_).components).length
																^ 0xffffffff))
												|| (widget != (((Widget) class235_39_).components[(((Widget) widget).index)])))
											continue;
									}
									ScriptExecutor.excute_script_event(script_event, widget);
								}
								if (i == 12362) {
									...
									if (Client.staff_level > 0 && Class216.aClass232_3009.method1488(-97, 82)
											&& Class216.aClass232_3009.method1488(-73, 81)
											&& (Class246_Sub41.anInt5531 ^ 0xffffffff) != -1) {
										int i_40_ = (-Class246_Sub41.anInt5531
												+ (((Class59_Sub3) Client.local_player).current_plane));
										if (i_40_ < 0)
											i_40_ = 0;
										else if (i_40_ > 3)
											i_40_ = 3;
										Class246_Sub41_Sub2.method2680(i_40_, i - 12299,
												(Client.base_y + (((Entity) Client.local_player).f_nc[0])),
												((((Entity) Client.local_player).f_mc[0])
														+ Client.base_x));
									}
									Class59_Sub5_Sub1.method2465(-1);
									for (int i_41_ = 0; i_41_ < 5; i_41_++)
										Class259_Sub3.anIntArray5358[i_41_]++;
									if (Class246_Sub28_Sub10.aBool6159 && ((PacketsDecoder.aLong273
											^ 0xffffffffffffffffL) > ((TimeUtility.time() - 60000L)
													^ 0xffffffffffffffffL)))
									...
									if ((Class246_Sub41_Sub2.anInt6481 ^ 0xffffffff) < -501) {
										...
										if ((i_42_ & 0x4 ^ 0xffffffff) == -5)
											Tile.anInt2147 += SpotAnimType.anInt2096;
									...
									if ((Class246_Sub28_Sub27.anInt6755 ^ 0xffffffff) < -56)
										Class246_Sub28_Sub15.anInt6364 = -2;
									if (Tile.anInt2147 < -40)
										SpotAnimType.anInt2096 = 1;
									ISAAC.anInt628++;
									if ((Tile.anInt2147 ^ 0xffffffff) < -41)
										SpotAnimType.anInt2096 = -1;
									...
									try {
										if (Class65.aClass6_864 == null
												|| (((Buffer) (Class130_Sub1.stream)).position ^ 0xffffffff) >= -1)
											break;
										Class34.anInt454 += (((Buffer) (Class130_Sub1.stream)).position);
	...
	static final String method1586(String string, int i, String string_44_, String string_45_) {
		try {
			if (i != -9)
				return null;
			anInt3485++;
			for (int i_46_ = string_45_.indexOf(string_44_); (i_46_ ^ 0xffffffff) != 0; i_46_ = string_45_
					.indexOf(string_44_, string.length() + i_46_))
				string_45_ = (string_45_.substring(0, i_46_) + string
						+ string_45_.substring(i_46_ + string_44_.length()));
			return string_45_;
		} catch (RuntimeException runtimeexception) {
