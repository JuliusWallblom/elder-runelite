...
final class Class246_Sub28_Sub28 extends TextureOperation {
				...
				while_117_: do {
					do {
						if ((i_1_ ^ 0xffffffff) != -1) {
							...
							anInt6793 = stream.readUnsignedByte();
							break while_117_;
						}
						anInt6788 = stream.readUnsignedByte();
						break while_117_;
					} while (false);
	...
	static final boolean method2812(int i, Widget class235) {
		try {
			anInt6790++;
			int i_2_ = -105 / ((i - 71) / 50);
			if ((((Widget) class235).content_type ^ 0xffffffff) == (EnumLoader.anInt2046 ^ 0xffffffff)) {
	...
	final int[][] method2139(byte i, int i_3_) {
		try {
			anInt6791++;
			int[][] is = ((TextureOperation) this).aClass136_4933.method922((byte) 19, i_3_);
			if (i <= 33)
				anInt6793 = 103;
	...
	final int[] method2135(int i, int i_35_) {
		try {
			...
			int[] is = ((TextureOperation) this).aClass66_4938.method435((byte) -112, i_35_);
