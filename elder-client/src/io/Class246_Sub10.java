...
final class Class246_Sub10 extends Node {
	...
	int anInt4077;
	int anInt4078;
	static MultilingualString aClass67_4079 = new MultilingualString("Unable to find ", "Spieler kann nicht gefunden werden: ", "Impossible de trouver ", "N\u00e3o \u00e9 poss\u00edvel encontrar ");
	...
	static {
		new MultilingualString("The channel you tried to join is currently full.", "Der von dir gew\u00fcnschte Chatraum ist derzeit \u00fcberf\u00fcllt.", "Le canal que vous essayez de rejoindre est plein.", "O canal que voc\u00ea tentou acessar est\u00e1 cheio no momento.");
	}
}
