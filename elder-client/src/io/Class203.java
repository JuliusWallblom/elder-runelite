...
final class Class203 {
	...
	private CacheIndex aClass_fs2871;
	...
	final Class230 method1335(int i, int i_1_, int i_2_, int i_3_, int i_4_, Class214 class214) {
		try {
			...
			return new Class230(((Class153) class153).texture_id, class2s, ((Class153) class153).anInt2208, i, i_3_, i_4_);
		} catch (RuntimeException runtimeexception) {
	...
	private final Class153 method1336(int i, byte i_6_) {
		try {
			...
			if (class153 != null)
				return class153;
			byte[] is = aClass_fs2871.get_file(i, 29);
			class153 = new Class153();
			if (is != null)
				class153.method1013(new Buffer(is), -1);
			if (i_6_ <= 42)
	...
	Class203(Class101 class101, int i, CacheIndex class_fs) {
		try {
			aClass_fs2871 = class_fs;
			aClass_fs2871.child_count(29);
		} catch (RuntimeException runtimeexception) {
	...
	static {
		new MultilingualString("I can't reach that!", "Da kommst du nicht hin.", "Je ne peux pas l'atteindre !", "N\u00e3o consigo alcan\u00e7ar!");
