...
public final class CacheIndex {
	...
	static FontMetric aClass73_148;
	static Cursors aClass156_150;
	public Class195 aClass195_151 = null;
	static int anInt152;
	static int anInt153;
	static int anInt154;

	private final boolean method84() {
		anInt140++;
	...
	final int method86(String string) {
		anInt136++;
		if (!method84())
			return -1;
	...
	private final boolean method93(int i, int i_11_) {
		try {
			...
			if ((i ^ 0xffffffff) > -1 || ((i ^ 0xffffffff) <= (((Class195) aClass195_151).anIntArray2748.length ^ 0xffffffff)) || ((((Class195) aClass195_151).anIntArray2748[i] ^ 0xffffffff) == -1)) {
				if (!RenderSequenceLoader.aBool1451)
					return false;
	...
	private final boolean method101(int i, int i_20_, int i_21_, int[] is) {
		try {
			...
			if (is != null && ((is[0] ^ 0xffffffff) != -1 || is[1] != 0 || (is[2] ^ 0xffffffff) != -1 || (is[3] ^ 0xffffffff) != -1)) {
				...
				Buffer stream = new Buffer(is_26_);
				stream.method2407(5, ((Buffer) stream).buffer.length, -65, is);
			} else
			...
			if ((i_22_ ^ 0xffffffff) < -2) {
				if ((((CacheIndex) this).anInt126 ^ 0xffffffff) == -3) {
					int i_28_ = is_27_.length;
					int i_29_ = is_27_[--i_28_] & 0xff;
					i_28_ -= i_22_ * i_29_ * 4;
					Buffer stream = new Buffer(is_27_);
					int i_30_ = 0;
					int i_31_ = 0;
					((Buffer) stream).position = i_28_;
					...
					for (int i_54_ = 0; (i_22_ ^ 0xffffffff) < (i_54_ ^ 0xffffffff); i_54_++) {
						...
						if (is_23_ == null)
							...
							i_55_ = is_23_[i_54_];
						if ((((CacheIndex) this).anInt126 ^ 0xffffffff) == -1)
	...
	private final void method106(int i, int i_63_) {
		try {
			do {
				...
				anObjectArray147[i_63_] = (Class177.method1159((byte) 109, false, aClass154_146.method1023(VarpType.method599(i, 122), i_63_)));
			} while (false);
			if (i != 0)
				aClass195_151 = null;
			anInt154++;
	...
	final byte[] method108(int i, int i_65_, int[] is, byte i_66_) {
		try {
			...
			if (i_66_ >= -49)
				aClass195_151 = null;
			do {
				if ((((CacheIndex) this).anInt126 ^ 0xffffffff) != -2) {
					if (((CacheIndex) this).anInt126 != 2)
						break;
	...
	final boolean method112(int i, int i_74_, int index) {
		try {
			anInt119++;
			if (!method84())
				return false;
			if (i != -1)
				return true;
			if ((((Class195) aClass195_151).anIntArray2748.length ^ 0xffffffff) == -2)
				return method85(i_74_, (byte) -124, index);
			if (!method93(i_74_, -2))
				return false;
			if (((Class195) aClass195_151).anIntArray2748[i_74_] == 1)
				return method85(index, (byte) -124, i_74_);
			throw new RuntimeException();
		} catch (RuntimeException runtimeexception) {
	...
	static final CacheIndex load_cache_index(int i, boolean... bools) {
		Filestore.anInt2052++;
		...
		Class59_Sub1_Sub2.aClass154_Sub1Array6127[i] = Class194_Sub1.aClass142_4140.method958(Class121.aClass208_1678,
				class208, 255, i);
		if (bools[1])
			Class59_Sub1_Sub2.aClass154_Sub1Array6127[i].method2096((byte) 126);
		return new CacheIndex(Class59_Sub1_Sub2.aClass154_Sub1Array6127[i], bools[0], bools[2] ? 1 : 0);
	}

	CacheIndex(Class154 class154, boolean bool, int i) {
		try {
			if ((i ^ 0xffffffff) > -1 || (i ^ 0xffffffff) < -3)
				throw new IllegalArgumentException("js5: Invalid value " + i + " supplied for discardunpacked");
			((CacheIndex) this).anInt126 = i;
			aBool135 = bool;
