...
final class Class231 {
	...
	static MultilingualString aClass67_3171;
	static int anInt3172;

	static final Class128_Sub1 method1479(int i, int[] is, int i_0_, Class260_Sub2 class260_sub2, int[] is_1_,
			byte i_2_) {
		try {
			anInt3170++;
			...
			throw Class193.method1272(runtimeexception,
					("uo.A(" + i + ',' + (is != null ? "{...}" : "null") + ',' + i_0_ + ','
							+ (class260_sub2 != null ? "{...}" : "null") + ',' + (is_1_ != null ? "{...}" : "null")
							+ ',' + i_2_ + ')'));
		}
	}
	...
	public static void method1480(byte i) {
		try {
			Client.grand_exchange_objects = null;
			if (i != -10)
				Client.grand_exchange_objects = null;
			aClass67_3171 = null;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1481(int i, CacheIndex class_fs, int i_8_, int i_9_, byte i_10_, boolean bool, int i_11_) {
		try {
			anInt3172++;
			...
			throw Class193.method1272(runtimeexception, ("uo.C(" + i + ',' + (class_fs != null ? "{...}" : "null") + ','
					+ i_8_ + ',' + i_9_ + ',' + i_10_ + ',' + bool + ',' + i_11_ + ')'));
		}
	}

	static {
		new MultilingualString("Thank-you, your abuse report has been received.",
		...
		Client.grand_exchange_objects = new Class18[6];
		aClass67_3171 = new MultilingualString("flash2:", "blinken2:", "clignotant2:", "flash2:");
	}
}
