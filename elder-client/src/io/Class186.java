...
public final class Class186 {
	...
	static MultilingualString aClass67_2637;
			...
			try {
				do {
					if ((i ^ 0xffffffff) > (i_2_ ^ 0xffffffff)) {
						RenderAnimation.method918(i, -99, i_1_, i_2_, (Class246_Sub28_Sub6.anIntArrayArray6042[i_0_]));
						if (!Client.f_ob)
							break;
					}
					RenderAnimation.method918(i_2_, i_3_ - 75, i_1_, i, (Class246_Sub28_Sub6.anIntArrayArray6042[i_0_]));
				} while (false);
				anInt2638++;
				if (i_3_ == 10)
					break;
	...
	static final void method1221(byte i, Buffer stream) {
		try {
	...
	static {
		aClass67_2637 = (new MultilingualString("You can't add yourself to your own ignore list.", "Du kannst dich nicht auf deine eigene Ignorieren-Liste setzen!", "Vous ne pouvez pas ajouter votre nom \u00e0 votre liste noire.", "Voc\u00ea n\u00e3o pode adicionar a si pr\u00f3prio \u00e0 sua lista de ignorados."));
	}
}
