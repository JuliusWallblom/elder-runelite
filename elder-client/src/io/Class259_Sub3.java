...
class Class259_Sub3 extends Class259 {
	...
	static SceneGraph aClass260_5357;
	...
	static final void method2272(Class255_Sub1 class255_sub1, byte[][] is, byte i) {
		do {
			try {
				for (int i_0_ = 0; ((((MapRegion) class255_sub1).anInt3670 ^ 0xffffffff) < (i_0_
						^ 0xffffffff)); i_0_++) {
					...
					for (int i_1_ = 0; Class38_Sub1_Sub1.anInt6770 >> 3 > i_1_; i_1_++) {
						for (int i_2_ = 0; ((Class152.anInt2205 >> 3 ^ 0xffffffff) < (i_2_ ^ 0xffffffff)); i_2_++) {
							...
							if ((i_3_ ^ 0xffffffff) != 0) {
								...
								if (!((MapRegion) class255_sub1).aBool3658 || (i_4_ ^ 0xffffffff) == -1) {
									int i_5_ = (0x6 & i_3_) >> 1;
									int i_6_ = 0x3ff & i_3_ >> 14;
									int i_7_ = 0x7ff & i_3_ >> 3;
									int i_8_ = (i_6_ / 8 << 8) - -(i_7_ / 8);
									for (int i_9_ = 0; MapRegion.region_ids.length > i_9_; i_9_++) {
										if (((MapRegion.region_ids[i_9_] ^ 0xffffffff) == (i_8_ ^ 0xffffffff))
												&& is[i_9_] != null) {
											class255_sub1.method2340(is[i_9_], 8 * i_1_, (i_6_ & 0x7) * 8, i_5_,
													8 * i_2_, i_0_, Client.sprite_loader, 8 * (0x7 & i_7_),
													Class95.aClass199Array1235, i_4_, (byte) 103, Revision.OSRS);
											break;
										}
									}
								}
				...
				throw Class193.method1272(runtimeexception, ("tq.J(" + (class255_sub1 != null ? "{...}" : "null") + ','
						+ (is != null ? "{...}" : "null") + ',' + i + ')'));
			}
			break;
		} while (false);
