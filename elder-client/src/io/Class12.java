...
final class Class12 {
	...
	static final void method137(int i, int i_0_) {
		try {
			do {
				if (anInt182 == 0) {
					Sprite.aClass246_Sub37_Sub1_433.method2503(true, i);
					if (!Client.f_ob)
						break;
				}
				Varbit.anInt1534 = i;
	...
	static final void method139(int i, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_) {
		do {
			try {
				...
				if (i_4_ != 255)
					method140(33);
				if ((i_2_ ^ 0xffffffff) > -2 || i_8_ < 1
						|| ((-2 + Class38_Sub1_Sub1.anInt6770 ^ 0xffffffff) > (i_2_ ^ 0xffffffff))
						|| i_8_ > -2 + Class152.anInt2205)
					break;
				int i_10_ = i;
				if (i_10_ < 3 && Class211.method1389(i_2_, -29792, i_8_))
					i_10_++;
				if ((Client.current_renderer.method2052(Buffer.anInt5656, 111)
						|| SwitchInt.method2179(i_2_, Class40_Sub6.anInt5103, (byte) 56, i_10_, i_8_))
						&& Class106.tiles != null) {
					Class246_Sub28_Sub3.aClass255_Sub1_5900.method2337(Client.sprite_loader, -4,
							Class95.aClass199Array1235[i], i_9_, i, i_8_, i_2_);
					if (i_7_ < 0)
						break;
					boolean bool = (Settings.ground_decorations);
					Settings.ground_decorations = true;
					Class246_Sub28_Sub3.aClass255_Sub1_5900.render_objects(i_2_, i, i_6_, i_5_, i_7_,
							Client.sprite_loader, i_3_, i_8_, i_10_, (byte) 28, Class95.aClass199Array1235[i],
							Revision.OSRS);
					Settings.ground_decorations = bool;
				}
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception, ("bf.D(" + i + ',' + i_2_ + ',' + i_3_ + ',' + i_4_ + ','
