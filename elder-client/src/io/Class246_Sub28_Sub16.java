...
final class Class246_Sub28_Sub16 extends TextureOperation {
	...
	public static void method2656(int i) {
		try {
			...
			Cache.reset_index(Revision.PRE_EOC_634, "textures");
	...
	final void method2143(int i, int i_1_, Buffer stream) {
		try {
			if (i == 4) {
				if ((i_1_ ^ 0xffffffff) == -1)
					texture_id = stream.readUnsignedShort();
				anInt6396++;
			}
		} catch (RuntimeException runtimeexception) {
	...
	final void method2138(int i, byte i_2_, int i_3_) {
		do {
			try {
				...
				anInt6402++;
				if ((texture_id ^ 0xffffffff) > -1 || Class79_Sub1.anInterface6_5163 == null)
					break;
				int i_4_ = (((Material) Class79_Sub1.anInterface6_5163.get_material(-31305, texture_id)).aBool3335 ? 64 : 128);
				anIntArray6404 = Class79_Sub1.anInterface6_5163.method14(false, 5754, texture_id, 1.0F, i_4_, i_4_);
				anInt6400 = i_4_;
				anInt6399 = i_4_;
			} catch (RuntimeException runtimeexception) {
	...
	final int[][] method2139(byte i, int i_5_) {
		try {
			anInt6397++;
			int[][] is = ((TextureOperation) this).aClass136_4933.method922((byte) 117, i_5_);
			if (i <= 33)
				anInt6400 = -43;
			if (((Class136) ((TextureOperation) this).aClass136_4933).aBool1946) {
				int i_6_ = (((EnumLoader.anInt2044 ^ 0xffffffff) == (anInt6400 ^ 0xffffffff) ? i_5_ : i_5_ * anInt6400 / EnumLoader.anInt2044) * anInt6399);
				int[] is_7_ = is[0];
				int[] is_8_ = is[1];
				int[] is_9_ = is[2];
