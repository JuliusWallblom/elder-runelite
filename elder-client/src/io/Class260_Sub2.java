...
final class Class260_Sub2 extends SceneGraph {
	...
	final void X(int i, int i_1_, int i_2_, int[] is) {
		try {
			anInt4284++;
			float f = (((float) i_2_ * ((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5363)
					+ ((((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5378 * (float) i_1_)
							+ (((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5386) * (float) i)
					+ ((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5362);
			if ((float) ((Class260_Sub2) this).f_cf > f || f > (float) ((Class260_Sub2) this).anInt4371)
				is[0] = is[1] = is[2] = -1;
			else {
				int i_3_ = (int) ((float) ((Class260_Sub2) this).anInt4366
						* ((((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5393) + (((float) i_2_
								* ((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5388)
								+ ((((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5372 * (float) i)
										+ (float) i_1_ * ((Class_c_Sub1) (((Class260_Sub2) this).f_hg)).aFloat5387)))
						/ f);
				int i_4_ = (int) (((((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5385)
						+ ((((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5364) * (float) i
								+ ((float) i_1_ * ((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5382)
								+ ((float) i_2_ * ((Class_c_Sub1) (((Class260_Sub2) this).f_hg)).aFloat5367)))
						* (float) ((Class260_Sub2) this).f_tf / f);
				if (!((float) i_3_ >= ((Class260_Sub2) this).aFloat4383)
						|| !(((Class260_Sub2) this).aFloat4344 >= (float) i_3_)
						|| !((float) i_4_ >= ((Class260_Sub2) this).f_qf)
						|| !((float) i_4_ <= ((Class260_Sub2) this).aFloat4361))
					is[0] = is[1] = is[2] = -1;
				else {
					is[2] = (int) f;
	...
	final Class128 method1726(int i, int i_6_, int[] is, int[] is_7_) {
		try {
			...
			throw Class193.method1272(runtimeexception, ("fd.UC(" + i + ',' + i_6_ + ','
	...
	final Interface10 method1902(boolean bool, int i, Buffer nativebuffer, int i_10_, int i_11_) {
		try {
			...
			throw Class193.method1272(runtimeexception, ("fd.LE(" + bool + ',' + i + ','
					+ (nativebuffer != null ? "{...}" : "null") + ',' + i_10_ + ',' + i_11_ + ')'));
		}
	}
	...
	private final void method1903(boolean bool) {
		try {
			...
			for (/**/; (f_jf ^ 0xffffffff) < (i ^ 0xffffffff); i++) {
				...
				int i_12_ = 16386 + i;
				Varbit.aFloatArray1536[0] = (float) class246_sub41.method2317(false);
				Varbit.aFloatArray1536[1] = (float) class246_sub41.method2318((byte) 27);
				Varbit.aFloatArray1536[2] = (float) class246_sub41.method2321((byte) -60);
				Varbit.aFloatArray1536[3] = 1.0F;
				OpenGL.glLightfv(i_12_, 4611, Varbit.aFloatArray1536, 0);
				int i_13_ = class246_sub41.method2319((byte) -112);
				float f = class246_sub41.method2316(false) / 255.0F;
				Varbit.aFloatArray1536[0] = f * (float) (PacketsDecoder.method184(16753966, i_13_) >> 16);
				Varbit.aFloatArray1536[1] = (float) (PacketsDecoder.method184(65287, i_13_) >> 8) * f;
				Varbit.aFloatArray1536[2] = (float) PacketsDecoder.method184(255, i_13_) * f;
				OpenGL.glLightfv(i_12_, 4609, Varbit.aFloatArray1536, 0);
				OpenGL.glLightf(i_12_, 4617,
						1.0F / (float) (class246_sub41.method2322(81) * class246_sub41.method2322(116)));
			...
			if (class109_14_ != class109) {
				if (class109 == null)
					...
					if (class109_14_ != null) {
						if ((((Class109) class109).anInt1553 ^ 0xffffffff) != (((Class109) class109_14_).anInt1553
								^ 0xffffffff)) {
							OpenGL.glDisable(((Class109) class109_14_).anInt1553);
	...
	final synchronized void method1908(int i, byte i_20_) {
		try {
			...
			aClass166_4320.push_head(class246);
		} catch (RuntimeException runtimeexception) {
	...
	final void O(int i, int i_22_, int i_23_, int i_24_, int i_25_, int i_26_) {
		do {
			try {
				...
				throw Class193.method1272(runtimeexception,
						("fd.O(" + i + ',' + i_22_ + ',' + i_23_ + ',' + i_24_ + ',' + i_25_ + ',' + i_26_ + ')'));
			}
			break;
		} while (false);
	}
	...
	final synchronized void method1910(int i, int i_30_, int i_31_) {
		try {
			anInt4292++;
			SwitchInt class246_sub33 = new SwitchInt(i_30_);
			if (i > -44)
				method1709(-39, 94, -5, -127, -35, -16);
			((Node) class246_sub33).hash = (long) i_31_;
			aClass166_4319.push_head(class246_sub33);
		} catch (RuntimeException runtimeexception) {
	...
	final void NA(int i, int i_37_, int i_38_, int i_39_, int i_40_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("fd.NA(" + i + ',' + i_37_ + ',' + i_38_ + ',' + i_39_ + ',' + i_40_ + ')'));
		}
	}
	...
	final void method1913(boolean bool, float f, float f_41_, float f_42_, float f_43_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("fd.IB(" + bool + ',' + f + ',' + f_41_ + ',' + f_42_ + ',' + f_43_ + ')'));
		}
	}

	final AbstractModel method1695(Model class103, int i, int i_44_, int i_45_, int i_46_) {
		try {
			anInt4193++;
			return new HDModel(this, class103, i, i_45_, i_46_, i_44_);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, ("fd.BA(" + (class103 != null ? "{...}" : "null") + ',' + i
					+ ',' + i_44_ + ',' + i_45_ + ',' + i_46_ + ')'));
		}
	}
		...
		do {
			try {
				do {
					...
					OpenGL.glScissor(anInt4373 + f_wg, (-anInt4337 + (anInt4324 - -((Class260_Sub2) this).f_tb)),
							-anInt4373 + f_nf, anInt4337 + -anInt4386);
				} while (false);
				anInt4272++;
				if (i < -3)
					break;
	...
	private final void method1923(byte i) {
		try {
			f_ae++;
			float[] fs = f_bf;
			float f = ((float) (-((Class260_Sub2) this).f_vf * ((Class260_Sub2) this).f_cf)
					/ (float) ((Class260_Sub2) this).anInt4366);
			float f_48_ = ((float) ((((Class260_Sub2) this).f_vd - ((Class260_Sub2) this).f_vf)
					* ((Class260_Sub2) this).f_cf) / (float) ((Class260_Sub2) this).anInt4366);
			if (i >= -70)
				method1925(10, 30, 114, 87);
			float f_49_ = ((float) (((Class260_Sub2) this).anInt4339 * ((Class260_Sub2) this).f_cf)
					/ (float) ((Class260_Sub2) this).f_tf);
			float f_50_ = ((float) (((Class260_Sub2) this).f_cf
					* (-((Class260_Sub2) this).f_tb + ((Class260_Sub2) this).anInt4339))
					/ (float) ((Class260_Sub2) this).f_tf);
			do {
				if (f != f_48_ && f_50_ != f_49_) {
					...
					fs[14] = f_hf = (-(f_51_ * (float) ((Class260_Sub2) this).anInt4371)
							/ (float) (-((Class260_Sub2) this).f_cf + ((Class260_Sub2) this).anInt4371));
					fs[2] = 0.0F;
					fs[15] = 0.0F;
					fs[10] = f_cg = ((float) -(((Class260_Sub2) this).anInt4371 - -((Class260_Sub2) this).f_cf)
							/ (float) (-((Class260_Sub2) this).f_cf + ((Class260_Sub2) this).anInt4371));
					fs[1] = 0.0F;
					fs[11] = -1.0F;
					fs[0] = f_51_ / (f_48_ - f);
	...
	final Class211 method1709(int i, int i_52_, int i_53_, int i_54_, int i_55_, int i_56_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("fd.VA(" + i + ',' + i_52_ + ',' + i_53_ + ',' + i_54_ + ',' + i_55_ + ',' + i_56_ + ')'));
		}
	}
	...
	final Class211 method1739(Class211 class211, Class211 class211_60_, float f, Class211 class211_61_) {
		try {
			anInt4245++;
			if (class211 != null && class211_60_ != null && ((Class260_Sub2) this).aBool4340
					&& ((Class260_Sub2) this).aBool4322 && ((Class260_Sub2) this).aBool4358) {
				...
				if (class109_sub4 != null && class109_sub4_63_ != null) {
					int i = (((((Class109_Sub4) class109_sub4_63_).anInt4571
							^ 0xffffffff) > (((Class109_Sub4) class109_sub4).anInt4571 ^ 0xffffffff))
									? ((Class109_Sub4) class109_sub4).anInt4571
									: ((Class109_Sub4) class109_sub4_63_).anInt4571);
					if (class211_61_ != class211 && class211_61_ != class211_60_
							&& class211_61_ instanceof Class211_Sub1_Sub1) {
			...
			throw Class193.method1272(runtimeexception,
					("fd.HC(" + (class211 != null ? "{...}" : "null") + ',' + (class211_60_ != null ? "{...}" : "null")
							+ ',' + f + ',' + (class211_61_ != null ? "{...}" : "null") + ')'));
		}
	}

	final void method1703(AbstractModel class_t, Class129 class129, Class_c class_c, Class130_Sub5 class130_sub5,
			int i) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("fd.HA(" + (class_t != null ? "{...}" : "null") + ',' + (class129 != null ? "{...}" : "null") + ','
							+ (class_c != null ? "{...}" : "null") + ',' + (class130_sub5 != null ? "{...}" : "null")
							+ ',' + i + ')'));
		}
	}

	final void method1926(boolean bool, byte i, int textureId, boolean bool_66_) {
		try {
			if (anInt4376 != textureId) {
				if (textureId >= 0) {
					if (TextureLoader.osrs(textureId)) {
						Texture tex = ((TextureLoader) Class246_Sub37_Sub1.textureLoader).get_texture(textureId,
								Revision.OSRS, 2);
						if (tex.animationDirection != 0
								|| tex.animationSpeed != 0) {
							method1963((byte) -62,
									tex.animationSpeed,
									tex.animationDirection,
									0.0F);
						} else {
							method1917(0);
						}
					} else {
						Class109_Sub1 class109_sub1 = ((Class260_Sub2) this).f_ie.method319(textureId, -128);
						Material class238 = ((SceneGraph) this).anInterface6_3714.get_material(-31305, textureId);
						if (((Material) class238).animationDirection != 0
								|| ((((Material) class238).animationSpeed ^ 0xffffffff) != -1)) {
							int i_67_ = !((Material) class238).aBool3335 ? 128 : 64;
							int i_68_ = i_67_ * 50;
							method1963((byte) -62,
									(float) (((Material) class238).animationSpeed
											* (((Class260_Sub2) this).f_qe % i_68_))
											/ (float) i_68_,
									(float) (((Material) class238).animationDirection
											* (((Class260_Sub2) this).f_qe % i_68_))
											/ (float) i_68_,
									0.0F);
						} else
						...
						if (!((Class260_Sub2) this).aBool4325) {
							f_fe.method1520(-113, bool_66_, bool, ((Material) class238).aByte3343);
							f_fe.method1521(((Material) class238).anInt3336, ((Material) class238).aByte3342, false);
							if (!f_fe.method1518((byte) -92, class109_sub1, (((Material) class238).anInt3341))) {
								method1905((byte) 78, class109_sub1);
								method1900(i ^ 0x1e0d, ((Material) class238).anInt3341);
							}
						} else {
							f_fe.method1520(-105, bool_66_, bool, 3);
							method1905((byte) 78, class109_sub1);
							method1900(7681, ((Material) class238).anInt3341);
						}
					}
				} else {
					method1917(i - 12);
			...
			throw Class193.method1272(runtimeexception,
					("fd.IF(" + bool + ',' + i + ',' + textureId + ',' + bool_66_ + ')'));
		}
	}
	...
	private final void method1927(byte i) {
		try {
			...
			Class246_Sub38.aFloatArray5446[1] = (((Class260_Sub2) this).aFloat4332
					* -((Class260_Sub2) this).aFloat4352);
			int i_69_ = -8 % ((8 - i) / 58);
			Class246_Sub38.aFloatArray5446[2] = (-((Class260_Sub2) this).aFloat4352
					* ((Class260_Sub2) this).aFloat4367);
			Class246_Sub38.aFloatArray5446[3] = 1.0F;
	...
	final void T(int i, float f, float f_70_, float f_71_, float f_72_, float f_73_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("fd.T(" + i + ',' + f + ',' + f_70_ + ',' + f_71_ + ',' + f_72_ + ',' + f_73_ + ')'));
		}
	}
	...
	final synchronized void method1687(int i) {
		try {
			...
			while (!aClass166_4316.method1111((byte) -123)) {
				SwitchInt class246_sub33 = (SwitchInt) aClass166_4316.method1100(4095);
				Class243.anIntArray3446[i_76_++] = (int) ((Node) class246_sub33).hash;
				((Class260_Sub2) this).anInt4314 -= ((SwitchInt) class246_sub33).value;
				if (i_76_ == 1000) {
			...
			while (!aClass166_4317.method1111((byte) -125)) {
				SwitchInt class246_sub33 = (SwitchInt) aClass166_4317.method1100(4095);
				Class243.anIntArray3446[i_76_++] = (int) ((Node) class246_sub33).hash;
				((Class260_Sub2) this).anInt4312 -= ((SwitchInt) class246_sub33).value;
				if (i_76_ == 1000) {
			...
			while (!aClass166_4318.method1111((byte) -126)) {
				SwitchInt class246_sub33 = (SwitchInt) aClass166_4318.method1100(4095);
				Class243.anIntArray3446[i_76_++] = ((SwitchInt) class246_sub33).value;
			...
			while (!aClass166_4319.method1111((byte) -124)) {
				SwitchInt class246_sub33 = (SwitchInt) aClass166_4319.method1100(4095);
				Class243.anIntArray3446[i_76_++] = (int) ((Node) class246_sub33).hash;
				anInt4315 -= ((SwitchInt) class246_sub33).value;
				if ((i_76_ ^ 0xffffffff) == -1001) {
			...
			while (!aClass166_4313.method1111((byte) -126)) {
				SwitchInt class246_sub33 = (SwitchInt) aClass166_4313.method1100(4095);
				OpenGL.glDeleteLists((int) (((Node) class246_sub33).hash), (((SwitchInt) class246_sub33).value));
			}
			...
			if (IA() > 100663296 && TimeUtility.time() > 60000L + aLong4390) {
				System.gc();
				aLong4390 = TimeUtility.time();
			}
	...
	final Class210 method1738(int i, int i_79_, int[][] is, int[][] is_80_, int i_81_, int i_82_, int i_83_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("fd.TC(" + i + ',' + i_79_ + ',' + (is != null ? "{...}" : "null") + ','
							+ (is_80_ != null ? "{...}" : "null") + ',' + i_81_ + ',' + i_82_ + ',' + i_83_ + ')'));
		}
	}
		...
		try {
			if (anInt4393 != i) {
				...
				if (((Class260_Sub2) this).f_vd > 0 && ((Class260_Sub2) this).f_tb > 0)
					OpenGL.glOrtho(0.0, (double) ((Class260_Sub2) this).f_vd, (double) ((Class260_Sub2) this).f_tb, 0.0,
							-1.0, 1.0);
				OpenGL.glMatrixMode(5888);
				OpenGL.glLoadIdentity();
				anInt4393 = 1;
	...
	final void method1728(int i, int i_84_, int i_85_, int i_86_, int i_87_, int i_88_, Class128 class128, int i_89_,
			int i_90_) {
		try {
			anInt4276++;
			...
			float f = (((Class109_Sub1_Sub1) class109_sub1_sub1).aFloat6730
					/ (float) (((Class109_Sub1_Sub1) class109_sub1_sub1).anInt6724));
			float f_91_ = (((Class109_Sub1_Sub1) class109_sub1_sub1).aFloat6727
					/ (float) (((Class109_Sub1_Sub1) class109_sub1_sub1).anInt6729));
			...
			throw Class193.method1272(runtimeexception,
					("fd.ED(" + i + ',' + i_84_ + ',' + i_85_ + ',' + i_86_ + ',' + i_87_ + ',' + i_88_ + ','
							+ (class128 != null ? "{...}" : "null") + ',' + i_89_ + ',' + i_90_ + ')'));
		}
	}
	...
	private final void method1933(int i) {
		try {
			...
			float f_95_ = (aFloat4353 * (float) -((Class260_Sub2) this).anInt4339
					/ (float) ((Class260_Sub2) this).f_tf);
			if (i != -16933)
				((Class260_Sub2) this).aBool4340 = true;
			float f_96_ = (aFloat4353 * (float) (-((Class260_Sub2) this).f_vf + ((Class260_Sub2) this).f_vd)
					/ (float) ((Class260_Sub2) this).anInt4366);
			float f_97_ = ((float) (-((Class260_Sub2) this).anInt4339 + ((Class260_Sub2) this).f_tb) * aFloat4353
					/ (float) ((Class260_Sub2) this).f_tf);
			OpenGL.glMatrixMode(5889);
			OpenGL.glLoadIdentity();
			if (f != f_96_ && f_95_ != f_97_)
				OpenGL.glOrtho((double) f, (double) f_96_, (double) -f_97_, (double) -f_95_,
						(double) (-((Class260_Sub2) this).aFloat4359 + (float) (((Class260_Sub2) this).f_cf)),
						(double) (-((Class260_Sub2) this).aFloat4359 + (float) (((Class260_Sub2) this).anInt4371)));
			OpenGL.glMatrixMode(5888);
		} catch (RuntimeException runtimeexception) {
	...
	Class260_Sub2(int i, Canvas canvas, TextureInterface interface6, int i_98_, Signlink class52) {
		super(i, interface6);
		...
		try {
			...
			try {
				...
				if (f_qg.indexOf("radeon") != -1) {
					...
					for (int i_102_ = 0; strings.length > i_102_; i_102_++) {
						...
						try {
							if (string.length() > 0) {
								if ((string.charAt(0) ^ 0xffffffff) == -121 && string.length() >= 3
										&& Class48.method323(string.substring(1, 3), 59)) {
								...
								if (string.equals("hd"))
									...
									if ((string.length() ^ 0xffffffff) <= -5
											&& (Class48.method323(string.substring(0, 4), 59))) {
				...
				f_ne = true;
				((Class260_Sub2) this).f_ie = new Class47(this, ((SceneGraph) this).anInterface6_3714);
				method1964((byte) 127);
			...
			throw Class193.method1272(runtimeexception,
					("fd.<init>(" + i + ',' + (canvas != null ? "{...}" : "null") + ','
							+ (interface6 != null ? "{...}" : "null") + ',' + i_98_ + ','
							+ (class52 != null ? "{...}" : "null") + ')'));
		}
	}

	final void method1934(Class160 class160, int i, Class160 class160_104_, Class160 class160_105_,
			Class160 class160_106_) {
		try {
			if (class160_106_ != null) {
				method1944(((Class160) class160_106_).anInterface10_2264, -121);
				OpenGL.glVertexPointer(((Class160) class160_106_).aByte2268, ((Class160) class160_106_).aShort2269,
						f_ag.method21(true), (f_ag.method32(12786) + (long) (((Class160) class160_106_).aByte2265)));
			...
			if (class160_104_ != null) {
				...
				OpenGL.glNormalPointer(((Class160) class160_104_).aShort2269, f_ag.method21(true),
						(f_ag.method32(12786) + (long) (((Class160) class160_104_).aByte2265)));
			...
			if (i > 113) {
				if (class160 != null) {
					...
					OpenGL.glColorPointer(((Class160) class160).aByte2268, ((Class160) class160).aShort2269,
							f_ag.method21(true), (f_ag.method32(12786) + (long) (((Class160) class160).aByte2265)));
				...
				if (class160_105_ == null)
					...
					OpenGL.glTexCoordPointer(((Class160) class160_105_).aByte2268,
							((Class160) class160_105_).aShort2269, f_ag.method21(true),
							(f_ag.method32(12786) - -(long) ((Class160) class160_105_).aByte2265));
					OpenGL.glEnableClientState(32888);
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("fd.MD(" + (class160 != null ? "{...}" : "null") + ',' + i + ','
							+ (class160_104_ != null ? "{...}" : "null") + ','
							+ (class160_105_ != null ? "{...}" : "null") + ','
							+ (class160_106_ != null ? "{...}" : "null") + ')'));
		}
	}
	...
	final void method1679(int i, Class246_Sub41[] class246_sub41s) {
		do {
			try {
				...
				throw Class193.method1272(runtimeexception,
						("fd.EB(" + i + ',' + (class246_sub41s != null ? "{...}" : "null") + ')'));
			}
			break;
		} while (false);
	}
	...
	final void method1935(boolean bool, Interface4 interface4) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("fd.CG(" + bool + ',' + (interface4 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	final void method1685(Class_u class_u) {
		do {
			try {
				...
				// anInterface10_4348 = method1960(0, ((Buffer) stream_sub2).position, ((Buffer)
				// stream_sub2).buffer, false, 20);
	...
	final synchronized void method1939(int i, int i_110_, int i_111_) {
		try {
			f_hc++;
			if (i_111_ < -17) {
				SwitchInt class246_sub33 = new SwitchInt(i_110_);
				((Node) class246_sub33).hash = (long) i;
				aClass166_4316.push_head(class246_sub33);
			}
		} catch (RuntimeException runtimeexception) {
	...
	final synchronized void method1941(boolean bool, int i) {
		try {
			if (bool == true) {
				f_jd++;
				SwitchInt class246_sub33 = new SwitchInt(i);
				aClass166_4318.push_head(class246_sub33);
			}
		} catch (RuntimeException runtimeexception) {
	...
	final void method1942(Class_c_Sub1 class_c_sub1, int i) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					"fd.OF(" + (class_c_sub1 != null ? "{...}" : "null") + ',' + i + ')');
		}
	}
	...
	final AbstractSprite method1721(int i, int i_120_, int i_121_, int i_122_, boolean bool) {
		try {
			anInt4241++;
			return new Class_l_Sub2(this, i, i_120_, i_121_, i_122_);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("fd.SB(" + i + ',' + i_120_ + ',' + i_121_ + ',' + i_122_ + ',' + bool + ')'));
		}
	}
	...
	final void method1948(int i, Class_c_Sub1 class_c_sub1) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("fd.NF(" + i + ',' + (class_c_sub1 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	final void method1680() {
		do {
			try {
				...
				if (!f_ne)
					break;
				Texture.method2701(false, 478210754, true);
				f_ne = false;
			} catch (RuntimeException runtimeexception) {
	...
	final void method1694(int i, int i_123_, int i_124_, int i_125_, int i_126_, int i_127_, int i_128_) {
		try {
			...
			throw Class193.method1272(runtimeexception, ("fd.CD(" + i + ',' + i_123_ + ',' + i_124_ + ',' + i_125_ + ','
					+ i_126_ + ',' + i_127_ + ',' + i_128_ + ')'));
		}
	}

	final void method1740(AbstractModel[] class_ts, Class129 class129, Class_c class_c, Class130_Sub5[] class130_sub5s,
			int i) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("fd.CB(" + (class_ts != null ? "{...}" : "null") + ',' + (class129 != null ? "{...}" : "null")
							+ ',' + (class_c != null ? "{...}" : "null") + ','
							+ (class130_sub5s != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}
	...
	final void ia(int i, int i_135_) {
		try {
			do {
				if (i != ((Class260_Sub2) this).f_cf
						|| ((i_135_ ^ 0xffffffff) != (((Class260_Sub2) this).anInt4371 ^ 0xffffffff))) {
	...
	final Interface1 method1955(int i, int i_136_, boolean bool, byte[] is, int i_137_) {
		try {
			...
			throw Class193.method1272(runtimeexception, ("fd.MB(" + i + ',' + i_136_ + ',' + bool + ','
					+ (is != null ? "{...}" : "null") + ',' + i_137_ + ')'));
		}
	}
	...
	final void method1698(float f, float f_141_, float f_142_) {
		try {
			IterableNodeHashTable.aFloat1135 = f_141_;
	...
	final void method1753(int i, int i_143_, int i_144_, int i_145_, int i_146_, int i_147_) {
		do {
			try {
				...
				throw Class193.method1272(runtimeexception, ("fd.SC(" + i + ',' + i_143_ + ',' + i_144_ + ',' + i_145_
						+ ',' + i_146_ + ',' + i_147_ + ')'));
			}
			break;
		} while (false);
	...
	final void method1743(int i, int i_151_, int i_152_, int i_153_, int i_154_, int i_155_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("fd.BC(" + i + ',' + i_151_ + ',' + i_152_ + ',' + i_153_ + ',' + i_154_ + ',' + i_155_ + ')'));
		}
	}
	...
	final void ca(int i, Class128 class128, int i_160_, int i_161_) {
		try {
			...
			float f = (((Class109_Sub1_Sub1) class109_sub1_sub1).aFloat6730
					/ (float) (((Class109_Sub1_Sub1) class109_sub1_sub1).anInt6724));
			float f_162_ = (((Class109_Sub1_Sub1) class109_sub1_sub1).aFloat6727
					/ (float) (((Class109_Sub1_Sub1) class109_sub1_sub1).anInt6729));
			...
			throw Class193.method1272(runtimeexception,
					("fd.ca(" + i + ',' + (class128 != null ? "{...}" : "null") + ',' + i_160_ + ',' + i_161_ + ')'));
		}
	}
		...
		do {
			try {
				...
				do {
					...
					aFloat4388 = (-aFloat4326
							+ (float) (((Class260_Sub2) this).anInt4371 + -((Class260_Sub2) this).anInt4323));
	...
	final Interface10 method1960(int i, int i_165_, byte[] is, boolean bool, int i_166_) {
		try {
			...
			throw Class193.method1272(runtimeexception, ("fd.LA(" + i + ',' + i_165_ + ','
					+ (is != null ? "{...}" : "null") + ',' + bool + ',' + i_166_ + ')'));
		}
	}
	...
	final void method1748(AbstractModel[] class_ts, Class_c class_c, Class130_Sub5[] class130_sub5s, int i) {
		try {
			anInt4254++;
			...
			throw Class193.method1272(runtimeexception,
					("fd.IC(" + (class_ts != null ? "{...}" : "null") + ',' + (class_c != null ? "{...}" : "null") + ','
							+ (class130_sub5s != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}

	final Font method1716(FontMetric class73, LDSprite[] class10s, boolean bool) {
		try {
			f_eb++;
			return new Class116_Sub2(this, class73, class10s, bool);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, ("fd.Q(" + (class73 != null ? "{...}" : "null") + ','
					+ (class10s != null ? "{...}" : "null") + ',' + bool + ')'));
		}
	}
	...
	final void UA(int i, int i_171_, int i_172_) {
		try {
			if (((((Class260_Sub2) this).anInt4364 ^ 0xffffffff) != (i ^ 0xffffffff))
					|| i_171_ != ((Class260_Sub2) this).anInt4377 || i_172_ != ((Class260_Sub2) this).anInt4323) {
	...
	final void DA(int i, int i_173_, int i_174_, int i_175_, int i_176_, int i_177_, byte[] is, int i_178_,
			int i_179_) {
		try {
			f_pb++;
			float f;
			float f_180_;
			do {
				if (aClass109_Sub1_Sub1_4347 == null
						|| (((Class109_Sub1) aClass109_Sub1_Sub1_4347).anInt3760 ^ 0xffffffff) > (i_174_ ^ 0xffffffff)
						|| (((Class109_Sub1) aClass109_Sub1_Sub1_4347).anInt3752 < i_175_)) {
					aClass109_Sub1_Sub1_4347 = Class18.method176(false, (byte) -116, is, this, i_174_, i_175_, 6406,
							6406);
				...
				f_180_ = ((float) i_174_ * (((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_4347).aFloat6730)
						/ (float) (((Class109_Sub1) aClass109_Sub1_Sub1_4347).anInt3760));
				f = ((float) i_175_ * (((Class109_Sub1_Sub1) aClass109_Sub1_Sub1_4347).aFloat6727)
						/ (float) (((Class109_Sub1) aClass109_Sub1_Sub1_4347).anInt3752));
			} while (false);
			method1930(false);
			...
			throw Class193.method1272(runtimeexception,
					("fd.DA(" + i + ',' + i_173_ + ',' + i_174_ + ',' + i_175_ + ',' + i_176_ + ',' + i_177_ + ','
							+ (is != null ? "{...}" : "null") + ',' + i_178_ + ',' + i_179_ + ')'));
		}
	}
	...
	final Class246_Sub41 method1751(int i, int i_185_, int i_186_, int i_187_, int i_188_, float f) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("fd.M(" + i + ',' + i_185_ + ',' + i_186_ + ',' + i_187_ + ',' + i_188_ + ',' + f + ')'));
		}
	}
	...
	final void TA(int i, int i_189_, int i_190_, int i_191_, int i_192_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("fd.TA(" + i + ',' + i_189_ + ',' + i_190_ + ',' + i_191_ + ',' + i_192_ + ')'));
		}
	}
	...
	private final void method1964(byte i) {
		do {
			try {
				...
				((Class260_Sub2) this).f_lg = new HDModel(this);
				((Class260_Sub2) this).f_rf = new HDModel(this);
				((Class260_Sub2) this).aClass_t_Sub1_4372 = new HDModel(this);
				((Class260_Sub2) this).f_ef = new HDModel(this);
				((Class260_Sub2) this).f_ug = new HDModel(this);
				((Class260_Sub2) this).aClass_t_Sub1_4328 = new HDModel(this);
				((Class260_Sub2) this).f_ig = new HDModel(this);
				if (i <= 94)
					f_dh = null;
				((Class260_Sub2) this).aClass_t_Sub1_4387 = new HDModel(this);
				((Class260_Sub2) this).f_jg = new HDModel(this);
				((Class260_Sub2) this).aClass_t_Sub1_4336 = new HDModel(this);
	...
	final void b(int i, int i_194_, int i_195_, int i_196_, int i_197_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("fd.b(" + i + ',' + i_194_ + ',' + i_195_ + ',' + i_196_ + ',' + i_197_ + ')'));
		}
	}
	...
	final void method1967(int i, int i_200_, int i_201_, Interface1 interface1, byte i_202_) {
		try {
			...
			throw Class193.method1272(runtimeexception, ("fd.GF(" + i + ',' + i_200_ + ',' + i_201_ + ','
					+ (interface1 != null ? "{...}" : "null") + ',' + i_202_ + ')'));
		}
	}
	...
	final boolean JA(int i, int i_204_, int i_205_, int i_206_, int i_207_, int i_208_) {
		try {
			anInt4234++;
			float f = (((float) i_205_ * ((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5363)
					+ ((float) i_204_ * ((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5378
							+ (float) i * ((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5386)
					+ ((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5362);
			if (f < 1.0F)
				f = 1.0F;
			float f_209_ = (((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5362
					+ ((((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5386 * (float) i_206_)
							+ (((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5378) * (float) i_207_
							+ (((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5363) * (float) i_208_));
			if (f_209_ < 1.0F)
				f_209_ = 1.0F;
			if (((float) ((Class260_Sub2) this).f_cf > f && (float) ((Class260_Sub2) this).f_cf > f_209_)
					|| (f > (float) ((Class260_Sub2) this).anInt4371
							&& f_209_ > (float) ((Class260_Sub2) this).anInt4371))
				return false;
			int i_210_ = (int) ((float) ((Class260_Sub2) this).anInt4366
					* ((((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5372) * (float) i
							+ ((float) i_204_ * (((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5387))
							+ ((float) i_205_ * (((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5388))
							+ (((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5393))
					/ f);
			int i_211_ = (int) ((float) ((Class260_Sub2) this).anInt4366
					* ((((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5372) * (float) i_206_
							+ ((float) i_207_ * (((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5387))
							+ (((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5388) * (float) i_208_
							+ (((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5393))
					/ f_209_);
			if (((float) i_210_ < ((Class260_Sub2) this).aFloat4383
					&& (float) i_211_ < ((Class260_Sub2) this).aFloat4383)
					|| (((Class260_Sub2) this).aFloat4344 < (float) i_210_
							&& ((Class260_Sub2) this).aFloat4344 < (float) i_211_))
				return false;
			int i_212_ = (int) (((((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5367) * (float) i_205_
					+ ((((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5364) * (float) i
							+ (((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5382) * (float) i_204_)
					+ (((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5385)) * (float) ((Class260_Sub2) this).f_tf
					/ f);
			int i_213_ = (int) ((float) ((Class260_Sub2) this).f_tf
					* ((((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5367) * (float) i_208_
							+ (((float) i_206_ * (((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5364))
									+ (((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5382) * (float) i_207_)
							+ (((Class_c_Sub1) ((Class260_Sub2) this).f_hg).aFloat5385))
					/ f_209_);
			if (((float) i_212_ < ((Class260_Sub2) this).f_qf && ((Class260_Sub2) this).f_qf > (float) i_213_)
					|| ((float) i_212_ > ((Class260_Sub2) this).aFloat4361
							&& (float) i_213_ > ((Class260_Sub2) this).aFloat4361))
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("fd.JA(" + i + ',' + i_204_ + ',' + i_205_ + ',' + i_206_ + ',' + i_207_ + ',' + i_208_ + ')'));
		}
	}
	...
	final void method1970(int i, Interface1 interface1) {
		do {
			try {
				...
				throw Class193.method1272(runtimeexception,
						("fd.JE(" + i + ',' + (interface1 != null ? "{...}" : "null") + ')'));
			}
			break;
		} while (false);
	}

	final void method1717(int i, int i_217_, int i_218_, int i_219_, int i_220_, int i_221_, int i_222_, int i_223_,
			int i_224_, int i_225_) {
		try {
			anInt4253++;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, ("fd.RC(" + i + ',' + i_217_ + ',' + i_218_ + ',' + i_219_ + ','
					+ i_220_ + ',' + i_221_ + ',' + i_222_ + ',' + i_223_ + ',' + i_224_ + ',' + i_225_ + ')'));
		}
	}
	...
	final void method1971(Interface4 interface4, int i) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					"fd.QE(" + (interface4 != null ? "{...}" : "null") + ',' + i + ')');
		}
	}

	final AbstractSprite method1706(int[] is, int i, int i_227_, int i_228_, int i_229_) {
		try {
			anInt4221++;
			return new Class_l_Sub2(this, i_228_, i_229_, is, i, i_227_);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, ("fd.LC(" + (is != null ? "{...}" : "null") + ',' + i + ','
					+ i_227_ + ',' + i_228_ + ',' + i_229_ + ')'));
		}
	}

	final AbstractSprite method1706_osrs(int[] is, int i, int i_227_, int i_228_, int i_229_) {
		try {
			anInt4221++;
			return new Class_l_Sub2(this, i_228_, i_229_, is, i, i_227_);
		} catch (RuntimeException runtimeexception) {
	...
	final int[] F(int i, int i_230_, int i_231_, int i_232_) {
		try {
			...
			for (int i_233_ = 0; i_232_ > i_233_; i_233_++)
				OpenGL.glReadPixelsi(i, (-i_233_ + ((Class260_Sub2) this).f_tb + -i_230_), i_231_, 1, 32993,
						((Class260_Sub2) this).f_sg, is, i_233_ * i_231_);
			return is;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("fd.F(" + i + ',' + i_230_ + ',' + i_231_ + ',' + i_232_ + ')'));
		}
	}

	final AbstractSprite ld_to_abstract_sprite(LDSprite class10, boolean bool) {
		try {
			anInt4287++;
			int[] is = new int[(((LDSprite) class10).anInt155 * ((LDSprite) class10).anInt156)];
			int i = 0;
			int i_234_ = 0;
			if (((LDSprite) class10).aByteArray161 == null) {
				for (int i_235_ = 0; ((i_235_ ^ 0xffffffff) > (((LDSprite) class10).anInt155 ^ 0xffffffff)); i_235_++) {
					for (int i_236_ = 0; ((LDSprite) class10).anInt156 > i_236_; i_236_++) {
						int i_237_ = (((LDSprite) class10).anIntArray160[(((LDSprite) class10).aByteArray157[i++]
								& 0xff)]);
						is[i_234_++] = ((i_237_ ^ 0xffffffff) == -1 ? 0 : Class236.method1523(i_237_, -16777216));
					}
				}
			} else {
				for (int i_238_ = 0; ((((LDSprite) class10).anInt155 ^ 0xffffffff) < (i_238_ ^ 0xffffffff)); i_238_++) {
					for (int i_239_ = 0; ((LDSprite) class10).anInt156 > i_239_; i_239_++) {
						is[i_234_++] = (Class236.method1523(((LDSprite) class10).aByteArray161[i] << 24,
								(((LDSprite) class10).anIntArray160[PacketsDecoder.method184(255,
										(((LDSprite) class10).aByteArray157[i]))])));
						i++;
					}
				}
			}
			AbstractSprite class_l = method1706(is, 0, ((LDSprite) class10).anInt156, ((LDSprite) class10).anInt156,
					((LDSprite) class10).anInt155);
			class_l.MA(((LDSprite) class10).anInt158, ((LDSprite) class10).anInt162, ((LDSprite) class10).anInt159,
					((LDSprite) class10).anInt163);
			return class_l;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					"fd.P(" + (class10 != null ? "{...}" : "null") + ',' + bool + ')');
		}
	}
	...
	final synchronized void method1973(int i, long l) {
		do {
			try {
				...
				aClass166_4321.push_head(class246);
				if (i == -34844)
					break;
				f_ke = null;
			} catch (RuntimeException runtimeexception) {
	...
	private final void method1975(int i) {
		try {
			do {
				...
				float f = (((Class260_Sub2) this).aFloat4343
						/ (((Class260_Sub2) this).aFloat4343 + ((Class260_Sub2) this).aFloat4359));
				float f_259_ = f * f;
			...
			anInt4291++;
			((Class260_Sub2) this).aFloat4389 = (-((Class260_Sub2) this).aFloat4359
					+ (float) ((Class260_Sub2) this).anInt4371);
	...
	final void p(int i) {
		try {
			f_kd++;
			method1958(-47, 0);
			OpenGL.glClearColor((float) (i & 0xff0000) / 1.671168E7F, (float) (i & 0xff00) / 65280.0F,
					(float) (0xff & i) / 255.0F, (float) (i >>> 24) / 255.0F);
			OpenGL.glClear(16384);
		} catch (RuntimeException runtimeexception) {
	...
	final synchronized void method1978(int i, byte i_263_, int i_264_) {
		try {
			anInt4267++;
			SwitchInt class246_sub33 = new SwitchInt(i_264_);
			((Node) class246_sub33).hash = (long) i;
			if (i_263_ <= 107)
				((Class260_Sub2) this).aFloat4367 = 1.509716F;
			aClass166_4317.push_head(class246_sub33);
		} catch (RuntimeException runtimeexception) {
