...
final class Class134 implements Interface4 {
	...
	private final void method904(int i, int i_4_, Class109_Sub1 class109_sub1, int i_5_) {
		try {
			...
			if ((anInt1868 & (i_6_ ^ 0xffffffff) ^ 0xffffffff) != -1) {
				if (anInt1846 != ((Class109_Sub1) class109_sub1).anInt3760
			...
			throw Class193.method1272(runtimeexception,
					("ml.G(" + i + ',' + i_4_ + ',' + (class109_sub1 != null ? "{...}" : "null") + ',' + i_5_ + ')'));
		}
	}
	...
	private final void method905(int i, int i_7_, int i_8_, Class109_Sub4 class109_sub4, int i_9_) {
		try {
			...
			if ((anInt1868 & (i_10_ ^ 0xffffffff) ^ 0xffffffff) != -1) {
				if (((anInt1846 ^ 0xffffffff) != (((Class109_Sub4) class109_sub4).anInt4571 ^ 0xffffffff))
						|| ((anInt1866 ^ 0xffffffff) != (((Class109_Sub4) class109_sub4).anInt4571 ^ 0xffffffff)))
					throw new RuntimeException();
			} else {
			...
			throw Class193.method1272(runtimeexception, ("ml.N(" + i + ',' + i_7_ + ',' + i_8_ + ','
					+ (class109_sub4 != null ? "{...}" : "null") + ',' + i_9_ + ')'));
		}
	}
	...
	final void method906(Class246_Sub1_Sub12 class246_sub1_sub12, int i, byte i_11_) {
		try {
			...
			if ((anInt1868 & (i_12_ ^ 0xffffffff)) != 0) {
				if (((anInt1846 ^ 0xffffffff) != (((Class246_Sub1_Sub12) class246_sub1_sub12).anInt6254 ^ 0xffffffff))
						|| ((anInt1866 ^ 0xffffffff) != ((((Class246_Sub1_Sub12) class246_sub1_sub12).anInt6253)
								^ 0xffffffff)))
					throw new RuntimeException();
			} else {
			...
			throw Class193.method1272(runtimeexception,
					("ml.Q(" + (class246_sub1_sub12 != null ? "{...}" : "null") + ',' + i + ',' + i_11_ + ')'));
		}
	}
	...
	static final void method909(int i, Class246_Sub35 class246_sub35, int i_15_, boolean bool) {
		do {
			try {
				anInt1852++;
				if (class246_sub35 != null && class246_sub35 != (((Class166) Varbit.aClass166_1525).aClass246_2343)) {
					int x = ((Class246_Sub35) class246_sub35).anInt5151;
					int y = ((Class246_Sub35) class246_sub35).anInt5154;
					int var2 = ((Class246_Sub35) class246_sub35).anInt5156;
					int i_19_ = (int) ((Class246_Sub35) class246_sub35).aLong5157;
					if (var2 >= 2000)
						var2 -= 2000;
					long l = ((Class246_Sub35) class246_sub35).aLong5157;
					if (var2 == 1004 || (var2 ^ 0xffffffff) == -1013 || var2 == 1008 || var2 == 1001
							|| var2 == 1006)
						Class246_Sub28_Sub31.method2852(var2, true, x, i_19_);
					if ((var2 ^ 0xffffffff) == -46) {
						...
						Class130_Sub1.stream.writeShort128((byte) -123, x + Client.base_x);
						Class130_Sub1.stream.writeShort128((byte) -120, Client.base_y + y);
						...
						MapScenes.method1639(22, l, x, y);
					}
					if ((var2 ^ 0xffffffff) == -11) {
						Player class_r_sub1 = Class143.players[i_19_];
						if (class_r_sub1 != null) {
							...
							Class130_Sub1.stream.method2358((byte) 23,
									(Class216.aClass232_3009.method1488(-90, 82) ? 1 : 0));
					...
					if (var2 == 15) {
						Npc class_r_sub2 = VarcLoader.aClass_r_Sub2Array1002[i_19_];
						if (class_r_sub2 != null) {
							...
							Class130_Sub1.stream.write128Byte(0,
									(!Class216.aClass232_3009.method1488(-83, 82) ? 0 : 1));
							Class130_Sub1.stream.writeShort((byte) 67, i_19_);
							Class90.method570(0, ((Entity) class_r_sub2).f_nc[0], ((Entity) class_r_sub2).f_mc[0],
									class_r_sub2.method2670((byte) 127), true, class_r_sub2.method2670((byte) 127), 0,
									-2, 111);
						}
					}
					if ((var2 ^ 0xffffffff) == -47) {
						Player class_r_sub1 = Class143.players[i_19_];
						if (class_r_sub1 != null) {
							Class246_Sub28_Sub4.anInt5976 = 2;
							Class107.anInt1508 = i;
							...
							Class130_Sub1.stream.method2358((byte) 23,
									(!Class216.aClass232_3009.method1488(-93, 82) ? 0 : 1));
							Class90.method570(0, ((Entity) class_r_sub1).f_nc[0], ((Entity) class_r_sub1).f_mc[0],
									class_r_sub1.method2670((byte) 127), true, class_r_sub1.method2670((byte) 127), 0,
									-2, 99);
						}
					...
					if (var2 == 6) {
						...
						Class130_Sub1.stream.readIntV2(-1276441384, Class231.anInt3168);
						Class130_Sub1.stream.writeShortLE128((byte) -53, Client.base_y + y);
						Class130_Sub1.stream.writeShort128((byte) -107, i_19_);
						Class130_Sub1.stream.writeShort((byte) 67, Class87.anInt1145);
						Class130_Sub1.stream.writeShortLE(x - -Client.base_x, (byte) 84);
						Class130_Sub1.stream.writeShortLE(SubScript.anInt1161, (byte) 78);
						Class246_Sub1_Sub7.method2548(x, 29310, y);
					}
					if ((var2 ^ 0xffffffff) == -60) {
						if (Client.staff_level <= 0 || !Class216.aClass232_3009.method1488(-125, 82)
								|| !Class216.aClass232_3009.method1488(-87, 81)) {
							Class107.anInt1508 = i;
							...
							Class130_Sub1.stream.writeShort128((byte) -117, x + Client.base_x);
							Class130_Sub1.stream.writeShortLE128((byte) -101, y + Client.base_y);
						} else
							Class246_Sub41_Sub2.method2680((((Class59_Sub3) Client.local_player).current_plane), 63,
									Client.base_y + y, x + Client.base_x);
					}
					if ((var2 ^ 0xffffffff) == -59) {
						Player class_r_sub1 = Class143.players[i_19_];
						if (class_r_sub1 != null) {
							Class107.anInt1508 = i;
							Class7.anInt97 = i_15_;
							...
							Class130_Sub1.stream.writeByte(255,
									(!Class216.aClass232_3009.method1488(-103, 82) ? 0 : 1));
							Class90.method570(0, ((Entity) class_r_sub1).f_nc[0], ((Entity) class_r_sub1).f_mc[0],
									class_r_sub1.method2670((byte) 127), true, class_r_sub1.method2670((byte) 127), 0,
									-2, 123);
						}
					}
					if ((var2 ^ 0xffffffff) == -9) {
						Class246_Sub28_Sub19.anInt6547 = 0;
						Class246_Sub28_Sub4.anInt5976 = 2;
						Class56.anInt794++;
						Class7.anInt97 = i_15_;
						...
						Class130_Sub1.stream.readIntV2(-1276441384, Class231.anInt3168);
						Class130_Sub1.stream.writeShortLE128((byte) -114, ((Entity) Client.local_player).f_db);
						Class130_Sub1.stream.writeShort((byte) 67, Class87.anInt1145);
						Class130_Sub1.stream.writeShort((byte) 67, SubScript.anInt1161);
						Class130_Sub1.stream.method2358((byte) 23,
								(!Class216.aClass232_3009.method1488(-128, 82) ? 0 : 1));
					}
					if ((var2 ^ 0xffffffff) == -22) {
						Npc class_r_sub2 = VarcLoader.aClass_r_Sub2Array1002[i_19_];
						if (class_r_sub2 != null) {
							Class107.anInt1508 = i;
							Class246_Sub28_Sub4.anInt5976 = 2;
							...
							Class99.anInt1282++;
							Class246_Sub28_Sub19.anInt6547 = 0;
							Class243.writePacket(-86, TransformList.NPC_CLICK_2_PACKET);
							Class130_Sub1.stream.method2358((byte) 23,
									(!Class216.aClass232_3009.method1488(-103, 82) ? 0 : 1));
					...
					if ((var2 ^ 0xffffffff) == -24) {
						Class246_Sub28_Sub4.anInt5976 = 2;
						Class107.anInt1508 = i;
						Class246_Sub28_Sub19.anInt6547 = 0;
						Class7.anInt97 = i_15_;
						Class_e.anInt1212++;
						Class243.writePacket(-97, SceneGraph.OBJECT_CLICK_3_PACKET);
						Class130_Sub1.stream.writeShortLE(Client.base_x + x, (byte) 113);
						Class130_Sub1.stream.writeByte(255, (!Class216.aClass232_3009.method1488(-110, 82) ? 0 : 1));
						Class130_Sub1.stream.writeShort((byte) 67, Client.base_y + y);
						Class130_Sub1.stream.writeShortLE128((byte) -103, 0x7fffffff & (int) (l >>> 32));
						MapScenes.method1639(22, l, x, y);
					}
					if ((var2 ^ 0xffffffff) == -26) {
						Class246_Sub28_Sub19.anInt6547 = 0;
						...
						Class130_Sub1.stream.writeShortLE128((byte) -60, y + Client.base_y);
						Class130_Sub1.stream.writeShort128((byte) -115, (int) (l >>> 32) & 0x7fffffff);
						Class130_Sub1.stream.writeShortLE128((byte) -79, Client.base_x + x);
					...
					if (var2 == 49) {
						...
						Class7.anInt97 = i_15_;
						Class243.writePacket(-94, SceneGraph.aClass201_3725);
						...
						Class130_Sub1.stream.writeShort((byte) 67, Client.base_x + x);
						Class246_Sub1_Sub7.method2548(x, 29310, y);
					}
					if (var2 == 1007) {
						Class107.anInt1508 = i;
						...
						Class130_Sub1.stream.writeShortLE(y + Client.base_y, (byte) 105);
						Class130_Sub1.stream.writeShort128((byte) -107, 0x7fffffff & (int) (l >>> 32));
						Class130_Sub1.stream.writeShort((byte) 67, x - -Client.base_x);
						MapScenes.method1639(22, l, x, y);
					}
					if ((var2 ^ 0xffffffff) == -17) {
						Class107.anInt1508 = i;
						Class246_Sub28_Sub19.anInt6547 = 0;
						Class7.anInt97 = i_15_;
						...
						Class130_Sub1.stream.writeShort((byte) 67, Client.base_x + x);
						Class130_Sub1.stream.writeShortLE128((byte) -49, y - -Client.base_y);
						Class246_Sub1_Sub7.method2548(x, 29310, y);
					}
					if ((var2 ^ 0xffffffff) == -61 && Client.meslayerContinueWidget == null) {
						Class51.method339(y, 0, x);
						Client.meslayerContinueWidget = Widget.get_component(y, x);
						Widget.redraw_widget(Client.meslayerContinueWidget);
					}
					if (var2 == 9) {
						Widget class235 = Widget.get_component(y, x);
						if (class235 != null) {
							...
							Class155.method1029(((ClickMaskNode) class246_sub27).anInt4898,
									class246_sub27.get_widget_flags(16693),
									class235, (byte) -38);
							Class218.aString3026 = Class179.method1174(class235, (byte) 120);
							if (Class218.aString3026 == null)
								Class218.aString3026 = "Null";
							Class246_Sub7.aString3964 = ((Widget) class235).data_text + "<col=ffffff>";
						}
					} else {
						if ((var2 ^ 0xffffffff) == -13) {
							Player class_r_sub1 = Class143.players[i_19_];
							if (class_r_sub1 != null) {
								Class107.anInt1508 = i;
								Class246_Sub28_Sub4.anInt5976 = 2;
								...
								Class130_Sub1.stream.write128Byte(0,
										!Class216.aClass232_3009.method1488(-106, 82) ? 0 : 1);
								Class130_Sub1.stream.writeShortLE128((byte) -120, i_19_);
								Class90.method570(0, ((Entity) class_r_sub1).f_nc[0], ((Entity) class_r_sub1).f_mc[0],
										class_r_sub1.method2670((byte) 127), true, class_r_sub1.method2670((byte) 127),
										0, -2, 105);
							}
						}
						if ((var2 ^ 0xffffffff) == -58) {
							Player class_r_sub1 = Class143.players[i_19_];
							if (class_r_sub1 != null) {
								Class107.anInt1508 = i;
								Class246_Sub28_Sub4.anInt5976 = 2;
								...
								Class130_Sub1.stream.write128Byte(0,
										Class216.aClass232_3009.method1488(-100, 82) ? 1 : 0);
						...
						if (var2 == 30) {
							...
							Class130_Sub1.stream.writeShort128((byte) -127, x + Client.base_x);
							Class130_Sub1.stream.readIntV2(-1276441384, Class231.anInt3168);
							Class130_Sub1.stream.writeShort128((byte) -117, SubScript.anInt1161);
						...
						if (var2 == 19) {
							...
							Class130_Sub1.stream.writeShort128((byte) -122, x + Client.base_x);
							Class130_Sub1.stream.readIntV2(-1276441384, Class231.anInt3168);
							Class130_Sub1.stream.writeShort128((byte) -106, Class87.anInt1145);
							Class130_Sub1.stream.writeShort128((byte) -105, SubScript.anInt1161);
							Class130_Sub1.stream.writeShort((byte) 67, Client.base_y + y);
						...
						if (var2 == 50) {
							...
							if (class_r_sub2 != null) {
								...
								Class246_Sub28_Sub4.anInt5976 = 2;
								Class243.writePacket(-108, Filestore.aClass201_2060);
								Class130_Sub1.stream.method2358((byte) 23,
										(Class216.aClass232_3009.method1488(-93, 82) ? 1 : 0));
								Class130_Sub1.stream.writeShortLE128((byte) -90, i_19_);
								Class90.method570(0, ((Entity) class_r_sub2).f_nc[0], ((Entity) class_r_sub2).f_mc[0],
										class_r_sub2.method2670((byte) 127), true, class_r_sub2.method2670((byte) 127),
										0, -2, 103);
							}
						}
						if ((var2 ^ 0xffffffff) == -6) {
							Player class_r_sub1 = Class143.players[i_19_];
							if (class_r_sub1 != null) {
								Class246_Sub28_Sub4.anInt5976 = 2;
								Class107.anInt1508 = i;
								...
								Class130_Sub1.stream.writeShortLE128((byte) -75, i_19_);
								Class130_Sub1.stream.write128Byte(0,
										Class216.aClass232_3009.method1488(-98, 82) ? 1 : 0);
								Class90.method570(0, ((Entity) class_r_sub1).f_nc[0], ((Entity) class_r_sub1).f_mc[0],
										class_r_sub1.method2670((byte) 127), true, class_r_sub1.method2670((byte) 127),
										0, -2, 119);
							}
						...
						if (var2 == 22) {
							...
							if (class_r_sub2 != null) {
								...
								Class130_Sub1.stream.writeShortLE128((byte) -73, SubScript.anInt1161);
								Class130_Sub1.stream.writeByte(255,
										!Class216.aClass232_3009.method1488(-101, 82) ? 0 : 1);
								Class90.method570(0, ((Entity) class_r_sub2).f_nc[0], ((Entity) class_r_sub2).f_mc[0],
										class_r_sub2.method2670((byte) 127), true, class_r_sub2.method2670((byte) 127),
										0, -2, 123);
							}
						...
						if ((var2 ^ 0xffffffff) == -3) {
							...
							Class130_Sub1.stream.writeShort128((byte) -112, i_19_);
							Class130_Sub1.stream.writeShort((byte) 67, x - -Client.base_x);
							Class130_Sub1.stream.writeShort128((byte) -121, y - -Client.base_y);
							Class130_Sub1.stream.method2358((byte) 23,
									(!Class216.aClass232_3009.method1488(-104, 82) ? 0 : 1));
							Class246_Sub1_Sub7.method2548(x, 29310, y);
						}
						if ((var2 ^ 0xffffffff) == -19) {
							Class107.anInt1508 = i;
							Class246_Sub28_Sub4.anInt5976 = 2;
							Class7.anInt97 = i_15_;
							Class244.anInt3451++;
							...
							Class130_Sub1.stream.writeShortLE128((byte) -84, x + Client.base_x);
							...
							Class130_Sub1.stream.writeShort((byte) 67, y - -Client.base_y);
							MapScenes.method1639(22, l, x, y);
						}
						if (var2 == 3) {
							Npc class_r_sub2 = VarcLoader.aClass_r_Sub2Array1002[i_19_];
							if (class_r_sub2 != null) {
								...
								Class130_Sub1.stream.write128Byte(0,
										Class216.aClass232_3009.method1488(-92, 82) ? 1 : 0);
								Class90.method570(0, ((Entity) class_r_sub2).f_nc[0], ((Entity) class_r_sub2).f_mc[0],
										class_r_sub2.method2670((byte) 127), true, class_r_sub2.method2670((byte) 127),
										0, -2, 115);
							}
						...
						if ((var2 ^ 0xffffffff) == -18) {
							...
							if (class_r_sub1 != null) {
								...
								Class130_Sub1.stream.method2358((byte) 23,
										(Class216.aClass232_3009.method1488(-84, 82) ? 1 : 0));
								Class130_Sub1.stream.writeShort((byte) 67, i_19_);
								Class90.method570(0, ((Entity) class_r_sub1).f_nc[0], ((Entity) class_r_sub1).f_mc[0],
										class_r_sub1.method2670((byte) 127), true, class_r_sub1.method2670((byte) 127),
										0, -2, 103);
						...
						if (var2 == 1003) {
							...
							if (class_r_sub2 != null) {
								...
								if (class253 != null) {
									...
									Class130_Sub1.stream.writeShort((byte) 67, ((NpcType) class253).id);
								}
							}
						}
						if ((var2 ^ 0xffffffff) == -14) {
							Player class_r_sub1 = Class143.players[i_19_];
							if (class_r_sub1 != null) {
								Class7.anInt97 = i_15_;
								Class68.anInt895++;
								...
								Class130_Sub1.stream.writeByte(255,
										!Class216.aClass232_3009.method1488(-114, 82) ? 0 : 1);
								Class90.method570(0, ((Entity) class_r_sub1).f_nc[0], ((Entity) class_r_sub1).f_mc[0],
										class_r_sub1.method2670((byte) 127), true, class_r_sub1.method2670((byte) 127),
										0, -2, 125);
							}
						...
						if (var2 == 44) {
							if (Client.staff_level > 0 && Class216.aClass232_3009.method1488(-104, 82)
									&& Class216.aClass232_3009.method1488(-119, 81))
								Class246_Sub41_Sub2.method2680(((Class59_Sub3) Client.local_player).current_plane,
										63, y + Client.base_y, x + Client.base_x);
							else {
								Class40_Sub9.method2309(x, -120, i_19_, y);
								if (i_19_ == 1) {
									Class130_Sub1.stream.writeByte(255, -1);
									Class130_Sub1.stream.writeByte(255, -1);
									Class130_Sub1.stream.writeShort((byte) 67, (int) Camera.camera_yaw);
						...
						if (var2 == 51) {
							...
							Class243.writePacket(-70, InvTypeLoader.aClass201_840);
							Class130_Sub1.stream.writeShort((byte) 67, i_19_);
							Class130_Sub1.stream.write128Byte(0, (Class216.aClass232_3009.method1488(-97, 82) ? 1 : 0));
							Class130_Sub1.stream.writeShortLE128((byte) -88, x + Client.base_x);
							Class130_Sub1.stream.writeShortLE128((byte) -56, y + Client.base_y);
							Class246_Sub1_Sub7.method2548(x, 29310, y);
						}
						if ((var2 ^ 0xffffffff) == -1011) {
							Class246_Sub28_Sub4.anInt5976 = 2;
							Class246_Sub28_Sub19.anInt6547 = 0;
							Class7.anInt97 = i_15_;
							Class18.anInt262++;
						...
						if (var2 == 4) {
							...
							Class7.anInt97 = i_15_;
							Class107.anInt1508 = i;
							Class243.writePacket(-126, LocType.aClass201_2592);
							Class130_Sub1.stream.writeShortLE(x + Client.base_x, (byte) 121);
							Class130_Sub1.stream.writeShortLE(Client.base_y + y, (byte) 97);
						...
						if ((var2 ^ 0xffffffff) == -21) {
							...
							if (class_r_sub1 != null) {
								...
								Class130_Sub1.stream.method2358((byte) 23,
										(Class216.aClass232_3009.method1488(-114, 82) ? 1 : 0));
						...
						if ((var2 ^ 0xffffffff) == -12) {
							...
							if (class_r_sub2 != null) {
								...
								Class139.anInt1985++;
								Class246_Sub28_Sub4.anInt5976 = 2;
								Class243.writePacket(-108, ObjType.NPC_CLICK_1_PACKET_NEW);
								Class130_Sub1.stream.write128Byte(0,
										!Class216.aClass232_3009.method1488(-72, 82) ? 0 : 1);
								Class130_Sub1.stream.writeShort((byte) 67, i_19_);
								Class90.method570(0, ((Entity) class_r_sub2).f_nc[0], ((Entity) class_r_sub2).f_mc[0],
										class_r_sub2.method2670((byte) 127), true, class_r_sub2.method2670((byte) 127),
										0, -2, 126);
	...
	final void method911(int i, int i_21_, Class109_Sub4 class109_sub4, int i_22_) {
		do {
			try {
				...
				throw Class193.method1272(runtimeexception, ("ml.T(" + i + ',' + i_21_ + ','
						+ (class109_sub4 != null ? "{...}" : "null") + ',' + i_22_ + ')'));
			}
			break;
		} while (false);
	}
	...
	final void method913(byte i, Class109_Sub1 class109_sub1, int i_25_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("ml.O(" + i + ',' + (class109_sub1 != null ? "{...}" : "null") + ',' + i_25_ + ')'));
		}
	}
	...
	Class134(Class260_Sub2 class260_sub2) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					"ml.<init>(" + (class260_sub2 != null ? "{...}" : "null") + ')');
		}
	}
