...
final class Class246_Sub41_Sub2 extends Class246_Sub41 {
	...
	static final String method2678(int i, Class246_Sub35 class246_sub35) {
		try {
			if (i >= -25)
				aClass54_6474 = null;
			anInt6473++;
			if (((Class246_Sub35) class246_sub35).aString5152 == null
					|| ((Class246_Sub35) class246_sub35).aString5152.length() <= 0)
				return ((Class246_Sub35) class246_sub35).aString5149;
			return (((Class246_Sub35) class246_sub35).aString5149
					+ Class78.aClass67_1015.get(Preferences.language_code)
					+ ((Class246_Sub35) class246_sub35).aString5152);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("kc.F(" + i + ',' + (class246_sub35 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	static final void method2679(int i, boolean bool, int i_0_, int i_1_, int i_2_, int i_3_) {
		try {
			...
			int i_8_;
			int i_9_;
			if ((i_3_ ^ 0xffffffff) > (ObjType.anInt2818 ^ 0xffffffff)) {
				i_8_ = (ObjType.anInt2818 * i_6_ >> 12) + i_7_;
				i_9_ = ObjType.anInt2818;
			...
			int i_10_;
			int i_11_;
			if ((i_2_ ^ 0xffffffff) > (ObjType.anInt2818 ^ 0xffffffff)) {
				i_11_ = (i_6_ * ObjType.anInt2818 >> 12) + i_7_;
				i_10_ = ObjType.anInt2818;
	...
	static final void method2680(int i, int i_19_, int i_20_, int i_21_) {
		try {
			anInt6480++;
			String string = ("tele " + i + "," + (i_21_ >> 6) + "," + (i_20_ >> 6) + "," + (0x3f & i_21_) + ","
					+ (i_19_ & i_20_));
			System.out.println(string);
			Client.run_command(string, true);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, ("kc.A(" + i + ',' + i_19_ + ',' + i_20_ + ',' + i_21_ + ')'));
		}
	}

	static final int method2681(PacketsDecoder class_is, SceneGraph class260, byte i) {
		try {
			if (i != -31)
				return 10;
			anInt6476++;
			...
			if ((((PacketsDecoder) class_is).anInt279 ^ 0xffffffff) != 0) {
				Material class238 = (((SceneGraph) class260).anInterface6_3714.get_material(i - 31274,
						(class260.method1684() ? ((PacketsDecoder) class_is).anInt279
								: ((PacketsDecoder) class_is).anInt276)));
				if (TextureLoader.osrs((class260.method1684() ? ((PacketsDecoder) class_is).anInt279
						: ((PacketsDecoder) class_is).anInt276)) || !((Material) class238).aBool3339)
					return ((Material) class238).aShort3354;
			}
	...
	static {
		...
		anInt6481 = 0;
		new MultilingualString("You cannot send a quick chat message to a player on this world at this time.",
