...
final class Class246_Sub28_Sub18 extends TextureOperation {
	...
	static final void method2688(byte i) {
		try {
			...
			for (int i_0_ = 0; ((Client.total_characters ^ 0xffffffff) < (i_0_ ^ 0xffffffff)); i_0_++) {
				int i_1_ = Client.characters[i_0_].method1233((byte) 126);
				char c = Client.characters[i_0_].method1236();
				if (i_1_ != 84) {
					if (Class216.aClass232_3009.method1488(-120, 82) && i_1_ == 66) {
						if (Class246_Sub28_Sub30.aClipboard6876 != null) {
							...
							for (int i_2_ = -1 + Class55.aStringArray786.length; i_2_ >= 0; i_2_--) {
								if (Class55.aStringArray786[i_2_] != null
										&& (Class55.aStringArray786[i_2_].length() ^ 0xffffffff) < -1)
						...
						if (i_1_ == 85 && (Class246_Sub1_Sub14.anInt6596 ^ 0xffffffff) < -1) {
							Class246_Sub14.aString4438 = ((Class246_Sub14.aString4438.substring(0,
									-1 + Class246_Sub1_Sub14.anInt6596))
									+ (Class246_Sub14.aString4438.substring(Class246_Sub1_Sub14.anInt6596)));
							Class246_Sub1_Sub14.anInt6596--;
						} else if ((i_1_ ^ 0xffffffff) == -102
								&& (Class246_Sub1_Sub14.anInt6596 < Class246_Sub14.aString4438.length()))
							Class246_Sub14.aString4438 = ((Class246_Sub14.aString4438.substring(0,
									Class246_Sub1_Sub14.anInt6596))
									+ (Class246_Sub14.aString4438.substring(Class246_Sub1_Sub14.anInt6596 + 1)));
						else if (i_1_ != 96 || (Class246_Sub1_Sub14.anInt6596 ^ 0xffffffff) >= -1) {
							if (i_1_ != 97 || ((Class246_Sub1_Sub14.anInt6596
									^ 0xffffffff) <= (Class246_Sub14.aString4438.length() ^ 0xffffffff))) {
								if ((i_1_ ^ 0xffffffff) != -103) {
									if ((i_1_ ^ 0xffffffff) == -104)
										Class246_Sub1_Sub14.anInt6596 = Class246_Sub14.aString4438.length();
									else if (i_1_ != 104 || ((Class59.anInt823
											^ 0xffffffff) <= ((Class55.aStringArray786).length ^ 0xffffffff))) {
										if (i_1_ != 105 || ((Class59.anInt823 ^ 0xffffffff) >= -1)) {
											if (Texture.method2700(-127, c) || c == 58 || (c ^ 0xffffffff) == -45
													|| c == 32 || (c ^ 0xffffffff) == -96 || c == 45
													|| (c ^ 0xffffffff) == -44 || (c ^ 0xffffffff) == -92
													|| (c ^ 0xffffffff) == -94) {
												Class246_Sub14.aString4438 = ((Class246_Sub14.aString4438.substring(0,
														(Class246_Sub1_Sub14.anInt6596)))
														+ Client.characters[i_0_].method1236()
														+ (Class246_Sub14.aString4438
																.substring(Class246_Sub1_Sub14.anInt6596)));
												Class246_Sub1_Sub14.anInt6596++;
											}
										} else {
											Class59.anInt823--;
											SceneGraph.method1711(0);
											Class246_Sub1_Sub14.anInt6596 = Class246_Sub14.aString4438.length();
										}
									} else {
										Class59.anInt823++;
							...
							try {
								...
								if (string != null) {
									...
									if (strings.length <= 1)
										...
										for (int i_3_ = 0; ((i_3_ ^ 0xffffffff) > (strings.length
												^ 0xffffffff)); i_3_++) {
			...
			while_127_: do {
				do {
					if (i_5_ != 0) {
						...
						anInt6511 = stream.readUnsignedShort();
						break while_127_;
					}
					anInt6518 = stream.readUnsignedShort();
					break while_127_;
				} while (false);
				anInt6513 = stream.readUnsignedShort();
			} while (false);
			if (i != 4)
	...
	final int[][] method2139(byte i, int i_6_) {
		try {
			...
			anInt6516++;
			int[][] is = ((TextureOperation) this).aClass136_4933.method922((byte) 18, i_6_);
