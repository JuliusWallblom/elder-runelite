...
class Class38_Sub1 extends Class38 {
	...
	static MultilingualString aClass67_5105 = new MultilingualString("level: ", "Stufe: ", "niveau ", "n\u00edvel: ");
	...
	static IncomingPacket SET_INTERFACE_SPRITE_IN;
	static IncomingPacket SET_WIDGET_HEIGHT_IN;
	...
	static final int method2188(int i) {
		try {
			...
			if (Class150.aClass235_2196 == null) {
				if (ContextMenus.context_menu_open || Class230.anInt3147 <= 0) {
					int i_3_ = Material.aClass102_3360.method640((byte) 58);
					int i_4_ = Material.aClass102_3360.method636(3045);
					...
					if (!Node.shift_click_use || !Class216.aClass232_3009.method1488(-118, 81) || (Class230.anInt3147 ^ 0xffffffff) >= -3)
						return (((Class246_Sub35) (Class246_Sub35) ((Node) (((Class166) Varbit.aClass166_1525).aClass246_2343)).prev).anInt5155);
					return ((Class246_Sub35) (Class246_Sub35) (((Node) ((Node) (((Class166) Varbit.aClass166_1525).aClass246_2343)).prev).prev)).anInt5155;
				}
			}
			return -1;
		} catch (RuntimeException runtimeexception) {
	...
	public static void method2190(int i) {
		try {
			...
			if (i == -9160) {
				...
				SET_INTERFACE_SPRITE_IN = null;
				SET_WIDGET_HEIGHT_IN = null;
				aFrame5114 = null;
			}
		} catch (RuntimeException runtimeexception) {
	...
	static {
		HIDE_INTERFACE_COMPONENT_IN = new IncomingPacket(41, 11);
		SET_INTERFACE_SPRITE_IN = new IncomingPacket(110, 14);
		SET_WIDGET_HEIGHT_IN = new IncomingPacket(111, 14);
	}
}
