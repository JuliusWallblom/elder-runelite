...
final class Class246_Sub17 extends Node {
	...
	private IterableNodeHashTable aClass85_4661;
	...
	private final void method2043(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_) {
		try {
			...
			if ((0x7f & i ^ 0xffffffff) == -1 || (0x7f & i_0_) == 0) {
				...
				Node class246 = aClass85_4661.get(l);
				if (class246 != null) {
	...
	Class246_Sub17(Class260_Sub2 class260_sub2, Class210_Sub2 class210_sub2, Class246_Sub41 class246_sub41, int[] is) {
		try {
			...
			if ((i_50_ ^ 0xffffffff) < -1) {
				aStream4648 = new Buffer(i_50_ * 2);
				aStream_Sub2_4659 = new Stream_Sub2(i_50_ * 16);
				aClass85_4661 = new IterableNodeHashTable(Class206.method1350(i_50_, 269173057));
				int i_56_ = 0;
				i_51_ = 0;
				...
				anInterface1_4651 = (aClass260_Sub2_4655.method1955(125, ((Buffer) aStream4648).position, false, ((Buffer) aStream4648).buffer, 5123));
				anInterface10_4642 = (aClass260_Sub2_4655.method1960(0, ((Buffer) aStream_Sub2_4659).position, ((Buffer) aStream_Sub2_4659).buffer, false, 16));
	...
	static {
		new MultilingualString(" days.", " Tage.", " jours.", " dias.");
	}
}
