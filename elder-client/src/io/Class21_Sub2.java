	...
	Class21_Sub2(int i, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_) {
		...
		try {
			...
			throw Class193.method1272(runtimeexception,
					("gu.<init>(" + i + ',' + i_2_ + ',' + i_3_ + ',' + i_4_ + ',' + i_5_ + ',' + i_6_ + ')'));
		}
	}
	...
	static final void method2014(int i) {
		try {
			...
			for (Class130_Sub4 class130_sub4 = ((Class130_Sub4) HashMap.aClass68_762
					.method439((byte) 93)); class130_sub4 != null; class130_sub4 = ((Class130_Sub4) HashMap.aClass68_762
							.method439((byte) 98)))
				Class_c_Sub1.method2275((byte) -69, class130_sub4);
			int i_9_;
			int i_10_;
			if (Client.current_renderer.method2052(Buffer.anInt5656, 126)) {
				i_9_ = 0;
				i_10_ = 3;
			} else
