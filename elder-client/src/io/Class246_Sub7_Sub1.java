...
final class Class246_Sub7_Sub1 extends Class246_Sub7 {
	...
	final void method1833(int i, byte i_0_, Class109_Sub1 class109_sub1, Class109_Sub1 class109_sub1_1_) {
		try {
			...
			if (aClass109_Sub1Array6087 != null) {
				...
				int i_2_ = IterableNodeHashTable.method540(anInt6079, false);
				int i_3_ = IterableNodeHashTable.method540(anInt6088, false);
				int i_4_ = 0;
			...
			OpenGL.glUniform3fARB(OpenGL.glGetUniformLocationARB(l_6_, "params"), Class239.aFloat3376, IterableNodeHashTable.aFloat1135, 0.0F);
	...
	final void method1840(int i, int i_8_, int i_9_) {
		try {
			...
			anInt6088 = i_8_;
			if (i == 8574) {
				int i_10_ = IterableNodeHashTable.method540(anInt6079, false);
				int i_11_ = IterableNodeHashTable.method540(anInt6088, false);
	...
	static final void method2564(boolean bool) {
		try {
			...
			for (int i_16_ = 0; i > i_16_; i_16_++) {
				Player class_r_sub1 = Class143.players[is[i_16_]];
				if (class_r_sub1 != null && (((Entity) class_r_sub1).anInt6471 ^ 0xffffffff) < -1) {
					((Entity) class_r_sub1).anInt6471--;
					if (((Entity) class_r_sub1).anInt6471 == 0)
						((Entity) class_r_sub1).aString6429 = null;
				}
			}
			for (int i_17_ = 0; i_17_ < Class5.anInt55; i_17_++) {
				int i_18_ = Class246_Sub28_Sub29.anIntArray6815[i_17_];
				Npc class_r_sub2 = VarcLoader.aClass_r_Sub2Array1002[i_18_];
				if (class_r_sub2 != null && ((Entity) class_r_sub2).anInt6471 > 0) {
					((Entity) class_r_sub2).anInt6471--;
					if ((((Entity) class_r_sub2).anInt6471 ^ 0xffffffff) == -1)
						((Entity) class_r_sub2).aString6429 = null;
				}
			}
		} catch (RuntimeException runtimeexception) {
