...
final class Class167 {
	...
	final void method1114(Buffer stream) {
		...
		for (int i_0_ = 0; i_0_ < 10; i_0_++) {
			...
			anIntArray2367[i_0_] = stream.readSmart();
			anIntArray2373[i_0_] = stream.readSmart((byte) 89);
		}
		anInt2374 = stream.readSmart((byte) 72);
		anInt2381 = stream.readSmart((byte) 92);
		((Class167) this).anInt2370 = stream.readUnsignedShort();
		((Class167) this).anInt2379 = stream.readUnsignedShort();
