...
public abstract class Class246_Sub7 extends Node {
	...
	public static void method1828(int i) {
		try {
			aString3964 = null;
			Cache.reset_index(Revision.PRE_EOC_634, "maps");
			Cache.reset_index(Revision.OSRS, "maps");
			if (i != 0)
				method1835(-47, 20, -73);
			aClass13_3960 = null;
	...
	static final boolean method1830(int i, int i_1_, int i_2_) {
		try {
			if (i_2_ != 2074)
				aString3964 = null;
			anInt3961++;
			if (!(Class246_Sub28_Sub14.method2633(i, -1376312589, i_1_) | (0x70000 & i) != 0)
					&& !Tile.method996(i_1_, -1, i))
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
	...
	Class246_Sub7(Class260_Sub2 class260_sub2) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					"cg.<init>(" + (class260_sub2 != null ? "{...}" : "null") + ')');
		}
	}
	...
	static {
		new MultilingualString("Sending request to leave channel...", "Chatraum wird verlassen...",
