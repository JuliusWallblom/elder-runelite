...
final class Class246_Sub28_Sub24 extends TextureOperation {
	...
	static final void method2737(int i) {
		try {
			if (Class246_Sub28_Sub34.method2872(true)) {
				...
				Renderer.aBool572 = true;
				Class_q_Sub1.anInt6670 = 0;
				try {
					Class246_Sub28_Sub30.aClipboard6876 = Client.instance.getToolkit().getSystemClipboard();
	...
	final int[][] method2139(byte i, int i_5_) {
		try {
			anInt6680++;
			int[][] is = ((TextureOperation) this).aClass136_4933.method922((byte) -124, i_5_);
			if (i <= 33)
				method2737(111);
	...
	final int[] method2135(int i, int i_14_) {
		try {
			...
			anInt6672++;
			int[] is = ((TextureOperation) this).aClass66_4938.method435((byte) -112, i_14_);
	...
	static final void method2740(byte i, int i_18_) {
		try {
			anInt6678++;
			if ((i_18_ ^ 0xffffffff) != (TextureLoader.anInt980 ^ 0xffffffff)) {
				...
				Class136.method925(Class152.anInt2205 >> 3, Client.sprite_loader, Class38_Sub1_Sub1.anInt6770 >> 3, 125);
				int i_20_ = 121 % ((i + 14) / 51);
				TextureLoader.anInt980 = i_18_;
			}
		} catch (RuntimeException runtimeexception) {
