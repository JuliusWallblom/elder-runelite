...
public abstract class SceneGraph implements RSScene {
	...
	TextureInterface anInterface6_3714;
	...
	static AbstractSprite[] aClass_lArray3726;
	...
	static final synchronized SceneGraph method1682(TextureInterface interface6, int i, Canvas canvas, int i_7_,
			byte i_8_, Signlink class52) {
		try {
			anInt3721++;
			int i_9_ = -1;
			...
			if ((i_7_ ^ 0xffffffff) != -1) {
				...
				class260 = SubScript.method567(canvas, 23932, i_9_, interface6);
			int i_11_ = 42 % ((23 - i_8_) / 32);
			Class246_Sub28_Sub8.aBoolArray6074[i_9_] = true;
			return class260;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("ya.NG(" + (interface6 != null ? "{...}" : "null") + ',' + i + ','
							+ (canvas != null ? "{...}" : "null") + ',' + i_7_ + ',' + i_8_ + ','
							+ (class52 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	abstract AbstractModel method1695(Model class103, int i, int i_29_, int i_30_, int i_31_);
	...
	final void method1697(int i, int i_32_, int i_33_, int i_34_, int i_35_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("ya.LG(" + i + ',' + i_32_ + ',' + i_33_ + ',' + i_34_ + ',' + i_35_ + ')'));
		}
	}
	...
	abstract void method1703(AbstractModel class_t, Class129 class129, Class_c class_c, Class130_Sub5 class130_sub5,
			int i);
	...
	abstract AbstractSprite method1706(int[] is, int i, int i_43_, int i_44_, int i_45_);

	abstract AbstractSprite method1706_osrs(int[] is, int i, int i_43_, int i_44_, int i_45_);
	...
	final void method1708(boolean bool) {
		do {
			try {
				Class246_Sub28_Sub8.aBoolArray6074[((SceneGraph) this).anInt3719] = false;
				anInt3718++;
				method1680();
				if (bool == true)
					break;
				((SceneGraph) this).anInt3719 = 58;
			} catch (RuntimeException runtimeexception) {
		...
		try {
			...
			if ((Class59.anInt823 ^ 0xffffffff) >= -1)
				...
				for (int i_53_ = 0; ((i_53_ ^ 0xffffffff) > (Class55.aStringArray786.length ^ 0xffffffff)); i_53_++) {
					if (Class55.aStringArray786[i_53_].startsWith("--> ")
							&& (++i_52_ ^ 0xffffffff) == (Class59.anInt823 ^ 0xffffffff)) {
	...
	abstract Font method1716(FontMetric class73, LDSprite[] class10s, boolean bool);

	abstract void method1717(int i, int i_54_, int i_55_, int i_56_, int i_57_, int i_58_, int i_59_, int i_60_,
			int i_61_, int i_62_);
	...
	abstract AbstractSprite method1721(int i, int i_64_, int i_65_, int i_66_, boolean bool);
	...
	abstract void method1728(int i, int i_73_, int i_74_, int i_75_, int i_76_, int i_77_, Class128 class128, int i_78_,
			int i_79_);
		...
		while_170_: for (int i = 0; i < Class59_Sub2_Sub2.anInt6015; i++) {
			...
			if (Class59_Sub2_Sub1.anIntArray5784 != null) {
				for (int i_87_ = 0; i_87_ < Class59_Sub2_Sub1.anIntArray5784.length; i_87_++) {
					if (Class59_Sub2_Sub1.anIntArray5784[i_87_] != -1000000
							&& ((((Class121) class121).anInt1671 <= Class59_Sub2_Sub1.anIntArray5784[i_87_])
									|| (((Class121) class121).anInt1664 <= Class59_Sub2_Sub1.anIntArray5784[i_87_]))
							&& ((((Class121) class121).anInt1657 <= Class246_Sub28_Sub4.anIntArray5978[i_87_])
									|| (((Class121) class121).anInt1674 <= Class246_Sub28_Sub4.anIntArray5978[i_87_]))
							&& ((((Class121) class121).anInt1657 >= InputStream_Sub1.anIntArray4828[i_87_])
									|| (((Class121) class121).anInt1674 >= InputStream_Sub1.anIntArray4828[i_87_]))
							&& ((((Class121) class121).anInt1661 <= Class59_Sub3_Sub2.anIntArray5885[i_87_])
									|| (((Class121) class121).anInt1658 <= Class59_Sub3_Sub2.anIntArray5885[i_87_]))
							&& ((((Class121) class121).anInt1661 >= Player.f_vd[i_87_])
									|| (((Class121) class121).anInt1658 >= Player.f_vd[i_87_])))
						continue while_170_;
				}
			}
			if (((Class121) class121).anInt1662 == 1) {
				...
				if (i_88_ >= 0 && i_88_ <= Class125.anInt1777 + Class125.anInt1777) {
					...
					if (bool) {
						...
						((Class121) class121).anInt1654 = ((((Class121) class121).anInt1661 - Class111.anInt1576) << 8)
								/ i_91_;
						((Class121) class121).anInt1672 = ((((Class121) class121).anInt1658 - Class111.anInt1576) << 8)
								/ i_91_;
						((Class121) class121).anInt1670 = ((((Class121) class121).anInt1671
								- Class246_Sub28_Sub20.anInt6573) << 8) / i_91_;
						((Class121) class121).anInt1665 = ((((Class121) class121).anInt1664
								- Class246_Sub28_Sub20.anInt6573) << 8) / i_91_;
				...
				if (i_92_ >= 0 && i_92_ <= Class125.anInt1777 + Class125.anInt1777) {
					...
					if (bool) {
						...
						((Class121) class121).anInt1655 = ((((Class121) class121).anInt1657
								- Class246_Sub1_Sub10.anInt6199) << 8) / i_95_;
						((Class121) class121).anInt1660 = ((((Class121) class121).anInt1674
								- Class246_Sub1_Sub10.anInt6199) << 8) / i_95_;
						((Class121) class121).anInt1670 = ((((Class121) class121).anInt1671
								- Class246_Sub28_Sub20.anInt6573) << 8) / i_95_;
						((Class121) class121).anInt1665 = ((((Class121) class121).anInt1664
								- Class246_Sub28_Sub20.anInt6573) << 8) / i_95_;
						Class236.aClass121Array3306[Class109_Sub1.anInt3755++] = class121;
					}
				...
				if (i_96_ > Class203.anInt2875) {
					...
					if (bool) {
						...
						((Class121) class121).anInt1655 = ((((Class121) class121).anInt1657
								- Class246_Sub1_Sub10.anInt6199) << 8) / i_96_;
						((Class121) class121).anInt1660 = ((((Class121) class121).anInt1674
								- Class246_Sub1_Sub10.anInt6199) << 8) / i_96_;
						((Class121) class121).anInt1654 = ((((Class121) class121).anInt1661 - Class111.anInt1576) << 8)
								/ i_96_;
	...
	final void method1734(int i, int i_103_, int i_104_, byte i_105_, int i_106_, int i_107_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("ya.HG(" + i + ',' + i_103_ + ',' + i_104_ + ',' + i_105_ + ',' + i_106_ + ',' + i_107_ + ')'));
		}
	}
	...
	final void method1736(int i, int i_113_, int i_114_, int i_115_, int i_116_, int i_117_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("ya.EG(" + i + ',' + i_113_ + ',' + i_114_ + ',' + i_115_ + ',' + i_116_ + ',' + i_117_ + ')'));
		}
	}
	...
	final void method1737(int i, int i_118_, int i_119_, int i_120_, int i_121_, int i_122_) {
		do {
			try {
				...
				throw Class193.method1272(runtimeexception, ("ya.MG(" + i + ',' + i_118_ + ',' + i_119_ + ',' + i_120_
						+ ',' + i_121_ + ',' + i_122_ + ')'));
			}
			break;
		} while (false);
	...
	abstract void DA(int i, int i_125_, int i_126_, int i_127_, int i_128_, int i_129_, byte[] is, int i_130_,
			int i_131_);

	abstract Class210 method1738(int i, int i_132_, int[][] is, int[][] is_133_, int i_134_, int i_135_, int i_136_);

	abstract Class211 method1739(Class211 class211, Class211 class211_137_, float f, Class211 class211_1SceneGraph);

	SceneGraph(int i, TextureInterface interface6) {
		try {
			((SceneGraph) this).anInterface6_3714 = interface6;
			((SceneGraph) this).anInt3719 = i;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("ya.<init>(" + i + ',' + (interface6 != null ? "{...}" : "null") + ')'));
		}
	}

	abstract void method1740(AbstractModel[] class_ts, Class129 class129, Class_c class_c,
			Class130_Sub5[] class130_sub5s, int i);
	...
	final void method1745(byte i, int i_147_, int i_148_, int i_149_, int i_150_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("ya.IG(" + i + ',' + i_147_ + ',' + i_148_ + ',' + i_149_ + ',' + i_150_ + ')'));
		}
	}

	static final boolean method1746(int i, int i_151_, int i_152_, int i_153_, int i_154_, int i_155_, int i_156_,
		...
		try {
			...
			if (i_157_ - -i_154_ <= i_156_ || (i_152_ + i_156_ ^ 0xffffffff) >= (i_157_ ^ 0xffffffff))
				return false;
			if ((i_151_ + i_153_ ^ 0xffffffff) >= (i_155_ ^ 0xffffffff)
					|| (i_155_ + i ^ 0xffffffff) >= (i_151_ ^ 0xffffffff))
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, ("ya.OG(" + i + ',' + i_151_ + ',' + i_152_ + ',' + i_153_ + ','
					+ i_154_ + ',' + i_155_ + ',' + i_156_ + ',' + i_157_ + ',' + i_158_ + ')'));
		}
	}
	...
	abstract void method1748(AbstractModel[] class_ts, Class_c class_c, Class130_Sub5[] class130_sub5s, int i);

	abstract AbstractSprite ld_to_abstract_sprite(LDSprite class10, boolean bool);
	...
	static {
		new MultilingualString("You cannot report that person for Staff Impersonation, they are Staff.",
				"Diese Person ist ein Mitarbeiter!",
				"Cette personne est un membre du personnel, vous ne pouvez pas la signaler pour abus d'identit\u00e9.",
				"Voc\u00ea n\u00e3o pode denunciar essa pessoa por tentar se passar por membro da equipe, pois ela faz parte da equipe.");
		anInt3722 = -1;
		aClass201_3725 = new OutgoingPacket(7, 7);
		new MultilingualString(null, "die k\u00fcrzlich gesprochen oder gehandelt haben.", null, null);
