...
final class Class148 {
	...
	static final void method1002(int i, String string, int i_4_, int i_5_, int i_6_, Font class116, int i_7_, Widget class235, int i_8_, int i_9_, FontMetric class73, Class128 class128) {
		try {
			anInt2185++;
			int i_10_;
			do {
				if (Class130_Sub3.anInt4417 == 4) {
					i_10_ = (int) Camera.camera_yaw & 0x3fff;
					if (!Client.f_ob)
						break;
				}
				i_10_ = 0x3fff & (int) Camera.camera_yaw - -Class95.anInt1253;
			} while (false);
			int i_11_ = 10 + Math.max(((Widget) class235).screen_width / 2, ((Widget) class235).screen_height / 2);
			int i_12_ = i_5_ * i_5_ + i_8_ * i_8_;
			if (i_4_ == 3 && i_12_ <= i_11_ * i_11_) {
				int i_13_ = MathUtils.SINE[i_10_];
				int i_14_ = MathUtils.COSINE[i_10_];
				if (Class130_Sub3.anInt4417 != 4) {
				...
				i_15_ -= i_17_ / 2;
				if (((-((Widget) class235).screen_width ^ 0xffffffff) >= (i_15_ ^ 0xffffffff)) && i_15_ <= ((Widget) class235).screen_width && i_16_ >= -((Widget) class235).screen_height && i_16_ <= ((Widget) class235).screen_height)
					class116.method799(0, i_7_, null, i, 1, class128, (-i_18_ + (-i_6_ + (-i_16_ + (((Widget) class235).screen_height / 2 + i_7_)))), (i_15_ - -i - -(((Widget) class235).screen_width / 2)), 0, 0, 50, i_17_, i_9_, 0, string, null);
			}
		} catch (RuntimeException runtimeexception) {
	...
	static {
		new MultilingualString(" joined the channel.", " hat den Chatraum betreten.", " a rejoint le canal.", " entrou no canal.");
		anInt2184 = 0;
	}
}
