...
final class Class174 {
	...
	final void method1143(int i, boolean bool, int i_0_) {
		try {
							...
							while_215_: do {
								do {
									if (i_3_ != 1) {
										...
										i_1_ = (MathUtils.SINE[i_2_ << 3] >> 5) + 1024;
										break while_218_;
									}
			...
			((Class174) this).aClass246_Sub41_2452.method2315(0,
					(float) (anInt2455 + (anInt2448 * i_1_ >> 11)) / 2048.0F);
	...
	static final void method1146(Object[] objects, long[] ls, byte i) {
		try {
			...
			throw Class193.method1272(runtimeexception, ("qc.B(" + (objects != null ? "{...}" : "null") + ','
					+ (ls != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}
			...
			for (;;) {
				...
				for (int i_11_ = 0; ((Class246_Sub32) class246_sub32).anInt5043 > i_11_; i_11_++) {
					if ((((Class246_Sub32) class246_sub32).aClass182Array5041[i_11_]) != null) {
						...
						if (((((Class246_Sub32) class246_sub32).aClass182Array5041[i_11_].anInt2539)
								^ 0xffffffff) == -1)
							bool = true;
					}
					if ((((Class246_Sub32) class246_sub32).aClass182Array5047[i_11_]) != null) {
						...
						if (((((Class246_Sub32) class246_sub32).aClass182Array5047[i_11_].anInt2539)
								^ 0xffffffff) == -1)
							bool = true;
					}
				}
				...
				int i_12_ = ((Buffer) stream_sub1).position;
							...
							if (i_14_ == 3) {
								...
								for (int i_17_ = 0; is.length > i_17_; i_17_++) {
									ObjectInputStream objectinputstream = (new ObjectInputStream(
											new ByteArrayInputStream(is[i_17_])));
				...
				stream_sub1.method2408(-1591647264, -i_12_ + ((Buffer) stream_sub1).position);
				class246_sub32.remove();
			}
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("qc.E(" + i + ',' + (stream_sub1 != null ? "{...}" : "null") + ',' + i_10_ + ')'));
		}
	}
	...
	private final void method1149(SceneGraph class260, int i, int i_19_, int i_20_, int i_21_, int i_22_, int i_23_) {
		try {
			if (i == -591532287) {
				anInt2464++;
			...
			throw Class193.method1272(runtimeexception, ("qc.C(" + (class260 != null ? "{...}" : "null") + ',' + i + ','
	...
	Class174(SceneGraph class260, Buffer stream, int i) {
		try {
			if (Class59_Sub1_Sub2.anIntArray6123 == null)
				Class246_Sub1_Sub15.method2715(true);
			((Class174) this).anInt2461 = stream.readUnsignedByte();
			...
			int i_24_ = stream.readUnsignedShort() << i;
			int i_25_ = stream.readUnsignedShort() << i;
			int i_26_ = stream.readUnsignedShort() << i;
			int i_27_ = stream.readUnsignedByte();
			int i_28_ = 2 * i_27_ + 1;
			((Class174) this).aShortArray2447 = new short[i_28_];
			for (int i_29_ = 0; ((i_29_ ^ 0xffffffff) > (((Class174) this).aShortArray2447.length
					^ 0xffffffff)); i_29_++) {
				int i_30_ = (short) stream.readUnsignedShort();
				int i_31_ = i_30_ >>> 8;
			...
			int i_33_ = (Class40_Sub3.anIntArray4064 != null ? Class40_Sub3.anIntArray4064[stream.readUnsignedShort()]
					: (Entity.f_eb[(0xffff & Class_e.method594(-32, stream.readUnsignedShort()))]));
			...
			throw Class193.method1272(runtimeexception, ("qc.<init>(" + (class260 != null ? "{...}" : "null") + ','
					+ (stream != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}
