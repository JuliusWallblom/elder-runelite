...
abstract class Class187 {
	...
	static IterableNodeHashTable aClass85_2651;
	static int anInt2652;
	static boolean aBool2653;
	static int[] anIntArray2654;

	static final Tile method1222(int i, int i_0_, int i_1_) {
		if (Class106.tiles[i][i_0_][i_1_] == null) {
			...
			if (bool && i >= Class154_Sub1.anInt4803 - 1)
				return null;
			VarpType.method596(i, i_0_, i_1_);
		}
		return Class106.tiles[i][i_0_][i_1_];
	}
	...
	static final void method1225(byte i) {
		try {
			...
			synchronized (Clan.aClass54_7109) {
				if (i != -57)
					anIntArray2654 = null;
				Clan.aClass54_7109.method383(i ^ ~0x59);
			}
		} catch (RuntimeException runtimeexception) {
	...
	Class187(Class260_Sub2 class260_sub2, int i, byte[] is, int i_3_, boolean bool) {
		try {
			...
			throw Class193.method1272(runtimeexception, ("rg.<init>(" + (class260_sub2 != null ? "{...}" : "null") + ','
					+ i + ',' + (is != null ? "{...}" : "null") + ',' + i_3_ + ',' + bool + ')'));
		}
	}
	...
	Class187(Class260_Sub2 class260_sub2, int i, Buffer nativebuffer, int i_4_, boolean bool) {
		try {
			...
			throw Class193.method1272(runtimeexception, ("rg.<init>(" + (class260_sub2 != null ? "{...}" : "null") + ','
					+ i + ',' + (nativebuffer != null ? "{...}" : "null") + ',' + i_4_ + ',' + bool + ')'));
		}
	}
	...
	static final int method1227(int i, int i_5_, int i_6_, int i_7_, int i_8_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("rg.N(" + i + ',' + i_5_ + ',' + i_6_ + ',' + i_7_ + ',' + i_8_ + ')'));
		}
	}

	static {
		new MultilingualString("To talk, start each line of chat with the / symbol.",
		...
		aBool2653 = false;
		anInt2652 = 999999;
		aClass85_2651 = new IterableNodeHashTable(16);
	}
}
