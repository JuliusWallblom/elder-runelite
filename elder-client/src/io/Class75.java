...
final class Class75 {
	...
	static final void method472(Buffer stream, byte i) {
		try {
			anInt985++;
			int i_0_ = stream.readSmart((byte) 56);
			FontMetric.aClass5Array962 = new Class5[i_0_];
			for (int i_1_ = 0; (i_0_ ^ 0xffffffff) < (i_1_ ^ 0xffffffff); i_1_++) {
				FontMetric.aClass5Array962[i_1_] = new Class5();
				((Class5) FontMetric.aClass5Array962[i_1_]).anInt64 = stream.readSmart((byte) 103);
				((Class5) FontMetric.aClass5Array962[i_1_]).aString54 = stream.method2360(i ^ ~0x70);
			}
			...
			for (int i_2_ = 0; i_2_ < Class246_Sub4.anInt3863; i_2_++) {
				...
				((Class63) class63_sub1).anInt854 = stream.readUnsignedByte();
		...
		try {
			for (Class130_Sub8 class130_sub8 = (Class130_Sub8) GameEngine.aClass68_7208
				...
				if ((Client.cycle ^ 0xffffffff) <= (((Class130_Sub8) class130_sub8).anInt5611 ^ 0xffffffff))
					...
					Class246_Sub1_Sub16.method2746(i_6_, 64 + (((Class130_Sub8) class130_sub8).anInt5610 << 7),
							(((Class130_Sub8) class130_sub8).anInt5619 << 7) + 64,
							((Class130_Sub8) class130_sub8).anInt5617, 2 * ((Class130_Sub8) class130_sub8).anInt5620,
							i >> 1, (byte) 41, i_10_ >> 1, i_8_);
					FontCache.bold_font.draw_centered_text(((Class130_Sub8) class130_sub8).aString5608,
							i_11_ - -Class257.anIntArray3689[0], i_9_ - -Class257.anIntArray3689[1],
							~0xffffff | ((Class130_Sub8) class130_sub8).anInt5621, 0, 0);
				}
			}
			if (i_7_ < 15)
				method473((byte) -97);
			...
			throw Class193.method1272(runtimeexception, ("hd.D(" + i + ',' + i_6_ + ',' + i_7_ + ',' + i_8_ + ',' + i_9_
					+ ',' + i_10_ + ',' + i_11_ + ')'));
		}
	}

	static {
		new MultilingualString("This mute will remain for a further ", "Diese Stummschaltung gilt f\u00fcr weitere ",
