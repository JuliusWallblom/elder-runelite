...
final class Class19 {
	...
	static final void method189(SceneGraph class260, CacheIndex sprites_index, int i, CacheIndex font_metrics_index) {
		try {
			Class217.aClass73_3022 = Class129.method878(6, 0, Buffer.f_eb, font_metrics_index);
			anInt291++;
			int i_5_ = 31 % ((-13 - i) / 62);
			FontCache.small_font = class260.method1716(Class217.aClass73_3022,
					LDSprite.method129(sprites_index, Buffer.f_eb, 0), true);
			Class246_Sub5.aClass73_3892 = Class129.method878(6, 0, Class36.f_ib, font_metrics_index);
			FontCache.regular_font = class260.method1716(Class246_Sub5.aClass73_3892,
					LDSprite.method129(sprites_index, Class36.f_ib, 0), true);
			CacheIndex.aClass73_148 = Class129.method878(6, 0, Class259_Sub1.anInt4510, font_metrics_index);
			FontCache.bold_font = class260.method1716(CacheIndex.aClass73_148,
					LDSprite.method129(sprites_index, (Class259_Sub1.anInt4510), 0), true);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	static final void method190(int i, Widget class235, int i_6_, int i_7_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("bu.E(" + i + ',' + (class235 != null ? "{...}" : "null") + ',' + i_6_ + ',' + i_7_ + ')'));
		}
	}
		...
		try {
			...
			while_245_: do {
				...
				for (;;) {
					...
					if ((c_16_ ^ 0xffffffff) != (c_17_ ^ 0xffffffff) && ((Character.toUpperCase(c_16_)
							^ 0xffffffff) != (Character.toUpperCase(c_17_) ^ 0xffffffff))) {
			...
			for (int i_19_ = 0; (i_19_ ^ 0xffffffff) > (i_18_ ^ 0xffffffff); i_19_++) {
				...
				if (c_21_ != c_20_ && (Character.toUpperCase(c_20_) != Character.toUpperCase(c_21_))) {
					...
					if (c_20_ != c_21_)
						return (Class75.method475((byte) -78, i_10_, c_20_)
								+ -Class75.method475((byte) -78, i_10_, c_21_));
				}
			}
	...
	Class19(int i, int i_27_, int i_28_, int i_29_, byte i_30_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("bu.<init>(" + i + ',' + i_27_ + ',' + i_28_ + ',' + i_29_ + ',' + i_30_ + ')'));
		}
	}
	...
	Class19(Class19 class19_31_, int i) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("bu.<init>(" + (class19_31_ != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}

	static {
		new MultilingualString("You can spot a moderator by the gold crown next to their name.",
				"Mitarbeiter haben eine goldene Krone neben ihrem Namen.",
				"Vous pouvez reconna\u00eetre les mod\u00e9rateurs \u00e0 la couronne dor\u00e9e en regard de leur nom.",
				"Os moderadores da Jagex s\u00e3o identificados por uma coroa dourada pr\u00f3xima ao \u007fnome.");
		new MultilingualString("You are not allowed to join this user's clan channel.",
