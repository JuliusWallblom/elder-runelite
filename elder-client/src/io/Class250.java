...
final class Class250 {
	...
	static MultilingualString aClass67_3531 = new MultilingualString("Loading - please wait.", "Ladevorgang - bitte warte.", "Chargement en cours. Veuillez patienter.", "Carregando. Aguarde.");
	...
	static final void method1598(int i, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, byte i_8_) {
		try {
			anInt3533++;
			int i_9_ = Class180.method1176(Class109_Sub4.anInt4570, -24309, i, AbstractModel.anInt1442);
			int i_10_ = Class180.method1176(Class109_Sub4.anInt4570, -24309, i_7_, AbstractModel.anInt1442);
			int i_11_ = Class180.method1176(Class110.anInt1573, -24309, i_4_, ObjType.anInt2818);
			int i_12_ = Class180.method1176(Class110.anInt1573, -24309, i_5_, ObjType.anInt2818);
			int i_13_ = Class180.method1176(Class109_Sub4.anInt4570, -24309, i - -i_6_, AbstractModel.anInt1442);
			int i_14_ = Class180.method1176(Class109_Sub4.anInt4570, -24309, -i_6_ + i_7_, AbstractModel.anInt1442);
			for (int i_15_ = i_9_; (i_13_ ^ 0xffffffff) < (i_15_ ^ 0xffffffff); i_15_++)
				RenderAnimation.method918(i_11_, 123, i_3_, i_12_, (Class246_Sub28_Sub6.anIntArrayArray6042[i_15_]));
			for (int i_16_ = i_10_; i_14_ < i_16_; i_16_--)
				RenderAnimation.method918(i_11_, -64, i_3_, i_12_, (Class246_Sub28_Sub6.anIntArrayArray6042[i_16_]));
			int i_17_ = Class180.method1176(Class110.anInt1573, -24309, i_4_ - -i_6_, ObjType.anInt2818);
			int i_18_ = Class180.method1176(Class110.anInt1573, -24309, -i_6_ + i_5_, ObjType.anInt2818);
			int i_19_ = -31 / ((23 - i_8_) / 42);
			for (int i_20_ = i_13_; i_20_ <= i_14_; i_20_++) {
				int[] is = Class246_Sub28_Sub6.anIntArrayArray6042[i_20_];
				RenderAnimation.method918(i_11_, -19, i_3_, i_17_, is);
				RenderAnimation.method918(i_18_, -81, i_3_, i_12_, is);
			}
		} catch (RuntimeException runtimeexception) {
		...
		do {
			try {
				...
				if (string != null) {
					...
					if (string_21_ != null) {
						for (int i_22_ = 0; ((Widget.anInt3266 ^ 0xffffffff) < (i_22_ ^ 0xffffffff)); i_22_++) {
							...
							if (string_23_ != null && string_23_.equals(string_21_)) {
								Widget.anInt3266--;
								for (int i_24_ = i_22_; Widget.anInt3266 > i_24_; i_24_++) {
									...
									SequenceLoader.aStringArray6745[i_24_] = (SequenceLoader.aStringArray6745[i_24_ + 1]);
	...
	static final void method1603(byte i, String string) {
		try {
			...
			if (Client.sign_link.anApplet733 != null) {
				try {
					if (i < -11) {
						String string_38_ = Client.sign_link.anApplet733.getParameter("cookieprefix");
						String string_39_ = Client.sign_link.anApplet733.getParameter("cookiehost");
						...
						do {
							...
							string_40_ += ("; Expires=" + (HDModel.method2039((94608000000L + TimeUtility.time()), -20881)) + "; Max-Age=" + 94608000L);
						} while (false);
						Class80.method520(("document.cookie=\"" + string_40_ + "\""), Client.sign_link.anApplet733, false);
					}
	...
	static final boolean method1604(CacheIndex class_fs, Class246_Sub37_Sub1 class246_sub37_sub1, CacheIndex class_fs_41_, CacheIndex class_fs_42_, byte i) {
		try {
			anInt3530++;
			Class246_Sub28_Sub15.aClass_fs6368 = class_fs_42_;
			StructType.aClass_fs6860 = class_fs_41_;
			if (i >= -52)
				return true;
			FloorDefinition.aClass_fs2923 = class_fs;
			Sprite.aClass246_Sub37_Sub1_433 = class246_sub37_sub1;
			return true;
		} catch (RuntimeException runtimeexception) {
	...
	Class250(int i, int i_43_) {
		try {
			if (i != i_43_) {
				int i_44_ = KeyHandler.method2324(i, i_43_, -1);
				i /= i_44_;
				i_43_ /= i_44_;
				anInt3523 = i_43_;
