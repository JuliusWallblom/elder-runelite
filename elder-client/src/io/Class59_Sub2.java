...
abstract class Class59_Sub2 extends Class59 {
	...
	static final void method2019(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, byte i_5_, int i_6_, int i_7_,
			int i_8_) {
		do {
			try {
				if (i_3_ == i_1_ && (i_8_ ^ 0xffffffff) == (i_4_ ^ 0xffffffff)
						&& (i_7_ ^ 0xffffffff) == (i ^ 0xffffffff) && (i_6_ ^ 0xffffffff) == (i_2_ ^ 0xffffffff))
				...
				throw Class193.method1272(runtimeexception, ("ii.DA(" + i + ',' + i_0_ + ',' + i_1_ + ',' + i_2_ + ','
	...
	static final void method2020(int i, int i_34_, int i_35_, int i_36_, int i_37_) {
		try {
			do {
				if ((ObjType.anInt2818 ^ 0xffffffff) >= (-i_36_ + i_37_ ^ 0xffffffff)
						&& (i_36_ + i_37_ ^ 0xffffffff) >= (Class110.anInt1573 ^ 0xffffffff)
						&& AbstractModel.anInt1442 <= i - i_36_
						&& (i + i_36_ ^ 0xffffffff) >= (Class109_Sub4.anInt4570 ^ 0xffffffff)) {
					IdentityKitLoader.method586(i_37_, i_36_, i, (byte) 48, i_34_);
					if (!Client.f_ob)
						break;
				}
			...
			throw Class193.method1272(runtimeexception,
					("ii.CA(" + i + ',' + i_34_ + ',' + i_35_ + ',' + i_36_ + ',' + i_37_ + ')'));
		}
	}
		...
		do {
			try {
				...
				if ((Widget.root_interface ^ 0xffffffff) != 0) {
					int i_38_ = Material.aClass102_3360.method640((byte) 58);
					int i_39_ = Material.aClass102_3360.method636(i + 2917);
					Class246_Sub30 class246_sub30 = (Class246_Sub30) Widget.f_qb.method1104(109);
	...
	final void method405(int i, int i_40_, Class59 class59, byte i_41_, boolean bool, SceneGraph class260, int i_42_) {
		try {
			if (i_41_ != -99)
			...
			throw Class193.method1272(runtimeexception,
					("ii.L(" + i + ',' + i_40_ + ',' + (class59 != null ? "{...}" : "null") + ',' + i_41_ + ',' + bool
							+ ',' + (class260 != null ? "{...}" : "null") + ',' + i_42_ + ')'));
		}
	}
	...
	Class59_Sub2(int i, int i_45_, int i_46_, int i_47_, int i_48_, int i_49_, int i_50_) {
		try {
			...
			throw Class193.method1272(runtimeexception, ("ii.<init>(" + i + ',' + i_45_ + ',' + i_46_ + ',' + i_47_
					+ ',' + i_48_ + ',' + i_49_ + ',' + i_50_ + ')'));
		}
	}

	static {
		anIntArrayArray4545 = new int[][] { { 2, 4, 6, 0 }, { 0, 2, 3, 5, 6, 4 }, { 0, 1, 4, 5 }, { 4, 6, 0, 2 },
		...
		anIntArray4559 = new int[] { 28 + Settings.draw_distance, 35 + Settings.draw_distance,
				40 + Settings.draw_distance, 44 + Settings.draw_distance };
		SEND_PROJECTILE_PACKET = new IncomingPacket(57, 19);
	}
}
