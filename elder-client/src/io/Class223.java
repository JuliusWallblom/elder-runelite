...
final class Class223 {
	...
	static MultilingualString aClass67_3075 = new MultilingualString("Loaded interface scripts", "Interface-Skripte geladen", "Interfaces charg\u00e9es", "Interfaces carregadas");
	...
	public final int method1439(int i, int i_2_) {
		try {
			anInt3071++;
			if (i != 109)
