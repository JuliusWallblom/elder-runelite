...
final class Class116_Sub1 extends Font {
	...
	Class116_Sub1(Class260_Sub1 class260_sub1, FontMetric class73, LDSprite[] class10s, int[] is, int[] is_54_) {
		...
		for (int i = 0; i < class10s.length; i++) {
			aByteArrayArray3988[i] = ((LDSprite) class10s[i]).aByteArray161;
			anIntArray3993[i] = ((LDSprite) class10s[i]).anInt162;
			anIntArray3992[i] = ((LDSprite) class10s[i]).anInt158;
		}
	}
