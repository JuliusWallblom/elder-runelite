...
final class Class116_Sub2 extends Font {
	...
	Class116_Sub2(Class260_Sub2 class260_sub2, FontMetric class73, LDSprite[] class10s, boolean bool) {
		super(class260_sub2, class73);
		aClass260_Sub2_4431 = class260_sub2;
		int i = 0;
		for (int i_0_ = 0; i_0_ < 256; i_0_++) {
			LDSprite class10 = class10s[i_0_];
			if (((LDSprite) class10).anInt155 > i)
				i = ((LDSprite) class10).anInt155;
			if (((LDSprite) class10).anInt156 > i)
				i = ((LDSprite) class10).anInt156;
		}
		int i_1_ = i * 16;
		if (bool) {
			byte[] is = new byte[i_1_ * i_1_];
			for (int i_2_ = 0; i_2_ < 256; i_2_++) {
				LDSprite class10 = class10s[i_2_];
				byte[] is_3_ = ((LDSprite) class10).aByteArray157;
				int i_4_ = ((LDSprite) class10).anInt155;
				int i_5_ = ((LDSprite) class10).anInt156;
				int i_6_ = i_2_ % 16 * i;
				int i_7_ = i_2_ / 16 * i;
			...
			for (int i_12_ = 0; i_12_ < 256; i_12_++) {
				LDSprite class10 = class10s[i_12_];
				int[] is_13_ = ((LDSprite) class10).anIntArray160;
				byte[] is_14_ = ((LDSprite) class10).aByteArray161;
				byte[] is_15_ = ((LDSprite) class10).aByteArray157;
				int i_16_ = ((LDSprite) class10).anInt155;
				int i_17_ = ((LDSprite) class10).anInt156;
		...
		for (int i_27_ = 0; i_27_ < 256; i_27_++) {
			LDSprite class10 = class10s[i_27_];
			int i_28_ = ((LDSprite) class10).anInt155;
			int i_29_ = ((LDSprite) class10).anInt156;
			int i_30_ = ((LDSprite) class10).anInt162;
			int i_31_ = ((LDSprite) class10).anInt158;
