...
final class Class40_Sub3 extends Class40 {
	...
	static final int method1860(int i, Widget class235, int i_0_) {
		try {
			if (i_0_ >= -104)
			...
			if (!Widget.get_active_properties(class235).method2120(i, 1)
				...
				return -1;
			if (((Widget) class235).f_pc == null || ((Widget) class235).f_pc.length <= i)
				return -1;
			return ((Widget) class235).f_pc[i];
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("dm.E(" + i + ',' + (class235 != null ? "{...}" : "null") + ',' + i_0_ + ')'));
		}
	}
	...
	Class40_Sub3(Class260_Sub2 class260_sub2, Class_m class_m) {
		...
		try {
			...
			method1861(-11540);
			aClass109_Sub2_4062 = new Class109_Sub2(((Class40) this).aClass260_Sub2_613, 6406, 2, new byte[] { 0, -1 },
					6406);
			aClass109_Sub2_4062.method1791((byte) 35, false);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, ("dm.<init>(" + (class260_sub2 != null ? "{...}" : "null") + ','
					+ (class_m != null ? "{...}" : "null") + ')'));
		}
	}
	...
	final void method278(int i, boolean bool) {
		try {
			if (((((Class260_Sub2) ((Class40) this).aClass260_Sub2_613).anInt4377) ^ 0xffffffff) < -1) {
				...
				Class246_Sub28_Sub34.aFloatArray7009[3] = 0.25F
						+ ((Class260_Sub2) ((Class40) this).aClass260_Sub2_613).f_gf * f;
				OpenGL.glPushMatrix();
				OpenGL.glLoadIdentity();
				OpenGL.glTexGenfv(8192, 9474, Class246_Sub28_Sub34.aFloatArray7009, 0);
				OpenGL.glPopMatrix();
				((Class40) this).aClass260_Sub2_613.method1943(0.5F,
						(float) ((Class260_Sub2) ((Class40) this).aClass260_Sub2_613).anInt4377, 27060);
	...
	static final void method1864(byte i) {
		try {
			Material.method1533(22050, ((Renderer) (Client.current_renderer)).aBool570, false, 2);
			anInt4059++;
			...
			Class236.anInt3307 = Cache.get_index(Revision.PRE_EOC_634, "music").method86(Constants.LOGIN_MUSIC);
			int i_4_ = 49 / ((i + 57) / 33);
		} catch (RuntimeException runtimeexception) {
	...
	final void method283(int i, Class109 class109, boolean bool) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("dm.B(" + i + ',' + (class109 != null ? "{...}" : "null") + ',' + bool + ')'));
		}
	}
			...
			try {
				...
				if ((0x1 & i) == 1) {
					if (!((Class_m) aClass_m4052).aBool1538) {
						...
						((Class40) this).aClass260_Sub2_613.method1905((byte) 78,
								(((Class_m) aClass_m4052).aClass109_Sub1Array1541[i_7_]));
					} else {
						((Class40) this).aClass260_Sub2_613.method1905((byte) 78,
								((Class_m) aClass_m4052).aClass109_Sub3_1543);
						Class246_Sub28_Sub34.aFloatArray7009[3] = (float) ((((Class260_Sub2) ((Class40) this).aClass260_Sub2_613).f_qe)
								% 4000) / 4000.0F;
						Class246_Sub28_Sub34.aFloatArray7009[1] = 0.0F;
					...
					((Class40) this).aClass260_Sub2_613.method1905((byte) 78,
							((Class_m) aClass_m4052).aClass109_Sub1Array1541[0]);
				if (i_5_ > 76)
					break;
	...
	static final void method1865(int i, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_) {
		try {
			...
			RenderAnimation.method918(-i_8_ + i_12_, -101, i_10_, i_12_ - -i_8_,
					Class246_Sub28_Sub6.anIntArrayArray6042[i]);
			...
			while ((i_14_ ^ 0xffffffff) < -1) {
				...
				RenderAnimation.method918(i_31_, i_9_ + 484166167, i_10_, i_30_,
						(Class246_Sub28_Sub6.anIntArrayArray6042[i_28_]));
				RenderAnimation.method918(i_31_, 126, i_10_, i_30_, (Class246_Sub28_Sub6.anIntArrayArray6042[i_29_]));
			}
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("dm.C(" + i + ',' + i_8_ + ',' + i_9_ + ',' + i_10_ + ',' + i_11_ + ',' + i_12_ + ')'));
		}
	}
