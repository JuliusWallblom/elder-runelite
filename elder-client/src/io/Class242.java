...
public final class Class242 {
	...
	static RenderAnimation aClass135_3416 = new RenderAnimation();
	...
	private Buffer aStream3431 = new Buffer(4);
	private int anInt3432;
	private Buffer aStream3433;
		...
		try {
			...
			if (aClass6_3429 != null) {
				try {
					...
					if (i == 56)
						aClass6_3429.method76(4, 0, (((Buffer) aStream3431).buffer), i + 71);
				} catch (IOException ioexception) {
					try {
						aClass6_3429.method72(false);
					} catch (Exception exception) {
		...
		try {
			...
			if (aClass6_3429 != null) {
				try {
					...
					aClass6_3429.method76(4, 0, (((Buffer) aStream3431).buffer), 126);
				} catch (IOException ioexception) {
					try {
						aClass6_3429.method72(false);
					} catch (Exception exception) {
	...
	final SubIncomingPacket method1554(int i, byte i_1_, byte i_2_, boolean bool, int i_3_) {
		try {
			...
			((NodeSub) class246_sub1_sub6_sub1).aLong3739 = l;
		...
		try {
			...
			try {
				...
				for (SubIncomingPacket class246_sub1_sub6_sub1 = ((SubIncomingPacket) aClass217_3417.method1408((byte) 87)); class246_sub1_sub6_sub1 != null; class246_sub1_sub6_sub1 = ((SubIncomingPacket) aClass217_3417.method1411(true))) {
					...
					aStream3431.method2380(-77, (int) (((NodeSub) class246_sub1_sub6_sub1).aLong3739));
					aClass6_3429.method76(4, 0, (((Buffer) aStream3431).buffer), 127);
				...
				for (SubIncomingPacket class246_sub1_sub6_sub1 = ((SubIncomingPacket) aClass217_3427.method1408((byte) 87)); class246_sub1_sub6_sub1 != null; class246_sub1_sub6_sub1 = ((SubIncomingPacket) aClass217_3427.method1411(true))) {
					...
					aStream3431.method2380(-41, (int) (((NodeSub) class246_sub1_sub6_sub1).aLong3739));
					aClass6_3429.method76(4, 0, (((Buffer) aStream3431).buffer), 127);
				...
				for (int i_7_ = 0; (i_7_ ^ 0xffffffff) > -101; i_7_++) {
					...
					if (aClass246_Sub1_Sub6_Sub1_3437 == null)
						...
						i_9_ = 1;
					if (i_9_ <= 0) {
						int i_10_ = (-((SubIncomingPacket) aClass246_Sub1_Sub6_Sub1_3437).aByte7092 + (((Buffer) (((SubIncomingPacket) aClass246_Sub1_Sub6_Sub1_3437).aStream7089)).buffer).length);
						int i_11_ = (-((SubIncomingPacket) aClass246_Sub1_Sub6_Sub1_3437).anInt7090 + 512);
						if ((i_10_ - ((Buffer) (((SubIncomingPacket) aClass246_Sub1_Sub6_Sub1_3437).aStream7089)).position ^ 0xffffffff) > (i_11_ ^ 0xffffffff))
							i_11_ = i_10_ - ((Buffer) (((SubIncomingPacket) aClass246_Sub1_Sub6_Sub1_3437).aStream7089)).position;
						if ((i_11_ ^ 0xffffffff) < (i_8_ ^ 0xffffffff))
							i_11_ = i_8_;
						aClass6_3429.method65(((Buffer) (((SubIncomingPacket) aClass246_Sub1_Sub6_Sub1_3437).aStream7089)).position, (byte) 113, i_11_, ((Buffer) (((SubIncomingPacket) aClass246_Sub1_Sub6_Sub1_3437).aStream7089)).buffer);
						if ((aByte3435 ^ 0xffffffff) != -1) {
							for (int i_12_ = 0; (i_11_ ^ 0xffffffff) < (i_12_ ^ 0xffffffff); i_12_++)
								((Buffer) (((SubIncomingPacket) aClass246_Sub1_Sub6_Sub1_3437).aStream7089)).buffer[i_12_ + ((Buffer) (((SubIncomingPacket) aClass246_Sub1_Sub6_Sub1_3437).aStream7089)).position] = (byte) (VarpType.method599((((Buffer) (((SubIncomingPacket) aClass246_Sub1_Sub6_Sub1_3437).aStream7089)).buffer[(i_12_ + ((Buffer) (((SubIncomingPacket) aClass246_Sub1_Sub6_Sub1_3437).aStream7089)).position)]), aByte3435));
						}
						((Buffer) (((SubIncomingPacket) aClass246_Sub1_Sub6_Sub1_3437).aStream7089)).position += i_11_;
						((SubIncomingPacket) aClass246_Sub1_Sub6_Sub1_3437).anInt7090 += i_11_;
						if (((Buffer) (((SubIncomingPacket) aClass246_Sub1_Sub6_Sub1_3437).aStream7089)).position == i_10_) {
							aClass246_Sub1_Sub6_Sub1_3437.removeDual();
						...
						int i_13_ = i_9_ - ((Buffer) aStream3433).position;
						if ((i_13_ ^ 0xffffffff) < (i_8_ ^ 0xffffffff))
							i_13_ = i_8_;
						aClass6_3429.method65(((Buffer) aStream3433).position, (byte) 113, i_13_, (((Buffer) aStream3433).buffer));
						if (aByte3435 != 0) {
							for (int i_14_ = 0; (i_13_ ^ 0xffffffff) < (i_14_ ^ 0xffffffff); i_14_++)
								((Buffer) aStream3433).buffer[((Buffer) aStream3433).position + i_14_] = (byte) (VarpType.method599((((Buffer) aStream3433).buffer[(((Buffer) aStream3433).position + i_14_)]), aByte3435));
						}
						((Buffer) aStream3433).position += i_13_;
						if ((i_9_ ^ 0xffffffff) >= (((Buffer) aStream3433).position ^ 0xffffffff)) {
							if (aClass246_Sub1_Sub6_Sub1_3437 == null) {
								((Buffer) aStream3433).position = 0;
								int i_15_ = aStream3433.readUnsignedByte();
								int i_16_ = aStream3433.readUnsignedShort();
								int i_17_ = aStream3433.readUnsignedByte();
								...
								if (!bool) {
									for (class246_sub1_sub6_sub1 = ((SubIncomingPacket) aClass217_3426.method1408((byte) 87)); class246_sub1_sub6_sub1 != null; class246_sub1_sub6_sub1 = ((SubIncomingPacket) aClass217_3426.method1411(true))) {
										if (((NodeSub) class246_sub1_sub6_sub1).aLong3739 == l)
											break;
									}
								} else {
								...
								((SubIncomingPacket) aClass246_Sub1_Sub6_Sub1_3437).aStream7089 = (new Buffer(i_20_ + i_18_ - -(((SubIncomingPacket) aClass246_Sub1_Sub6_Sub1_3437).aByte7092)));
								...
								if (((Buffer) aStream3433).buffer[0] != -1)
									aClass246_Sub1_Sub6_Sub1_3437 = null;
								else {
	...
	static final boolean method1562(MapFunction class140, int i) {
		try {
			anInt3425++;
			if (class140 == null)
				return false;
			if (!((MapFunction) class140).aBool1996)
				return false;
			if (!class140.method942(i - 11249, Class79.anInterface11_1025))
				return false;
			if (Class246_Sub28_Sub11.aClass85_6164.get((long) ((MapFunction) class140).anInt2006) != null)
				return false;
			if (Class40_Sub1.aClass85_3776.get((long) ((MapFunction) class140).anInt2014) != null)
				return false;
			if (i != 2)
				method1559(114, -84);
			return true;
