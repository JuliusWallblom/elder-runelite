...
abstract class Class40 {
	...
	static SequenceLoader[] aClass246_Sub1_Sub17Array611 = new SequenceLoader[14];
	...
	static final void method279(boolean bool, SceneGraph class260) {
		do {
			try {
				anInt614++;
				if (bool != true)
					aClass246_Sub1_Sub17Array611 = null;
				if ((((Class59_Sub3) Client.local_player).current_plane != Class211_Sub1.anInt5343)
						&& Class106.tiles != null) {
					if (!Class246_Sub1_Sub16.method2743(-4, (((Class59_Sub3) Client.local_player).current_plane),
							class260))
						break;
					Class211_Sub1.anInt5343 = (((Class59_Sub3) Client.local_player).current_plane);
				}
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception,
						("dl.N(" + bool + ',' + (class260 != null ? "{...}" : "null") + ')'));
			}
			break;
		} while (false);
	}
	...
	Class40(Class260_Sub2 class260_sub2) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					"dl.<init>(" + (class260_sub2 != null ? "{...}" : "null") + ')');
		}
	}
	...
	static {
		...
		for (int i_3_ = 0; i_3_ < 256; i_3_++) {
			for (int i_4_ = 0; i_3_ >= i_4_; i_4_++)
				aByteArray612[i++] = (byte) (int) (255.0
						/ Math.sqrt((double) ((float) (i_3_ * i_3_ + (i_4_ * i_4_) + 65535) / 65535.0F)));
		}
