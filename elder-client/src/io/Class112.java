	...
	static final int method770(Class246_Sub35 class246_sub35, int i) {
		try {
			...
			if (Class252.method1619((((Class246_Sub35) class246_sub35).anInt5156), 0))
				is = ((ObjType) (MapRegion.aClass191_3663.list(22883, (int) (((Class246_Sub35) class246_sub35).aLong5157)))).anIntArray2772;
				...
				if (!Class246_Sub28_Sub27.method2767((((Class246_Sub35) class246_sub35).anInt5156), (byte) -112)) {
					if (StructLoader.method390(-110, (((Class246_Sub35) class246_sub35).anInt5156))) {
						Object object = null;
						LocType class185;
						if (((Class246_Sub35) class246_sub35).anInt5156 == 1010)
							class185 = (Class143.aClass251_2067.list((int) (((Class246_Sub35) class246_sub35).aLong5157), 0));
						else
							class185 = (Class143.aClass251_2067.list((int) (0x7fffffffL & (((Class246_Sub35) class246_sub35).aLong5157) >>> 32), 0));
				...
				is = (((ObjType) MapRegion.aClass191_3663.list(22883, (((Class246_Sub35) class246_sub35).anInt5148))).anIntArray2772);
			if (is != null)
				string += Class247.method1581(is, 124);
			int i_5_ = CacheIndex.aClass73_148.method461(string, i ^ 0x78, (Class106_Sub2.aClass_lArray5340));
