...
final class Class257 {
	...
	static final float[] method1665(float f, int i, int i_0_, int i_1_, int i_2_, byte i_3_, float f_4_, float f_5_) {
		try {
			...
			throw Class193.method1272(runtimeexception, ("wo.B(" + f + ',' + i + ',' + i_0_ + ',' + i_1_ + ',' + i_2_
					+ ',' + i_3_ + ',' + f_4_ + ',' + f_5_ + ')'));
		}
	}

	static final void remove_interfaces(int i, boolean bool, Revision revision) {
		System.out.println("remove interfaces revision: " + revision);
		do {
			try {
				Class209.anInt2947++;
				anInt3687++;
				Class243.writePacket(-123, Class24.CLOSE_INTERFACE_OUT);
				ScriptExecutor.field816 = true;
				for (WidgetParent class246_sub40 = (WidgetParent) Widget.widget_parents.first(
						(byte) -23); class246_sub40 != null; class246_sub40 = (WidgetParent) Widget.widget_parents
								.next((byte) -20)) {
					if (!class246_sub40.method1576(-127)) {
						class246_sub40 = (WidgetParent) Widget.widget_parents.first((byte) -23);
						if (class246_sub40 == null)
							break;
					}
					if ((((WidgetParent) class246_sub40).type ^ 0xffffffff) == -1)
						Widget.close_widget(true, class246_sub40, bool, -112,
	...
	static final void method1667(int i) {
		try {
			...
			if (i != 0)
				method1668(-98, -8);
			for (Class246_Sub1_Sub9 class246_sub1_sub9 = ((Class246_Sub1_Sub9) ScriptEvent.aClass166_4968.method1104(
					45)); class246_sub1_sub9 != null; class246_sub1_sub9 = (Class246_Sub1_Sub9) ScriptEvent.aClass166_4968
							.method1108((byte) -112)) {
				...
				if (((Class59_Sub3_Sub2) class59_sub3_sub2).aBool5886) {
					class246_sub1_sub9.remove();
					class59_sub3_sub2.method2489(true);
				} else if (((Class59_Sub3_Sub2) class59_sub3_sub2).anInt5868 <= Client.cycle) {
