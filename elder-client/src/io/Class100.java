...
public class Class100 {
	...
	static MultilingualString aClass67_1300;
	...
	static final void setWindowedMode(int i, int i_0_, int i_1_, boolean bool, boolean bool_2_) {
		try {
			Class130_Sub8.aLong5616 = 0L;
			anInt1305++;
			if (bool_2_ != false)
				anInt1306 = -128;
			int i_3_ = Client.get_frame_mode((byte) -123);
			if (i == 3 || (i_3_ ^ 0xffffffff) == -4)
				bool = true;
			if (!Client.sprite_loader.method1686())
				bool = true;
			ScriptEvent.method2150(i, i_3_, (byte) -45, i_1_, bool, i_0_);
	...
	static {
		aClass67_1300 = new MultilingualString(" is already on your ignore list.", " steht bereits auf deiner Ignorieren-Liste!", " est d\u00e9j\u00e0 dans votre liste noire.", " j\u00e1 est\u00e1 na sua lista de ignorados.");
	}
}
