...
final class da extends AbstractModel implements Class_d {
	private na ana3984;
	private qa aqa3985;
	long nativeid;
	Class303[] aClass162Array3986;
	...
	final native void animate_0(int i, int[] is, int i_3_, int i_4_, int i_5_, boolean bool, int i_6_, int[] is_7_,
			int sequence_id, SequenceType sequence_type);

	final native boolean animateStart();

	final void method682(AbstractModel class_t, int i, int i_8_, int i_9_, boolean bool) {
	...
	final native void onFinishAnimating();
	...
	final AbstractModel method678(byte i, int i_17_, boolean bool) {
	...
	final native void animate_1(int i, int[] is, int i_25_, int i_26_, int i_27_, int i_28_, boolean bool,
			int sequence_id, SequenceType sequence_type);

	private final native void q(qa var_qa, na var_na, int i, int i_29_, int[] is, int[] is_30_, int[] is_31_,
			int[] is_32_, short[] is_33_, int i_34_, int[] is_35_, int[] is_36_, int[] is_37_, int[] is_38_,
			byte[] is_39_, int[] is_40_, byte[] is_41_, short[] is_42_, short[] is_43_, int[] is_44_, byte i_45_,
			short[] is_46_, int i_47_, byte[] is_48_, short[] is_49_, short[] is_50_, short[] is_51_, int[] is_52_,
			int[] is_53_, int[] is_54_, byte[] is_55_, byte[] is_56_, int[] is_57_, int[] is_58_, int[] is_59_,
			int[] is_60_, int i_61_, int i_62_, int i_63_, int i_64_, int i_65_, int i_66_, int[] is_67_);

	da(qa var_qa, na var_na, Model class103, int i, int i_68_, int i_69_, int i_70_) {
		aqa3985 = var_qa;
		ana3984 = var_na;
		((da) this).aClass19Array3987 = ((Model) class103).aClass19Array1364;
		((da) this).aClass162Array3986 = ((Model) class103).aClass303Array1547;
		int i_71_ = (((Model) class103).aClass19Array1364 == null ? 0 : ((Model) class103).aClass19Array1364.length);
		int i_72_ = (((Model) class103).aClass303Array1547 == null ? 0 : ((Model) class103).aClass303Array1547.length);
		int i_73_ = 0;
		...
		for (int i_75_ = 0; i_75_ < i_72_; i_75_++)
			is[i_73_++] = ((Class303) ((da) this).aClass162Array3986[i_75_]).anInt2289;
		int i_76_ = (((Model) class103).aClass125Array1583 == null ? 0 : ((Model) class103).aClass125Array1583.length);
		int[] is_77_ = new int[i_76_ * 8];
		int i_78_ = 0;
		for (int i_79_ = 0; i_79_ < i_76_; i_79_++) {
			SomeClass class131 = ((Model) class103).aClass125Array1583[i_79_];
			Class98 class98 = Class247.method1578(true, ((SomeClass) class131).anInt1828);
			is_77_[i_78_++] = ((SomeClass) class131).anInt1823;
		...
		for (int i_80_ = 0; i_80_ < i_76_; i_80_++) {
			SomeClass class131 = ((Model) class103).aClass125Array1583[i_80_];
			is_77_[i_78_++] = ((SomeClass) class131).anInt1829;
		}
		// 11-14
		q(aqa3985, ana3984, ((Model) class103).vertices, ((Model) class103).anInt1573, ((Model) class103).verticesX,
				((Model) class103).verticesY, ((Model) class103).verticesZ,
				((Model) class103).vertexSkins, ((Model) class103).aShortArray1351, ((Model) class103).faces,
				((Model) class103).indices1, ((Model) class103).indices2, ((Model) class103).indices3,
				((Model) class103).faceRenderTypes, ((Model) class103).faceRenderPriorities,
				((Model) class103).faceAlphas,
				((Model) class103).textureCoords, ((Model) class103).faceColors, ((Model) class103).faceTextures,
				((Model) class103).faceSkins, ((Model) class103).priority, ((Model) class103).aShortArray1338,
				((Model) class103).texture_faces, ((Model) class103).textureRenderTypes, ((Model) class103).texIndices1,
				((Model) class103).texIndices2, ((Model) class103).texIndices3, ((Model) class103).texTriangleX,
				((Model) class103).texTriangleY, ((Model) class103).texTriangleZ, ((Model) class103).aByteArray1330,
				((Model) class103).f_ab, ((Model) class103).f_fb, ((Model) class103).anIntArray1335,
				((Model) class103).anIntArray1366, is, i_71_, i_72_, i, i_68_, i_69_, i_70_, is_77_);
	}
	...
	final void method1843(int i, Class_c class_c) {
		...
		if (((da) this).aClass162Array3986 != null) {
			for (int i_88_ = 0; i_88_ < ((da) this).aClass162Array3986.length; i_88_++) {
				Class303 class162 = ((da) this).aClass162Array3986[i_88_];
				Class303 class162_89_ = class162;
				if (((Class303) class162).aClass162_2296 != null)
					class162_89_ = ((Class303) class162).aClass162_2296;
				if (((Class303) class162).aClass_c2291 != null)
					((Class303) class162).aClass_c2291.za(class_c);
				else
					((Class303) class162).aClass_c2291 = class_c.method582();
				((Class303) class162_89_).anInt2294 = qa.E[i_86_++];
				((Class303) class162_89_).anInt2292 = qa.E[i_86_++];
				((Class303) class162_89_).anInt2301 = qa.E[i_86_++];
			}
		}
	}
}
