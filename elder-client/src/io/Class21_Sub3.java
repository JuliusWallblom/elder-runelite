	...
	static final int method2077(boolean bool, boolean bool_7_, int i, int i_8_, byte i_9_) {
		try {
			...
			for (int i_11_ = 0; ((((Class246_Sub18) class246_sub18).anIntArray4682.length ^ 0xffffffff) < (i_11_ ^ 0xffffffff)); i_11_++) {
				if ((((Class246_Sub18) class246_sub18).anIntArray4682[i_11_] >= 0) && (((((Class246_Sub18) class246_sub18).anIntArray4682[i_11_]) ^ 0xffffffff) > (((Class191) MapRegion.aClass191_3663).anInt2690 ^ 0xffffffff))) {
					ObjType class197 = MapRegion.aClass191_3663.list(22883, (((Class246_Sub18) class246_sub18).anIntArray4682[i_11_]));
					int i_12_ = (class197.method1289(i_8_, -114, (((ParamType) ParamType.list(i_8_)).default_int)));
					if (!bool_7_)
						i_10_ += i_12_;
					else
	...
	final void method196(int i, int i_25_, int i_26_) {
		do {
			try {
				...
				TransformList.method2117(i_29_, ((Class21) this).anInt317, i_28_, -32, i_27_, ((Class21) this).anInt319, i_30_, ((Class21) this).anInt321);
				if (i <= -78)
					break;
				anInt4731 = -11;
			} catch (RuntimeException runtimeexception) {
