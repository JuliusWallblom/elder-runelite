...
final class Class246_Sub28_Sub29 extends TextureOperation {
	...
	static AbstractSprite[] aClass_lArray6820;
	...
	static final boolean method2818(int i, int i_1_, int i_2_, int i_3_) {
		...
		if (Class160.method1060(i_4_ + 1, Class59_Sub3_Sub4.aClass210Array6993[i].l(i_1_, i_2_) + i_3_, i_5_ + 1) && Class160.method1060(i_4_ + NodeSub.anInt3744 - 1, Class59_Sub3_Sub4.aClass210Array6993[i].l(i_1_ + 1, i_2_) + i_3_, i_5_ + 1) && Class160.method1060(i_4_ + NodeSub.anInt3744 - 1, Class59_Sub3_Sub4.aClass210Array6993[i].l(i_1_ + 1, i_2_ + 1) + i_3_, i_5_ + NodeSub.anInt3744 - 1) && Class160.method1060(i_4_ + 1, Class59_Sub3_Sub4.aClass210Array6993[i].l(i_1_, i_2_ + 1) + i_3_, i_5_ + NodeSub.anInt3744 - 1))
			return true;
		return false;
	}
	...
	final int[][] method2139(byte i, int i_16_) {
		try {
			if (i < 33)
				return null;
			anInt6816++;
			int[][] is = ((TextureOperation) this).aClass136_4933.method922((byte) 79, i_16_);
