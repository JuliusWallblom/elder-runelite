...
public class Buffer extends Node {
	...
	public int g4() {
		this.position += 4;
		return ((this.buffer[this.position - 3] & 255) << 16) + (this.buffer[this.position - 1] & 255)
				+ ((this.buffer[this.position - 2] & 255) << 8) + ((this.buffer[this.position - 4] & 255) << 24);
	}

	public final int readUnsignedByte() {
		anInt5638++;
		return (((Buffer) this).buffer[((Buffer) this).position++] & 0xff);
	}

	public int readShort() {
		this.position += 2;
		int var2 = (this.buffer[this.position - 1] & 255) + ((this.buffer[this.position - 2] & 255) << 8);
		if (var2 > 32767) {
			var2 -= 65536;
		}
	...
	final int readIntV1(int i) {
		try {
			...
			if (i >= -90)
				readByte128(20);
			return ((0xff & (((Buffer) this).buffer[-3 + ((Buffer) this).position]))
					+ ((((((Buffer) this).buffer[-2 + ((Buffer) this).position]) & 0xff) << 24)
							- (-(0xff0000 & (((Buffer) this).buffer[-1 + ((Buffer) this).position]) << 16)
									- ((((Buffer) this).buffer[-4 + ((Buffer) this).position]) << 8 & 0xff00))));
	...
	final long method2355(int i, int i_1_) {
		try {
			...
			long l = 0L;
			for (/**/; i_2_ >= 0; i_2_ -= 8)
				l |= (0xffL & (long) (((Buffer) this).buffer[((Buffer) this).position++])) << i_2_;
			return l;
		} catch (RuntimeException runtimeexception) {
	...
	final int read24BitInteger(byte i) {
		try {
			anInt5634++;
			((Buffer) this).position += 3;
			return (((((Buffer) this).buffer[-2 + ((Buffer) this).position] & 0xff) << 8)
					+ (((0xff & (((Buffer) this).buffer[-3 + ((Buffer) this).position])) << 16)
							- -((((Buffer) this).buffer[-1 + ((Buffer) this).position]) & 0xff)));
		} catch (RuntimeException runtimeexception) {
	...
	final void writeShortLE(int i, byte i_3_) {
		try {
			if (i_3_ <= 76)
				MapRegion.luminances = null;
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) i;
			anInt5643++;
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) (i >> 8);
		} catch (RuntimeException runtimeexception) {
	...
	final void method2358(byte i, int i_4_) {
		do {
			try {
				f_cb++;
				((Buffer) this).buffer[((Buffer) this).position++] = (byte) (i_4_ + 128);
				if (i == 23)
					break;
	...
	final void writeShortLE128(byte i, int i_5_) {
		try {
			...
			if (i > -48)
				method2388(-37, 70);
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) (i_5_ + 128);
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) (i_5_ >> 8);
		} catch (RuntimeException runtimeexception) {
	...
	final String method2360(int i) {
		try {
			int i_6_ = -17 % ((-82 - i) / 44);
			anInt5664++;
			byte i_7_ = ((Buffer) this).buffer[((Buffer) this).position++];
			if ((i_7_ ^ 0xffffffff) != -1)
				throw new IllegalStateException("Bad version number in gjstr2");
			int i_8_ = ((Buffer) this).position;
			while ((((Buffer) this).buffer[((Buffer) this).position++] ^ 0xffffffff) != -1) {
				/* empty */
			}
			int i_9_ = -i_8_ + ((Buffer) this).position - 1;
			if (i_9_ == 0)
				return "";
			return Class_l_Sub2.method2299(11783, ((Buffer) this).buffer, i_9_, i_8_);
		} catch (RuntimeException runtimeexception) {
	...
	final boolean method2363(boolean bool) {
		try {
			((Buffer) this).position -= 4;
			f_pb++;
			int i = Class96.method612(0, (byte) 87, ((Buffer) this).buffer, ((Buffer) this).position);
	...
	final int readSmart() {
		f_gb++;
		int i_14_ = ((Buffer) this).buffer[((Buffer) this).position] & 0xff;
		if ((i_14_ ^ 0xffffffff) > -129)
			return readUnsignedByte() - 64;
		return -49152 + readUnsignedShort();
	}

	final int readShortSmart() {
		int var2 = buffer[position] & 255;
		return ~var2 > -129 ? readUnsignedByte() - 64 : readUnsignedShort() - 0xc000;
	}
	...
	final int method2366(byte i) {
		try {
			...
			int i_15_ = ((((Buffer) this).buffer[((Buffer) this).position - 2] & 0xff)
					+ ((((Buffer) this).buffer[-1 + ((Buffer) this).position]) << 8 & 0xff00));
	...
	final void writeLong(long l, byte i) {
		try {
			...
			anInt5654++;
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) (int) (l >> 56);
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) (int) (l >> 48);
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) (int) (l >> 40);
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) (int) (l >> 32);
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) (int) (l >> 24);
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) (int) (l >> 16);
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) (int) (l >> 8);
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) (int) l;
		} catch (RuntimeException runtimeexception) {
	...
	final void writeShort128(byte i, int i_16_) {
		try {
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) (i_16_ >> 8);
			if (i <= -98) {
				f_vb++;
				((Buffer) this).buffer[((Buffer) this).position++] = (byte) (i_16_ + 128);
			}
		} catch (RuntimeException runtimeexception) {
	...
	public int readUShortSmart() {
		int var1 = this.buffer[this.position] & 255;
	...
	final int readSmart(byte i) {
		try {
			if (i <= 49)
				((Buffer) this).buffer = null;
			f_qb++;
			int i_17_ = 0xff & ((Buffer) this).buffer[((Buffer) this).position];
	...
	final byte readByteC(int i) {
		try {
			...
			if (i != 0)
				method2388(64, -71);
			return (byte) -(((Buffer) this).buffer[((Buffer) this).position++]);
		} catch (RuntimeException runtimeexception) {
	...
	final void readBytes(byte i, int i_18_, int i_19_, byte[] is) {
		try {
			for (int i_20_ = i_19_; i_18_ + i_19_ > i_20_; i_20_++)
				is[i_20_] = ((Buffer) this).buffer[((Buffer) this).position++];
			if (i != 22)
				((Buffer) this).position = 47;
			anInt5663++;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("iv.Q(" + i + ',' + i_18_ + ',' + i_19_ + ',' + (is != null ? "{...}" : "null") + ')'));
		}
	}
	...
	final int method2372(byte i) {
		try {
			...
			anInt5645++;
			((Buffer) this).position += 2;
			int i_21_ = ((0xff & (((Buffer) this).buffer[((Buffer) this).position - 1]) - 128)
					+ (((((Buffer) this).buffer[-2 + ((Buffer) this).position]) & 0xff) << 8));
			if (i_21_ > 32767)
				i_21_ -= 65536;
			return i_21_;
		} catch (RuntimeException runtimeexception) {
	...
	final int readIntV2(int i) {
		try {
			...
			anInt5652++;
			((Buffer) this).position += 4;
			return ((0xff & (((Buffer) this).buffer[((Buffer) this).position - 2]))
					+ (0xff0000 & (((Buffer) this).buffer[((Buffer) this).position - 4]) << 16)
					+ ((((((Buffer) this).buffer[((Buffer) this).position - 3]) & 0xff) << 24)
							+ (0xff00 & (((Buffer) this).buffer[((Buffer) this).position - 1]) << 8)));
		} catch (RuntimeException runtimeexception) {
	...
	final int readIntLE(int i) {
		try {
			...
			if (i <= 24)
				return -84;
			f_ub++;
			return ((((Buffer) this).buffer[((Buffer) this).position - 4] & 0xff)
					+ (((((Buffer) this).buffer[((Buffer) this).position - 3]) & 0xff) << 8)
					+ (((((Buffer) this).buffer[((Buffer) this).position - 1]) << 24 & ~0xffffff)
							+ ((((Buffer) this).buffer[((Buffer) this).position - 2]) << 16 & 0xff0000)));
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, "iv.EA(" + i + ')');
		}
	}

	final int method2375(int i) {
		try {
			anInt5644++;
			((Buffer) this).position += 2;
			int i_22_ = (((((Buffer) this).buffer[((Buffer) this).position - 2] & 0xff) << 8)
					- -(((Buffer) this).buffer[((Buffer) this).position - 1] & 0xff));
	...
	final void readIntV2(int i, int i_23_) {
		try {
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) (i_23_ >> 16);
			anInt5627++;
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) (i_23_ >> 24);
			if (i != -1276441384)
				MapRegion.luminances = null;
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) i_23_;
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) (i_23_ >> 8);
		} catch (RuntimeException runtimeexception) {
	...
	final void method2377(int i, int i_24_) {
		try {
			((Buffer) this).buffer[-4 + -i_24_ + ((Buffer) this).position] = (byte) (i_24_ >> 24);
			anInt5641++;
			((Buffer) this).buffer[i + ((Buffer) this).position + -i_24_] = (byte) (i_24_ >> 16);
			((Buffer) this).buffer[-2 + -i_24_ + ((Buffer) this).position] = (byte) (i_24_ >> 8);
			((Buffer) this).buffer[-1 + (((Buffer) this).position + -i_24_)] = (byte) i_24_;
		} catch (RuntimeException runtimeexception) {
	...
	final int readUnsignedShortLE128(byte i) {
		try {
			...
			f_hb++;
			((Buffer) this).position += 2;
			return (((((Buffer) this).buffer[-1 + ((Buffer) this).position] << 8) & 0xff00)
					- -((((Buffer) this).buffer[((Buffer) this).position - 2]) - 128 & 0xff));
		} catch (RuntimeException runtimeexception) {
	...
	final String method2379(int i) {
		try {
			anInt5640++;
			if (((Buffer) this).buffer[((Buffer) this).position] == 0) {
	...
	final void method2380(int i, int i_25_) {
		try {
			f_wb++;
			if (i < -11) {
				((Buffer) this).buffer[((Buffer) this).position++] = (byte) (i_25_ >> 16);
				((Buffer) this).buffer[((Buffer) this).position++] = (byte) (i_25_ >> 8);
				((Buffer) this).buffer[((Buffer) this).position++] = (byte) i_25_;
			}
		} catch (RuntimeException runtimeexception) {
	...
	final void writeString(int i, String string) {
		try {
			...
			((Buffer) this).position += Class_j.method716(string, 0, string.length(), ((Buffer) this).position, -55,
					((Buffer) this).buffer);
			if (i >= 54)
				((Buffer) this).buffer[((Buffer) this).position++] = (byte) 0;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("iv.A(" + i + ',' + (string != null ? "{...}" : "null") + ')'));
		}
	}
		...
		try {
			...
			if (bool == true) {
				for (/**/; (i_28_ ^ 0xffffffff) > (i + i_27_ ^ 0xffffffff); i_28_++)
					((Buffer) this).buffer[((Buffer) this).position++] = is[i_28_];
			}
		} catch (RuntimeException runtimeexception) {
			runtimeexception.printStackTrace();
			throw Class193.method1272(runtimeexception,
					("iv.AB(" + i + ',' + bool + ',' + (is != null ? "{...}" : "null") + ',' + i_27_ + ')'));
		}
	}
	...
	final int readUnsignedByte128(int i) {
		try {
			if (i != 27574)
				write128Byte(90, 60);
			anInt5636++;
			return (0xff & (((Buffer) this).buffer[((Buffer) this).position++] - 128));
		} catch (RuntimeException runtimeexception) {
	...
	final void write128Byte(int i, int i_29_) {
		do {
			try {
				((Buffer) this).buffer[((Buffer) this).position++] = (byte) (128 + -i_29_);
				f_fb++;
				if (i == 0)
					break;
				anInt5656 = 10;
	...
	final void method2385(BigInteger exp, byte i, BigInteger mod) {
		try {
			anInt5642++;
			int i_31_ = ((Buffer) this).position;
			...
			throw Class193.method1272(runtimeexception, ("iv.M(" + (mod != null ? "{...}" : "null") + ',' + i + ','
					+ (exp != null ? "{...}" : "null") + ')'));
		}
	}
	...
	final int readUnsignedByteC(int i) {
		try {
			if (i > -77)
				anInt5656 = -57;
			f_db++;
			return (0xff & -((Buffer) this).buffer[((Buffer) this).position++]);
		} catch (RuntimeException runtimeexception) {
	...
	final void writeShort(byte i, int i_35_) {
		try {
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) (i_35_ >> 8);
			f_nb++;
			if (i != 67)
				readIntV1(107);
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) i_35_;
		} catch (RuntimeException runtimeexception) {
	...
	final int method2388(int i, int i_36_) {
		try {
			if (i_36_ != -19774)
				return 111;
			anInt5639++;
			int i_37_ = Class96.method612(i, (byte) -107, ((Buffer) this).buffer, ((Buffer) this).position);
		...
		do {
			try {
				...
				for (int i_39_ = i * 8; i_39_ >= 0; i_39_ -= 8)
					((Buffer) this).buffer[((Buffer) this).position++] = (byte) (int) (l >> i_39_);
				if (i_38_ == 12)
					break;
				anInt5656 = 44;
			} catch (RuntimeException runtimeexception) {
			...
			try {
				...
				for (int i_40_ = 0; Class59.anInt819 > i_40_; i_40_++) {
					...
					if (((Class258) class258).aClass246_Sub37_Sub3_3692 == null) {
						...
						if ((((Class258) class258).anInt3695
								^ 0xffffffff) > ((((Class258) class258).aByte3702 == 2 ? -1500 : -10) ^ 0xffffffff))
							bool = true;
						else {
							if (((((Class258) class258).aByte3702 ^ 0xffffffff) == -2)
									&& (((Class258) class258).aClass229_3696 == null)) {
								((Class258) class258).aClass229_3696 = Class229.method1467(
										(Cache.get_index(Revision.PRE_EOC_634, "sound_effects")),
										((Class258) class258).anInt3700, 0);
								if (((Class258) class258).aClass229_3696 == null)
									continue;
								((Class258) class258).anInt3695 += ((Class258) class258).aClass229_3696.method1469();
							} else if ((((Class258) class258).aByte3702 ^ 0xffffffff) == -3
									&& ((((Class258) class258).aClass246_Sub9_3693) == null
											|| ((((Class258) class258).aClass246_Sub3_Sub1_3694) == null))) {
								if (((Class258) class258).aClass246_Sub9_3693 == null)
									((Class258) class258).aClass246_Sub9_3693 = (Class246_Sub9.method1848(
											Cache.client_cache
													.get(IndexConstants.PRE_EOC_634_MIDI_INSTRUMENTS_INDEX),
											((Class258) class258).anInt3700));
								if (((Class258) class258).aClass246_Sub9_3693 == null)
									continue;
								if ((((Class258) class258).aClass246_Sub3_Sub1_3694) == null) {
									((Class258) class258).aClass246_Sub3_Sub1_3694 = ((Class258) class258).aClass246_Sub9_3693
											.method1854(new int[] { 22050 });
									if ((((Class258) class258).aClass246_Sub3_Sub1_3694) == null)
										continue;
								}
							}
							if ((((Class258) class258).anInt3695 ^ 0xffffffff) > -1) {
								...
								if (((Class258) class258).anInt3701 == 0)
									...
									if ((i_42_ ^ 0xffffffff) != ((((Class59_Sub3) Client.local_player).current_plane)
										...
										if (i_48_ < 0)
											i_48_ = 0;
										i_41_ = ((i_43_ - i_48_) * ((((Renderer) (Client.current_renderer)).anInt603)
												* (((Class258) class258).anInt3697)) / i_43_) >> 8;
									}
								}
								if (i_41_ > 0) {
									...
									if (((Class258) class258).aByte3702 != 1) {
										...
										class246_sub3_sub1 = (((Class258) class258).aClass229_3696.method1468()
												.method2655(Class148.aClass250_2178));
									Class246_Sub37_Sub3 class246_sub37_sub3 = (((Class258) class258).aClass246_Sub37_Sub3_3692 = (Class246_Sub37_Sub3
											.method2809(class246_sub3_sub1, 100, i_41_)));
				...
				if (((((Renderer) Client.current_renderer).anInt587) ^ 0xffffffff) != -1 && Class36.anInt512 != -1)
					Class15.method158((((Renderer) (Client.current_renderer)).anInt587), Class36.anInt512, 0,
							Cache.get_index(Revision.PRE_EOC_634, "music"), -15727, false);
	...
	final int method2391(byte i) {
		try {
			anInt5647++;
			int i_50_ = ((Buffer) this).buffer[((Buffer) this).position++];
			if (i != 37)
				return 95;
			int i_51_ = 0;
			for (/**/; i_50_ < 0; i_50_ = ((Buffer) this).buffer[((Buffer) this).position++])
	...
	final int readInt(byte i) {
		try {
			anInt5646++;
			((Buffer) this).position += 4;
			return (((((Buffer) this).buffer[((Buffer) this).position - 2] << 8) & 0xff00)
					+ ((~0xffffff & (((Buffer) this).buffer[((Buffer) this).position - 4]) << 24)
							+ (((0xff & (((Buffer) this).buffer[-3 + ((Buffer) this).position])) << 16)
									+ (0xff & (((Buffer) this).buffer[-1 + ((Buffer) this).position])))));
		} catch (RuntimeException runtimeexception) {
		...
		for (int var5 = 0; var5 < var2; ++var5) { // L: 154
			...
			if (var6 != 0) { // L: 156
				if (var6 >= 128 && var6 < 160) { // L: 157
					char var7 = cp1252AsciiExtension[var6 - 128]; // L: 158
					if (var7 == 0) { // L: 159
						var7 = '?';
					}
	...
	public String readStringCp1252NullTerminated() {
		int var1 = this.position; // L: 266

		while (this.buffer[++this.position - 1] != 0) { // L: 267
		}

		int var2 = this.position - var1 - 1; // L: 268
		return var2 == 0 ? "" : decodeStringCp1252(this.buffer, var1, var2); // L: 269 270
	}
	...
	public String gjstr() {
		...
		return var2 == 0 ? "" : getString(this.buffer, var1, var2);
	}

	public int g3() {
		this.position += 3;
		return ((this.buffer[this.position - 3] & 255) << 16) + (this.buffer[this.position - 1] & 255)
				+ ((this.buffer[this.position - 2] & 255) << 8);
	}
	...
	final void writeInt(int i, byte i_53_) {
		try {
			anInt5635++;
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) (i >> 24);
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) (i >> 16);
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) (i >> 8);
	...
	final byte read128Byte(int i) {
		try {
			...
			if (i != 128)
				return (byte) 108;
			return (byte) (-(((Buffer) this).buffer[((Buffer) this).position++]) + 128);
		} catch (RuntimeException runtimeexception) {
	...
	final int method2398(int i) {
		try {
			...
			anInt5628++;
			((Buffer) this).position += 2;
			int i_57_ = (((((Buffer) this).buffer[((Buffer) this).position - 1] << 8) & 0xff00)
					- -((((Buffer) this).buffer[-2 + ((Buffer) this).position]) - 128 & 0xff));
			if (i_57_ > 32767)
				i_57_ -= 65536;
			return i_57_;
		} catch (RuntimeException runtimeexception) {
	...
	final int readUnsignedShort() {
		...
		return ((0xff & (((Buffer) this).buffer[-1 + ((Buffer) this).position]))
				+ ((((Buffer) this).buffer[((Buffer) this).position - 2]) << 8 & 0xff00));
	}
	...
	public int method5507(int var1) {
		this.position += 4;
		return ((this.buffer[this.position - 3] & 255) << 16) + (this.buffer[this.position - 1] & 255)
				+ ((this.buffer[this.position - 2] & 255) << 8) + ((this.buffer[this.position - 4] & 255) << 24);
	}

	public int method5519(short var1) {
		if (this.buffer[this.position] < 0) {
			return this.method5507(-537411802) & Integer.MAX_VALUE;
		} else {
	...
	public static final char[] field3641 = new char[] { '\u20ac', '\u0000', '\u201a', '\u0192', '\u201e', '\u2026',
			'\u2020', '\u2021', '\u02c6', '\u2030', '\u0160', '\u2039', '\u0152', '\u0000', '\u017d', '\u0000',
			'\u0000', '\u2018', '\u2019', '\u201c', '\u201d', '\u2022', '\u2013', '\u2014', '\u02dc', '\u2122',
			'\u0161', '\u203a', '\u0153', '\u0000', '\u017e', '\u0178' };
	...
	public String readNullTerminatedString() {
		...
		return var3 == 0 ? "" : method507(this.buffer, var2, var3, (byte) -37);
	}
	...
	public byte[] readBytes() {
		...
		while (buffer[position++] != 10)
			;
		byte data[] = new byte[position - index - 1];
		System.arraycopy(buffer, index, data, index - index, position - 1 - index);
		return data;
	}
	...
	final String readString(byte i) {
		try {
			anInt5659++;
			int i_59_ = ((Buffer) this).position;
			while (((Buffer) this).buffer[((Buffer) this).position++] != 0) {
				/* empty */
			}
			if (i != -40)
				return null;
			int i_60_ = -1 + ((Buffer) this).position + -i_59_;
			if ((i_60_ ^ 0xffffffff) == -1)
				return "";
			return Class_l_Sub2.method2299(11783, ((Buffer) this).buffer, i_60_, i_59_);
		} catch (RuntimeException runtimeexception) {
	...
	final int readUnsignedShortLE(int i) {
		try {
			...
			((Buffer) this).position += 2;
			anInt5651++;
			return ((0xff & (((Buffer) this).buffer[-2 + ((Buffer) this).position]))
					+ ((((Buffer) this).buffer[((Buffer) this).position - 1]) << 8 & 0xff00));
		} catch (RuntimeException runtimeexception) {
	...
	final void method2403(int[] is, int i) {
		try {
			f_bb++;
			int i_65_ = ((Buffer) this).position / 8;
			((Buffer) this).position = 0;
			if (i == 1207900229) {
	...
	final void method2404(byte i, int i_72_) {
		do {
			try {
				((Buffer) this).buffer[((Buffer) this).position++] = (byte) i_72_;
				anInt5629++;
				((Buffer) this).buffer[((Buffer) this).position++] = (byte) (i_72_ >> 8);
				if (i <= -48)
					break;
				anInt5656 = 37;
			} catch (RuntimeException runtimeexception) {
	...
	final byte readByte() {
		return ((Buffer) this).buffer[((Buffer) this).position++];
	}
	...
	final void method2407(int i, int i_74_, int i_75_, int[] is) {
		try {
			f_kb++;
			int i_76_ = ((Buffer) this).position;
			...
			((Buffer) this).position = i_76_;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("iv.MB(" + i + ',' + i_74_ + ',' + i_75_ + ',' + (is != null ? "{...}" : "null") + ')'));
		}
	}
	...
	final void method2408(int i, int i_84_) {
		try {
			if (i == -1591647264) {
				anInt5631++;
				((Buffer) this).buffer[-1 + (-i_84_ + ((Buffer) this).position)] = (byte) i_84_;
			}
		} catch (RuntimeException runtimeexception) {
	...
	final void method2410(int i, int i_85_) {
		try {
			anInt5666++;
			((Buffer) this).buffer[-2 + (-i_85_ + ((Buffer) this).position)] = (byte) (i_85_ >> 8);
			if (i >= -21)
				method2358((byte) 121, -87);
			((Buffer) this).buffer[-i_85_ + (((Buffer) this).position - 1)] = (byte) i_85_;
		} catch (RuntimeException runtimeexception) {
	...
	final int readUnsignedShort128(int i) {
		try {
			...
			if (i != 952968608)
				anInt5656 = 104;
			((Buffer) this).position += 2;
			return (((((Buffer) this).buffer[-2 + ((Buffer) this).position] << 8) & 0xff00)
					+ (0xff & (((Buffer) this).buffer[-1 + ((Buffer) this).position]) - 128));
		} catch (RuntimeException runtimeexception) {
	...
	Buffer(int i) {
		try {
			((Buffer) this).buffer = Class149.method1003(14592, i);
			((Buffer) this).position = 0;
		} catch (RuntimeException runtimeexception) {
	...
	final byte readByte128(int i) {
		try {
			...
			if (i >= -34)
				anInt5656 = -30;
			return (byte) (-128 + (((Buffer) this).buffer[((Buffer) this).position++]));
		} catch (RuntimeException runtimeexception) {
	...
	final void method2413(int i, int i_86_) {
		try {
			anInt5653++;
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) i_86_;
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) (i_86_ >> 8);
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) (i_86_ >> 16);
			if (i != -428659336)
				f_eb = 80;
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) (i_86_ >> 24);
		} catch (RuntimeException runtimeexception) {
	...
	final void writeByte(int i, int i_87_) {
		try {
			...
			((Buffer) this).buffer[((Buffer) this).position++] = (byte) i_87_;
			f_ab++;
		} catch (RuntimeException runtimeexception) {
	...
	static {
		new MultilingualString("Join your channel by clicking 'Join Chat' and typing: ",
