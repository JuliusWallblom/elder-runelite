	...
	static final int method2347(int i, int i_0_, int i_1_, boolean bool) {
		try {
			...
			if ((i_0_ ^ 0xffffffff) > -1
					|| (((Class246_Sub18) class246_sub18).anIntArray4679.length ^ 0xffffffff) >= (i_0_ ^ 0xffffffff))
				return 0;
	...
	static final byte[] method2349(byte[] is, boolean bool) {
		try {
			...
			if (i != 0) {
				...
				if (i_4_ > 10000000 || i_4_ < 0 || ((Class240.anInt3389 ^ 0xffffffff) != -1
						&& (Class240.anInt3389 ^ 0xffffffff) > (i_4_ ^ 0xffffffff)))
					// throw new RuntimeException();
					return new byte[100];
