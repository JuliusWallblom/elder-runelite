...
final class Class16 {
	...
	static int anInt236;
	private IterableNodeHashTable aClass85_237;
	static Class12 aClass12_238 = new Class12(6, 4);
	static SequenceLoader[] aClass246_Sub1_Sub17Array239 = new SequenceLoader[14];
	...
	final Node method160(boolean bool) {
		try {
			...
			if (bool != true)
				method160(true);
			if ((anInt241 ^ 0xffffffff) < -1
					&& aClass246_240 != (((IterableNodeHashTable) aClass85_237).aClass246Array1118[anInt241 - 1])) {
				Node class246 = aClass246_240;
				aClass246_240 = ((Node) class246).next;
				return class246;
			}
			while (anInt241 < ((IterableNodeHashTable) aClass85_237).anInt1115) {
				Node class246 = (((Node) (((IterableNodeHashTable) aClass85_237).aClass246Array1118[anInt241++])).next);
				if (((IterableNodeHashTable) aClass85_237).aClass246Array1118[-1 + anInt241] != class246) {
					aClass246_240 = ((Node) class246).next;
					return class246;
				}
			}
	...
	Class16(IterableNodeHashTable class85) {
		try {
