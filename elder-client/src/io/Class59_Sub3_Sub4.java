...
final class Class59_Sub3_Sub4 extends Class59_Sub3 implements Class_f {
	...
	public final AbstractModel method23(SceneGraph class260, int i, int i_0_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("vb.D(" + (class260 != null ? "{...}" : "null") + ',' + i + ',' + i_0_ + ')'));
		}
	}

	static final void method2863(int i, CacheIndex class_fs, byte i_2_, int i_3_, boolean bool, int i_4_, int i_5_) {
		do {
			try {
				Varbit.anInt1534 = i;
				if (i_2_ == -89) {
					...
					Class22.anInt327 = (Sprite.aClass246_Sub37_Sub1_433.method2512(0) / i_3_);
					if (Class22.anInt327 >= 1)
						break;
					Class22.anInt327 = 1;
				}
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception, ("vb.CA(" + i + ',' + (class_fs != null ? "{...}" : "null")
						+ ',' + i_2_ + ',' + i_3_ + ',' + bool + ',' + i_4_ + ',' + i_5_ + ')'));
			}
			break;
		} while (false);
	}
	...
	Class59_Sub3_Sub4(SceneGraph class260, LocType class185, int i, int i_7_, int i_8_, int i_9_, int i_10_,
			boolean bool, int i_11_, int i_12_, int i_13_, int i_14_, int i_15_, int i_16_, boolean bool_17_) {
		super(i, i_8_, i_9_, i_10_, i_11_, i_12_, i_13_, i_14_, ((LocType) class185).supports_items == 1,
				Class65.method427(true, i_16_, i_15_));
		do {
			try {
				aBool6979 = ((((LocType) class185).wall_or_door ^ 0xffffffff) != -1 && !bool);
				aByte6974 = (byte) i_16_;
				aByte6985 = (byte) i_7_;
				aShort6998 = (short) ((LocType) class185).id;
				aBool6988 = bool_17_;
				aBool6976 = bool;
				aByte6992 = (byte) i_15_;
				aBool6989 = (class260.method1683() && ((LocType) class185).aBool2583 && !aBool6976
						&& (Client.current_renderer.method271(Buffer.anInt5656, (byte) -28) ^ 0xffffffff) != -1);
				int i_18_ = 2048;
				if (aBool6988)
					i_18_ |= 0x10000;
				...
				if (!aBool6988)
					break;
				((Class59_Sub3_Sub4) this).aClass_t6973 = ((Class59_Sub3_Sub4) this).aClass_t6973.method678((byte) 0,
						i_18_, false);
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception,
						("vb.<init>(" + (class260 != null ? "{...}" : "null") + ','
								+ (class185 != null ? "{...}" : "null") + ',' + i + ',' + i_7_ + ',' + i_8_ + ',' + i_9_
								+ ',' + i_10_ + ',' + bool + ',' + i_11_ + ',' + i_12_ + ',' + i_13_ + ',' + i_14_ + ','
								+ i_15_ + ',' + i_16_ + ',' + bool_17_ + ')'));
			}
			break;
		} while (false);
	}
	...
	static final int[] method2864(int i, boolean bool, int i_19_, int i_20_, int i_21_, float f, int i_22_, int i_23_) {
		try {
			...
			throw Class193.method1272(runtimeexception, ("vb.R(" + i + ',' + bool + ',' + i_19_ + ',' + i_20_ + ','
					+ i_21_ + ',' + f + ',' + i_22_ + ',' + i_23_ + ')'));
		}
	}

	final void method405(int i, int i_24_, Class59 class59, byte i_25_, boolean bool, SceneGraph class260, int i_26_) {
		do {
			try {
				anInt6990++;
				if (i_25_ == -99) {
					if (class59 instanceof Class59_Sub4_Sub2) {
						...
						if (((Class59_Sub3_Sub4) this).aClass_t6973 != null
								&& (((Class59_Sub4_Sub2) class59_sub4_sub2).aClass_t6834) != null)
							((Class59_Sub3_Sub4) this).aClass_t6973.method682(
									(((Class59_Sub4_Sub2) class59_sub4_sub2).aClass_t6834), i_24_, i_26_, i, bool);
					} else {
						if (!(class59 instanceof Class59_Sub3_Sub4))
							break;
						Class59_Sub3_Sub4 class59_sub3_sub4_27_ = (Class59_Sub3_Sub4) class59;
						if (((Class59_Sub3_Sub4) this).aClass_t6973 == null
								|| (((Class59_Sub3_Sub4) class59_sub3_sub4_27_).aClass_t6973) == null)
							break;
						((Class59_Sub3_Sub4) this).aClass_t6973.method682(
								(((Class59_Sub3_Sub4) class59_sub3_sub4_27_).aClass_t6973), i_24_, i_26_, i, bool);
					}
				}
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception,
						("vb.L(" + i + ',' + i_24_ + ',' + (class59 != null ? "{...}" : "null") + ',' + i_25_ + ','
								+ bool + ',' + (class260 != null ? "{...}" : "null") + ',' + i_26_ + ')'));
			}
			break;
		} while (false);
	}
	...
	final boolean method409(int i, int i_28_, SceneGraph class260, int i_29_) {
		try {
			anInt6984++;
			AbstractModel class_t = method2865(class260, 1, 131072);
			if (i_28_ != 0)
				aShort6998 = (short) -96;
			if (class_t != null) {
			...
			throw Class193.method1272(runtimeexception,
					("vb.A(" + i + ',' + i_28_ + ',' + (class260 != null ? "{...}" : "null") + ',' + i_29_ + ')'));
		}
	}
	...
	private final AbstractModel method2865(SceneGraph class260, int i, int i_30_) {
		try {
			anInt7000++;
			if (((Class59_Sub3_Sub4) this).aClass_t6973 != null
					&& (class260.method1710(((Class59_Sub3_Sub4) this).aClass_t6973.P(), i_30_) ^ 0xffffffff) == -1)
			...
			throw Class193.method1272(runtimeexception,
					("vb.C(" + (class260 != null ? "{...}" : "null") + ',' + i + ',' + i_30_ + ')'));
		}
	}
	...
	final Class130_Sub3 method407(SceneGraph class260, int i) {
		try {
			...
			((Class59_Sub3_Sub4) this).aClass_t6973.method680(class_c,
					(class130_sub3 == null ? null : (((Class130_Sub3) class130_sub3).aClass130_Sub5Array4415[0])), 0);
			if (i > -87)
				aBool6988 = true;
			return class130_sub3;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					"vb.H(" + (class260 != null ? "{...}" : "null") + ',' + i + ')');
		}
	}
	...
	final void method403(SceneGraph class260, int i) {
		do {
			try {
				...
				if (i >= 53)
					break;
				Cache.client_cache.set(IndexConstants.PRE_EOC_634_CONFIG_PARTICLE_INDEX, null);
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception,
						("vb.B(" + (class260 != null ? "{...}" : "null") + ',' + i + ')'));
			}
			break;
		} while (false);
	}
		...
		do {
			try {
				...
				if (class246_sub1_sub4 != null)
					Class29.method230(class246_sub1_sub4, aByte6985, ((Class59_Sub3) this).x, ((Class59_Sub3) this).y,
							null);
				if (i == -12694)
					break;
				method9(62);
	...
	static final int method2867(String string, int i, Buffer stream) {
		try {
			f_bb++;
			int i_32_ = ((Buffer) stream).position;
			byte[] is = Class153.method1014(string, i ^ 0x4620);
			stream.method2406((byte) -8, is.length);
			((Buffer) stream).position += (Class246_Sub19_Sub2.aClass99_6812.method625(is, ((Buffer) stream).position,
					(byte) 40, i, ((Buffer) stream).buffer, is.length));
			return -i_32_ + ((Buffer) stream).position;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, ("vb.AA(" + (string != null ? "{...}" : "null") + ',' + i + ','
					+ (stream != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public final void method20(boolean bool, SceneGraph class260) {
		do {
			try {
				...
				if (class246_sub1_sub4 != null)
					Class246_Sub12.method1980(class246_sub1_sub4, aByte6985, ((Class59_Sub3) this).x,
							((Class59_Sub3) this).y, null);
				if (bool == true)
					break;
				method2868(-128);
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception,
						("vb.W(" + bool + ',' + (class260 != null ? "{...}" : "null") + ')'));
			}
			break;
		} while (false);
	}
	...
	private final Class133 method2869(byte i, int i_33_, SceneGraph class260, boolean bool) {
		try {
			anInt6972++;
			if (i != 10)
				return null;
			LocType class185 = Class143.aClass251_2067.list(aShort6998 & 0xffff, 0);
			Class210 class210;
			...
			return class185.method1210(class260, ((Class59_Sub3) this).x, i - 7, i_33_, ((Class59_Sub3) this).anInt5052,
					bool, ((aByte6992 ^ 0xffffffff) != -12 ? (int) aByte6974 : aByte6974 + 4), class210,
					((Class59_Sub3) this).y, ((aByte6992 ^ 0xffffffff) != -12 ? aByte6992 : 10), class210_34_);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("vb.DA(" + i + ',' + i_33_ + ',' + (class260 != null ? "{...}" : "null") + ',' + bool + ')'));
		}
	}
