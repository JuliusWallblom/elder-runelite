...
abstract class TextureOperation extends Node {
	...
	final int[] method2133(int i, int i_0_, int i_1_) {
		try {
			...
			if (i_1_ != 0)
				return null;
			if (!((TextureOperation) ((TextureOperation) this).texture_ops[i_0_]).aBool4947)
				return (((TextureOperation) this).texture_ops[i_0_].method2139((byte) 92, i)[0]);
			return ((TextureOperation) this).texture_ops[i_0_].method2135(123, i);
	...
	void method2134(boolean bool) {
		try {
			if (bool != false)
				((TextureOperation) this).aBool4947 = true;
			anInt4944++;
		} catch (RuntimeException runtimeexception) {
	...
	void method2138(int i, byte i_4_, int i_5_) {
		try {
			...
			if (i_4_ != -54)
				method2142(7);
			int i_6_ = ((((TextureOperation) this).anInt4932 ^ 0xffffffff) == -256 ? i : ((TextureOperation) this).anInt4932);
			if (((TextureOperation) this).aBool4947)
				((TextureOperation) this).aClass66_4938 = new Class66(i_6_, i, i_5_);
			else
				((TextureOperation) this).aClass136_4933 = new Class136(i_6_, i, i_5_);
		} catch (RuntimeException runtimeexception) {
	...
	final int[][] method2141(int i, int i_8_, int i_9_) {
		try {
			...
			if (i != 3)
				return null;
			if (!((TextureOperation) ((TextureOperation) this).texture_ops[i_8_]).aBool4947)
				return ((TextureOperation) this).texture_ops[i_8_].method2139((byte) 127, i_9_);
			int[] is = ((TextureOperation) this).texture_ops[i_8_].method2135(117, i_9_);
	...
	void method2142(int i) {
		try {
			do {
				if (!((TextureOperation) this).aBool4947) {
					((TextureOperation) this).aClass136_4933.method926((byte) 56);
					((TextureOperation) this).aClass136_4933 = null;
					if (!Client.f_ob)
						break;
				}
				((TextureOperation) this).aClass66_4938.method429(258510055);
				((TextureOperation) this).aClass66_4938 = null;
			} while (false);
			if (i > 120)
				anInt4941++;
		} catch (RuntimeException runtimeexception) {
	...
	void method2143(int i, int i_11_, Buffer stream) {
		do {
			try {
				anInt4945++;
				if (i == 4)
	...
	TextureOperation(int i, boolean bool) {
		try {
			((TextureOperation) this).aBool4947 = bool;
			((TextureOperation) this).texture_ops = new TextureOperation[i];
		} catch (RuntimeException runtimeexception) {
