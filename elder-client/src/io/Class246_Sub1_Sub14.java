	...
	static final void method2712(String string, int i, int i_19_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("mb.C(" + (string != null ? "{...}" : "null") + ',' + i + ',' + i_19_ + ')'));
		}
	}

	static final AbstractModel method2713(int i, int i_20_, SceneGraph class260, int i_21_, int i_22_, int i_23_,
			int i_24_) {
		try {
			anInt6594++;
			long l = (long) i;
			AbstractModel class_t = ((AbstractModel) Class59_Sub3_Sub3.aClass54_6277.method379(l, (byte) 58));
			int i_25_ = 2055;
			if (class_t == null) {
				Model class103 = Model.get_model(0, Cache.get_index(Settings.data, "models"), i, Settings.data);
				if (class103 == null)
					return null;
				if ((((Model) class103).anInt1358 ^ 0xffffffff) > -14)
			...
			throw Class193.method1272(runtimeexception,
					("mb.B(" + i + ',' + i_20_ + ',' + (class260 != null ? "{...}" : "null") + ',' + i_21_ + ',' + i_22_
							+ ',' + i_23_ + ',' + i_24_ + ')'));
		}
	}
