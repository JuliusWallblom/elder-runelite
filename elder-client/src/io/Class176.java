...
final class Class176 {
		...
		do {
			try {
				...
				if ((Signlink.anInt740 ^ 0xffffffff) != -3) {
					try {
						Method method = (aClass2482 != null ? aClass2482
								: (aClass2482 = Client.getClassByName("java.lang.Runtime")))
	...
	static final boolean method1156(Class59_Sub3 class59_sub3, boolean bool) {
		...
		if (((Class59_Sub3) class59_sub3).aShort5057 < 0 || ((Class59_Sub3) class59_sub3).aShort5064 < 0
				|| ((Class59_Sub3) class59_sub3).aShort5065 >= Class240.xSize
				|| ((Class59_Sub3) class59_sub3).aShort5062 >= HDModel.ySize)
			return false;
		for (int i_3_ = ((Class59_Sub3) class59_sub3).aShort5057; i_3_ <= ((Class59_Sub3) class59_sub3).aShort5065; i_3_++) {
			for (int i_4_ = ((Class59_Sub3) class59_sub3).aShort5064; i_4_ <= ((Class59_Sub3) class59_sub3).aShort5062; i_4_++) {
				Tile class147 = Class187.method1222((((Class59_Sub3) class59_sub3).current_plane), i_3_, i_4_);
				if (class147 != null) {
					int i_5_ = 0;
					...
					Class3 class3_6_ = ((Tile) class147).aClass3_2160;
					if (class3_6_ == null)
						((Tile) class147).aClass3_2160 = class3;
					else {
	...
	public static void method1157(int i) {
		try {
			aClass13_2476 = null;
			aClass87_2480 = null;
			Cache.reset_index(Revision.PRE_EOC_634, "skins");
			Cache.reset_index(Revision.OSRS, "skins");
			int i_9_ = -24 % ((-25 - i) / 34);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1158(AbstractSprite[] class_ls, int i) {
		try {
			anInt2478++;
			Class149.anInt2192 = class_ls.length;
			Class21_Sub4.anIntArray4924 = new int[i + Class149.anInt2192];
			Class106_Sub2.aClass_lArray5340 = new AbstractSprite[Class149.anInt2192 + 10];
	...
	static {
		new MultilingualString("You appear to be telling someone your password - please don't!",
