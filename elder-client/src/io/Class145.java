...
public final class Class145 {
	...
	final Class145 method974(int i) {
		try {
			if (i != -21447)
				return null;
			anInt2099++;
			return new Class145(((Class145) this).anInt2106, ((Class145) this).anInt2098, ((Class145) this).anInt2102,
					((Class145) this).anInt2109, ((Class145) this).anInt2101, ((Class145) this).anInt2113);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method977(int i) {
		do {
			try {
				anInt2108++;
				if (Camera.camera_pitch < 1024.0F)
					Camera.camera_pitch = 1024.0F;
				for (/**/; Camera.camera_yaw >= 16384.0F; Camera.camera_yaw -= 16384.0F) {
					/* empty */
				}
				if (Camera.camera_pitch > 3072.0F)
					Camera.camera_pitch = 3072.0F;
				for (/**/; Camera.camera_yaw < 0.0F; Camera.camera_yaw += 16384.0F) {
					/* empty */
				}
				int i_3_ = 101 % ((i + 3) / 37);
				int i_4_ = Class_c_Sub1.anInt5366 >> 7;
				int i_5_ = Class246_Sub34.anInt5135 >> 7;
				int i_6_ = Class6.getAverageHeight(Class_c_Sub1.anInt5366, -77, Class246_Sub28_Sub24.anInt6681,
						Class246_Sub34.anInt5135);
				int i_7_ = 0;
				if (i_4_ > 3 && (i_5_ ^ 0xffffffff) < -4
						&& (i_4_ ^ 0xffffffff) > (Class38_Sub1_Sub1.anInt6770 - 4 ^ 0xffffffff)
						&& i_5_ < Class152.anInt2205 - 4) {
					for (int i_8_ = i_4_ - 4; 4 + i_4_ >= i_8_; i_8_++) {
						for (int i_9_ = -4 + i_5_; (i_5_ + 4 ^ 0xffffffff) <= (i_9_ ^ 0xffffffff); i_9_++) {
							...
							if ((i_10_ ^ 0xffffffff) > -4 && Class211.method1389(i_8_, -29792, i_9_))
								i_10_++;
							int i_11_ = 0;
							if ((((MapRegion) Class246_Sub28_Sub3.aClass255_Sub1_5900).aByteArrayArrayArray3649) != null
									&& (((MapRegion) Class246_Sub28_Sub3.aClass255_Sub1_5900).aByteArrayArrayArray3649[i_10_]) != null)
								i_11_ = (0xff
										& (((MapRegion) (Class246_Sub28_Sub3.aClass255_Sub1_5900)).aByteArrayArrayArray3649[i_10_][i_8_][i_9_]))
										* 8;
	...
	private Class145(int i, int i_15_, int i_16_, int i_17_, int i_18_, int i_19_) {
		...
		try {
			...
			throw Class193.method1272(runtimeexception,
					("no.<init>(" + i + ',' + i_15_ + ',' + i_16_ + ',' + i_17_ + ',' + i_18_ + ',' + i_19_ + ')'));
		}
	}
}
