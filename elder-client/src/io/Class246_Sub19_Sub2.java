...
final class Class246_Sub19_Sub2 extends Class246_Sub19 implements ImageProducer {
	...
	static final boolean method2814(int i, boolean bool, int i_0_) {
		try {
			if (bool != false)
				return true;
			anInt6802++;
			if (!(Class100_Sub1.method2174(i_0_, i, (byte) -55) | (0x800 & i_0_ ^ 0xffffffff) != -1)
					&& !Class6.method71(-20147, i, i_0_))
				return false;
			return true;
	...
	public final synchronized void removeConsumer(ImageConsumer imageconsumer) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("re.removeConsumer(" + (imageconsumer != null ? "{...}" : "null") + ')'));
		}
	}
	...
	private final synchronized void method2815(int i) {
		try {
			...
			if (anImageConsumer6798 != null) {
				anImageConsumer6798.setPixels(i, 0, ((Class246_Sub19) this).anInt4706,
						((Class246_Sub19) this).anInt4705, aColorModel6801, ((Class246_Sub19) this).anIntArray4704, 0,
						((Class246_Sub19) this).anInt4706);
	...
	private final synchronized void method2816(int i, boolean bool, int i_1_, int i_2_, int i_3_) {
		do {
			try {
				anInt6806++;
				if (anImageConsumer6798 != null) {
					anImageConsumer6798.setPixels(i_1_, i_2_, i_3_, i, aColorModel6801,
							((Class246_Sub19) this).anIntArray4704, ((Class246_Sub19) this).anInt4706 * i_2_ - -i_1_,
							((Class246_Sub19) this).anInt4706);
					anImageConsumer6798.imageComplete(2);
					if (bool == true)
						break;
	...
	public final void startProduction(ImageConsumer imageconsumer) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("re.startProduction(" + (imageconsumer != null ? "{...}" : "null") + ')'));
		}
	}
	...
	final void method2071(int i, int i_4_, int i_5_, Graphics graphics) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("re.E(" + i + ',' + i_4_ + ',' + i_5_ + ',' + (graphics != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public final synchronized boolean isConsumer(ImageConsumer imageconsumer) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					"re.isConsumer(" + (imageconsumer != null ? "{...}" : "null") + ')');
		}
	}
	...
	final void method2064(int i, int i_6_, int i_7_, Graphics graphics, byte i_8_, int i_9_) {
		do {
			try {
				...
				throw Class193.method1272(runtimeexception, ("re.B(" + i + ',' + i_6_ + ',' + i_7_ + ','
						+ (graphics != null ? "{...}" : "null") + ',' + i_8_ + ',' + i_9_ + ')'));
			}
			break;
		} while (false);
	}
	...
	final void method2069(byte i, Canvas canvas) {
		do {
			try {
				...
				((Class246_Sub19) this).anIntArray4704 = new int[(((Class246_Sub19) this).anInt4706
						* ((Class246_Sub19) this).anInt4705)];
	...
	public final synchronized void addConsumer(ImageConsumer imageconsumer) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("re.addConsumer(" + (imageconsumer != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public final void requestTopDownLeftRightResend(ImageConsumer imageconsumer) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("re.requestTopDownLeftRightResend(" + (imageconsumer != null ? "{...}" : "null") + ')'));
		}
	}

	static {
		new MultilingualString("Unable to delete name - system busy.",
