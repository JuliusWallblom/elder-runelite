...
final class Class246_Sub28_Sub19 extends TextureOperation {
	...
	static final boolean method2691(byte i, int i_0_, int i_1_, int i_2_) {
		try {
			...
			boolean bool = true;
			if (class_f != null)
				bool &= SequenceLoader.method2760(27298, class_f);
			class_f = ((Class_f) Class17.method168(i_1_, i_2_, i_0_, (aClass6550 != null ? aClass6550 : (aClass6550 = Client.getClassByName("Class_f")))));
			if (class_f != null)
				bool &= SequenceLoader.method2760(27298, class_f);
	...
	final int[] method2135(int i, int i_3_) {
		try {
			anInt6535++;
			int[] is = ((TextureOperation) this).aClass66_4938.method435((byte) -112, i_3_);
			int i_4_ = -59 % ((67 - i) / 50);
			if (((Class66) ((TextureOperation) this).aClass66_4938).aBool887) {
				int i_5_ = Varc.anIntArray6245[i_3_] - 2048;
								...
								while_120_: do {
									do {
										if ((i_13_ ^ 0xffffffff) != -1) {
											...
											anInt6538 = stream.readUnsignedShort();
											break while_124_;
										}
										anInt6537 = stream.readUnsignedShort();
										break while_124_;
									} while (false);
									anInt6540 = stream.readUnsignedShort();
									break while_124_;
								} while (false);
								anInt6539 = stream.readUnsignedShort();
								break while_124_;
							} while (false);
							anInt6542 = stream.readUnsignedShort();
							break while_124_;
						} while (false);
						anInt6534 = stream.readUnsignedShort();
						break while_124_;
					} while (false);
					anInt6543 = stream.readUnsignedShort();
				} while (false);
				anInt6536++;
			}
		} catch (RuntimeException runtimeexception) {
	...
	private final boolean method2693(int i, int i_14_, int i_15_) {
		try {
			...
			int i_17_ = (StructType.anIntArray6855[(i_16_ * 255 & 0xfff2a) >> 12]);
	...
	private final boolean method2694(int i, int i_18_, byte i_19_) {
		try {
			...
			int i_21_ = StructType.anIntArray6855[255 * i_20_ >> 12 & 0xff];
