...
public final class Class246_Sub11 extends Node {
	...
	static Widget aClass235_4106;
	static MultilingualString aClass67_4107 = new MultilingualString("Attack", "Angreifen", "Attaquer", "Atacar");
	...
	final void method1870(int[] is, int i, int i_5_) {
		do {
			try {
				anInt4086++;
				int i_6_ = 0;
				Buffer stream = Class215.aStream3001;
				if (i_5_ > -20)
				...
				if ((i_6_ ^ 0xffffffff) >= -1)
					break;
				aClass194_Sub1_4108.method2(((Buffer) stream).buffer, true, 5123, ((Buffer) stream).position);
				aClass260_Sub2_4098.method1934(aClass160_4094, 121, ((Class210_Sub2) aClass210_Sub2_4088).f_gb,
						((Class210_Sub2) aClass210_Sub2_4088).aClass160_5024,
						((Class210_Sub2) aClass210_Sub2_4088).f_ab);
				aClass260_Sub2_4098.method1926(((0x7 & ((Class210_Sub2) aClass210_Sub2_4088).anInt5020) != 0),
						(byte) 12, ((Class246_Sub11) this).anInt4103,
						((0x8 & ((Class210_Sub2) aClass210_Sub2_4088).anInt5020) != 0));
				if (((Class260_Sub2) aClass260_Sub2_4098).aBool4325)
					aClass260_Sub2_4098.GA(2147483647, ((Class246_Sub11) this).anInt4090,
							((Class246_Sub11) this).anInt4089, ((Class246_Sub11) this).anInt4097);
				OpenGL.glMatrixMode(5890);
				OpenGL.glPushMatrix();
				OpenGL.glScalef(1.0F / ((Class246_Sub11) this).aFloat4102, 1.0F / ((Class246_Sub11) this).aFloat4102,
						1.0F);
				OpenGL.glMatrixMode(5888);
				aClass260_Sub2_4098.method1934(aClass160_4094, 123, ((Class210_Sub2) aClass210_Sub2_4088).f_gb,
						((Class210_Sub2) aClass210_Sub2_4088).aClass160_5024,
						((Class210_Sub2) aClass210_Sub2_4088).f_ab);
	...
	final void method1872(int i, int i_19_, int i_20_, boolean bool) {
		try {
			anIntArray4100[(((Class210) aClass210_Sub2_4088).anInt2956 * i - -i_20_)] = Class236.method1523(
					(anIntArray4100[(((Class210) aClass210_Sub2_4088).anInt2956) * i - -i_20_]), 1 << i_19_);
			if (bool != false)
	...
	final void method1873(int i, int i_21_, byte i_22_, int i_23_, float f) {
		try {
			...
			if ((((Class246_Sub11) this).anInt4103 ^ 0xffffffff) != 0) {
				Material class238 = ((SceneGraph) aClass260_Sub2_4098).anInterface6_3714.get_material(-31305,
						((Class246_Sub11) this).anInt4103);
				int i_24_ = 0xff & ((Material) class238).aByte3344;
				if (i_24_ != 0 && (((Material) class238).aByte3343 ^ 0xffffffff) != -5) {
					int i_25_;
					if ((i ^ 0xffffffff) <= -1) {
						if ((i ^ 0xffffffff) >= -128)
							i_25_ = i * 131586;
					...
					if (i_24_ == 256)
						...
						int i_26_ = i_24_;
						int i_27_ = -i_24_ + 256;
						i_23_ = ((((i_27_ * (i_23_ & 0xff00ff) + (i_25_ & 0xff00ff) * i_26_) & ~0xff00ff)
								- -(0xff0000 & (i_27_ * (0xff00 & i_23_) + i_26_ * (0xff00 & i_25_)))) >> 8);
					}
				}
				int i_28_ = 0xff & ((Material) class238).brightness;
				if (i_28_ != 0) {
					i_28_ += 256;
	...
	Class246_Sub11(Class210_Sub2 class210_sub2, int i, int i_36_, int i_37_, int i_38_, int i_39_) {
		try {
			...
			anIntArray4100 = new int[(((Class210) aClass210_Sub2_4088).anInt2956
					* ((Class210) aClass210_Sub2_4088).anInt2952)];
			aClass194_Sub1_4108 = new Class194_Sub1(aClass260_Sub2_4098, 5123, null, 1);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, ("dw.<init>(" + (class210_sub2 != null ? "{...}" : "null") + ','
					+ i + ',' + i_36_ + ',' + i_37_ + ',' + i_38_ + ',' + i_39_ + ')'));
		}
	}
}
