...
final class Class210_Sub2 extends Class210 {
	...
	public static void method2152(boolean bool) {
		try {
			if (bool == false) {
				...
				aClass248_5018 = null;
				Cache.reset_index(Revision.PRE_EOC_634, "sprites");
				Cache.reset_index(Revision.PRE_EOC_550, "sprites");
				Cache.reset_index(Revision.OSRS, "sprites");
				Cache.reset_index(Revision.CUSTOM_PRE_EOC_550, "sprites");
				aClass211_5015 = null;
			}
	...
	final void drawShadedTriangle(int i, int i_0_) {
		try {
			anInt5003++;
		} catch (RuntimeException runtimeexception) {
		...
		do {
			try {
				...
				if (f_fb > 0) {
					...
					if (((Buffer) Class215.aStream3001).buffer.length < 2 * anInt4992)
						Class215.aStream3001 = new Buffer(anInt4992 * 2);
					else
						((Buffer) Class215.aStream3001).position = 0;
					int i_17_ = 0;
					...
					if ((i_17_ ^ 0xffffffff) >= -1)
						break;
					Class194_Sub1 class194_sub1 = (new Class194_Sub1(((Class210_Sub2) this).aClass260_Sub2_5004, 5123, ((Buffer) Class215.aStream3001).buffer, ((Buffer) Class215.aStream3001).position));
	...
	final void method1379(Class246_Sub41 class246_sub41, int[] is) {
		try {
			aClass166_5006.push_head(new Class246_Sub17(((Class210_Sub2) this).aClass260_Sub2_5004, this, class246_sub41, is));
			anInt4998++;
		} catch (RuntimeException runtimeexception) {
	...
	final void B(int i, int i_80_, int[] is, int[] is_81_, int[] is_82_, int[] is_83_, int[] is_84_, int[] is_85_, int[] is_86_, int[] is_87_, int i_88_, int i_89_, int i_90_, boolean bool) {
		try {
			...
			for (int i_91_ = 0; is_84_.length > i_91_; i_91_++) {
				...
				Node class246;
				for (class246 = f_eb.get(l); class246 != null; class246 = f_eb.method541(-1)) {
	...
	Class210_Sub2(Class260_Sub2 class260_sub2, int i, int i_92_, int i_93_, int i_94_, int[][] is, int[][] is_95_, int i_96_) {
		...
		do {
			try {
				...
				f_eb = new IterableNodeHashTable(128);
	...
	final void ca() {
		try {
			...
			if (f_fb <= 0)
				...
				int i_109_ = IterableNodeHashTable.method540(f_fb / 4, false);
				if (i_109_ < 1)
					i_109_ = 1;
				IterableNodeHashTable class85 = new IterableNodeHashTable(i_109_);
		...
		do {
			try {
				if (f_ib != null) {
					...
					if ((((Buffer) Class215.aStream3001).buffer.length ^ 0xffffffff) > (2 * anInt4992 ^ 0xffffffff))
						Class215.aStream3001 = new Buffer(2 * anInt4992);
					int i_204_ = -i_201_ + i;
					int i_205_ = i_204_;
					if (i_204_ < 0)
						i_204_ = 0;
