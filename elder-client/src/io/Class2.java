...
final class Class2 {
	...
	int anInt8;
	private int anInt9;
	private static AbstractSprite aClass_l10;
	private int anInt11;
	private int anInt12;
	private static AbstractModel aClass_t13;
	private static int[] anIntArray14 = new int[4];
	private int anInt15;
	private int anInt16;
	private int anInt17;
	private static AbstractSprite aClass_l18;
	private int anInt19;
	private int anInt20;
	private int anInt21;
	private AbstractSprite aClass_l22;

	private static final void method38(SceneGraph class260) {
		if (aClass_t13 == null) {
			Model class103 = new Model(580, 1104, 1);
			class103.method649((byte) 0, (short) 1024, (byte) 0, (short) 0, 25543, (short) 1024, (short) 1024, (byte) 0,
					(short) 0, (short) 32767);
			class103.method647(0, 128, 0, 0);
			class103.method647(0, -128, 0, 0);
			for (int i = 0; i <= 24; i++) {
				int i_0_ = i * 8192 / 24;
				int i_1_ = MathUtils.SINE[i_0_];
				int i_2_ = MathUtils.COSINE[i_0_];
				for (int i_3_ = 1; i_3_ < 24; i_3_++) {
					int i_4_ = i_3_ * 8192 / 24;
					int i_5_ = MathUtils.COSINE[i_4_] >> 8;
					int i_6_ = MathUtils.SINE[i_4_] * i_1_ >> 23;
					int i_7_ = MathUtils.SINE[i_4_] * i_2_ >> 23;
				...
				if (i > 0) {
					...
					for (int i_10_ = 1; i_10_ < 23; i_10_++) {
						int i_11_ = i_9_ + 1;
						int i_12_ = i_8_ + 1;
						class103.method654(i_8_, (short) 0, (byte) 0, i_9_, -126, i_11_, (short) 127, (byte) 0,
								(byte) 0);
						class103.method654(i_8_, (short) 0, (byte) 0, i_11_, -119, i_12_, (short) 127, (byte) 0,
								(byte) 0);
						i_9_ = i_11_;
						i_8_ = i_12_;
					}
			...
			((Model) class103).anInt1573 = ((Model) class103).vertices;
			((Model) class103).faceSkins = null;
			((Model) class103).vertexSkins = null;
			((Model) class103).faceRenderPriorities = null;
			aClass_t13 = class260.method1695(class103, 51200, 33, 64, 768);
		}
	}

	private final void method39(SceneGraph class260, Class2 class2_13_) {
		Model class103 = Model.get_model(0, Class246_Sub28_Sub12.aClass_fs6195, anInt5);
		if (class103 != null) {
			...
			if (anInt6 != 0) {
				...
				int i_17_ = MathUtils.SINE[i_16_];
				int i_18_ = MathUtils.COSINE[i_16_];
			...
			if (anInt16 != 0) {
				...
				int i_21_ = MathUtils.SINE[i_20_];
				int i_22_ = MathUtils.COSINE[i_20_];
			...
			AbstractModel class_t = class260.method1695(class103, 2048, 0, 64, 768);
	...
	private final boolean method41(SceneGraph class260, Class2 class2_29_) {
		if (aClass_l22 == null) {
			if (anInt11 == 0) {
				if (Class246_Sub28_Sub33.anInterface6_6967.method13(anInt5, 19378)) {
					int[] is = (Class246_Sub28_Sub33.anInterface6_6967.method16(false, anInt5, false, 0.7F, anInt15,
							anInt15));
	...
	final boolean method42(int i, int i_30_, int i_31_, int i_32_) {
		...
		if (i_37_ > i_32_)
			i_37_ = IterableNodeHashTable.method540(i_32_, false);
		if (i_37_ > 512)
			i_37_ = 512;
		if (i_37_ != anInt15)
			anInt15 = i_37_;
	...
	private static final void method43(SceneGraph class260) {
		if (aClass_l10 == null) {
			...
			for (int i = 0; i < 64; i++) {
				...
				for (int i_43_ = 0; i_43_ < 64; i_43_++) {
					...
					if (i_46_ < 0)
						...
						i_46_ = 255;
					int i_47_ = i_46_ / 2;
					is_38_[i_41_ + i_43_] = is_38_[i_41_
							+ i_45_] = is_38_[i_42_ + i_43_] = is_38_[i_42_ + i_45_] = ~0xffffff | i_46_ << 16;
					is[i_41_ + i_43_] = is[i_41_
							+ i_45_] = is[i_42_ + i_43_] = is[i_42_ + i_45_] = 127 - i_47_ << 24 | 0xffffff;
				}
			}
	...
	private final void method45(SceneGraph class260, Class2 class2_48_) {
		method38(class260);
		method43(class260);
		class260.da(anIntArray14);
		class260.OA(0, 0, anInt15, anInt15);
		...
		if (anInt6 != 0) {
			int i_51_ = MathUtils.SINE[anInt6];
			int i_52_ = MathUtils.COSINE[anInt6];
			int i_53_ = i_49_ * i_52_ - i_50_ * i_51_ >> 15;
			i_50_ = i_49_ * i_51_ + i_50_ * i_52_ >> 15;
			i_49_ = i_53_;
		}
		if (anInt16 != 0) {
			int i_54_ = MathUtils.SINE[anInt16];
			int i_55_ = MathUtils.COSINE[anInt16];
			int i_56_ = i_50_ * i_54_ + i * i_55_ >> 15;
			i_50_ = i_50_ * i_55_ - i * i_54_ >> 15;
			i = i_56_;
		}
		AbstractModel class_t = aClass_t13.method678((byte) 0, 51200, true);
		if (!class260.method1692()) {
			class_t.BA((short) 127,
					((Material) Class246_Sub28_Sub33.anInterface6_6967.get_material(-31305, anInt5)).aShort3354);
	...
	final void method47(SceneGraph class260, int i, int i_60_, int i_61_, int i_62_, int i_63_, int i_64_) {
		if (aClass_l22 != null) {
	...
	final boolean method48(SceneGraph class260, Class2 class2_69_) {
