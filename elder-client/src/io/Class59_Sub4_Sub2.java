...
final class Class59_Sub4_Sub2 extends Class59_Sub4 implements Class_f {
		...
		do {
			try {
				...
				if (class246_sub1_sub4 == null)
					break;
				Class29.method230(class246_sub1_sub4, aByte6852, ((Class59_Sub4) this).anInt5184,
						((Class59_Sub4) this).anInt5186, null);
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception,
						("rj.U(" + (class260 != null ? "{...}" : "null") + ',' + i + ')'));
			}
			break;
		} while (false);
	}

	private final Class133 method2821(int i, int i_0_, SceneGraph class260, boolean bool) {
		try {
			anInt6836++;
			LocType class185 = Class143.aClass251_2067.list(0xffff & aShort6842, 0);
			if (i > -103)
				aShort6842 = (short) -58;
			Class210 class210;
			...
			return class185.method1210(class260, ((Class59_Sub4) this).anInt5184, 3, i_0_,
					((Class59_Sub4) this).anInt5188, bool, aByte6822, class210, ((Class59_Sub4) this).anInt5186,
					aByte6825, class210_1_);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("rj.C(" + i + ',' + i_0_ + ',' + (class260 != null ? "{...}" : "null") + ',' + bool + ')'));
		}
	}
	...
	final void method403(SceneGraph class260, int i) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					"rj.B(" + (class260 != null ? "{...}" : "null") + ',' + i + ')');
		}
	}

	public final AbstractModel method23(SceneGraph class260, int i, int i_7_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("rj.D(" + (class260 != null ? "{...}" : "null") + ',' + i + ',' + i_7_ + ')'));
		}
	}
	...
	final void method405(int i, int i_10_, Class59 class59, byte i_11_, boolean bool, SceneGraph class260, int i_12_) {
		try {
			do {
				if (class59 instanceof Class59_Sub4_Sub2) {
					Class59_Sub4_Sub2 class59_sub4_sub2_13_ = (Class59_Sub4_Sub2) class59;
					if (((Class59_Sub4_Sub2) this).aClass_t6834 == null
							|| (((Class59_Sub4_Sub2) class59_sub4_sub2_13_).aClass_t6834) == null)
						break;
					((Class59_Sub4_Sub2) this).aClass_t6834.method682(
							(((Class59_Sub4_Sub2) class59_sub4_sub2_13_).aClass_t6834), i_10_, i_12_, i, bool);
					if (!Client.f_ob)
						break;
				}
				if (class59 instanceof Class59_Sub3_Sub4) {
					...
					if (((Class59_Sub4_Sub2) this).aClass_t6834 != null
							&& (((Class59_Sub3_Sub4) class59_sub3_sub4).aClass_t6973) != null)
						((Class59_Sub4_Sub2) this).aClass_t6834.method682(
								(((Class59_Sub3_Sub4) class59_sub3_sub4).aClass_t6973), i_10_, i_12_, i, bool);
				}
			} while (false);
			if (i_11_ != -99)
			...
			throw Class193.method1272(runtimeexception,
					("rj.L(" + i + ',' + i_10_ + ',' + (class59 != null ? "{...}" : "null") + ',' + i_11_ + ',' + bool
							+ ',' + (class260 != null ? "{...}" : "null") + ',' + i_12_ + ')'));
		}
	}

	Class59_Sub4_Sub2(SceneGraph class260, LocType class185, int i, int i_14_, int i_15_, int i_16_, boolean bool,
			int i_17_, int i_18_, boolean bool_19_) {
		super(i_14_, i_15_, i_16_, Class246_Sub1_Sub15.method2717(i_17_, i_18_, 31654));
		do {
			try {
				aShort6842 = (short) ((LocType) class185).id;
				((Class59_Sub4) this).anInt5184 = i_14_;
				aBool6850 = ((LocType) class185).wall_or_door != 0 && !bool;
				aByte6852 = (byte) i;
				aBool6821 = bool_19_;
				...
				aBool6838 = (class260.method1683() && ((LocType) class185).aBool2583 && !aBool6826
						&& Client.current_renderer.method271(Buffer.anInt5656, (byte) -28) != 0);
				int i_20_ = 2048;
				if (aBool6821)
					i_20_ |= 0x10000;
				...
				if (!aBool6821)
					break;
				((Class59_Sub4_Sub2) this).aClass_t6834 = ((Class59_Sub4_Sub2) this).aClass_t6834.method678((byte) 0,
						i_20_, false);
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception,
						("rj.<init>(" + (class260 != null ? "{...}" : "null") + ','
								+ (class185 != null ? "{...}" : "null") + ',' + i + ',' + i_14_ + ',' + i_15_ + ','
								+ i_16_ + ',' + bool + ',' + i_17_ + ',' + i_18_ + ',' + bool_19_ + ')'));
			}
			break;
		} while (false);
	}
	...
	static final boolean method2824(int i, int i_21_, int i_22_) {
		try {
			...
			anInt6840++;
			if (!((i_22_ & 0x70000 ^ 0xffffffff) != -1 | Class46.method310((byte) 101, i_22_, i))
					&& !Tile.method996(i, -1, i_22_))
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
	...
	private final AbstractModel method2825(byte i, int i_24_, SceneGraph class260) {
		try {
			anInt6847++;
			if (((Class59_Sub4_Sub2) this).aClass_t6834 != null
					&& (class260.method1710(((Class59_Sub4_Sub2) this).aClass_t6834.P(), i_24_) ^ 0xffffffff) == -1)
			...
			throw Class193.method1272(runtimeexception,
					("rj.AA(" + i + ',' + i_24_ + ',' + (class260 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	final boolean method409(int i, int i_26_, SceneGraph class260, int i_27_) {
		try {
			if (i_26_ != 0)
				aBool6844 = true;
			anInt6835++;
			AbstractModel class_t = method2825((byte) 32, 131072, class260);
			if (class_t != null) {
				Class_c class_c = class260.method1730();
				class_c.j(((Class59_Sub4) this).anInt5184, ((Class59_Sub4) this).anInt5188,
						((Class59_Sub4) this).anInt5186);
			...
			throw Class193.method1272(runtimeexception,
					("rj.A(" + i + ',' + i_26_ + ',' + (class260 != null ? "{...}" : "null") + ',' + i_27_ + ')'));
		}
	}
	...
	public final void method20(boolean bool, SceneGraph class260) {
		do {
			try {
				...
				if (class246_sub1_sub4 != null)
					Class246_Sub12.method1980(class246_sub1_sub4, aByte6852, ((Class59_Sub4) this).anInt5184,
							((Class59_Sub4) this).anInt5186, null);
				if (bool == true)
					break;
	...
	static final void method2826(int i, int i_28_, int i_29_) {
		try {
			anInt6829++;
			int i_30_ = (CacheIndex.aClass73_148.method459(-1, Class219.aClass67_3039.get(Preferences.language_code)));
			for (Class246_Sub35 class246_sub35 = ((Class246_Sub35) Varbit.aClass166_1525
					.method1104(119)); class246_sub35 != null; class246_sub35 = ((Class246_Sub35) Varbit.aClass166_1525
							.method1108((byte) -112))) {
			...
			if (Client.client_width < i_30_ + i_33_)
				i_33_ = -i_30_ + Client.client_width;
			if ((i_33_ ^ 0xffffffff) > -1)
				i_33_ = 0;
			int i_34_ = i_28_;
			if ((Client.client_height ^ 0xffffffff) > (i_34_ + i_32_ ^ 0xffffffff))
				i_34_ = Client.client_height + -i_32_;
			SwitchInt.anInt5082 = i_33_;
			if (i_34_ < 0)
				i_34_ = 0;
			if (i >= -53)
				method2824(49, -22, -7);
			ContextMenus.context_menu_open = true;
			VarpType.anInt1226 = i_34_;
			Class94.anInt1233 = i_30_;
			Class246_Sub13.context_menu_height = (Settings.osrs_context_menus ? 22 : 26) + Class230.anInt3147 * 16;
		} catch (RuntimeException runtimeexception) {
