...
final class Class126 {
		...
		do {
			try {
				do {
					...
					Class38_Sub1.anInt5116 = Buffer.anInt5656;
	...
	static final void method865(byte i) {
		try {
			...
			Class246_Sub30 class246_sub30 = (Class246_Sub30) Widget.f_qb.method1104(95);
			boolean bool = (Class150.aClass235_2196 != null || (Class59_Sub3_Sub2.f_db ^ 0xffffffff) < -1);
			if (bool)
				Model.anInt1365 = 1;
			if (!Node.shift_click_use || !Class216.aClass232_3009.method1488(-82, 81) || Class230.anInt3147 <= 2) {
				if (bool)
					Widget.f_tc = ((Class246_Sub35) ((Node) (((Class166) Varbit.aClass166_1525).aClass246_2343)).prev);
				else
					Class134.method909(class246_sub30.method2161((byte) -87), ((Class246_Sub35) ((Node) (((Class166) Varbit.aClass166_1525).aClass246_2343)).prev), class246_sub30.method2160(109), true);
			} else if (!bool)
				Class134.method909(class246_sub30.method2161((byte) -86), ((Class246_Sub35) (((Node) ((Node) (((Class166) Varbit.aClass166_1525).aClass246_2343)).prev).prev)), class246_sub30.method2160(78), true);
			else
				Widget.f_tc = ((Class246_Sub35) (((Node) ((Node) (((Class166) Varbit.aClass166_1525).aClass246_2343)).prev).prev));
		} catch (RuntimeException runtimeexception) {
