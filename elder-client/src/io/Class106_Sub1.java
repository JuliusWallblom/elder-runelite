...
final class Class106_Sub1 extends Class106 {
		...
		do {
			try {
				...
				if (NodeSub.aClass260_3741 == null)
					break;
				NodeSub.aClass260_3741.method1708(true);
				NodeSub.aClass260_3741 = null;
	...
	final void method726(int i, boolean bool, Class210 class210, float f, byte i_3_) {
		try {
			...
			throw Class193.method1272(runtimeexception, ("fc.E(" + i + ',' + bool + ','
					+ (class210 != null ? "{...}" : "null") + ',' + f + ',' + i_3_ + ')'));
		}
	}
	...
	static final void method1892(int i, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, boolean bool) {
		try {
			do {
				if ((ObjType.anInt2818 ^ 0xffffffff) < (-i_4_ + i ^ 0xffffffff) || Class110.anInt1573 < i_4_ + i
						|| AbstractModel.anInt1442 > -i_4_ + i_6_
						|| ((Class109_Sub4.anInt4570 ^ 0xffffffff) > (i_4_ + i_6_ ^ 0xffffffff))) {
			...
			throw Class193.method1272(runtimeexception,
					("fc.C(" + i + ',' + i_4_ + ',' + i_5_ + ',' + i_6_ + ',' + i_7_ + ',' + i_8_ + ',' + bool + ')'));
		}
	}
	...
	static final void method1893(int i) {
		try {
			...
			anInt4164++;
			Varbit.aClass166_1525.method1102(-55);
			if (i >= -87)
				method1893(15);
	...
	final void method1895(Class100_Sub1 class100_sub1, int i) {
		do {
			try {
						...
						if ((((Class100_Sub1) class100_sub1).anInt5079 ^ 0xffffffff) <= -1) {
							if ((i_18_ ^ 0xffffffff) != -22) {
								if ((i_18_ ^ 0xffffffff) == -21) {
									Tile class147 = ((Tile) (((Class100) class100_sub1).anObject1307));
									if ((((Tile) class147).aClass59_Sub4_2172) != null)
										((Tile) class147).aClass59_Sub4_2172.method403(Class259_Sub3.aClass260_5357,
												68);
									if ((((Tile) class147).aClass59_Sub4_2152) != null)
										((Tile) class147).aClass59_Sub4_2152.method403(Class259_Sub3.aClass260_5357,
												80);
									if ((((Tile) class147).aClass59_Sub2_2153) != null)
										((Tile) class147).aClass59_Sub2_2153.method403(Class259_Sub3.aClass260_5357,
												98);
									if ((((Tile) class147).aClass59_Sub2_2159) != null)
										((Tile) class147).aClass59_Sub2_2159.method403(Class259_Sub3.aClass260_5357,
												115);
									if ((((Tile) class147).floorDecorationIThink) != null)
										((Tile) class147).floorDecorationIThink.method403(Class259_Sub3.aClass260_5357,
												i - 25069);
									...
									if (i_18_ < 40 || i_18_ > 43) {
										if ((i_18_ ^ 0xffffffff) == -23)
											...
											if ((i_18_ ^ 0xffffffff) <= -11 && ((i_18_ ^ 0xffffffff) >= -14)) {
												Class259_Sub3.aClass260_5357
														.method1744(((Class100_Sub1) class100_sub1).anInt5079);
										...
										((Class210) (((Class100) class100_sub1).anObject1307)).method1384(
												Class244.anInt3454, Class59_Sub2_Sub2.anInt6025, Class125.anInt1777,
												Class251.aBoolArrayArray3556, i_18_ - 40 == 0);
									}
								} else {
									Class259_Sub3.aClass260_5357.g(3000.0F, f * 1.5F);
									((Class210) ((Class100) class100_sub1).anObject1307).method1384(Class244.anInt3454,
											Class59_Sub2_Sub2.anInt6025, Class125.anInt1777,
											Class187_Sub1.aBoolArrayArray4866, -30 + i_18_ == 0);
								}
							} else
								Class303.method1073(class100_sub1,
										((Tile) (((Class100) class100_sub1).anObject1307)));
				...
				throw Class193.method1272(runtimeexception,
						("fc.N(" + (class100_sub1 != null ? "{...}" : "null") + ',' + i + ')'));
			}
			break;
		} while (false);
	}
