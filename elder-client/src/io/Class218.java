...
public final class Class218 {
	...
	static final void method1413(boolean bool, int i) {
		do {
			try {
				...
				if (!bool)
					break;
				for (Class246_Sub5 class246_sub5 = ((Class246_Sub5) VarcLoader.aClass166_992.method1104(i ^ ~0x7a88)); class246_sub5 != null; class246_sub5 = ((Class246_Sub5) VarcLoader.aClass166_992.method1108((byte) -112))) {
					if ((((Class246_Sub5) class246_sub5).aClass246_Sub37_Sub3_3893) != null) {
						Canvas_Sub1.aClass246_Sub37_Sub2_6889.method2627(((Class246_Sub5) class246_sub5).aClass246_Sub37_Sub3_3893);
						((Class246_Sub5) class246_sub5).aClass246_Sub37_Sub3_3893 = null;
					}
	...
	static final Class109_Sub1_Sub1 method1414(Class260_Sub2 class260_sub2, int i, int[] is, boolean bool, int i_0_, int i_1_) {
		try {
			...
			anInt3028++;
			if (!((Class260_Sub2) class260_sub2).aBool4385 && (!WidgetParent.method2313(200, i_0_) || !WidgetParent.method2313(i_1_ + 201, i))) {
	...
	public static void method1418(int i) {
		try {
			LocType.field3386 = null;
			Cache.client_cache.set(IndexConstants.PRE_EOC_634_CONFIG_SEQ_INDEX, null);
			Cache.client_cache.set(IndexConstants.PRE_EOC_550_CONFIG_SEQ_INDEX, null);
			if (i != 1)
				aString3026 = null;
			aString3026 = null;
			anIntArray3025 = null;
