...
final class Class47 {
	private TextureInterface anInterface6_677;
	static int anInt678;
	static int anInt679;
	...
	public static void method314(boolean bool) {
		do {
			try {
				...
				if (bool == true)
					break;
				draw_map_lines(6, -98, -124, -108, null, -45, 29, -114, 0);
	...
	static final void method317(boolean bool) {
		if (bool) {
			Class106.tiles = Class1.aClass147ArrayArrayArray4;
			Class59_Sub3_Sub4.aClass210Array6993 = Class154.aClass210Array2215;
		} else {
			Class106.tiles = Class115.aClass147ArrayArrayArray1605;
			Class59_Sub3_Sub4.aClass210Array6993 = Class246_Sub28_Sub3.aClass210Array5899;
		}
		Class154_Sub1.anInt4803 = Class106.tiles.length;
	}

	static final void draw_map_lines(int i, int i_4_, int i_5_, int i_6_, SceneGraph class260, int i_7_, int i_8_,
			int i_9_, int i_10_) {
		do {
			try {
				anInt681++;
				...
				if (class_f != null) {
					...
					if (((LocType) class185).map_scene == -1) {
						int i_13_ = i_4_;
						if ((((LocType) class185).wall_or_door ^ 0xffffffff) < -1)
							i_13_ = i_10_;
						...
						IdentityKitType.draw_map_scenes(class260, i_11_, i_9_ ^ 0x45e3, class185, i_6_, i_8_);
					}
				}
				class_f = ((Class_f) Class17.method168(i, i_7_, i_5_,
						(aClass688 != null ? aClass688 : (aClass688 = Client.getClassByName("Class_f")))));
				if (class_f != null) {
					LocType class185 = Class143.aClass251_2067.list(class_f.method21(true), 0);
					...
					if ((((LocType) class185).map_scene ^ 0xffffffff) == 0) {
						if (i_15_ == 9) {
							int i_16_ = -1118482;
							if (((LocType) class185).wall_or_door > 0) {
								i_16_ = -1179648;
							}
							if (i_14_ != 0 && i_14_ != 2) {
						...
						IdentityKitType.draw_map_scenes(class260, i_14_, 116, class185, i_6_, i_8_);
					}
				}
				class_f = (Class_f) Class246_Sub14.method1997(i, i_7_, i_5_);
				if (class_f != null) {
					LocType class185 = (Class143.aClass251_2067.list(class_f.method21(true), i_9_ ^ 0x458d));
					int i_17_ = 0x3 & class_f.method18((byte) -70);
					if (((LocType) class185).map_scene != -1) {
						IdentityKitType.draw_map_scenes(class260, i_17_, 120, class185, i_6_, i_8_);
					}
				}
				if (i_9_ == 17805)
					break;
				draw_map_lines(-52, -91, 95, 17, null, -122, -81, 60, 20);
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception,
						("ee.A(" + i + ',' + i_4_ + ',' + i_5_ + ',' + i_6_ + ','
								+ (class260 != null ? "{...}" : "null") + ',' + i_7_ + ',' + i_8_ + ',' + i_9_ + ','
								+ i_10_ + ')'));
			}
			break;
		} while (false);
	...
	final Class109_Sub1 method319(int i, int i_18_) {
		try {
			...
			if (!anInterface6_677.method13(i, 19378))
				return null;
			Material class238 = anInterface6_677.get_material(-31305, i);
			int i_19_ = (((Material) class238).aBool3335 ? 64 : ((Class260_Sub2) aClass260_Sub2_680).f_ce);
			Class109_Sub1 class109_sub1;
			if (((Material) class238).aBool3337 && aClass260_Sub2_680.method1742()) {
				float[] fs = anInterface6_677.method15(0.7F, i, i_19_, false, i_19_, 15752);
				class109_sub1 = new Class109_Sub1(aClass260_Sub2_680, 3553, 34842, i_19_, i_19_,
						((Material) class238).aByte3349 != 0, fs, 6408);
			} else {
				int[] is;
				int i_20_;
				if (((Material) class238).aBool3340 && ParamType.method809(((Material) class238).aByte3343, -6)) {
				...
				class109_sub1 = new Class109_Sub1(aClass260_Sub2_680, 3553, i_20_, i_19_, i_19_,
						(((Material) class238).aByte3349 ^ 0xffffffff) != -1, is, false);
			}
			class109_sub1.method1767(10497, ((Material) class238).aBool3352, ((Material) class238).aBool3353);
	...
	Class47(Class260_Sub2 class260_sub2, TextureInterface interface6) {
		try {
			anInterface6_677 = interface6;
			aClass260_Sub2_680 = class260_sub2;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, ("ee.<init>(" + (class260_sub2 != null ? "{...}" : "null") + ','
					+ (interface6 != null ? "{...}" : "null") + ')'));
		}
	}

	static {
		new MultilingualString("Leave request already in progress - please wait...",
		...
		aClass125Array687 = new Class125[Constants.MAX_INDEX_COUNT];
	}
}
