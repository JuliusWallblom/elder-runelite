...
public final class Class195 {
	...
	int[] anIntArray2735;
	int anInt2736;
	public Class223 aClass223_2737;
	int anInt2738;
	int anInt2739;
	...
	private final void method1275(byte[] is, int i) {
		do {
			try {
				anInt2744++;
				Buffer stream = new Buffer(Class130_Sub8.method2349(is, false));
				...
				((Class195) this).anInt2728 = stream.readUnsignedShort();
				int i_2_ = 0;
				...
				for (int i_4_ = 0; ((((Class195) this).anInt2728 ^ 0xffffffff) < (i_4_ ^ 0xffffffff)); i_4_++) {
					((Class195) this).anIntArray2735[i_4_] = i_2_ += stream.readUnsignedShort();
				...
				for (int i_9_ = 0; i_9_ < ((Class195) this).anInt2728; i_9_++)
					((Class195) this).anIntArray2726[(((Class195) this).anIntArray2735[i_9_])] = stream.readUnsignedShort();
				for (int i_10_ = 0; i_10_ < ((Class195) this).anInt2728; i_10_++) {
					...
					for (int i_14_ = 0; (i_14_ ^ 0xffffffff) > (i_12_ ^ 0xffffffff); i_14_++) {
						int i_15_ = (((Class195) this).anIntArrayArray2733[i_11_][i_14_] = i_2_ += stream.readUnsignedShort());
						if (i_13_ < i_15_)
							i_13_ = i_15_;
					}
