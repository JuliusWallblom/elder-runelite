...
final class Class116_Sub4 extends Font {
	...
	Class116_Sub4(Class260_Sub1 class260_sub1, FontMetric class73, LDSprite[] class10s, int[] is, int[] is_103_) {
		...
		for (int i = 0; i < class10s.length; i++) {
			aByteArrayArray5316[i] = ((LDSprite) class10s[i]).aByteArray157;
			anIntArray5315[i] = ((LDSprite) class10s[i]).anInt162;
			anIntArray5319[i] = ((LDSprite) class10s[i]).anInt158;
		}
	}
}
