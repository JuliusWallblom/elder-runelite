...
final class Class211_Sub1_Sub1 extends Class211_Sub1 {
	...
	final boolean method2610(Class109_Sub4 class109_sub4, float f, Class109_Sub4 class109_sub4_0_, int i) {
		try {
			...
			if ((((Class109_Sub4) class109_sub4_0_).anInt4571 != ((Class109_Sub1) (((Class260_Sub2) aClass260_Sub2_6230).aClass109_Sub1_4338)).anInt3760)
					|| (((Class109_Sub1) (((Class260_Sub2) aClass260_Sub2_6230).aClass109_Sub1_4338)).anInt3752 != ((Class109_Sub4) class109_sub4_0_).anInt4571))
				((Class260_Sub2) aClass260_Sub2_6230).aClass109_Sub1_4338 = new Class109_Sub1(aClass260_Sub2_6230, 3553,
						6408, (((Class109_Sub4) class109_sub4_0_).anInt4571),
						(((Class109_Sub4) class109_sub4_0_).anInt4571));
			if ((((Class109_Sub1) ((Class260_Sub2) aClass260_Sub2_6230).f_pf).anInt3760) != ((Class109_Sub4) class109_sub4).anInt4571
					|| (((Class109_Sub1) ((Class260_Sub2) aClass260_Sub2_6230).f_pf).anInt3752 != ((Class109_Sub4) class109_sub4).anInt4571))
				((Class260_Sub2) aClass260_Sub2_6230).f_pf = new Class109_Sub1(aClass260_Sub2_6230, 3553, 6408,
						(((Class109_Sub4) class109_sub4).anInt4571), (((Class109_Sub4) class109_sub4).anInt4571));
			aClass260_Sub2_6230.da(TransformList.anIntArray4883);
			...
			OpenGL.glViewport(0, 0, ((Class109_Sub4) aClass109_Sub4_6233).anInt4571,
					((Class109_Sub4) aClass109_Sub4_6233).anInt4571);
			...
			for (int i_2_ = i; i_2_ < 6; i_2_++) {
				...
				OpenGL.glBlitFramebufferEXT(0, 0, ((Class109_Sub4) class109_sub4_0_).anInt4571,
						((Class109_Sub4) class109_sub4_0_).anInt4571, 0, 0,
						((Class109_Sub4) class109_sub4_0_).anInt4571, ((Class109_Sub4) class109_sub4_0_).anInt4571,
						16384, 9728);
			...
			OpenGL.glPopAttrib();
			aClass260_Sub2_6230.OA(TransformList.anIntArray4883[0], TransformList.anIntArray4883[1],
					TransformList.anIntArray4883[2], TransformList.anIntArray4883[3]);
			if (bool)
				aClass109_Sub4_6233.method761(-109);
			return bool;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, ("ht.C(" + (class109_sub4 != null ? "{...}" : "null") + ',' + f
					+ ',' + (class109_sub4_0_ != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}
	...
	Class211_Sub1_Sub1(Class260_Sub2 class260_sub2, int i) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("ht.<init>(" + (class260_sub2 != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}
	...
	static {
		new MultilingualString("Swap this note at any bank for the equivalent item.",
