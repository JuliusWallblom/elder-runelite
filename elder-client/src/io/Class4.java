...
final class Class4 {
	...
	final void method53(byte i, Buffer stream) {
		try {
			for (;;) {
	...
	final void method55(boolean bool) {
		do {
			try {
				...
				if (bool != true)
					anInt37 = 20;
				((Class4) this).anInt39 = MathUtils.COSINE[anInt37 << 3];
	...
	private final void method57(int i, Buffer stream, boolean bool) {
		try {
			if (bool != true)
			...
			if ((i ^ 0xffffffff) != -2) {
				if (i == 2)
					...
					if ((i ^ 0xffffffff) == -5) {
						((Class4) this).anInt49 = stream.readUnsignedByte();
						...
						((Class4) this).anInt36 = stream.readUnsignedByte();
				} else {
				...
				anInt37 = stream.readUnsignedShort();
			anInt41++;
		} catch (RuntimeException runtimeexception) {
