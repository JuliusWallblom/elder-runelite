...
final class Class220 {
	...
	static MultilingualString aClass67_3059;
	static MultilingualString aClass67_3059_OSRS;
	static MultilingualString aClass67_3059_550;
	static MultilingualString aClass67_3059_2;
	...
	static {
		new MultilingualString("You can't report yourself!", "Du kannst dich nicht selbst melden!", "Vous ne pouvez pas vous signaler vous-m\u00eame !", "Voc\u00ea n\u00e3o pode denunciar a si pr\u00f3prio!");
		anInt3055 = 0;
		...
		anInt3058 = 0;
		aClass67_3059_2 = new MultilingualString("Loaded additional fonts", "Laded Zusatzschriftarten", "Chargement de polices secondaires", "Carregando fontes principais");
		aClass67_3059 = new MultilingualString("Loading additional fonts - ", "Lade Zusatzschriftarten - ", "Chargement de polices secondaires - ", "Carregando fontes principais - ");
		aClass67_3059_OSRS = new MultilingualString("Loading additional OSRS fonts - ", "Lade OSRS Zusatzschriftarten - ", "Chargement de OSRS polices secondaires - ", "Carregando OSRS fontes principais - ");
		aClass67_3059_550 = new MultilingualString("Loading additional 550 fonts - ", "Lade 550 Zusatzschriftarten - ", "Chargement de 550 polices secondaires - ", "Carregando 550 fontes principais - ");
