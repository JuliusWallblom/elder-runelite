...
final class Class_ss extends TextureOperation {
	...
	static MultilingualString aClass67_7057;
	...
	static final void method2883(int i, int i_0_, int i_1_, int i_2_) {
		do {
			try {
				Class45.tileRenderFlags = new byte[i_2_][i_1_][i_0_];
				anInt7059++;
				if (i == 0)
					break;
				method2884((byte) -124);
	...
	final void method2143(int i, int i_3_, Buffer stream) {
		while_241_: do {
			try {
				anInt7053++;
				if (i != 4)
				...
				do {
					...
					anInt7055 = stream.readUnsignedByte();
					return;
				} while (false);
				anInt7051 = stream.readUnsignedByte();
				break;
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception,
						("ss.G(" + i + ',' + i_3_ + ',' + (stream != null ? "{...}" : "null") + ')'));
			}
		} while (false);
	}
	...
	final int[][] method2139(byte i, int i_5_) {
		try {
			if (i <= 33)
				anInt7055 = -106;
			anInt7052++;
			int[][] is = ((TextureOperation) this).aClass136_4933.method922((byte) 13, i_5_);
			if (((Class136) ((TextureOperation) this).aClass136_4933).aBool1946) {
				int i_6_ = Class246_Sub37_Sub1.f_gb / anInt7055;
				int i_7_ = EnumLoader.anInt2044 / anInt7051;
				int[][] is_8_;
				if ((i_7_ ^ 0xffffffff) < -1) {
					int i_9_ = i_5_ % i_7_;
					is_8_ = this.method2141(3, 0, i_9_ * EnumLoader.anInt2044 / i_7_);
				} else
	...
	final int[] method2135(int i, int i_19_) {
		try {
			...
			if (((Class66) ((TextureOperation) this).aClass66_4938).aBool887) {
				...
				int i_22_ = EnumLoader.anInt2044 / anInt7051;
				int[] is_23_;
				if ((i_22_ ^ 0xffffffff) < -1) {
					int i_24_ = i_19_ % i_22_;
					is_23_ = this.method2133(i_24_ * EnumLoader.anInt2044 / i_22_, 0, 0);
				} else
	...
	static {
		aClass67_7057 = new MultilingualString("Started 3d Library", "3D-Softwarebibliothek gestartet.",
				"Librairie 3D d\u00e9marr\u00e9e", "Biblioteca 3D iniciada");
