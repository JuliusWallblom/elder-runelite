...
final class Class246_Sub28_Sub22 extends TextureOperation {
	...
	static final void method2725(int i, int i_0_, int i_1_, int i_2_, int i_3_, boolean bool, boolean bool_4_) {
		...
		NodeSub.anInt3744 = 1 << Class126.anInt1781;
		Class40_Sub7.anInt5174 = NodeSub.anInt3744 >> 1;
		Class59_Sub2_Sub2.anInt6010 = (int) Math.sqrt((double) ((Class40_Sub7.anInt5174 * Class40_Sub7.anInt5174)
				+ (Class40_Sub7.anInt5174 * Class40_Sub7.anInt5174)));
		Class83.anInt1082 = NodeSub.anInt3744 >> 2;
		Class203.anInt2875 = NodeSub.anInt3744;
		Class240.xSize = i_1_;
		HDModel.ySize = i_2_;
		Class125.anInt1777 = i_3_;
		Class115.aClass147ArrayArrayArray1605 = new Tile[i_0_][Class240.xSize][HDModel.ySize];
		Class246_Sub28_Sub3.aClass210Array5899 = new Class210[i_0_];
		if (bool) {
			Class128_Sub2.anIntArrayArray5565 = new int[Class240.xSize][HDModel.ySize];
			Class187.aByteArrayArray2649 = new byte[Class240.xSize][HDModel.ySize];
			Class189.aByteArrayArray2669 = new byte[Class240.xSize][HDModel.ySize];
			Class1.aClass147ArrayArrayArray4 = new Tile[1][Class240.xSize][HDModel.ySize];
		...
		if (bool_4_) {
			MapRegion.aLongArrayArrayArray3648 = new long[i_0_][i_1_][i_2_];
			StructLoader.aClass174Array811 = new Class174[65535];
			MouseHandler.aBoolArray4449 = new boolean[65535];
			Class_c.anInt1195 = 0;
		} else {
			MapRegion.aLongArrayArrayArray3648 = null;
			StructLoader.aClass174Array811 = null;
			MouseHandler.aBoolArray4449 = null;
			Class_c.anInt1195 = 0;
		}
		...
		Class88.anIntArrayArrayArray1150 = new int[i_0_][Class240.xSize + 1][HDModel.ySize + 1];
		Class246_Sub28_Sub36.aClass59_Sub3Array7018 = new Class59_Sub3[5000];
		Class_a.anInt1181 = 0;
		Class187_Sub1.aBoolArrayArray4866 = (new boolean[Class125.anInt1777 + Class125.anInt1777 + 1][Class125.anInt1777
				+ Class125.anInt1777 + 1]);
		Class251.aBoolArrayArray3556 = (new boolean[Class125.anInt1777 + Class125.anInt1777 + 2][Class125.anInt1777
				+ Class125.anInt1777 + 2]);
	...
	final int[] method2135(int i, int i_5_) {
		try {
			anInt6624++;
			int[] is = ((TextureOperation) this).aClass66_4938.method435((byte) -112, i_5_);
			...
			if (((Class66) ((TextureOperation) this).aClass66_4938).aBool887) {
				...
				for (/**/; ((Class246_Sub37_Sub1.f_gb ^ 0xffffffff) < (i_7_ ^ 0xffffffff)); i_7_++) {
					...
					int i_9_ = Varc.anIntArray6245[i_5_];
	...
	final void method2143(int i, int i_14_, Buffer stream) {
		while_97_: do {
			try {
				anInt6628++;
				if (i == 4) {
					...
					while_96_: do {
						do {
							...
							anInt6626 = stream.readUnsignedByte();
							return;
						} while (false);
						anInt6625 = stream.readUnsignedByte();
						return;
					} while (false);
					anInt6630 = stream.readUnsignedShort();
					break;
				}
				break;
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception,
						("mr.G(" + i + ',' + i_14_ + ',' + (stream != null ? "{...}" : "null") + ')'));
			}
		} while (false);
	}
	...
	static {
		...
		new MultilingualString("To use this item please login to a members' server.",
