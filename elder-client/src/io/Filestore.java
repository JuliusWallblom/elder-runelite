...
final class Filestore {
	...
	final boolean method955(boolean bool) {
		try {
			...
			if (bool != true)
				aClass241_2051 = null;
			aStream2058 = new Buffer(aClass246_Sub1_Sub6_Sub1_2056.method2534(false));
			aClass154_Sub1Array2054 = (new Class154_Sub1[(-5 + ((Buffer) aStream2058).buffer.length) / 8]);
			return true;
	...
	static final void method957(byte i) {
		try {
			if (i == 60) {
				for (int i_0_ = 0; ((Class_a.aClass138ArrayArray1175.length ^ 0xffffffff) < (i_0_
						^ 0xffffffff)); i_0_++) {
	...
	final Class154_Sub1 method958(Class208 class208, Class208 class208_2_, int i, int i_3_) {
		try {
			anInt2048++;
			return method962(class208_2_, true, (byte) -115, i_3_, class208);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, ("nj.H(" + (class208 != null ? "{...}" : "null") + ','
					+ (class208_2_ != null ? "{...}" : "null") + ',' + i + ',' + i_3_ + ')'));
		}
	}
	...
	Filestore(Class242 class242, Class241 class241) {
		do {
			try {
				...
				throw Class193.method1272(runtimeexception, ("nj.<init>(" + (class242 != null ? "{...}" : "null") + ','
						+ (class241 != null ? "{...}" : "null") + ')'));
			}
			break;
		} while (false);
	...
	private final Class154_Sub1 method962(Class208 class208, boolean bool, byte i, int i_12_, Class208 class208_13_) {
		try {
			...
			((Buffer) aStream2058).position = 5 + i_12_ * 8;
			if (((Buffer) aStream2058).buffer.length <= ((Buffer) aStream2058).position)
				throw new RuntimeException();
			...
			Class154_Sub1 class154_sub1 = new Class154_Sub1(i_12_, class208, class208_13_, aClass242_2055,
					aClass241_2051, i_14_, i_15_, bool);
			aClass154_Sub1Array2054[i_12_] = class154_sub1;
			int i_16_ = 23 / ((-73 - i) / 33);
			return class154_sub1;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, ("nj.G(" + (class208 != null ? "{...}" : "null") + ',' + bool
					+ ',' + i + ',' + i_12_ + ',' + (class208_13_ != null ? "{...}" : "null") + ')'));
		}
	}
}
