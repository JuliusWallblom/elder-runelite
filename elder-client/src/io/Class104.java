...
final class Class104 {
	...
	static int f_tb;
	private int f_ub;
	static Widget f_vb = null;
	private int f_wb;
	/* synthetic */ static Class aClass1427;

	private final void method664(int i, Buffer stream, int i_0_) {
		try {
			f_ib++;
			if (i_0_ == -21) {
				if ((i ^ 0xffffffff) == -2) {
					((Class104) this).aShort1415 = (short) stream.readUnsignedShort();
					((Class104) this).aShort1382 = (short) stream.readUnsignedShort();
					((Class104) this).f_bb = (short) stream.readUnsignedShort();
					((Class104) this).f_mb = (short) stream.readUnsignedShort();
					int i_1_ = 3;
					...
					if (i == 3) {
						...
						if (i == 5)
							((Class104) this).anInt1401 = ((Class104) this).f_nb = stream
									.readUnsignedShort() << 12 << 0;
						else if (i == 6) {
							anInt1384 = stream.readInt((byte) 88);
							anInt1376 = stream.readInt((byte) 104);
						} else if (i == 7) {
							((Class104) this).anInt1381 = stream.readUnsignedShort();
							((Class104) this).anInt1390 = stream.readUnsignedShort();
						} else if (i == 8) {
							((Class104) this).f_pb = stream.readUnsignedShort();
							((Class104) this).anInt1379 = stream.readUnsignedShort();
						} else if (i != 9) {
							if (i != 10) {
								if (i == 12)
									((Class104) this).anInt1403 = stream.readByte();
								else if ((i ^ 0xffffffff) != -14) {
									if ((i ^ 0xffffffff) != -15) {
										if (i == 15)
											((Class104) this).anInt1387 = stream.readUnsignedShort();
										else if (i == 16) {
											((Class104) this).aBool1395 = (stream.readUnsignedByte()
													^ 0xffffffff) == -2;
											((Class104) this).f_lb = stream.readUnsignedShort();
											((Class104) this).f_eb = stream.readUnsignedShort();
											((Class104) this).aBool1383 = (stream.readUnsignedByte()
													^ 0xffffffff) == -2;
										} else if (i != 17) {
											if (i != 18) {
												if (i == 19)
													((Class104) this).anInt1412 = (stream.readUnsignedByte());
												else if ((i ^ 0xffffffff) != -21) {
													if (i == 21)
														anInt1391 = (stream.readUnsignedByte());
													else if (i == 22)
														((Class104) this).anInt1410 = (stream.readInt((byte) 96));
													else if (i == 23)
														anInt1377 = (stream.readUnsignedByte());
														...
														for (int i_3_ = 0; ((i_2_ ^ 0xffffffff) < (i_3_
																^ 0xffffffff)); i_3_++)
															((Class104) this).anIntArray1378[i_3_] = (stream
																	.readUnsignedShort());
													} else if (i == 26)
														...
														if (i != 28) {
															if (i != 29) {
																if ((i ^ 0xffffffff) != -31) {
																	if (i != 31) {
																		...
																		((Class104) this).anInt1401 = stream
																				.readUnsignedShort() << 12 << 0;
																		((Class104) this).f_nb = stream
																				.readUnsignedShort() << 12 << 0;
																	}
																} else
															...
															f_jb = (stream.readUnsignedByte());
													} else
														((Class104) this).anInt1426 = ((stream
																.readUnsignedShort()) << 12 << 0);
												} else
													f_wb = stream.readUnsignedByte();
											} else
												((Class104) this).anInt1392 = (stream.readInt((byte) 75));
										} else
											((Class104) this).f_ab = stream.readUnsignedShort();
									} else
										((Class104) this).anInt1402 = stream.readUnsignedShort();
								} else
									((Class104) this).f_cb = stream.readByte();
							} else {
								int i_4_ = stream.readUnsignedByte();
								((Class104) this).anIntArray1399 = new int[i_4_];
								for (int i_5_ = 0; i_4_ > i_5_; i_5_++)
									((Class104) this).anIntArray1399[i_5_] = stream.readUnsignedShort();
							}
						} else {
							...
							for (int i_7_ = 0; (i_7_ ^ 0xffffffff) > (i_6_ ^ 0xffffffff); i_7_++)
								((Class104) this).anIntArray1386[i_7_] = stream.readUnsignedShort();
						}
					} else {
						((Class104) this).anInt1406 = stream.readUnsignedByte();
						((Class104) this).f_db = stream.readByte();
					}
				} else
	...
	final void method666(Buffer stream, int i) {
		try {
			if (i == 28201) {
				for (;;) {
			...
			try {
				...
				if (i <= -108) {
					...
					if (((Class104) this).anInt1410 != -1) {
						...
						((Class104) this).anInt1408 = ((((Class104) this).anInt1410
								- ((((Class104) this).anInt1414 + -((Class104) this).anInt1422) / 2
										+ ((Class104) this).anInt1422))
								/ ((Class104) this).f_ob);
					}
					if ((((Class104) this).anInt1426 ^ 0xffffffff) != 0) {
						...
						((Class104) this).anInt1405 = ((((Class104) this).anInt1426 + (-((Class104) this).anInt1401
								- (((Class104) this).f_nb - ((Class104) this).anInt1401) / 2))
								/ ((Class104) this).anInt1424);
					}
					...
					((Class104) this).anInt1421 = ((((((Class104) this).anInt1392 & 0xffee6a) >> 16)
							+ -(((Class104) this).anInt1413 / 2) + -((Class104) this).anInt1393) << 8)
							/ ((Class104) this).anInt1411;
					((Class104) this).f_gb = (((0xff & ((Class104) this).anInt1392 >> 8) + -((Class104) this).anInt1398
							+ -(((Class104) this).anInt1380 / 2)) << 8) / ((Class104) this).anInt1411;
					((Class104) this).anInt1388 = (((0xff & ((Class104) this).anInt1392)
							+ (-((Class104) this).f_sb - ((Class104) this).anInt1396 / 2)) << 8)
							/ ((Class104) this).anInt1411;
					if ((((Class104) this).anInt1389 ^ 0xffffffff) == -1)
						((Class104) this).anInt1389 = 1;
					Class104 class104_9_ = this;
					((Class104) class104_9_).anInt1421 = (((Class104) class104_9_).anInt1421
							+ (((Class104) this).anInt1421 > 0 ? -4 : 4));
					Class104 class104_10_ = this;
					((Class104) class104_10_).f_gb = (((Class104) class104_10_).f_gb
							+ ((((Class104) this).f_gb ^ 0xffffffff) < -1 ? -4 : 4));
					((Class104) this).f_qb = (((((Class104) this).anInt1392 >> 24 & 0xff) + -((Class104) this).anInt1416
							+ -(((Class104) this).f_rb / 2)) << 8) / ((Class104) this).anInt1389;
					Class104 class104_11_ = this;
					((Class104) class104_11_).anInt1388 = (((Class104) class104_11_).anInt1388
							- ((((Class104) this).anInt1388 ^ 0xffffffff) >= -1 ? 4 : 4));
					Class104 class104_12_ = this;
					((Class104) class104_12_).f_qb = (((Class104) class104_12_).f_qb
							+ (((Class104) this).f_qb > 0 ? -4 : 4));
				}
			} catch (RuntimeException runtimeexception) {
	...
	static final void method669(int i) {
		try {
			f_tb++;
			Class82.underlay_loader.method705(5, false);
			ContextMenus.overlay_loader.method1150((byte) 115, 5);
			Material.aClass92_3358.method590(true, 5);
			Class143.aClass251_2067.method1606(5, i + 8);
			Class179.aClass228_2518.method1465((byte) -127, 5);
			MapRegion.aClass191_3663.method1254(-127, 5);
			...
			ParamType.aClass_v1641.method691((byte) -51, 5);
			Client.map_functions.method1092(5, (byte) 60);
			Client.map_scenes.method1644(5, -38);
			...
			CacheIndex.aClass156_150.method1036(5, -24605);
			Class246_Sub28_Sub25.struct_loader.method393(true, 5);
			ParamLoader.method1083(5, false);
			ParamType.method811(50, (byte) 55);
			Class_a.method573(true, 5);
			if (i != -2)
				method669(-126);
			Class243.method1567(48, 5);
			MapFunction.aClass54_2034.method380(5, -50);
			...
			ScriptExecutor.aClass54_2139.method380(5, -50);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method670() {
		for (int i = 0; i < Class_c.anInt1195; i++) {
			if (!MouseHandler.aBoolArray4449[i]) {
				Class174 class174 = StructLoader.aClass174Array811[i];
				...
				if (i_19_ >= HDModel.ySize)
					i_19_ = HDModel.ySize - 1;
				for (int i_20_ = i_18_; i_20_ <= i_19_; i_20_++) {
					...
					if (i_25_ >= Class240.xSize)
						i_25_ = Class240.xSize - 1;
					for (int i_26_ = i_24_; i_26_ <= i_25_; i_26_++) {
						int i_27_ = 1;
						Class59_Sub3 class59_sub3 = Class17.method168(i_13_, i_26_, i_20_,
								(aClass1427 != null ? aClass1427
										: (aClass1427 = Client.getClassByName("Class59_Sub3"))));
				...
				MouseHandler.aBoolArray4449[i] = true;
