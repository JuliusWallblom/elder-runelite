...
final class Class246_Sub28_Sub3 extends TextureOperation {
	...
	public static void method2492(int i) {
		do {
			try {
				...
				Cache.reset_index(Revision.PRE_EOC_634, "sound_effects");
				if (i == 0)
					break;
				method2492(1);
			} catch (RuntimeException runtimeexception) {
	...
	final void method2143(int i, int i_4_, Buffer stream) {
		try {
			...
			if ((i_5_ ^ 0xffffffff) == -1)
				anInt5894 = stream.readUnsignedShort();
			anInt5902++;
		} catch (RuntimeException runtimeexception) {
			...
			if (!Class168.aBool2400) {
				do {
					if (((Renderer) Client.current_renderer).aBool605) {
						Camera.camera_yaw = (float) (~0x7f & 191 + (int) Camera.camera_yaw);
						if (!Client.f_ob)
							break;
					}
	...
	final int[] method2135(int i, int i_6_) {
		try {
			...
			if (((Class66) ((TextureOperation) this).aClass66_4938).aBool887) {
				int i_7_ = Varc.anIntArray6245[i_6_];
	...
	static {
		new MultilingualString(null, "Spieler nicht auf deiner Freunde-Liste.", null, null);
	}
}
