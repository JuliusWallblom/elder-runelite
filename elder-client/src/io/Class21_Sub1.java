...
final class Class21_Sub1 extends Class21 {
	...
	static final void method1814(CacheIndex class_fs, int i) {
		try {
	...
	static final void method1815(int i, int[] is, int i_11_, int i_12_, int i_13_, int i_14_, int i_15_, int i_16_) {
		try {
			...
			if (i_16_ != 17054)
				method1813(-23);
			if ((i_13_ ^ 0xffffffff) < -1 && !WidgetParent.method2313(200, i_13_))
				throw new IllegalArgumentException("");
			if (i_12_ > 0 && !WidgetParent.method2313(200, i_12_))
				throw new IllegalArgumentException("");
			if (i != 32993)
				throw new IllegalArgumentException("");
			int i_17_ = 0;
	...
	final void method195(int i, int i_37_, int i_38_) {
		try {
			...
			AbstractModel.method686(i_45_, i_43_, i_42_, i_46_, i_41_, i_44_, i_39_, ((Class21) this).anInt317, i_40_, -1);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	static {
		new MultilingualString("To interact with this please login to a members' server.", "Logg dich auf einer Mitglieder-Welt ein, um damit zu interagieren.", "Veuillez vous connecter \u00e0 un serveur d'abonn\u00e9s pour cette interaction.", "Para interagir, acesse um servidor para membros.");
