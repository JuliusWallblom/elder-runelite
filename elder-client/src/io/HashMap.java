...
final class HashMap {
	...
	private IterableNodeHashTable aClass85_772;
	static int anInt773;
	static InvTypeLoader inv_type;
	static int anInt775;
	static int anInt776;
	static int anInt777;
	static int anInt778;
	...
	final Object method374(int i) {
		try {
			...
			while (class246_sub1_sub8 != null) {
				...
				class246_sub1_sub8_2_.remove();
				class246_sub1_sub8_2_.removeDual();
	...
	private final void method375(long l, int i) {
		try {
			anInt764++;
			Class246_Sub1_Sub8 class246_sub1_sub8 = (Class246_Sub1_Sub8) aClass85_772.get(l);
			if (i == 10131)
	...
	static final void method376(boolean bool) {
		try {
			if (bool != true)
				method372(64);
			if (Class149.anIntArray2191 == null || StructType.anIntArray6855 == null) {
				StructType.anIntArray6855 = new int[256];
				...
				for (int i = 0; i < 256; i++) {
					...
					StructType.anIntArray6855[i] = (int) (Math.cos(d) * 4096.0);
				}
			}
			anInt777++;
		} catch (RuntimeException runtimeexception) {
	...
	final Object method379(long l, byte i) {
		try {
			...
			Object object = class246_sub1_sub8.method2568(250);
			if (object == null) {
				class246_sub1_sub8.remove();
				class246_sub1_sub8.removeDual();
				anInt769 += ((Class246_Sub1_Sub8) class246_sub1_sub8).anInt6106;
				return null;
			}
			...
			do {
				if (class246_sub1_sub8.method2566((byte) 116)) {
					...
					((NodeSub) class246_sub1_sub8_sub1).aLong3739 = 0L;
					class246_sub1_sub8.remove();
					class246_sub1_sub8.removeDual();
					if (!Client.f_ob)
						break;
				...
				((NodeSub) class246_sub1_sub8).aLong3739 = 0L;
			} while (false);
			return object;
		} catch (RuntimeException runtimeexception) {
				...
				if (Class210_Sub2.aClass248_5018 != null) {
					for (Class246_Sub1_Sub8 class246_sub1_sub8 = ((Class246_Sub1_Sub8) aClass217_768.method1408((byte) 87)); class246_sub1_sub8 != null; class246_sub1_sub8 = ((Class246_Sub1_Sub8) aClass217_768.method1411(true))) {
						if (!class246_sub1_sub8.method2566((byte) 113)) {
							if ((++((NodeSub) class246_sub1_sub8).aLong3739 ^ 0xffffffffffffffffL) < ((long) i ^ 0xffffffffffffffffL)) {
								...
								ParamType.method813(true, class246_sub1_sub8, class246_sub1_sub8_6_);
								class246_sub1_sub8.remove();
								class246_sub1_sub8.removeDual();
							}
		...
		try {
			...
			while (class246_sub1_sub8 != null) {
				...
				if (object == null) {
					...
					class246_sub1_sub8 = ((Class246_Sub1_Sub8) aClass85_772.next((byte) -20));
					class246_sub1_sub8_7_.remove();
					class246_sub1_sub8_7_.removeDual();
					anInt769 += ((Class246_Sub1_Sub8) class246_sub1_sub8).anInt6106;
				} else
					return object;
			}
	...
	HashMap(int i) {
		try {
			...
			aClass85_772 = new IterableNodeHashTable(i_9_);
		} catch (RuntimeException runtimeexception) {
