...
final class Class246_Sub28_Sub17 extends TextureOperation {
	...
	public static void method2657(int i) {
		do {
			try {
				Cache.reset_index(Revision.PRE_EOC_634, "cs2");
				Cache.reset_index(Revision.PRE_EOC_550, "cs2");
				Cache.reset_index(Revision.OSRS, "cs2");
	...
	final int[][] method2139(byte i, int i_0_) {
		try {
			...
			if (i <= 33)
				return null;
			int[][] is = ((TextureOperation) this).aClass136_4933.method922((byte) -103, i_0_);
			while_137_: do {
				if (((Class136) ((TextureOperation) this).aClass136_4933).aBool1946) {
					...
					while_136_: do {
											...
											while_130_: do {
												while_129_: do {
													while_128_: do {
														do {
															if (i_12_ != 1) {
																...
																for (i_12_ = 0; (((Class246_Sub37_Sub1.f_gb)
																		^ 0xffffffff) < (i_12_
																				^ 0xffffffff)); i_12_++) {
													...
													for (i_12_ = 0; (i_12_ < (Class246_Sub37_Sub1.f_gb)); i_12_++) {
														...
														is_3_[i_12_] = (((i_13_ ^ 0xffffffff) != -1)
																? ((is_6_[i_12_] << 12) / i_13_)
																: 4096);
														is_4_[i_12_] = (((i_14_ ^ 0xffffffff) != -1)
																? ((is_7_[i_12_] << 12) / i_14_)
																: 4096);
														is_5_[i_12_] = (i_15_ != 0 ? ((is_8_[i_12_] << 12) / i_15_)
																: 4096);
													}
													break while_137_;
												} while (false);
												for (i_12_ = 0; (Class246_Sub37_Sub1.f_gb > i_12_); i_12_++) {
													is_3_[i_12_] = -(((-is_6_[i_12_] + 4096)
															* (4096 + -(is_9_[i_12_]))) >> 12) + 4096;
													is_4_[i_12_] = -(((4096 - is_7_[i_12_])
															* (4096 - (is_10_[i_12_]))) >> 12) + 4096;
													is_5_[i_12_] = -(((4096 + -is_11_[i_12_])
															* (-is_8_[i_12_] + 4096)) >> 12) + 4096;
												}
												break while_137_;
											} while (false);
											for (i_12_ = 0; (Class246_Sub37_Sub1.f_gb > i_12_); i_12_++) {
												...
												is_3_[i_12_] = (i_17_ < 2048 ? (is_6_[i_12_] * i_17_ >> 11)
														: (4096 + -(((4096 + -(is_6_[i_12_]))
																* (-i_17_ + 4096)) >> 11)));
												is_4_[i_12_] = (i_16_ >= 2048
														? (4096 + -(((4096 + -(is_7_[i_12_])) * (-i_16_ + 4096)) >> 11))
														: (is_7_[i_12_] * i_16_ >> 11));
												is_5_[i_12_] = (i_18_ < 2048 ? (is_8_[i_12_] * i_18_ >> 11)
														: -(((4096 - is_8_[i_12_]) * (-i_18_ + 4096)) >> 11) + 4096);
											}
											break while_137_;
										} while (false);
										for (i_12_ = 0; ((i_12_ ^ 0xffffffff) > (Class246_Sub37_Sub1.f_gb
												^ 0xffffffff)); i_12_++) {
											...
											is_4_[i_12_] = (i_19_ == 4096 ? 4096
													: ((is_10_[i_12_] << 12) / (4096 - i_19_)));
											is_5_[i_12_] = (i_21_ == 4096 ? 4096
													: ((is_11_[i_12_] << 12) / (4096 - i_21_)));
										}
										break while_137_;
									} while (false);
									for (i_12_ = 0; Class246_Sub37_Sub1.f_gb > i_12_; i_12_++) {
										...
										is_3_[i_12_] = (i_22_ != 0 ? -((-is_9_[i_12_] + 4096 << 12) / i_22_) + 4096
												: 0);
										is_4_[i_12_] = (i_23_ == 0 ? 0 : 4096 - (4096 - is_10_[i_12_] << 12) / i_23_);
										is_5_[i_12_] = (i_24_ == 0 ? 0
												: 4096 + -((4096 - is_11_[i_12_] << 12) / i_24_));
									}
									break while_137_;
								} while (false);
								for (i_12_ = 0; ((i_12_ ^ 0xffffffff) > (Class246_Sub37_Sub1.f_gb
						...
						for (i_12_ = 0; ((i_12_ ^ 0xffffffff) > (Class246_Sub37_Sub1.f_gb ^ 0xffffffff)); i_12_++) {
							...
							is_4_[i_12_] = ((i_40_ ^ 0xffffffff) > (i_42_ ^ 0xffffffff) ? -i_40_ + i_42_
									: i_40_ - i_42_);
	...
	final void method2143(int i, int i_49_, Buffer stream) {
		while_138_: do {
			try {
				anInt6408++;
				if (i != 4)
				...
				do {
					...
					anInt6411 = stream.readUnsignedByte();
					return;
				} while (false);
	...
	final int[] method2135(int i, int i_51_) {
		try {
			...
			anInt6405++;
			int[] is = ((TextureOperation) this).aClass66_4938.method435((byte) -112, i_51_);
			while_148_: do {
										...
										while_142_: do {
											while_141_: do {
												while_140_: do {
													while_139_: do {
														do {
															if (i_55_ != 1) {
																...
																for (i_55_ = 0; ((i_55_
																		^ 0xffffffff) > ((Class246_Sub37_Sub1.f_gb)
																				^ 0xffffffff)); i_55_++)
													...
													for (i_55_ = 0; (((Class246_Sub37_Sub1.f_gb) ^ 0xffffffff) < (i_55_
															^ 0xffffffff)); i_55_++) {
														int i_56_ = is_54_[i_55_];
														is[i_55_] = (i_56_ != 0 ? (((is_53_[i_55_]) << 12) / i_56_)
																: 4096);
													}
													break while_148_;
												} while (false);
												for (i_55_ = 0; (Class246_Sub37_Sub1.f_gb > i_55_); i_55_++)
													is[i_55_] = (4096 + -(((-is_53_[i_55_] + 4096)
															* (4096 + -(is_54_[i_55_]))) >> 12));
												break while_148_;
											} while (false);
											for (i_55_ = 0; (i_55_ < Class246_Sub37_Sub1.f_gb); i_55_++) {
												int i_57_ = is_54_[i_55_];
												is[i_55_] = (i_57_ >= 2048
														? -(((-i_57_ + 4096) * (-is_53_[i_55_] + 4096)) >> 11) + 4096
														: (i_57_ * is_53_[i_55_] >> 11));
											}
											break while_148_;
										} while (false);
										for (i_55_ = 0; i_55_ < Class246_Sub37_Sub1.f_gb; i_55_++) {
											int i_58_ = is_53_[i_55_];
											is[i_55_] = (((i_58_ ^ 0xffffffff) == -4097) ? 4096
													: ((is_54_[i_55_] << 12) / (4096 + -i_58_)));
										}
										break while_148_;
									} while (false);
									for (i_55_ = 0; Class246_Sub37_Sub1.f_gb > i_55_; i_55_++) {
										int i_59_ = is_53_[i_55_];
										is[i_55_] = ((i_59_ ^ 0xffffffff) != -1
												? 4096 - (4096 - is_54_[i_55_] << 12) / i_59_
												: 0);
									}
									break while_148_;
								} while (false);
	...
	static final Class182 method2658(Signlink class52, int i, String string, int i_68_) {
		try {
			...
			if (i == 1) {
				try {
					Class80.method519((byte) 17, class52.anApplet733, "openjs",
							new Object[] { new URL(class52.anApplet733.getCodeBase(), string).toString() });
			...
			if ((i ^ 0xffffffff) == -3) {
				try {
					class52.anApplet733.getAppletContext()
							.showDocument(new URL(class52.anApplet733.getCodeBase(), string), "_blank");
					Class182 class182 = new Class182();
					class182.anInt2539 = 1;
					return class182;
			...
			if (i == 3) {
				...
				try {
					class52.anApplet733.getAppletContext()
							.showDocument(new URL(class52.anApplet733.getCodeBase(), string), "_top");
					Class182 class182 = new Class182();
					class182.anInt2539 = 1;
					return class182;
				} catch (Exception exception) {
			...
			throw Class193.method1272(runtimeexception, ("ju.A(" + (class52 != null ? "{...}" : "null") + ',' + i + ','
					+ (string != null ? "{...}" : "null") + ',' + i_68_ + ')'));
		}
	}
	...
	static final void method2659(Class174 class174) {
		if (Class_c.anInt1195 < 65535) {
			...
			StructLoader.aClass174Array811[Class_c.anInt1195] = class174;
			MouseHandler.aBoolArray4449[Class_c.anInt1195] = false;
			Class_c.anInt1195++;
			...
			for (int i_70_ = i; i_70_ <= i_69_; i_70_++) {
				int i_71_ = 0;
				int i_72_ = ((class246_sub41.method2321((byte) -77) - class246_sub41.method2322(79)
						+ Class40_Sub7.anInt5174) >> Class126.anInt1781);
				if (i_72_ < 0) {
					i_71_ -= i_72_;
					i_72_ = 0;
				}
				int i_73_ = ((class246_sub41.method2321((byte) -38) + class246_sub41.method2322(80)
						- Class40_Sub7.anInt5174) >> Class126.anInt1781);
				if (i_73_ >= HDModel.ySize)
					i_73_ = HDModel.ySize - 1;
				for (int i_74_ = i_72_; i_74_ <= i_73_; i_74_++) {
					int i_75_ = ((Class174) class174).aShortArray2447[i_71_++];
					int i_76_ = (((class246_sub41.method2317(false) - class246_sub41.method2322(104)
							+ Class40_Sub7.anInt5174) >> Class126.anInt1781) + (i_75_ >>> 8));
					int i_77_ = i_76_ + (i_75_ & 0xff) - 1;
					if (i_76_ < 0)
						i_76_ = 0;
					if (i_77_ >= Class240.xSize)
						i_77_ = Class240.xSize - 1;
					for (int i_78_ = i_76_; i_78_ <= i_77_; i_78_++) {
						long l = (MapRegion.aLongArrayArrayArray3648[i_70_][i_78_][i_74_]);
						if ((l & 0xffffL) == 0L)
							MapRegion.aLongArrayArrayArray3648[i_70_][i_78_][i_74_] = l | (long) Class_c.anInt1195;
						else if ((l & 0xffff0000L) == 0L)
							MapRegion.aLongArrayArrayArray3648[i_70_][i_78_][i_74_] = l
									| (long) Class_c.anInt1195 << 16;
						else if ((l & 0xffff00000000L) == 0L)
							MapRegion.aLongArrayArrayArray3648[i_70_][i_78_][i_74_] = l
									| (long) Class_c.anInt1195 << 32;
						else if ((l & ~0xffffffffffffL) == 0L)
							MapRegion.aLongArrayArrayArray3648[i_70_][i_78_][i_74_] = l
									| (long) Class_c.anInt1195 << 48;
					}
				}
			}
		}
