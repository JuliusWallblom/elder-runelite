...
final class Class259_Sub2_Sub1 extends Class259_Sub2 {
	...
	static final Class123 method2845(int i, int i_0_, Signlink class52, int i_1_, Component component) {
		try {
			anInt6908++;
			if ((MapFunction.anInt2024 ^ 0xffffffff) == -1)
			...
			try {
				...
				if ((OverlayLoader.anInt2475 ^ 0xffffffff) < -1 && Class36.aClass215_492 == null) {
					Class36.aClass215_492 = new Class215();
					((Class215) Class36.aClass215_492).aClass52_2999 = class52;
					class52.method354(95, OverlayLoader.anInt2475, Class36.aClass215_492);
				}
				...
				try {
					...
					if ((OverlayLoader.anInt2475 ^ 0xffffffff) < -1 && Class36.aClass215_492 == null) {
						Class36.aClass215_492 = new Class215();
						((Class215) Class36.aClass215_492).aClass52_2999 = class52;
						class52.method354(i_0_ - 120, OverlayLoader.anInt2475, Class36.aClass215_492);
					}
					if (Class36.aClass215_492 != null) {
						if ((((Class215) Class36.aClass215_492).aClass123Array3002[i]) != null)
							throw new IllegalArgumentException();
	...
	static final void method2846(int i, byte i_3_, boolean bool, long l, int i_4_, String string, boolean bool_5_, String string_6_, int i_7_, int i_8_, int i_9_) {
		try {
			anInt6904++;
			if (!ContextMenus.context_menu_open && Class230.anInt3147 < 500) {
				...
				Varbit.aClass166_1525.push_head(class246_sub35);
				if (i_3_ != -55)
	...
	static final Class178 method2847(CacheIndex class_fs, int i, String string, boolean bool) {
		try {
			anInt6905++;
			int i_10_ = -107 % ((i + 30) / 50);
			int i_11_ = class_fs.method86(string);
			if (i_11_ == -1)
			...
			while (((Class178) class178).anInt2504 > i_12_) {
				Buffer stream = new Buffer(class_fs.get_file(is[i_13_++], i_11_));
				int i_14_ = stream.readInt((byte) 91);
				int i_15_ = stream.readUnsignedShort();
