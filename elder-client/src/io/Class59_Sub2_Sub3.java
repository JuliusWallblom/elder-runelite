...
final class Class59_Sub2_Sub3 extends Class59_Sub2 implements Class_f {
	...
	final Class130_Sub3 method407(SceneGraph class260, int i) {
		try {
			anInt6610++;
			AbstractModel class_t = (((Class59_Sub2_Sub3) this).aClass14_6620.method147(((Class59_Sub2) this).anInt4542,
					true, class260, ((Class59_Sub2) this).anInt4563, 2048, (byte) 119, false));
			if (class_t == null)
				return null;
			Class_c class_c = class260.method1730();
			class_c.j((((Class59_Sub2) this).anInt4563 - -((Class59_Sub2) this).anInt4540),
					((Class59_Sub2) this).anInt4552,
					(((Class59_Sub2) this).anInt4542 - -((Class59_Sub2) this).anInt4541));
			...
			do {
				if ((((Class14) ((Class59_Sub2_Sub3) this).aClass14_6620).aClass130_Sub2_214) == null) {
					class_t.method680(class_c, (class130_sub3 == null ? null
							: (((Class130_Sub3) class130_sub3).aClass130_Sub5Array4415[0])), 0);
					if (!Client.f_ob)
						break;
				}
				Class129 class129 = ((Class14) ((Class59_Sub2_Sub3) this).aClass14_6620).aClass130_Sub2_214
						.method1779();
			...
			((Class59_Sub2_Sub3) this).aClass14_6620.method155(true, i_1_, 50401, class_t, i_0_, class260, i_1_, i_0_);
			return class130_sub3;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					"mj.H(" + (class260 != null ? "{...}" : "null") + ',' + i + ')');
		}
	}
	...
	static final void method2722(int i, boolean bool, int i_5_, int i_6_, boolean bool_7_, int i_8_, int i_9_) {
		try {
			...
			if (bool && Class155.anInt2226 >= 100) {
				...
				Class246_Sub28_Sub8.anInt6077 = (Class6.getAverageHeight(Class246_Sub16.aInt92, 49,
						Class246_Sub28_Sub24.anInt6681, Class259_Sub1.anInt4509) + -OutgoingPacket.anInt2863);
			}
			Class130_Sub3.anInt4417 = 2;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, ("mj.K(" + i + ',' + bool + ',' + i_5_ + ',' + i_6_ + ','
					+ bool_7_ + ',' + i_8_ + ',' + i_9_ + ')'));
		}
	}
	...
	static final void method2723(Node class246, Node class246_10_, int i) {
		try {
			...
			throw Class193.method1272(runtimeexception, ("mj.S(" + (class246 != null ? "{...}" : "null") + ','
					+ (class246_10_ != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}

	public final AbstractModel method23(SceneGraph class260, int i, int i_12_) {
		try {
			anInt6612++;
			...
			throw Class193.method1272(runtimeexception,
					("mj.D(" + (class260 != null ? "{...}" : "null") + ',' + i + ',' + i_12_ + ')'));
		}
	}

	Class59_Sub2_Sub3(SceneGraph class260, LocType class185, int i, int i_14_, int i_15_, int i_16_, int i_17_,
			boolean bool, int i_18_, int i_19_, int i_20_, int i_21_, int i_22_, int i_23_) {
		super(i_15_, i_16_, i_17_, i_18_, i_19_, i_20_, Class178.method1168(i_22_, (byte) 58, i_21_));
		try {
			((Class59_Sub2_Sub3) this).aClass14_6620 = new Class14(class260, class185, i_21_, i_22_, i, i_14_, i_15_,
					i_17_, bool, i_23_);
			aBool6608 = ((((LocType) class185).wall_or_door ^ 0xffffffff) != -1 && !bool);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("mj.<init>(" + (class260 != null ? "{...}" : "null") + ',' + (class185 != null ? "{...}" : "null")
							+ ',' + i + ',' + i_14_ + ',' + i_15_ + ',' + i_16_ + ',' + i_17_ + ',' + bool + ',' + i_18_
	...
	final boolean method409(int i, int i_24_, SceneGraph class260, int i_25_) {
		try {
			anInt6621++;
			AbstractModel class_t = (((Class59_Sub2_Sub3) this).aClass14_6620.method147(((Class59_Sub2) this).anInt4542,
					false, class260, ((Class59_Sub2) this).anInt4563, 131072, (byte) 122, false));
			if (i_24_ != 0)
				((Class59_Sub2_Sub3) this).aClass14_6620 = null;
			if (class_t == null)
				return false;
			...
			throw Class193.method1272(runtimeexception,
					("mj.A(" + i + ',' + i_24_ + ',' + (class260 != null ? "{...}" : "null") + ',' + i_25_ + ')'));
		}
	}
	...
	final void method403(SceneGraph class260, int i) {
		do {
			try {
				...
				if (i < 53)
					((Class59_Sub2_Sub3) this).aClass14_6620 = null;
				AbstractModel class_t = (((Class59_Sub2_Sub3) this).aClass14_6620.method147(
						((Class59_Sub2) this).anInt4542, true, class260, ((Class59_Sub2) this).anInt4563, 262144,
						(byte) 126, false));
				if (class_t == null)
					break;
				int i_26_ = ((Class59_Sub2) this).anInt4563 >> 7;
				int i_27_ = ((Class59_Sub2) this).anInt4542 >> 7;
				((Class59_Sub2_Sub3) this).aClass14_6620.method155(false, i_27_, 50401, class_t, i_26_, class260, i_27_,
						i_26_);
			} catch (RuntimeException runtimeexception) {
				throw Class193.method1272(runtimeexception,
						("mj.B(" + (class260 != null ? "{...}" : "null") + ',' + i + ')'));
			}
			break;
		} while (false);
	}
