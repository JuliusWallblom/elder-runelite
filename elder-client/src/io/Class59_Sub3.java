...
abstract class Class59_Sub3 extends Class59 {
	...
	static final void method2170(int i, byte[][][] is, int i_2_, byte i_3_, int i_4_, int i_5_) {
		...
		for (int i_6_ = Class246_Sub37_Sub4.anInt6880; i_6_ < Class154_Sub1.anInt4803; i_6_++) {
			Tile[][] class147s = Class106.tiles[i_6_];
			for (int i_7_ = Class56.anInt796; i_7_ < Class188.anInt2662; i_7_++) {
				for (int i_8_ = Class133.anInt1834; i_8_ < Class246_Sub1_Sub10.f_db; i_8_++) {
					Tile class147 = class147s[i_7_][i_8_];
					if (class147 != null) {
						if (!(Class187_Sub1.aBoolArrayArray4866[i_7_ - Class244.anInt3454 + Class125.anInt1777][(i_8_
								- Class59_Sub2_Sub2.anInt6025 + Class125.anInt1777)])
								|| (is != null && i_6_ >= i_2_ && is[i_6_][i_7_][i_8_] == i_3_)) {
							((Tile) class147).aBool2166 = false;
							((Tile) class147).aBool2171 = false;
							((Tile) class147).aByte2162 = (byte) 0;
							if (i_7_ >= Class244.anInt3454 - 16 && i_7_ <= Class244.anInt3454 + 16
									&& i_8_ >= Class59_Sub2_Sub2.anInt6025 - 16
									&& i_8_ <= Class59_Sub2_Sub2.anInt6025 + 16
									&& ((((Tile) class147).aClass59_Sub4_2172 != null)
											|| (((Tile) class147).aClass59_Sub4_2152) != null
											|| (((Tile) class147).aClass59_Sub2_2153) != null
											|| (((Tile) class147).aClass59_Sub2_2159) != null
											|| (((Tile) class147).floorDecorationIThink) != null
											|| (((Tile) class147).aClass3_2160 != null)))
								Class245.aClass106_3462.method723(class147, (byte) -39);
						} else {
							((Tile) class147).aBool2166 = true;
							((Tile) class147).aBool2171 = true;
		...
		for (int i_9_ = Class246_Sub37_Sub4.anInt6880; i_9_ < Class154_Sub1.anInt4803; i_9_++) {
			...
			if (Class259_Sub3.aClass260_5357.method1684() && i_9_ >= i_2_ && is != null) {
				...
				if (Class56.anInt796 + Class187_Sub1.aBoolArrayArray4866.length > Class240.xSize)
					i_10_ -= (Class56.anInt796 + Class187_Sub1.aBoolArrayArray4866.length - Class240.xSize);
				int i_11_ = Class187_Sub1.aBoolArrayArray4866[0].length;
				if ((Class133.anInt1834 + Class187_Sub1.aBoolArrayArray4866[0].length) > HDModel.ySize)
					i_11_ -= (Class133.anInt1834 + Class187_Sub1.aBoolArrayArray4866[0].length - HDModel.ySize);
					...
					for (int i_14_ = Class_cs.anInt7143; i_14_ < i_11_; i_14_++) {
						...
						if (Class187_Sub1.aBoolArrayArray4866[i_12_][i_14_]) {
							...
							for (int i_16_ = i_9_; i_16_ >= 0; i_16_--) {
								if ((Class106.tiles[i_16_][i_13_][i_15_]) != null
										&& (((Tile) (Class106.tiles[i_16_][i_13_][i_15_])).aByte2174 == i_9_)) {
									Class251.aBoolArrayArray3556[i_12_][i_14_] = ((Tile) (Class106.tiles[i_16_][i_13_][i_15_])).aBool2166;
									break;
								}
							}
						}
				...
				Class245.aClass106_3462.method726(i_9_, true, (Class59_Sub3_Sub4.aClass210Array6993[i_9_]), f,
						(byte) 46);
			} else
				Class245.aClass106_3462.method726(i_9_, false, (Class59_Sub3_Sub4.aClass210Array6993[i_9_]), f,
						(byte) 46);
	...
	static final int method2171(int i, byte i_17_, int[] is, byte[][] is_18_, byte[] is_19_, int i_20_, int[] is_21_,
			byte[][] is_22_) {
		try {
			anInt5061++;
			int i_23_ = is[i_20_];
			...
			throw Class193.method1272(runtimeexception,
					("pe.NA(" + i + ',' + i_17_ + ',' + (is != null ? "{...}" : "null") + ','
							+ (is_18_ != null ? "{...}" : "null") + ',' + (is_19_ != null ? "{...}" : "null") + ','
							+ i_20_ + ',' + (is_21_ != null ? "{...}" : "null") + ','
							+ (is_22_ != null ? "{...}" : "null") + ')'));
		}
	}
