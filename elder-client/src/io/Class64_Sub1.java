...
final class Class64_Sub1 extends Class64 {
	...
	static final void method2219(int i, byte i_0_, Widget class235, int i_1_) {
		try {
			if (i_0_ == -82) {
			...
			throw Class193.method1272(runtimeexception,
					("sh.D(" + i + ',' + i_0_ + ',' + (class235 != null ? "{...}" : "null") + ',' + i_1_ + ')'));
		}
	}

	final void method422(int i, float f, int i_2_, int i_3_, float f_4_, int i_5_, float f_6_, float f_7_, int i_8_,
			int i_9_, float[] fs) {
		try {
			anInt5234++;
			...
			for (int i_21_ = 0; (i_21_ ^ 0xffffffff) > (i_3_ ^ 0xffffffff); i_21_++) {
				...
				for (int i_32_ = 0; i_32_ < i_2_; i_32_++) {
					...
					i_35_ &= i_10_;
					i_34_ &= i_10_;
					fs[i++] = (f_7_ * (Class_q.method2059(f_18_, 4449,
							(Class_q.method2059(f_27_, 4449, (Class_q.method2059(f_38_, 4449,
									(KeyHandler.method2328(f_37_, f_26_, -129,
											PacketsDecoder.method184(7, (anIntArray5237[i_28_ + i_34_])), f_17_)),
									(KeyHandler.method2328(f_36_, f_26_, -129,
											PacketsDecoder.method184(7, (anIntArray5237[i_28_ + i_35_])), f_17_)))),
									(Class_q.method2059(f_38_, 4449,
											(KeyHandler.method2328(f_37_, f_25_, -129,
													PacketsDecoder.method184((anIntArray5237[i_29_ + i_34_]), 7),
													f_17_)),
											(KeyHandler.method2328(f_36_, f_25_, i_8_ - 136,
													PacketsDecoder.method184(7, (anIntArray5237[i_29_ + i_35_])),
													f_17_)))))),
							(Class_q.method2059(f_27_, 4449, (Class_q.method2059(f_38_, 4449,
									(KeyHandler.method2328(f_37_, f_26_, -129,
											PacketsDecoder.method184((anIntArray5237[i_30_ + i_34_]), 7), f_16_)),
									(KeyHandler.method2328(f_36_, f_26_, -129,
											PacketsDecoder.method184((anIntArray5237[i_30_ + i_35_]), 7), f_16_)))),
									(Class_q.method2059(f_38_, 4449, (KeyHandler.method2328(f_37_, f_25_, -129,
											PacketsDecoder.method184(7, (anIntArray5237[i_34_ + i_31_])), f_16_)),
											(KeyHandler.method2328(f_36_, f_25_, VarpType.method599(i_8_, -136),
													PacketsDecoder.method184((anIntArray5237[i_31_ + i_35_]), 7),
													f_16_)))))))));
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("sh.B(" + i + ',' + f + ',' + i_2_ + ',' + i_3_ + ',' + f_4_ + ',' + i_5_ + ',' + f_6_ + ',' + f_7_
							+ ',' + i_8_ + ',' + i_9_ + ',' + (fs != null ? "{...}" : "null") + ')'));
		}
	}
			...
			for (;;) {
				...
				for (;;) {
					if (bool_46_) {
						...
						int i_51_ = stream.readUnsignedByte() >> 2;
						int i_52_ = i_39_ + i_50_;
						int i_53_ = i_41_ + i_49_;
						if ((i_52_ ^ 0xffffffff) < -1 && (i_53_ ^ 0xffffffff) < -1
								&& (i_52_ ^ 0xffffffff) > (i - 1 ^ 0xffffffff) && -1 + i_40_ > i_53_) {
							LocType class185 = Class143.aClass251_2067.list(i_43_, 0);
							if ((i_51_ ^ 0xffffffff) != -23 || Settings.ground_decorations
									|| ((LocType) class185).wall_or_door != 0 || ((LocType) class185).interact_type == 1
