...
final class Class246_Sub28_Sub12 extends TextureOperation {
	private int anInt6191 = 0;
	static AbstractSprite[] new_hit_bars;
	static AbstractSprite[] osrs_hit_bars;
	private int anInt6193 = 4096;
	static int anInt6194;
	static CacheIndex aClass_fs6195;
	...
	final void method2143(int i, int i_5_, Buffer stream) {
		try {
			if (i != 4)
			...
			while_118_: do {
				do {
					if ((i_6_ ^ 0xffffffff) != -1) {
						...
						anInt6191 = stream.readUnsignedShort();
						break while_118_;
					}
					anInt6193 = stream.readUnsignedShort();
					break while_118_;
				} while (false);
	...
	final int[][] method2139(byte i, int i_7_) {
		try {
			anInt6194++;
			int[][] is = ((TextureOperation) this).aClass136_4933.method922((byte) 69, i_7_);
