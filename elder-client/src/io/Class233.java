...
final class Class233 {
	...
	static AbstractSprite[] aClass_lArray3188;

	public static void method1491(byte i) {
		try {
			aClass_lArray3188 = null;
			int i_0_ = -91 / ((i + 47) / 62);
			Widget.widget_model_index = null;
			aClass12_3185 = null;
	...
	static final void method1492(int i, byte i_1_, Class246_Sub2 class246_sub2, int i_2_, int i_3_, Class198 class198,
			MapFunction class140, SceneGraph class260) {
		try {
			anInt3180++;
			int i_4_ = (-(i_2_ / 2) + (((Class246_Sub2) class246_sub2).anInt3810 - 5));
			int i_5_ = i_3_ + 2;
			if (((MapFunction) class140).anInt2013 != 0)
				class260.method1734(i_4_, i_2_ + 10, i_5_, (byte) 58, ((MapFunction) class140).anInt2013,
						(class198.method1303() * i + i_3_ - i_5_ + 1));
			if (((MapFunction) class140).anInt1997 != 0)
				class260.method1736(i_4_, ((MapFunction) class140).anInt1997,
						1 + (i * class198.method1303() + (i_3_ - i_5_)), 8, 10 + i_2_, i_5_);
			int i_6_ = ((MapFunction) class140).anInt2022;
			int i_7_ = -124 % ((i_1_ - 63) / 61);
			if (((Class246_Sub2) class246_sub2).aBool3802 && ((MapFunction) class140).anInt1999 != -1)
				i_6_ = ((MapFunction) class140).anInt1999;
			...
			throw Class193.method1272(runtimeexception,
					("uq.A(" + i + ',' + i_1_ + ',' + (class246_sub2 != null ? "{...}" : "null") + ',' + i_2_ + ','
							+ i_3_ + ',' + (class198 != null ? "{...}" : "null") + ','
							+ (class140 != null ? "{...}" : "null") + ',' + (class260 != null ? "{...}" : "null")
							+ ')'));
		}
	}
	...
	static final void method1493(int[] is, long[] ls, int i) {
		do {
			try {
				...
				throw Class193.method1272(runtimeexception, ("uq.D(" + (is != null ? "{...}" : "null") + ','
						+ (ls != null ? "{...}" : "null") + ',' + i + ')'));
			}
			break;
		} while (false);
