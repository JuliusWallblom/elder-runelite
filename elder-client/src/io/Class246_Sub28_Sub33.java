...
final class Class246_Sub28_Sub33 extends TextureOperation {
	...
	static TextureInterface anInterface6_6967;
	...
	static final int method2861(boolean bool, int i, boolean bool_0_) {
		try {
			...
			if (class246_sub18 == null)
				return (((Class246_Sub1_Sub2) HashMap.inv_type.method416(5, i)).anInt5697);
			int i_1_ = 0;
			...
			if (bool_0_ != true)
				aClass243_6959 = null;
			i_1_ += ((((Class246_Sub1_Sub2) HashMap.inv_type.method416(5, i)).anInt5697) + -(((Class246_Sub18) class246_sub18).anIntArray4682).length);
			return i_1_;
		} catch (RuntimeException runtimeexception) {
	...
	final int[][] method2139(byte i, int i_3_) {
		try {
			anInt6962++;
			int[][] is = ((TextureOperation) this).aClass136_4933.method922((byte) -105, i_3_);
			if (i <= 33)
				aClass243_6959 = null;
	...
	final void method2143(int i, int i_27_, Buffer stream) {
		while_47_: do {
			try {
				if (i == 4) {
					anInt6960++;
						...
						while_45_: do {
							while_44_: do {
								do {
									...
									anInt6961 = stream.readUnsignedShort();
									return;
								} while (false);
								anInt6970 = stream.readUnsignedShort();
								return;
							} while (false);
							anInt6969 = stream.readUnsignedShort();
							return;
						} while (false);
						anInt6965 = stream.readUnsignedShort();
						return;
					} while (false);
