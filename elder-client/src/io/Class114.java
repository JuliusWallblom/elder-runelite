...
final class Class114 implements Interface7 {
	...
	public final String method25(long l, byte i, int[] is, Class81 class81) {
		try {
			...
			if (Class194_Sub2.aClass81_4952 == class81) {
				EnumType class183 = Class246_Sub39.aClass141_5487.list(is[0], i - 186);
				return class183.getStringParamValue(111, (int) l);
			}
			if (i != 85)
				method777(-122, 28);
			if (Class256.aClass81_3675 == class81 || class81 == Class186.aClass81_2636) {
				ObjType class197 = MapRegion.aClass191_3663.list(22883, (int) l);
				return ((ObjType) class197).name;
			}
			if (class81 == Class21.aClass81_320 || Class206.aClass81_2898 == class81 || class81 == Class59_Sub5_Sub1.aClass81_5815)
				return Class246_Sub39.aClass141_5487.list(is[0], i ^ ~0xa).getStringParamValue(115, (int) l);
			return null;
	...
	static final void method778(int i, int i_1_, int i_2_, int i_3_, boolean bool, int i_4_, int i_5_, String string) {
		try {
			...
			((Class130_Sub8) class130_sub8).anInt5611 = Client.cycle - -i_1_;
	...
	static final Class198 method779(int i, byte i_6_) {
		try {
			...
			if (i == 0) {
				...
				if ((i ^ 0xffffffff) == -3) {
					if ((double) Class79.aFloat1033 == 3.0)
						return EnumLoader.aClass198_2043;
					if ((double) Class79.aFloat1033 == 4.0)
	...
	static {
		new MultilingualString("You are not currently in a channel.", "Du befindest dich derzeit nicht in einem Chatraum.", "Vous n'\u00eates dans aucun canal \u00e0 l'heure actuelle.", "No momento voc\u00ea n\u00e3o est\u00e1 em um canal.");
		anInt1598 = 0;
	}
}
