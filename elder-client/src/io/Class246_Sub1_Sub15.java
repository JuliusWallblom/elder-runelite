...
abstract class Class246_Sub1_Sub15 extends NodeSub {
	...
	static final void method2719(int i, Class12 class12) {
		try {
			...
			if (Class247.aClass12_3482 == class12) {
				...
				int i_5_ = Class78.packetStream.readUnsignedByte();
				Class143.aClass251_2067.list(i_4_, 0).method1211((byte) -126, i_5_);
				...
				int i_8_ = Class78.packetStream.readUnsignedByte();
				...
				if (i_9_ >= 0 && (i_10_ ^ 0xffffffff) <= -1 && (i_9_ ^ 0xffffffff) > (Class38_Sub1_Sub1.anInt6770 ^ 0xffffffff) && Class152.anInt2205 > i_10_) {
					...
					MapScenes.method1645(Class60.basePlane, 1546660647, i_9_, i_10_);
				}
			} else if (class12 == Class96.aClass12_1256) {
				Class78.packetStream.readUnsignedByte();
				int i_11_ = Class78.packetStream.readUnsignedByte();
				int i_12_ = Class82.baseTileX - -((i_11_ & 0x72) >> 4);
				int i_13_ = (i_11_ & 0x7) + Class106_Sub2.baseTileY;
				int i_14_ = Class78.packetStream.readUnsignedShort();
				int i_15_ = Class78.packetStream.readUnsignedByte();
				...
				int hash = Class78.packetStream.readUnsignedByte();
				boolean bool = (0x80 & hash) != 0;
				int baseX = ((hash & 0x3e) >> 3) + Class82.baseTileX;
				int baseY = (0x7 & hash) + Class106_Sub2.baseTileY;
				int distanceX = Class78.packetStream.readByte() + baseX;
				int distanceY = baseY - -Class78.packetStream.readByte();
				int lockOn = Class78.packetStream.method2375((byte) 1);
				int gfxId = Class78.packetStream.readUnsignedShort();
				int revision = Class78.packetStream.readInt();
				int startHeight = Class78.packetStream.readUnsignedByte() * 4;
				int endHeight = 4 * Class78.packetStream.readUnsignedByte();
				int delay = Class78.packetStream.readUnsignedShort();
				int delayAndSpeed = Class78.packetStream.readUnsignedShort();
				int angle1 = Class78.packetStream.readUnsignedByte();
				if (angle1 == 255)
					angle1 = -1;
				int angle2 = Class78.packetStream.readUnsignedByte();
				if ((baseX ^ 0xffffffff) <= -1 && (baseY ^ 0xffffffff) <= -1 && Class38_Sub1_Sub1.anInt6770 > baseX && Class152.anInt2205 > baseY && distanceX >= 0 && (distanceY ^ 0xffffffff) <= -1 && Class38_Sub1_Sub1.anInt6770 > distanceX && distanceY < Class152.anInt2205 && (gfxId ^ 0xffffffff) != -65536) {
					...
					endHeight <<= 0;
					Class_g class_g = new Class_g(gfxId, Class60.basePlane, baseX, baseY, startHeight, delay + Client.cycle, delayAndSpeed + Client.cycle, angle1, angle2, lockOn, endHeight, bool, revision);
					class_g.method2686(Client.cycle + delay, distanceX, Class6.getAverageHeight(distanceX, 62, Class60.basePlane, distanceY) + -endHeight, distanceY, 98);
					Class12.aClass166_180.push_head(new Class246_Sub1_Sub7(class_g));
				}
			} else if (Material.REMOVE_GROUND_ITEM == class12) {
				...
				if ((i_32_ ^ 0xffffffff) <= -1 && i_33_ >= 0 && ((Class38_Sub1_Sub1.anInt6770 ^ 0xffffffff) < (i_32_ ^ 0xffffffff)) && (i_33_ ^ 0xffffffff) > (Class152.anInt2205 ^ 0xffffffff)) {
					Class246_Sub13 class246_sub13 = (Class246_Sub13) (Class251.aClass85_3551.get((long) (Class60.basePlane << 28 | i_33_ << 14 | i_32_)));
				...
				int i_52_ = Class78.packetStream.readUnsigned128Byte();
				...
				int i_55_ = Class78.packetStream.readUnsignedByte();
				int i_56_ = Class82.baseTileX * 2 - -(0xf & i_55_ >> 4);
				int i_57_ = 2 * Class106_Sub2.baseTileY + (0xf & i_55_);
				boolean bool = ((Class78.packetStream.readUnsignedByte() ^ 0xffffffff) != -1);
				int i_58_ = Class78.packetStream.readByte() + i_56_;
				int i_59_ = i_57_ - -Class78.packetStream.readByte();
				int i_60_ = Class78.packetStream.method2375((byte) 1);
				int i_61_ = Class78.packetStream.method2375((byte) 1);
				int i_62_ = Class78.packetStream.readUnsignedShort();
				int i_63_ = Class78.packetStream.readByte();
				int i_64_ = 4 * Class78.packetStream.readUnsignedByte();
				int i_65_ = Class78.packetStream.readUnsignedShort();
				int i_66_ = Class78.packetStream.readUnsignedShort();
				int i_67_ = Class78.packetStream.readUnsignedByte();
				if ((i_67_ ^ 0xffffffff) == -256)
					i_67_ = -1;
				int i_68_ = Class78.packetStream.readUnsignedByte();
					...
					if (i_60_ != 0) {
						...
						if (i_60_ < 0) {
							...
							if ((Class109.anInt1567 ^ 0xffffffff) != (i_71_ ^ 0xffffffff))
								class_r = Class143.players[i_71_];
							else
							...
							class_r = VarcLoader.aClass_r_Sub2Array1002[i_73_];
						}
						if (class_r != null) {
							RenderAnimation class135 = class_r.get_render_sequence(-1, null);
							if ((((RenderAnimation) class135).anIntArrayArray1905 != null) && (((RenderAnimation) class135).anIntArrayArray1905[i_69_]) != null) {
								int i_74_ = (((RenderAnimation) class135).anIntArrayArray1905[i_69_][0]);
								int i_75_ = (((RenderAnimation) class135).anIntArrayArray1905[i_69_][2]);
								int i_76_ = ((Entity) class_r).f_fb.method203(-105);
								int i_77_ = MathUtils.SINE[i_76_];
								int i_78_ = MathUtils.COSINE[i_76_];
								int i_79_ = i_75_ * i_77_ + i_74_ * i_78_ >> 15;
								i_75_ = i_75_ * i_78_ - i_77_ * i_74_ >> 15;
								i_74_ = i_79_;
								i_56_ += i_74_;
								i_63_ -= (((RenderAnimation) class135).anIntArrayArray1905[i_69_][1]);
								i_57_ += i_75_;
							}
						}
					}
					Class_g class_g = new Class_g(i_62_, Class60.basePlane, i_56_, i_57_, i_63_, Client.cycle + i_65_, i_66_ - -Client.cycle, i_67_, i_68_, i_61_, i_64_, bool, 634);
					class_g.method2686(i_65_ - -Client.cycle, i_58_, (-i_64_ + Class6.getAverageHeight(i_58_, 57, Class60.basePlane, i_59_)), i_59_, 70);
					Class12.aClass166_180.push_head(new Class246_Sub1_Sub7(class_g));
				}
			} else if (class12 == Class81.aClass12_1066) {
				int i_80_ = Class78.packetStream.readUnsignedByte();
				int i_81_ = ((i_80_ & 0x73) >> 4) + Class82.baseTileX;
				int i_82_ = Class106_Sub2.baseTileY + (0x7 & i_80_);
				int i_83_ = Class78.packetStream.readUnsignedShort();
				if ((i_83_ ^ 0xffffffff) == -65536)
					i_83_ = -1;
				int i_84_ = Class78.packetStream.readUnsignedByte();
				int i_85_ = 0xf & i_84_ >> 4;
				int i_86_ = i_84_ & 0x7;
				int i_87_ = Class78.packetStream.readUnsignedByte();
				int i_88_ = Class78.packetStream.readUnsignedByte();
				if (i_81_ >= 0 && i_82_ >= 0 && (i_81_ ^ 0xffffffff) > (Class38_Sub1_Sub1.anInt6770 ^ 0xffffffff) && Class152.anInt2205 > i_82_) {
					int i_89_ = i_85_ + 1;
					if ((((Entity) Client.local_player).f_mc[0] ^ 0xffffffff) <= (i_81_ - i_89_ ^ 0xffffffff) && (i_89_ + i_81_ >= ((Entity) Client.local_player).f_mc[0]) && ((i_82_ + -i_89_ ^ 0xffffffff) >= (((Entity) Client.local_player).f_nc[0] ^ 0xffffffff)) && ((i_82_ + i_89_ ^ 0xffffffff) <= (((Entity) Client.local_player).f_nc[0] ^ 0xffffffff)))
				...
				int i_90_ = Class78.packetStream.readUnsignedByte();
				int i_91_ = (i_90_ >> 4 & 0x7) + Class82.baseTileX;
				int i_92_ = (0x7 & i_90_) + Class106_Sub2.baseTileY;
				int i_93_ = Class78.packetStream.readUnsignedShort();
				int i_94_ = Class78.packetStream.readUnsignedByte();
				int i_95_ = Class78.packetStream.readUnsignedShort();
				int i_96_ = Class78.packetStream.readUnsignedByte();
				if ((i_91_ ^ 0xffffffff) <= -1 && (i_92_ ^ 0xffffffff) <= -1 && ((Class38_Sub1_Sub1.anInt6770 ^ 0xffffffff) < (i_91_ ^ 0xffffffff)) && Class152.anInt2205 > i_92_) {
					...
					if ((i_99_ ^ 0xffffffff) > -4 && Class211.method1389(i_91_, -29792, i_92_))
						i_99_++;
					Class59_Sub3_Sub2 class59_sub3_sub2 = new Class59_Sub3_Sub2(i_93_, i_95_, Client.cycle, Class60.basePlane, i_99_, i_97_, Class6.getAverageHeight(i_97_, 64, (Class60.basePlane), i_98_) - i_94_, i_98_, i_91_, i_91_, i_92_, i_92_, i_96_);
					ScriptEvent.aClass166_4968.push_head(new Class246_Sub1_Sub9(class59_sub3_sub2));
				}
			} else if (StructLoader.aClass12_809 == class12) {
				int i_100_ = Class78.packetStream.readUnsignedByte();
				int i_101_ = ((0x74 & i_100_) >> 4) + Class82.baseTileX;
				int i_102_ = Class106_Sub2.baseTileY - -(i_100_ & 0x7);
				int i_103_ = Class78.packetStream.readUnsignedShort();
				int i_104_ = Class78.packetStream.readUnsignedShort();
				...
				if (Class251.aClass85_3551 != null && (i_101_ ^ 0xffffffff) <= -1 && (i_102_ ^ 0xffffffff) <= -1 && ((Class38_Sub1_Sub1.anInt6770 ^ 0xffffffff) < (i_101_ ^ 0xffffffff)) && i_102_ < Class152.anInt2205) {
					Class246_Sub13 class246_sub13 = ((Class246_Sub13) (Class251.aClass85_3551.get((long) (i_101_ | (i_102_ << 14 | Class60.basePlane << 28)))));
					if (class246_sub13 != null) {
						...
						MapScenes.method1645(Class60.basePlane, 1546660647, i_101_, i_102_);
					}
				}
			} else if (Class78.SEND_WORLD_OBJECT == class12) {
				int i_106_ = Class78.packetStream.readUnsigned128Byte();
				int i_107_ = i_106_ >> 2;
				...
				int i_114_ = Class78.packetStream.readUnsignedShort();
				...
				int i_122_ = Class78.packetStream.readUnsignedShort();
				int i_123_ = Class78.packetStream.readUnsignedShort();
				int i_124_ = Class78.packetStream.readUnsigned128Byte();
				...
				if ((i_125_ ^ 0xffffffff) <= -1 && (i_126_ ^ 0xffffffff) <= -1 && ((Class38_Sub1_Sub1.anInt6770 ^ 0xffffffff) < (i_125_ ^ 0xffffffff)) && Class152.anInt2205 > i_126_ && (i_123_ ^ 0xffffffff) != (Class109.anInt1567 ^ 0xffffffff)) {
					...
					MapScenes.method1645(Class60.basePlane, 1546660647, i_125_, i_126_);
				}
			} else {
				if (i < 35)
					method2715(false);
				if (Class169.SOME_PACKET_3 == class12) {
					...
					boolean bool = Class78.packetStream.readUnsignedByte() != 0;
					int distanceX = Class78.packetStream.readByte() + baseX;
					int distanceY = Class78.packetStream.readByte() + baseY;
					int lockOn = Class78.packetStream.method2375((byte) 1);
					int gfxId = Class78.packetStream.readUnsignedShort();
					int startHeight = 4 * Class78.packetStream.readUnsignedByte();
					int endHeight = 4 * Class78.packetStream.readUnsignedByte();
					int delay = Class78.packetStream.readUnsignedShort();
					int delayAndSpeed = Class78.packetStream.readUnsignedShort();
					int angle1 = Class78.packetStream.readUnsignedByte();
					...
					if (baseX >= 0 && (baseY ^ 0xffffffff) <= -1 && baseX < Class38_Sub1_Sub1.anInt6770 * 2 && ((baseY ^ 0xffffffff) > (2 * Class38_Sub1_Sub1.anInt6770 ^ 0xffffffff)) && (distanceX ^ 0xffffffff) <= -1 && distanceY >= 0 && (distanceX ^ 0xffffffff) > (2 * Class152.anInt2205 ^ 0xffffffff) && distanceY < Class152.anInt2205 * 2 && gfxId != 65535) {
						...
						distanceX *= 64;
						startHeight <<= 0;
						Class_g class_g = (new Class_g(gfxId, Class60.basePlane, baseX, baseY, startHeight, Client.cycle + delay, delayAndSpeed - -Client.cycle, angle1, angle2, lockOn, endHeight, bool, 634));
						class_g.method2686((delay + Client.cycle), distanceX, (-endHeight + Class6.getAverageHeight(distanceX, -96, Class60.basePlane, distanceY)), distanceY, 52);
						Class12.aClass166_180.push_head(new Class246_Sub1_Sub7(class_g));
					}
				} else {
