...
final class Class256 {
	...
	static final void method1662(Signlink class52, byte i, Frame frame) {
		try {
			...
			throw Class193.method1272(runtimeexception, ("wl.A(" + (class52 != null ? "{...}" : "null") + ',' + i + ','
					+ (frame != null ? "{...}" : "null") + ')'));
		}
	}
	...
	Class256(Class260_Sub2 class260_sub2, long l, int i) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("wl.<init>(" + (class260_sub2 != null ? "{...}" : "null") + ',' + l + ',' + i + ')'));
		}
	}
	...
	static final void method1663(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_) {
		try {
			...
			throw Class193.method1272(runtimeexception,
					("wl.C(" + i + ',' + i_0_ + ',' + i_1_ + ',' + i_2_ + ',' + i_3_ + ',' + i_4_ + ',' + i_5_ + ')'));
		}
	}

	static final CollisionMap method1664(byte i, int i_6_, int i_7_) {
		try {
			anInt3676++;
			CollisionMap class199 = new CollisionMap();
			((CollisionMap) class199).anInt2836 = -1;
			((CollisionMap) class199).anInt2830 = 1 + i_6_ + 5;
			((CollisionMap) class199).anInt2837 = 1 + i_7_ + 5;
			if (i > -117)
				return null;
			((CollisionMap) class199).anInt2841 = -1;
			((CollisionMap) class199).anIntArrayArray2829 = (new int[((CollisionMap) class199).anInt2837][((CollisionMap) class199).anInt2830]);
