...
final class Class66 {
	...
	static int anInt877;
	static MultilingualString aClass67_878 = new MultilingualString("skill: ", "Fertigkeit: ", "comp\u00e9tence ", "habilidade: ");
	private Class166 aClass166_879;
	private Class246_Sub8[] aClass246_Sub8Array880;
	static int anInt881;
	static AbstractSprite[] aClass_lArray882;
	...
	static final boolean method430(byte i, int i_1_, int i_2_) {
		try {
			...
			if (i >= -87)
				method432(-8);
			LocType class185 = Class143.aClass251_2067.list(i_1_, 0);
			if (i_2_ == 11)
				i_2_ = 10;
	...
	static final void method434(int i, int i_4_, Npc class_r_sub2, Player class_r_sub1, int i_5_, int i_6_, int i_7_, LocType class185) {
		try {
			anInt877++;
			...
			if (class185 == null) {
				if (class_r_sub2 != null) {
					...
					if (class253 != null) {
						((Class246_Sub5) class246_sub5).anInt3880 = i - -((NpcType) class253).size << 7;
						((Class246_Sub5) class246_sub5).anInt3872 = i_5_ - -((NpcType) class253).size << 7;
						((Class246_Sub5) class246_sub5).anInt3882 = Class246_Sub34.method2196((byte) -26, class_r_sub2);
						((Class246_Sub5) class246_sub5).anInt3870 = ((NpcType) class253).f_sb << 7;
						((Class246_Sub5) class246_sub5).anInt3887 = ((NpcType) class253).f_jb;
					}
					VarcLoader.aClass166_992.push_head(class246_sub5);
					...
					Class187.aClass85_2651.method547((long) (((Entity) class_r_sub1).f_db), -2301, class246_sub5);
				}
			} else {
				((Class246_Sub5) class246_sub5).aClass185_3871 = class185;
				int i_8_ = ((LocType) class185).size_x;
				int i_9_ = ((LocType) class185).size_y;
				if (i_6_ == 1 || i_6_ == 3) {
					i_8_ = ((LocType) class185).size_y;
					i_9_ = ((LocType) class185).size_x;
				}
				((Class246_Sub5) class246_sub5).anInt3887 = ((LocType) class185).anInt2578;
				((Class246_Sub5) class246_sub5).anInt3889 = ((LocType) class185).anint2113;
				((Class246_Sub5) class246_sub5).anInt3872 = i_5_ + i_9_ << 7;
				((Class246_Sub5) class246_sub5).anIntArray3878 = ((LocType) class185).field3392;
				((Class246_Sub5) class246_sub5).anInt3880 = i_8_ + i << 7;
				((Class246_Sub5) class246_sub5).anInt3882 = ((LocType) class185).ambient_sound;
				((Class246_Sub5) class246_sub5).anInt3870 = ((LocType) class185).anint2083 << 7;
				((Class246_Sub5) class246_sub5).anInt3890 = ((LocType) class185).anint2112;
				...
				Class150.aClass166_2195.push_head(class246_sub5);
			}
		} catch (RuntimeException runtimeexception) {
	...
	Class66(int i, int i_12_, int i_13_) {
		...
		try {
			texture_size = i_12_;
			anInt876 = i;
			aClass246_Sub8Array880 = new Class246_Sub8[texture_size];
