...
public final class Cursors {
	...
	private CacheIndex aClass_fs2233;
	...
	final Class60 method1032(int i, int i_0_) {
		try {
			...
			byte[] is = aClass_fs2233.get_file(i, 33);
			class60 = new Class60();
			((Class60) class60).aClass156_828 = this;
			if (is != null)
				class60.method410(new Buffer(is), 27223);
			synchronized (aClass54_2234) {
	...
	final void method1033(boolean bool) {
		try {
			...
			if (bool != true)
				method1036(51, 124);
			anInt2235++;
			synchronized (((Cursors) this).aClass54_2242) {
				((Cursors) this).aClass54_2242.method369(false);
			}
		} catch (RuntimeException runtimeexception) {
	...
	final void method1034(int i) {
		try {
			...
			anInt2231++;
			synchronized (((Cursors) this).aClass54_2242) {
				((Cursors) this).aClass54_2242.method383(96);
			}
		} catch (RuntimeException runtimeexception) {
	...
	final void method1036(int i, int i_8_) {
		try {
			...
			anInt2237++;
			synchronized (((Cursors) this).aClass54_2242) {
				((Cursors) this).aClass54_2242.method380(i, -50);
			}
			if (i_8_ != -24605)
				((Cursors) this).aClass_fs2239 = null;
		} catch (RuntimeException runtimeexception) {
	...
	Cursors(Class101 class101, int i, CacheIndex class_fs, CacheIndex class_fs_9_) {
		try {
			((Cursors) this).aClass_fs2239 = class_fs_9_;
			aClass_fs2233 = class_fs;
			aClass_fs2233.child_count(33);
		} catch (RuntimeException runtimeexception) {
	...
	static {
		new MultilingualString("Changes will take effect on your clan in the next 60 seconds.", "Die \u00c4nderungen am Chatraum werden innerhalb von 60 Sekunden g\u00fcltig.", "Les modifications seront apport\u00e9es \u00e0 votre clan dans les prochaines 60 secondes.", "As altera\u00e7\u00f5es passar\u00e3o a valer no seu cl\u00e3 nos pr\u00f3ximos 60 segundos.");
	}
}
