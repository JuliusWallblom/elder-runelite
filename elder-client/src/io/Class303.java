...
final class Class303 {
	...
	Class303 aClass162_2296;
	static IncomingPacket OPEN_INTERFACE_IN = new IncomingPacket(22, 13);
	...
	static final void method1073(Class100 class100, Tile class147) {
		if (((Tile) class147).aBool2171) {
			int i = ((Tile) class147).aShort2161;
			int i_0_ = ((Tile) class147).aShort2157;
			byte i_1_ = ((Tile) class147).aByte2175;
			byte i_2_ = ((Tile) class147).aByte2174;
			int i_3_ = (i << Class126.anInt1781) + Class40_Sub7.anInt5174;
			int i_4_ = (i_0_ << Class126.anInt1781) + Class40_Sub7.anInt5174;
			Tile[][] class147s = Class106.tiles[i_1_];
			float f;
			if (Class154.aClass210Array2215 == Class59_Sub3_Sub4.aClass210Array6993) {
				Class259_Sub3.aClass260_5357.GA(Class246_Sub28_Sub3.aClass210Array5899[0].a(i_3_, i_4_),
						Entity.method2672(i, i_0_), Class133.method899(i, i_0_), Class59_Sub4_Sub1.method2638(i, i_0_));
				f = 251.5F;
			} else
				f = 201.5F - 50.0F * (float) (i_2_ + 1);
			Class259_Sub3.aClass260_5357.g(3000.0F, f * 1.5F);
			if (((Tile) class147).aBool2166) {
				if (Class81.aBool1068) {
					if (i_1_ > 0) {
						Tile class147_5_ = (Class106.tiles[i_1_ - 1][i][i_0_]);
						if (class147_5_ != null && ((Tile) class147_5_).aBool2171)
							return;
					}
					if (i <= Class244.anInt3454 && i > Class56.anInt796) {
						Tile class147_6_ = class147s[i - 1][i_0_];
						if (class147_6_ != null && ((Tile) class147_6_).aBool2171
								&& (((Tile) class147_6_).aBool2166
										|| ((((Tile) class147).aByte2168 & 0x1) == 0)))
							return;
					}
					if (i >= Class244.anInt3454 && i < Class188.anInt2662 - 1) {
						Tile class147_7_ = class147s[i + 1][i_0_];
						if (class147_7_ != null && ((Tile) class147_7_).aBool2171
								&& (((Tile) class147_7_).aBool2166
										|| ((((Tile) class147).aByte2168 & 0x4) == 0)))
							return;
					}
					if (i_0_ <= Class59_Sub2_Sub2.anInt6025 && i_0_ > Class133.anInt1834) {
						Tile class147_8_ = class147s[i][i_0_ - 1];
						if (class147_8_ != null && ((Tile) class147_8_).aBool2171
								&& (((Tile) class147_8_).aBool2166
										|| ((((Tile) class147).aByte2168 & 0x8) == 0)))
							return;
					}
					if (i_0_ >= Class59_Sub2_Sub2.anInt6025 && i_0_ < Class246_Sub1_Sub10.f_db - 1) {
						Tile class147_9_ = class147s[i][i_0_ + 1];
						if (class147_9_ != null && ((Tile) class147_9_).aBool2171
								&& (((Tile) class147_9_).aBool2166
										|| ((((Tile) class147).aByte2168 & 0x2) == 0)))
							return;
					}
				} else
					Class81.aBool1068 = true;
				((Tile) class147).aBool2166 = false;
				if (((Tile) class147).aClass147_2165 != null) {
					Tile class147_10_ = ((Tile) class147).aClass147_2165;
					Class259_Sub3.aClass260_5357.g(3000.0F,
							(201.5F - 50.0F * (float) ((((Tile) class147_10_).aByte2174) + 1)) * 1.5F);
					if (!Class246_Sub13.method1988((((Tile) class147_10_).aByte2174), i, i_0_))
						Class59_Sub3_Sub4.aClass210Array6993[((Tile) class147_10_).aByte2174].drawShadedTriangle(i,
								i_0_);
					Class59_Sub4 class59_sub4 = ((Tile) class147_10_).aClass59_Sub4_2172;
					if (class59_sub4 != null) {
						if (Class246_Sub28_Sub25.aBool6705) {
							if ((((Class59_Sub4) class59_sub4).anInt5185 & ((Tile) class147).aShort2164) != 0)
								ParamLoader.method1079(class100, ((Class59_Sub4) class59_sub4).anInt5185, i_2_, i,
										i_0_);
							else
								Class246_Sub22.method2081(class100, i_1_, i, i_0_);
							Class259_Sub3.aClass260_5357.method1679(((Class100) class100).anInt1298,
									(((Class100) class100).aClass246_Sub41Array1301));
						}
						class59_sub4.method407(Class259_Sub3.aClass260_5357, -103);
					}
					for (Class3 class3 = ((Tile) class147_10_).aClass3_2160; class3 != null; class3 = ((Class3) class3).aClass3_28) {
				...
				if (bool) {
					Class59_Sub3_Sub4.aClass210Array6993[i_2_].drawShadedTriangle(i, i_0_);
					Class59_Sub1 class59_sub1 = ((Tile) class147).floorDecorationIThink;
				...
				int i_11_ = 0;
				int i_12_ = 0;
				Class59_Sub4 class59_sub4 = ((Tile) class147).aClass59_Sub4_2172;
				...
				if (class59_sub4 != null || class59_sub2 != null) {
					...
					if (Class59_Sub2_Sub2.anInt6025 == i_0_)
						...
						i_11_ += 6;
					i_12_ = ScriptEvent.anIntArray4982[i_11_];
					((Tile) class147).aShort2164 = Class246_Sub1_Sub8_Sub1.aShortArray7164[i_11_];
				}
				if (class59_sub4 != null) {
					if ((((Class59_Sub4) class59_sub4).anInt5185 & Class246_Sub15.anIntArray4443[i_11_]) != 0) {
						if (((Class59_Sub4) class59_sub4).anInt5185 == 16) {
							((Tile) class147).aByte2162 = (byte) 3;
							((Tile) class147).aByte2170 = Class193.aByteArray2714[i_11_];
							((Tile) class147).aByte2169 = (byte) (3 - ((Tile) class147).aByte2170);
						} else if (((Class59_Sub4) class59_sub4).anInt5185 == 32) {
							((Tile) class147).aByte2162 = (byte) 6;
							((Tile) class147).aByte2170 = Class40_Sub9.aByteArray5494[i_11_];
							((Tile) class147).aByte2169 = (byte) (6 - ((Tile) class147).aByte2170);
						} else if (((Class59_Sub4) class59_sub4).anInt5185 == 64) {
							((Tile) class147).aByte2162 = (byte) 12;
							((Tile) class147).aByte2170 = Class40_Sub3.aByteArray4070[i_11_];
							((Tile) class147).aByte2169 = (byte) (12 - ((Tile) class147).aByte2170);
						} else {
							((Tile) class147).aByte2162 = (byte) 9;
							((Tile) class147).aByte2170 = Class247.aByteArray3476[i_11_];
							((Tile) class147).aByte2169 = (byte) (9 - ((Tile) class147).aByte2170);
						}
					} else
						((Tile) class147).aByte2162 = (byte) 0;
					if ((((Class59_Sub4) class59_sub4).anInt5185 & i_12_) != 0
							&& !MouseHandler.method2004(i_2_, i, i_0_, (((Class59_Sub4) class59_sub4).anInt5185))) {
						if (Class246_Sub28_Sub25.aBool6705) {
							Class246_Sub22.method2081(class100, i_1_, i, i_0_);
							Class259_Sub3.aClass260_5357.method1679(((Class100) class100).anInt1298,
									(((Class100) class100).aClass246_Sub41Array1301));
					...
					Class59_Sub4 class59_sub4_13_ = ((Tile) class147).aClass59_Sub4_2152;
					if (class59_sub4_13_ != null && (((Class59_Sub4) class59_sub4_13_).anInt5185 & i_12_) != 0
							&& !MouseHandler.method2004(i_2_, i, i_0_, (((Class59_Sub4) class59_sub4_13_).anInt5185))) {
						if (Class246_Sub28_Sub25.aBool6705) {
							Class246_Sub22.method2081(class100, i_1_, i, i_0_);
							Class259_Sub3.aClass260_5357.method1679(((Class100) class100).anInt1298,
									(((Class100) class100).aClass246_Sub41Array1301));
				...
				if (class59_sub2 != null
						&& !(Class246_Sub28_Sub29.method2818(i_2_, i, i_0_, class59_sub2.method2023(false)))) {
					Class59_Sub2 class59_sub2_14_ = ((Tile) class147).aClass59_Sub2_2159;
					...
					if ((((Class59_Sub2) class59_sub2).anInt4549 & i_12_) != 0) {
						...
						if (i_19_ < i_18_) {
							...
							Class130_Sub3 class130_sub3 = class59_sub2_14_.method407((Class259_Sub3.aClass260_5357),
									-118);
							if (class130_sub3 != null) {
				...
				byte i_20_ = ((Tile) class147).aByte2168;
				if (i_20_ != 0) {
					if (i < Class244.anInt3454 && (i_20_ & 0x4) != 0) {
						Tile class147_21_ = class147s[i + 1][i_0_];
						if (class147_21_ != null && ((Tile) class147_21_).aBool2171)
							Class245.aClass106_3462.method727(class147_21_, 0);
					}
					if (i_0_ < Class59_Sub2_Sub2.anInt6025 && (i_20_ & 0x2) != 0) {
						Tile class147_22_ = class147s[i][i_0_ + 1];
						if (class147_22_ != null && ((Tile) class147_22_).aBool2171)
							Class245.aClass106_3462.method727(class147_22_, 0);
					}
					if (i > Class244.anInt3454 && (i_20_ & 0x1) != 0) {
						Tile class147_23_ = class147s[i - 1][i_0_];
						if (class147_23_ != null && ((Tile) class147_23_).aBool2171)
							Class245.aClass106_3462.method727(class147_23_, 0);
					}
					if (i_0_ > Class59_Sub2_Sub2.anInt6025 && (i_20_ & 0x8) != 0) {
						Tile class147_24_ = class147s[i][i_0_ - 1];
						if (class147_24_ != null && ((Tile) class147_24_).aBool2171)
							Class245.aClass106_3462.method727(class147_24_, 0);
					}
				}
			}
			if (((Tile) class147).aByte2162 != 0) {
				boolean bool = true;
				for (Class3 class3 = ((Tile) class147).aClass3_2160; class3 != null; class3 = ((Class3) class3).aClass3_28) {
					if ((((Class59_Sub3) ((Class3) class3).aClass59_Sub3_24).anInt5056) != VarcLoader.anInt997
							&& ((((Class3) class3).anInt31
									& ((Tile) class147).aByte2162) == ((Tile) class147).aByte2170)) {
						bool = false;
						break;
					}
				}
				if (bool) {
					Class59_Sub4 class59_sub4 = ((Tile) class147).aClass59_Sub4_2172;
					if (!MouseHandler.method2004(i_2_, i, i_0_, ((Class59_Sub4) class59_sub4).anInt5185)) {
						if (Class246_Sub28_Sub25.aBool6705) {
							do {
								if (((Class59_Sub4) class59_sub4).anInt5185 >= 16) {
									...
									if (((Class59_Sub4) class59_sub4).anInt5185 == 16) {
										...
										if (i_26_ < i_25_ && i > 0 && i_0_ <= HDModel.ySize) {
										...
										i_25_ += Class40_Sub7.anInt5174;
										i_26_ += Class40_Sub7.anInt5174;
										if (i_26_ < -i_25_ && i < Class240.xSize && i_0_ < HDModel.ySize) {
											Class246_Sub22.method2081(class100, i_1_, i + 1, (i_0_ + 1));
											break;
										}
									} else if ((((Class59_Sub4) class59_sub4).anInt5185) == 64) {
										i_25_ += Class40_Sub7.anInt5174;
										i_26_ -= Class40_Sub7.anInt5174;
										if (i_26_ > i_25_ && i < Class240.xSize && i_0_ > 0) {
											Class246_Sub22.method2081(class100, i_1_, i + 1, (i_0_ - 1));
											break;
										}
			...
			if (((Tile) class147).aBool2167) {
				try {
					((Tile) class147).aBool2167 = false;
					int i_27_ = 0;
					while_174_: for (Class3 class3 = ((Tile) class147).aClass3_2160; class3 != null; class3 = ((Class3) class3).aClass3_28) {
						Class59_Sub3 class59_sub3 = ((Class3) class3).aClass59_Sub3_24;
						if (((Class59_Sub3) class59_sub3).anInt5056 != VarcLoader.anInt997) {
							for (int i_28_ = (((Class59_Sub3) class59_sub3).aShort5057); (i_28_ <= ((Class59_Sub3) class59_sub3).aShort5065); i_28_++) {
								for (int i_29_ = (((Class59_Sub3) class59_sub3).aShort5064); i_29_ <= (((Class59_Sub3) class59_sub3).aShort5062); i_29_++) {
									Tile class147_30_ = class147s[i_28_][i_29_];
									if (((Tile) class147_30_).aBool2166) {
										((Tile) class147).aBool2167 = true;
										continue while_174_;
									}
									if (((Tile) class147_30_).aByte2162 != 0) {
										int i_31_ = 0;
										...
										if (i_29_ < (((Class59_Sub3) class59_sub3).aShort5062))
											i_31_ += 2;
										if ((i_31_
												& (((Tile) class147_30_).aByte2162)) == (((Tile) class147).aByte2169)) {
											((Tile) class147).aBool2167 = true;
											continue while_174_;
										}
									}
					...
					while (i_27_ > 0) {
						...
						for (int i_38_ = 0; i_38_ < i_27_; i_38_++) {
							...
							if (((Class59_Sub3) class59_sub3).anInt5056 != VarcLoader.anInt997) {
								...
								if (i_39_ > i_36_) {
									...
									int i_40_ = ((((Class59_Sub3) class59_sub3).x) - Class246_Sub1_Sub10.anInt6199);
									int i_41_ = ((((Class59_Sub3) class59_sub3).y) - Class111.anInt1576);
									int i_42_ = ((((Class59_Sub3) (((Class100) class100).aClass59_Sub3Array1295[i_37_])).x)
											- Class246_Sub1_Sub10.anInt6199);
									int i_43_ = (((Class59_Sub3) (((Class100) class100).aClass59_Sub3Array1295[i_37_])).y
											- Class111.anInt1576);
						...
						((Class59_Sub3) class59_sub3).anInt5056 = VarcLoader.anInt997;
						if (!Class_u_Sub1.method2419(i_2_, ((Class59_Sub3) class59_sub3).aShort5057,
								((Class59_Sub3) class59_sub3).aShort5065, ((Class59_Sub3) class59_sub3).aShort5064,
								((Class59_Sub3) class59_sub3).aShort5062, class59_sub3.method2168(-25430))) {
							if (Class246_Sub28_Sub25.aBool6705) {
								if (((Class59_Sub3) class59_sub3).aByte5055 != 0) {
									...
									Class246_Sub32.method2165(class100, i_1_,
											(((Class59_Sub3) class59_sub3).aShort5057),
											(((Class59_Sub3) class59_sub3).aShort5064),
											(((Class59_Sub3) class59_sub3).aShort5065),
											(((Class59_Sub3) class59_sub3).aShort5062));
								Class259_Sub3.aClass260_5357.method1679(((Class100) class100).anInt1298,
										(((Class100) class100).aClass246_Sub41Array1301));
							}
						...
						for (int i_46_ = ((Class59_Sub3) class59_sub3).aShort5057; i_46_ <= ((Class59_Sub3) class59_sub3).aShort5065; i_46_++) {
							for (int i_47_ = (((Class59_Sub3) class59_sub3).aShort5064); (i_47_ <= ((Class59_Sub3) class59_sub3).aShort5062); i_47_++) {
								Tile class147_48_ = class147s[i_46_][i_47_];
								if (((Tile) class147_48_).aByte2162 != 0)
									Class245.aClass106_3462.method727(class147_48_, 0);
								else if ((i_46_ != i || i_47_ != i_0_) && (((Tile) class147_48_).aBool2171))
									Class245.aClass106_3462.method727(class147_48_, 0);
							}
						}
					}
			...
			if (((Tile) class147).aClass129_2173 != null
					&& (((Tile) class147).aByte2154 == (byte) (Class38_Sub1_Sub1.anInt6768 & 0xff))) {
				Class129 class129 = ((Tile) class147).aClass129_2173;
				int i_49_ = Class59_Sub3_Sub4.aClass210Array6993[i_1_].l(i, i_0_);
				int i_50_;
				if (i_1_ < Class154_Sub1.anInt4803 - 1)
					i_50_ = (Class59_Sub3_Sub4.aClass210Array6993[i_1_].l(i, i_0_)
							- Class59_Sub3_Sub4.aClass210Array6993[i_1_ + 1].l(i, i_0_));
				else
					i_50_ = 8 << Class126.anInt1781;
				MapFunction.aClass_c2007.method585(i_3_, i_49_, i_4_, (((Class100) class100).anIntArray1304));
				int i_51_ = ((Class100) class100).anIntArray1304[2];
				MapFunction.aClass_c2007.method585(i_3_, i_49_ - i_50_, i_4_, (((Class100) class100).anIntArray1304));
			...
			if (((Tile) class147).aBool2171) {
				if (((Tile) class147).aByte2162 == 0) {
					if (i <= Class244.anInt3454 && i > Class56.anInt796) {
						Tile class147_55_ = class147s[i - 1][i_0_];
						if (class147_55_ != null && ((Tile) class147_55_).aBool2171)
							return;
					}
					if (i >= Class244.anInt3454 && i < Class188.anInt2662 - 1) {
						Tile class147_56_ = class147s[i + 1][i_0_];
						if (class147_56_ != null && ((Tile) class147_56_).aBool2171)
							return;
					}
					if (i_0_ <= Class59_Sub2_Sub2.anInt6025 && i_0_ > Class133.anInt1834) {
						Tile class147_57_ = class147s[i][i_0_ - 1];
						if (class147_57_ != null && ((Tile) class147_57_).aBool2171)
							return;
					}
					if (i_0_ >= Class59_Sub2_Sub2.anInt6025 && i_0_ < Class246_Sub1_Sub10.f_db - 1) {
						Tile class147_58_ = class147s[i][i_0_ + 1];
						if (class147_58_ != null && ((Tile) class147_58_).aBool2171)
							return;
					}
					((Tile) class147).aBool2171 = false;
					...
					if (((Tile) class147).aShort2164 != 0) {
						Class59_Sub2 class59_sub2 = ((Tile) class147).aClass59_Sub2_2153;
						if (class59_sub2 != null
								&& !(Class246_Sub28_Sub29.method2818(i_2_, i, i_0_, class59_sub2.method2023(false)))) {
							if ((((Class59_Sub2) class59_sub2).anInt4549 & ((Tile) class147).aShort2164) != 0) {
								if (Class246_Sub28_Sub25.aBool6705) {
									Class246_Sub22.method2081(class100, i_1_, i, i_0_);
									Class259_Sub3.aClass260_5357.method1679(((Class100) class100).anInt1298,
											(((Class100) class100).aClass246_Sub41Array1301));
								}
								Class130_Sub3 class130_sub3 = class59_sub2.method407((Class259_Sub3.aClass260_5357),
										-123);
								if (class130_sub3 != null) {
									((Class130_Sub3) class130_sub3).aClass59_4414 = class59_sub2;
									((Class130_Sub3) class130_sub3).anInt4408 = i_1_;
								...
								Class59_Sub2 class59_sub2_64_ = ((Tile) class147).aClass59_Sub2_2159;
								if (i_63_ > i_62_) {
									Class130_Sub3 class130_sub3 = (class59_sub2.method407(Class259_Sub3.aClass260_5357,
											-119));
									if (class130_sub3 != null) {
									...
									Class130_Sub3 class130_sub3 = (class59_sub2_64_
											.method407(Class259_Sub3.aClass260_5357, -88));
									if (class130_sub3 != null) {
						...
						Class59_Sub4 class59_sub4 = ((Tile) class147).aClass59_Sub4_2172;
						Class59_Sub4 class59_sub4_65_ = ((Tile) class147).aClass59_Sub4_2152;
						if (class59_sub4_65_ != null
								&& (((Class59_Sub4) class59_sub4_65_).anInt5185 & ((Tile) class147).aShort2164) != 0
								&& !MouseHandler.method2004(i_2_, i, i_0_,
										(((Class59_Sub4) class59_sub4_65_).anInt5185))) {
							if (Class246_Sub28_Sub25.aBool6705) {
								ParamLoader.method1079(class100, (((Class59_Sub4) class59_sub4_65_).anInt5185), i_1_, i,
										i_0_);
								Class259_Sub3.aClass260_5357.method1679(((Class100) class100).anInt1298,
										(((Class100) class100).aClass246_Sub41Array1301));
							}
							Class130_Sub3 class130_sub3 = class59_sub4_65_.method407((Class259_Sub3.aClass260_5357),
									-105);
							if (class130_sub3 != null) {
						...
						if (class59_sub4 != null
								&& (((Class59_Sub4) class59_sub4).anInt5185 & ((Tile) class147).aShort2164) != 0
								&& !MouseHandler.method2004(i_2_, i, i_0_, (((Class59_Sub4) class59_sub4).anInt5185))) {
							if (Class246_Sub28_Sub25.aBool6705) {
								ParamLoader.method1079(class100, ((Class59_Sub4) class59_sub4).anInt5185, i_1_, i,
										i_0_);
								Class259_Sub3.aClass260_5357.method1679(((Class100) class100).anInt1298,
										(((Class100) class100).aClass246_Sub41Array1301));
							}
					...
					if (i_1_ < Class154_Sub1.anInt4803 - 1) {
						Tile class147_66_ = (Class106.tiles[i_1_ + 1][i][i_0_]);
						if (class147_66_ != null && ((Tile) class147_66_).aBool2171)
							Class245.aClass106_3462.method725((byte) -73, class147_66_);
					}
					if (i < Class244.anInt3454) {
						Tile class147_67_ = class147s[i + 1][i_0_];
						if (class147_67_ != null && ((Tile) class147_67_).aBool2171)
							Class245.aClass106_3462.method727(class147_67_, 0);
					}
					if (i_0_ < Class59_Sub2_Sub2.anInt6025) {
						Tile class147_68_ = class147s[i][i_0_ + 1];
						if (class147_68_ != null && ((Tile) class147_68_).aBool2171)
							Class245.aClass106_3462.method727(class147_68_, 0);
					}
					if (i > Class244.anInt3454) {
						Tile class147_69_ = class147s[i - 1][i_0_];
						if (class147_69_ != null && ((Tile) class147_69_).aBool2171)
							Class245.aClass106_3462.method727(class147_69_, 0);
					}
					if (i_0_ > Class59_Sub2_Sub2.anInt6025) {
						Tile class147_70_ = class147s[i][i_0_ - 1];
						if (class147_70_ != null && ((Tile) class147_70_).aBool2171)
	...
	static final void method1074(MapFunction class140, Class246_Sub2 class246_sub2, byte i, SceneGraph class260) {
		try {
			anInt2295++;
			AbstractSprite class_l = class140.method944(105, class260);
			if (class_l != null) {
				...
				if (((MapFunction) class140).aString1998 != null) {
					i_75_ = (Class217.aClass73_3022.method458(null, null, (byte) -71, Class214.aStringArray2986,
							((MapFunction) class140).aString1998));
				...
				if (i == 55) {
					...
					int i_82_ = ((int) (32767.0
							* (Math.atan2((double) (-(((Class246_Sub2) class246_sub2).anInt3810) + i_73_),
									(double) (i_74_ + -(((Class246_Sub2) class246_sub2).anInt3805)))
									/ 3.141592653589793))
							& 0xffff);
					class_l.method736((float) i_73_ + (float) i_71_ / 2.0F, (float) i_71_ / 2.0F + (float) i_74_, 4096,
							i_82_);
					int i_83_ = -2;
					int i_84_ = -2;
					int i_85_ = -2;
					...
					if (((MapFunction) class140).aString1998 != null) {
						...
						if (((MapFunction) class140).anInt2013 != 0)
							class260.method1734(i_83_, -i_83_ + i_85_, i_84_, (byte) 58,
									(((MapFunction) class140).anInt2013), i_86_ - i_84_);
						if (((MapFunction) class140).anInt1997 != 0)
							class260.method1736(i_83_, (((MapFunction) class140).anInt1997), i_86_ - i_84_, 8,
									-i_83_ + i_85_, i_84_);
						for (int i_87_ = 0; (i_87_ ^ 0xffffffff) > (i_75_ ^ 0xffffffff); i_87_++) {
							...
							Class129.aClass198_1806.method1304(class260, string, i_80_, i_81_,
									((MapFunction) class140).anInt2022, true);
							i_81_ += Class129.aClass198_1806.method1303();
						}
					}
					if (((MapFunction) class140).anInt2026 != -1 || ((MapFunction) class140).aString1998 != null) {
						...
						Class211.aClass166_2963.push_head(class246_sub10);
					}
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("pf.G(" + (class140 != null ? "{...}" : "null") + ',' + (class246_sub2 != null ? "{...}" : "null")
							+ ',' + i + ',' + (class260 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	static final void method1075(int i, boolean bool, int i_88_, int i_89_, int i_90_) {
		try {
			int i_91_ = 0;
			if (bool == true) {
				for (/**/; (i_91_ ^ 0xffffffff) > (SequenceType.anInt1738 ^ 0xffffffff); i_91_++) {
					Rectangle rectangle = Class246_Sub28_Sub22.aRectangleArray6629[i_91_];
					if ((i ^ 0xffffffff) > (rectangle.width + rectangle.x ^ 0xffffffff)
							&& (rectangle.x ^ 0xffffffff) > (i_89_ + i ^ 0xffffffff)
							&& i_90_ < rectangle.height + rectangle.y && rectangle.y < i_88_ + i_90_)
			...
			throw Class193.method1272(runtimeexception,
					("pf.B(" + i + ',' + bool + ',' + i_88_ + ',' + i_89_ + ',' + i_90_ + ')'));
		}
	}

	final Class303 method1076(int i, boolean bool) {
		try {
			if (bool != false)
				return null;
			anInt2298++;
			return new Class303(((Class303) this).anInt2290, i);
		} catch (RuntimeException runtimeexception) {
	...
	static final boolean method1077(int i) {
		try {
			...
			if (Class106_Sub2.aBool5333) {
				try {
					if (((Boolean) Class80.method521(Client.sign_link.anApplet733, "showingVideoAd", 112))
							.booleanValue())
						return false;
					return true;
	...
	final Class4 method1078(byte i) {
		try {
			if (i <= 2)
				return null;
			anInt2303++;
			return Class59_Sub1_Sub1.method2541(0, ((Class303) this).anInt2290);
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, "pf.A(" + i + ')');
		}
	}

	Class303(int i, int i_92_) {
		try {
			((Class303) this).anInt2289 = i_92_;
			((Class303) this).anInt2290 = i;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, "pf.<init>(" + i + ',' + i_92_ + ')');
		}
	}

	Class303(Class303 class162_93_, int i) {
		try {
			((Class303) this).aClass162_2296 = class162_93_;
			((Class303) this).anInt2290 = ((Class303) ((Class303) this).aClass162_2296).anInt2290;
			((Class303) this).aClass_c2291 = ((Class303) ((Class303) this).aClass162_2296).aClass_c2291;
			((Class303) this).anInt2289 = ((Class303) ((Class303) this).aClass162_2296).anInt2289 - -i;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception,
					("pf.<init>(" + (class162_93_ != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}
}
