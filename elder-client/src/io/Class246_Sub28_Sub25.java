...
final class Class246_Sub28_Sub25 extends TextureOperation {
	static Class81 aClass81_6700 = new Class81(13, 0, 1, 0);
	static int anInt6701;
	static StructLoader struct_loader;
	static MultilingualString aClass67_6703 = new MultilingualString("Loading world list data", "Lade Liste der Welten",
	...
	static String[] aStringArray6707 = { "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov",
			"Dec" };
