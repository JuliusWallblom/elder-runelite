...
final class Class246_Sub32 extends Node {
	...
	static final void method2164(int i) {
		try {
			...
			UnderlayLoader.method701(4);
			for (int i_0_ = 0; i_0_ < 2048; i_0_++)
				Class143.players[i_0_] = null;
			Client.local_player = null;
			for (int i_1_ = 0; i_1_ < VarcLoader.aClass_r_Sub2Array1002.length; i_1_++) {
				Npc class_r_sub2 = VarcLoader.aClass_r_Sub2Array1002[i_1_];
				if (class_r_sub2 != null)
					((Entity) class_r_sub2).faceEntity = -1;
			}
	...
	static final void method2165(Class100 class100, int i, int i_3_, int i_4_, int i_5_, int i_6_) {
		...
		while_17_: for (int i_7_ = i_3_; i_7_ <= i_5_; i_7_++) {
			for (int i_8_ = i_4_; i_8_ <= i_6_; i_8_++) {
				long l = MapRegion.aLongArrayArrayArray3648[i][i_7_][i_8_];
				long l_9_ = 0L;
				while_16_: while (l_9_ <= 48L) {
					int i_10_ = (int) (l >>> (int) l_9_ & 0xffffL);
					if (i_10_ <= 0)
						break;
					Class174 class174 = StructLoader.aClass174Array811[i_10_ - 1];
			...
			while_18_: do {
				try {
					...
					if ((i_18_ ^ 0xffffffff) > -1 || (i_19_ ^ 0xffffffff) > -1
							|| ((-1 + Class38_Sub1_Sub1.anInt6770 ^ 0xffffffff) >= (i_18_ ^ 0xffffffff))
							|| i_19_ >= Class152.anInt2205 - 1)
						break while_19_;
						...
						do {
							if ((i_16_ ^ 0xffffffff) != -2) {
								if ((i_16_ ^ 0xffffffff) == -3) {
									Class_f class_f = ((Class_f) (Class17.method168(i, i_18_, i_19_,
											(aClass5051 != null ? aClass5051
													: (aClass5051 = (Client.getClassByName("Class_f")))))));
									if (class_f != null) {
										if ((i_17_ ^ 0xffffffff) == -12)
											i_17_ = 10;
										if (!(class_f instanceof Class59_Sub3_Sub3))
											Class12.method139(i, i_18_, i_17_, 255, i_15_, i_13_,
													class_f.method21(true), i_19_, i_16_);
										else
											((Class59_Sub3_Sub3) (Class59_Sub3_Sub3) class_f).aClass14_6269
													.method156(i_15_, 8192);
									}
								} else {
									if (i_16_ != 3)
										break;
									...
									if (!(class_f instanceof Class59_Sub1_Sub2))
										Class12.method139(i, i_18_, i_17_, 255, i_15_, i_13_, class_f.method21(true),
												i_19_, i_16_);
									else
										((Class59_Sub1_Sub2) (Class59_Sub1_Sub2) class_f).aClass14_6124.method156(i_15_,
												8192);
								}
								break;
							}
								...
								if ((i_17_ ^ 0xffffffff) == -5 || i_17_ == 5)
									...
									if (i_17_ == 6)
										...
										if ((i_17_ ^ 0xffffffff) != -8) {
											if (i_17_ == 8) {
												Class12.method139(i, i_18_, 4, 255, i_15_, 4 + i_13_, i_21_, i_19_,
														i_16_);
												Class12.method139(i, i_18_, 4, 255, i_15_, (2 + i_13_ & 0x3) + 4, i_21_,
														i_19_, i_16_);
											}
										} else
											Class12.method139(i, i_18_, 4, 255, i_15_, 4 + (0x3 & 2 + i_13_), i_21_,
													i_19_, i_16_);
										break;
									}
									break;
					...
					Class_f class_f_22_ = (Class_f) FontMetric.method463(i, i_18_, i_19_);
					do {
					...
					throw Class193.method1272(runtimeexception, ("ov.B(" + i + ',' + i_13_ + ',' + i_14_ + ',' + i_15_
