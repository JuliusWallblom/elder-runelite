...
final class Class137 implements Interface2 {
	...
	static final void method927(int i, int widget, byte i_1_) {
		try {
			anInt1951++;
			if (i_1_ != -109)
				MapRegion.chromas = null;
			Class246_Sub1_Sub10 class246_sub1_sub10 = Class228.method1455(widget, (byte) 116, 7);
			class246_sub1_sub10.method2600(i_1_ ^ 0x6497);
			((Class246_Sub1_Sub10) class246_sub1_sub10).anInt6211 = i;
		} catch (RuntimeException runtimeexception) {
			throw Class193.method1272(runtimeexception, ("mt.D(" + i + ',' + widget + ',' + i_1_ + ')'));
		}
	}

	static final void method928(boolean bool) {
		do {
			if (!Client.current_renderer.method2052(Buffer.anInt5656, 110) && (Class40_Sub6.anInt5103 != Class246_Sub28_Sub24.anInt6681)) {
				Class170.method1125(false, (byte) 104, Class130_Sub8.anInt5618, IdentityKitLoader.anInt1206, false);
			} else {
				Class40.method279(true, Client.sprite_loader);
	...
	static final void addInScreenNpcs(boolean largeScene, byte i) {
		try {
			...
			while (Class78.packetStream.method2478(8, Class130_Sub1_Sub1.anInt7046) >= 15) {
				...
				if (VarcLoader.aClass_r_Sub2Array1002[npcIndex] == null) {
					VarcLoader.aClass_r_Sub2Array1002[npcIndex] = new Npc();
					((Entity) VarcLoader.aClass_r_Sub2Array1002[npcIndex]).f_db = npcIndex;
					bool_4_ = true;
				}
				Npc class_r_sub2 = VarcLoader.aClass_r_Sub2Array1002[npcIndex];
				...
				class_r_sub2.method2934((byte) -128, (Class179.aClass228_2518.list(Class78.packetStream.readBits(-56, 14))));
				class_r_sub2.method2673(((NpcType) (((Npc) class_r_sub2).aClass253_7184)).size, (byte) -120);
				((Entity) class_r_sub2).f_cc = ((NpcType) (((Npc) class_r_sub2).aClass253_7184)).degreesToTurn << 3;
				if ((((Entity) class_r_sub2).f_cc ^ 0xffffffff) == -1)
					class_r_sub2.method2664(104, 0);
				else if (bool_4_)
					class_r_sub2.method2664(76, faceDirection);
				class_r_sub2.method2928(plane, -20437, i_9_ + ((Entity) Client.local_player).f_mc[0], class_r_sub2.method2670((byte) 127), (i_5_ ^ 0xffffffff) == -2, i_8_ + ((Entity) Client.local_player).f_nc[0]);
				if (((Npc) class_r_sub2).aClass253_7184.method1628(-60))
					Class66.method434(((Entity) class_r_sub2).f_mc[0], -1, class_r_sub2, null, ((Entity) class_r_sub2).f_nc[0], 0, ((Class59_Sub3) class_r_sub2).current_plane, null);
			}
	...
	static {
		new MultilingualString("You are temporarily blocked from joining channels - please try again later!", "Du darfst derzeit keine Chatr\u00e4ume betreten - bitte versuch es sp\u00e4ter.", "Vous \u00eates temporairement exclu des canaux - veuillez r\u00e9essayer ult\u00e9rieurement.", "Voc\u00ea est\u00e1 temporariamente impedido de entrar em canais. Tente de novo depois!");
	}
}
