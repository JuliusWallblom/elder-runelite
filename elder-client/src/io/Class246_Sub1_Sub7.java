...
final class Class246_Sub1_Sub7 extends NodeSub {
	...
	public static void method2547(byte i) {
		try {
			MapRegion.map_um = null;
			if (i != 122)
				HDModel.aBoolean3927 = true;
			anIntArray6027 = null;
	...
	static final void method2549(Buffer stream, int i, Signlink class52, int i_2_) {
		try {
			if (i_2_ == -12508) {
				anInt6031++;
				Class246_Sub32 class246_sub32 = new Class246_Sub32();
				((Class246_Sub32) class246_sub32).anInt5043 = stream.readUnsignedByte();
				...
				Class239.aClass166_3372.push_head(class246_sub32);
			}
		} catch (RuntimeException runtimeexception) {
