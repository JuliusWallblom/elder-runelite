...
final class Class18 {
	...
	int total_price;
	static int anInt266;
	static MultilingualString aClass67_267;
	...
	final int get_status() {
		return 0x7 & aByte264;
	}

	final int get_offer_type() {
		if ((aByte264 & 0x8) == 8)
			return 1;
		return 0;
	}
	...
	static final Class109_Sub1_Sub1 method176(boolean bool, byte i, byte[] is, Class260_Sub2 class260_sub2, int i_5_, int i_6_, int i_7_, int i_8_) {
		try {
			if (i > -113)
				aClass67_267 = null;
			anInt261++;
			if (!((Class260_Sub2) class260_sub2).aBool4385 && (!WidgetParent.method2313(200, i_5_) || !WidgetParent.method2313(200, i_6_))) {
	...
	static final Class130_Sub3 method177(int i, byte i_9_) {
		try {
			...
			synchronized (SomeClass.aClass68Array1822) {
				...
				if (((SomeClass.aClass68Array1822.length ^ 0xffffffff) >= (i ^ 0xffffffff)) || SomeClass.aClass68Array1822[i].method446((byte) 102)) {
					...
					class130_sub3 = (Class130_Sub3) SomeClass.aClass68Array1822[i].method441((byte) 110);
	...
	static final void method178(int i) {
		try {
			anInt253++;
			int[] is = new int[((Class191) MapRegion.aClass191_3663).anInt2690];
			int i_11_ = 0;
			if (i <= -105) {
				for (int i_12_ = 0; i_12_ < ((Class191) MapRegion.aClass191_3663).anInt2690; i_12_++) {
					ObjType class197 = MapRegion.aClass191_3663.list(22883, i_12_);
					if ((((ObjType) class197).maleModel0 ^ 0xffffffff) <= -1 || ((ObjType) class197).femaleModel0 >= 0)
						is[i_11_++] = i_12_;
				}
	...
	Class18(Buffer stream) {
		try {
			aByte264 = stream.readByte();
			((Class18) this).id = stream.readUnsignedShort();
			((Class18) this).price = stream.readInt((byte) 123);
			((Class18) this).amount = stream.readInt((byte) 126);
			((Class18) this).sold_amount = stream.readInt((byte) 105);
			((Class18) this).total_price = stream.readInt((byte) 95);
		} catch (RuntimeException runtimeexception) {
	...
	static {
		aClass67_267 = new MultilingualString("Discard", "Ablegen", "Jeter", "Descartar");
	}
}
