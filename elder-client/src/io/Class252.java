...
final class Class252 {
	...
	static final void method1620(int i, int i_9_, int i_10_, int i_11_, boolean bool) {
		try {
			...
			int i_14_ = -i_10_;
			int i_15_ = -1;
			int i_16_ = Class180.method1176(Class110.anInt1573, -24309, i_10_ + i_11_, ObjType.anInt2818);
			int i_17_ = Class180.method1176(Class110.anInt1573, -24309, -i_10_ + i_11_, ObjType.anInt2818);
			RenderAnimation.method918(i_17_, -119, i_9_, i_16_, Class246_Sub28_Sub6.anIntArrayArray6042[i]);
			while ((i_12_ ^ 0xffffffff) > (i_13_ ^ 0xffffffff)) {
				...
				if ((i_14_ ^ 0xffffffff) < -1) {
					...
					int i_18_ = -i_13_ + i;
					int i_19_ = i + i_13_;
					if ((i_19_ ^ 0xffffffff) <= (AbstractModel.anInt1442 ^ 0xffffffff) && Class109_Sub4.anInt4570 >= i_18_) {
						int i_20_ = Class180.method1176(Class110.anInt1573, -24309, i_12_ + i_11_, ObjType.anInt2818);
						int i_21_ = Class180.method1176(Class110.anInt1573, -24309, -i_12_ + i_11_, ObjType.anInt2818);
						if (i_19_ <= Class109_Sub4.anInt4570)
							RenderAnimation.method918(i_21_, 127, i_9_, i_20_, (Class246_Sub28_Sub6.anIntArrayArray6042[i_19_]));
						if ((i_18_ ^ 0xffffffff) <= (AbstractModel.anInt1442 ^ 0xffffffff))
							RenderAnimation.method918(i_21_, -40, i_9_, i_20_, (Class246_Sub28_Sub6.anIntArrayArray6042[i_18_]));
					}
				}
				i_12_++;
				int i_22_ = i + -i_12_;
				int i_23_ = i - -i_12_;
				if ((i_23_ ^ 0xffffffff) <= (AbstractModel.anInt1442 ^ 0xffffffff) && i_22_ <= Class109_Sub4.anInt4570) {
					int i_24_ = Class180.method1176(Class110.anInt1573, -24309, i_11_ + i_13_, ObjType.anInt2818);
					int i_25_ = Class180.method1176(Class110.anInt1573, -24309, i_11_ + -i_13_, ObjType.anInt2818);
					if (i_23_ <= Class109_Sub4.anInt4570)
						RenderAnimation.method918(i_25_, 126, i_9_, i_24_, (Class246_Sub28_Sub6.anIntArrayArray6042[i_23_]));
					if (AbstractModel.anInt1442 <= i_22_)
						RenderAnimation.method918(i_25_, -119, i_9_, i_24_, (Class246_Sub28_Sub6.anIntArrayArray6042[i_22_]));
				}
			}
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1621(byte i) {
		try {
			anInt3563++;
			Widget.custom_pre_eoc_550_sprite_cache.method369(false);
			Widget.pre_eoc_550_sprite_cache.method369(false);
			Widget.pre_eoc_634_sprite_cache.method369(false);
			Widget.osrs_widget_sprite_cache.method369(false);
			Class_ls.aClass54_963.method369(false);
			Class216.font_cache.method369(false);
			Class216.font_cache_550.method369(false);
			Class216.osrs_font_cache.method369(false);
