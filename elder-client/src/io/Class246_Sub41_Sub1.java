...
final class Class246_Sub41_Sub1 extends Class246_Sub41 {
	...
	static final int method2585(byte i, Entity class_r) {
		try {
			if (i != -17)
				Client.client_width = 31;
			anInt6169++;
			if (((Entity) class_r).f_cc == 0)
				return 0;
			if (((Entity) class_r).faceEntity != -1) {
				Entity class_r_7_ = null;
				if (((Entity) class_r).faceEntity >= 32768) {
					if (((Entity) class_r).faceEntity >= 32768)
						class_r_7_ = (Class143.players[-32768 + ((Entity) class_r).faceEntity]);
				} else
					class_r_7_ = (VarcLoader.aClass_r_Sub2Array1002[((Entity) class_r).faceEntity]);
				if (class_r_7_ != null) {
					int i_8_ = (-((Class59_Sub3) class_r_7_).x + ((Class59_Sub3) class_r).x);
					int i_9_ = (-((Class59_Sub3) class_r_7_).y + ((Class59_Sub3) class_r).y);
					if (i_8_ != 0 || i_9_ != 0)
			...
			do {
				if (!(class_r instanceof Player)) {
					...
					if ((((Npc) class_r_sub2).f_vc ^ 0xffffffff) == 0 || (((Entity) class_r_sub2).f_oc != 0 && ((Entity) class_r_sub2).f_kc <= 0))
						break;
					int i_10_ = (((Class59_Sub3) class_r_sub2).x - (-Client.base_x + (-Client.base_x + ((Npc) class_r_sub2).f_vc)) * 64);
					int i_11_ = (-(64 * (-Client.base_y + ((Npc) class_r_sub2).anInt7171 - Client.base_y)) + ((Class59_Sub3) class_r_sub2).y);
				...
				if ((((Player) class_r_sub1).anInt7133 ^ 0xffffffff) != 0 && (((Entity) class_r_sub1).f_oc == 0 || ((Entity) class_r_sub1).f_kc > 0)) {
