...
final class Class130_Sub4 extends Class130 {
	...
	static final void method2080(int i, long l) {
		try {
			anInt4738++;
			int i_0_ = (anInt4745 + ((Class59_Sub3) Client.local_player).x);
			int i_1_ = (Class246_Sub28_Sub27.anInt6755 + ((Class59_Sub3) Client.local_player).y);
			if ((Class_c_Sub1.anInt5366 - i_0_ ^ 0xffffffff) > 499 || -i_0_ + Class_c_Sub1.anInt5366 > 500
					|| Class246_Sub34.anInt5135 - i_1_ < -500 || Class246_Sub34.anInt5135 - i_1_ > 500) {
			...
			if (!((Renderer) Client.current_renderer).aBool605) {
				Camera.camera_pitch += Class24.aFloat341 * (float) l / 6.0F;
				Camera.camera_yaw += (float) l * Class259_Sub2_Sub1.aFloat6906 / 6.0F;
			}
	...
	static {
		...
		anInt4745 = 0;
		new MultilingualString("Now talking in clan channel of player: ", "Clanchat dieses Spieler beigetreten: ",
