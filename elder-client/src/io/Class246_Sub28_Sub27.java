...
final class Class246_Sub28_Sub27 extends TextureOperation {
	...
	public static void method2766(int i) {
		try {
			if (i == 255) {
				io.Client.current_renderer = null;
	...
	final int[] method2135(int i, int i_0_) {
		try {
			...
			if (((Class66) ((TextureOperation) this).aClass66_4938).aBool887) {
				...
				int[][] is_3_ = ((TextureOperation) this).aClass66_4938.method433(10);
				...
				for (int i_4_ = 0; i_4_ < anInt6749; i_4_++) {
					...
					int i_7_ = Class122.method826((byte) 94, random, EnumLoader.anInt2044);
					int i_8_ = (anInt6748 * StructType.anIntArray6855[i_5_] >> 12) + i_6_;
					...
					while_111_: do {
						while_110_: do {
							do {
								...
								anInt6747 = stream.readUnsignedByte();
								return;
							} while (false);
							anInt6749 = stream.readUnsignedShort();
							return;
						} while (false);
						anInt6748 = stream.readUnsignedByte();
						return;
					} while (false);
					anInt6751 = stream.readUnsignedShort();
					return;
				} while (false);
				anInt6758 = stream.readUnsignedShort();
				break;
			} catch (RuntimeException runtimeexception) {
